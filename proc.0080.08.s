...
sub_1001e43a:
	braw	sub_1001bebc	/* 1001e43a:	6000 da80 */

sub_1001e43e:
	braw	sub_1001c40c	/* 1001e43e:	6000 dfcc */

sub_1001e442:
	braw	sub_1001c410	/* 1001e442:	6000 dfcc */

sub_1001e446:
	braw	sub_1001ac8a	/* 1001e446:	6000 c842 */

sub_1001e44a:
	braw	sub_10016e64	/* 1001e44a:	6000 8a18 */

sub_1001e44e:
	braw	sub_10016e68	/* 1001e44e:	6000 8a18 */

sub_1001e452:
	linkw	%fp,#-28	/* 1001e452:	4e56 ffe4 */
	moveml	%a2-%a4,%sp@-	/* 1001e456:	48e7 0038 */
	moveal	%fp@(16),%a3	/* 1001e45a:	266e 0010 */
	moveal	%fp@(12),%a4	/* 1001e45e:	286e 000c */
	cmpal	#761,%a3	/* 1001e462:	b7fc 0000 02f9 */
	bnes	.L1001e486	/* 1001e468:	661c */
	movel	%a4,%sp@-	/* 1001e46a:	2f0c */
	jsr	%pc@(sub_1001d384)	/* 1001e46c:	4eba ef16 */
	addql	#4,%sp	/* 1001e470:	588f */
	movel	%d0,%sp@-	/* 1001e472:	2f00 */
	jsr	%pc@(sub_10016f08)	/* 1001e474:	4eba 8a92 */
	moveal	%fp@(20),%a0	/* 1001e478:	206e 0014 */
	moveb	#1,%a0@	/* 1001e47c:	10bc 0001 */
	addqw	#4,%sp	/* 1001e480:	584f */
	braw	.L1001e5c0	/* 1001e482:	6000 013c */

.L1001e486:
	cmpal	#929,%a3	/* 1001e486:	b7fc 0000 03a1 */
	bnes	.L1001e4ae	/* 1001e48c:	6620 */
	jsr	%pc@(sub_1002548a)	/* 1001e48e:	4eba 6ffa */
	moveal	%d0,%a0	/* 1001e492:	2040 */
	lea	%a0@(464),%a2	/* 1001e494:	45e8 01d0 */
	moveal	%a2@,%a0	/* 1001e498:	2052 */
	addql	#4,%a2@	/* 1001e49a:	5892 */
	movel	%a4,%a0@	/* 1001e49c:	208c */
	jsr	%pc@(sub_1001d69a)	/* 1001e49e:	4eba f1fa */
	moveal	%fp@(20),%a0	/* 1001e4a2:	206e 0014 */
	moveb	#1,%a0@	/* 1001e4a6:	10bc 0001 */
	braw	.L1001e5c0	/* 1001e4aa:	6000 0114 */

.L1001e4ae:
	cmpal	#937,%a3	/* 1001e4ae:	b7fc 0000 03a9 */
	bnes	.L1001e4ec	/* 1001e4b4:	6636 */
	cmpal	#2,%a4	/* 1001e4b6:	b9fc 0000 0002 */
	beqw	.L1001e5c0	/* 1001e4bc:	6700 0102 */
	movel	%a4,%d0	/* 1001e4c0:	200c */
	moveq	#-8,%d1	/* 1001e4c2:	72f8 */
	andl	%d0,%d1	/* 1001e4c4:	c280 */
	moveal	%d1,%a0	/* 1001e4c6:	2041 */
	movel	%a0@(4),%fp@(-12)	/* 1001e4c8:	2d68 0004 fff4 */
	jsr	%pc@(sub_1002548a)	/* 1001e4ce:	4eba 6fba */
	moveal	%d0,%a0	/* 1001e4d2:	2040 */
	lea	%a0@(464),%a2	/* 1001e4d4:	45e8 01d0 */
	moveal	%a2@,%a0	/* 1001e4d8:	2052 */
	addql	#4,%a2@	/* 1001e4da:	5892 */
	movel	%fp@(-12),%a0@	/* 1001e4dc:	20ae fff4 */
	moveal	%fp@(20),%a0	/* 1001e4e0:	206e 0014 */
	moveb	#1,%a0@	/* 1001e4e4:	10bc 0001 */
	braw	.L1001e5c0	/* 1001e4e8:	6000 00d6 */

.L1001e4ec:
	cmpal	#769,%a3	/* 1001e4ec:	b7fc 0000 0301 */
	bnew	.L1001e5c0	/* 1001e4f2:	6600 00cc */
	jsr	%pc@(sub_1002548a)	/* 1001e4f6:	4eba 6f92 */
	moveal	%d0,%a0	/* 1001e4fa:	2040 */
	lea	%a0@(464),%a3	/* 1001e4fc:	47e8 01d0 */
	moveal	%a3@,%a0	/* 1001e500:	2053 */
	addql	#4,%a3@	/* 1001e502:	5893 */
	moveq	#2,%d0	/* 1001e504:	7002 */
	movel	%d0,%a0@	/* 1001e506:	2080 */
	jsr	%pc@(sub_1002548a)	/* 1001e508:	4eba 6f80 */
	moveal	%d0,%a0	/* 1001e50c:	2040 */
	lea	%a0@(464),%a2	/* 1001e50e:	45e8 01d0 */
	moveal	%a2@,%a3	/* 1001e512:	2652 */
	subqw	#4,%a3	/* 1001e514:	594b */
	jsr	%pc@(sub_1002548a)	/* 1001e516:	4eba 6f72 */
	moveal	%d0,%a0	/* 1001e51a:	2040 */
	lea	%a0@(464),%a2	/* 1001e51c:	45e8 01d0 */
	moveal	%a2@,%a0	/* 1001e520:	2052 */
	addql	#4,%a2@	/* 1001e522:	5892 */
	movel	%a4,%a0@	/* 1001e524:	208c */
	moveq	#1,%d0	/* 1001e526:	7001 */
	movel	%d0,%sp@-	/* 1001e528:	2f00 */
	jsr	%pc@(sub_1002548a)	/* 1001e52a:	4eba 6f5e */
	moveal	%d0,%a0	/* 1001e52e:	2040 */
	pea	%a0@(464)	/* 1001e530:	4868 01d0 */
	jsr	%pc@(sub_1001e43a)	/* 1001e534:	4eba ff04 */
	jsr	%pc@(sub_1002548a)	/* 1001e538:	4eba 6f50 */
	moveal	%d0,%a0	/* 1001e53c:	2040 */
	lea	%a0@(464),%a2	/* 1001e53e:	45e8 01d0 */
	moveal	%a2@,%a4	/* 1001e542:	2852 */
	subqw	#8,%a4	/* 1001e544:	514c */
	addqw	#8,%sp	/* 1001e546:	504f */
	bras	.L1001e59c	/* 1001e548:	6052 */

.L1001e54a:
	moveq	#-8,%d0	/* 1001e54a:	70f8 */
	andl	%a4@,%d0	/* 1001e54c:	c094 */
	moveal	%d0,%a0	/* 1001e54e:	2040 */
	movel	%a0@,%a4@(4)	/* 1001e550:	2950 0004 */
	movel	%a4@(4),%sp@-	/* 1001e554:	2f2c 0004 */
	jsr	%pc@(sub_10018f0c)	/* 1001e558:	4eba a9b2 */
	movel	%d0,%fp@(-28)	/* 1001e55c:	2d40 ffe4 */
	jsr	%pc@(sub_1002548a)	/* 1001e560:	4eba 6f28 */
	moveal	%d0,%a0	/* 1001e564:	2040 */
	lea	%a0@(464),%a0	/* 1001e566:	41e8 01d0 */
	movel	%a0,%fp@(-24)	/* 1001e56a:	2d48 ffe8 */
	moveal	%a0@,%a1	/* 1001e56e:	2250 */
	addql	#4,%a0@	/* 1001e570:	5890 */
	movel	%fp@(-28),%a1@	/* 1001e572:	22ae ffe4 */
	movel	%a3@,%sp@-	/* 1001e576:	2f13 */
	jsr	%pc@(sub_10025810)	/* 1001e578:	4eba 7296 */
	jsr	%pc@(sub_1001cf26)	/* 1001e57c:	4eba e9a8 */
	jsr	%pc@(sub_1002548a)	/* 1001e580:	4eba 6f08 */
	moveal	%d0,%a0	/* 1001e584:	2040 */
	lea	%a0@(464),%a2	/* 1001e586:	45e8 01d0 */
	subql	#4,%a2@	/* 1001e58a:	5992 */
	moveal	%a2@,%a0	/* 1001e58c:	2052 */
	movel	%a0@,%a3@	/* 1001e58e:	2690 */
	moveq	#-8,%d0	/* 1001e590:	70f8 */
	andl	%a4@,%d0	/* 1001e592:	c094 */
	moveal	%d0,%a0	/* 1001e594:	2040 */
	movel	%a0@(4),%a4@	/* 1001e596:	28a8 0004 */
	addqw	#8,%sp	/* 1001e59a:	504f */

.L1001e59c:
	moveq	#2,%d0	/* 1001e59c:	7002 */
	cmpl	%a4@,%d0	/* 1001e59e:	b094 */
	bnes	.L1001e54a	/* 1001e5a0:	66a8 */
	jsr	%pc@(sub_1002548a)	/* 1001e5a2:	4eba 6ee6 */
	moveal	%d0,%a0	/* 1001e5a6:	2040 */
	lea	%a0@(464),%a2	/* 1001e5a8:	45e8 01d0 */
	movel	%a4,%a2@	/* 1001e5ac:	248c */
	movel	%a3@,%sp@-	/* 1001e5ae:	2f13 */
	jsr	%pc@(sub_1001d72a)	/* 1001e5b0:	4eba f178 */
	movel	%d0,%a3@	/* 1001e5b4:	2680 */
	moveal	%fp@(20),%a0	/* 1001e5b6:	206e 0014 */
	moveb	#1,%a0@	/* 1001e5ba:	10bc 0001 */
	addqw	#4,%sp	/* 1001e5be:	584f */

.L1001e5c0:
	moveml	%fp@(-40),%a2-%a4	/* 1001e5c0:	4cee 1c00 ffd8 */
	unlk	%fp	/* 1001e5c6:	4e5e */
	rts	/* 1001e5c8:	4e75 */
...
sub_1001e5da:
	linkw	%fp,#-20	/* 1001e5da:	4e56 ffec */
	moveml	%d3/%d7/%a3-%a4,%sp@-	/* 1001e5de:	48e7 1118 */
	jsr	%pc@(sub_1002548a)	/* 1001e5e2:	4eba 6ea6 */
	moveal	%d0,%a0	/* 1001e5e6:	2040 */
	lea	%a0@(464),%a3	/* 1001e5e8:	47e8 01d0 */
	moveal	%a3@,%a0	/* 1001e5ec:	2053 */
	addql	#4,%a3@	/* 1001e5ee:	5893 */
	moveq	#2,%d0	/* 1001e5f0:	7002 */
	movel	%d0,%a0@	/* 1001e5f2:	2080 */
	jsr	%pc@(sub_1002548a)	/* 1001e5f4:	4eba 6e94 */
	moveal	%d0,%a0	/* 1001e5f8:	2040 */
	lea	%a0@(464),%a4	/* 1001e5fa:	49e8 01d0 */
	moveal	%a4@,%a3	/* 1001e5fe:	2654 */
	lea	%a3@(-12),%a3	/* 1001e600:	47eb fff4 */
	jsr	%pc@(sub_1002548a)	/* 1001e604:	4eba 6e84 */
	moveal	%d0,%a0	/* 1001e608:	2040 */
	lea	%a0@(464),%a4	/* 1001e60a:	49e8 01d0 */
	moveal	%a4@,%a0	/* 1001e60e:	2054 */
	addql	#4,%a4@	/* 1001e610:	5894 */
	movel	%a3@,%a0@	/* 1001e612:	2093 */
	moveq	#1,%d0	/* 1001e614:	7001 */
	movel	%d0,%sp@-	/* 1001e616:	2f00 */
	jsr	%pc@(sub_1002548a)	/* 1001e618:	4eba 6e70 */
	moveal	%d0,%a0	/* 1001e61c:	2040 */
	pea	%a0@(464)	/* 1001e61e:	4868 01d0 */
	jsr	%pc@(sub_1001e43a)	/* 1001e622:	4eba fe16 */
	jsr	%pc@(sub_1002548a)	/* 1001e626:	4eba 6e62 */
	moveal	%d0,%a0	/* 1001e62a:	2040 */
	lea	%a0@(464),%a0	/* 1001e62c:	41e8 01d0 */
	movel	%a0,%fp@(-8)	/* 1001e630:	2d48 fff8 */
	moveal	%a0@,%a4	/* 1001e634:	2850 */
	subqw	#8,%a4	/* 1001e636:	514c */
	addqw	#8,%sp	/* 1001e638:	504f */
	braw	.L1001e6d2	/* 1001e63a:	6000 0096 */

.L1001e63e:
	moveq	#-8,%d0	/* 1001e63e:	70f8 */
	andl	%a4@,%d0	/* 1001e640:	c094 */
	moveal	%d0,%a0	/* 1001e642:	2040 */
	movel	%a0@,%a4@(4)	/* 1001e644:	2950 0004 */
	movel	%a4@(4),%fp@(-20)	/* 1001e648:	2d6c 0004 ffec */
	movel	%fp@(-20),%sp@-	/* 1001e64e:	2f2e ffec */
	jsr	%pc@(sub_10025242)	/* 1001e652:	4eba 6bee */
	moveb	%d0,%d7	/* 1001e656:	1e00 */
	moveq	#1,%d3	/* 1001e658:	7601 */
	moveq	#0,%d0	/* 1001e65a:	7000 */
	moveb	%d7,%d0	/* 1001e65c:	1007 */
	movel	%a3@(4),%d1	/* 1001e65e:	222b 0004 */
	asrl	#3,%d1	/* 1001e662:	e681 */
	cmpl	%d0,%d1	/* 1001e664:	b280 */
	addqw	#4,%sp	/* 1001e666:	584f */
	beqs	.L1001e68a	/* 1001e668:	6720 */
	movel	%d3,%sp@-	/* 1001e66a:	2f03 */
	movel	%a3@(4),%sp@-	/* 1001e66c:	2f2b 0004 */
	moveq	#0,%d0	/* 1001e670:	7000 */
	moveb	%d7,%d0	/* 1001e672:	1007 */
	movel	%d0,%sp@-	/* 1001e674:	2f00 */
	movel	%fp@(-20),%sp@-	/* 1001e676:	2f2e ffec */
	jsr	%pc@(sub_1001765e)	/* 1001e67a:	4eba 8fe2 */
	lea	%sp@(12),%sp	/* 1001e67e:	4fef 000c */
	movel	%sp@+,%d3	/* 1001e682:	261f */
	tstb	%d0	/* 1001e684:	4a00 */
	bnes	.L1001e68a	/* 1001e686:	6602 */
	moveq	#0,%d3	/* 1001e688:	7600 */

.L1001e68a:
	tstb	%d3	/* 1001e68a:	4a03 */
	beqs	.L1001e6c8	/* 1001e68c:	673a */
	jsr	%pc@(sub_1002548a)	/* 1001e68e:	4eba 6dfa */
	moveal	%d0,%a0	/* 1001e692:	2040 */
	lea	%a0@(464),%a0	/* 1001e694:	41e8 01d0 */
	movel	%a0,%fp@(-16)	/* 1001e698:	2d48 fff0 */
	moveal	%a0@,%a1	/* 1001e69c:	2250 */
	addql	#4,%a0@	/* 1001e69e:	5890 */
	movel	%fp@(-20),%a1@	/* 1001e6a0:	22ae ffec */
	movel	%a3@(8),%sp@-	/* 1001e6a4:	2f2b 0008 */
	jsr	%pc@(sub_10025810)	/* 1001e6a8:	4eba 7166 */
	jsr	%pc@(sub_1001cf26)	/* 1001e6ac:	4eba e878 */
	jsr	%pc@(sub_1002548a)	/* 1001e6b0:	4eba 6dd8 */
	moveal	%d0,%a0	/* 1001e6b4:	2040 */
	lea	%a0@(464),%a0	/* 1001e6b6:	41e8 01d0 */
	movel	%a0,%fp@(-12)	/* 1001e6ba:	2d48 fff4 */
	subql	#4,%a0@	/* 1001e6be:	5990 */
	moveal	%a0@,%a0	/* 1001e6c0:	2050 */
	movel	%a0@,%a3@(8)	/* 1001e6c2:	2750 0008 */
	addqw	#4,%sp	/* 1001e6c6:	584f */

.L1001e6c8:
	moveq	#-8,%d0	/* 1001e6c8:	70f8 */
	andl	%a4@,%d0	/* 1001e6ca:	c094 */
	moveal	%d0,%a0	/* 1001e6cc:	2040 */
	movel	%a0@(4),%a4@	/* 1001e6ce:	28a8 0004 */

.L1001e6d2:
	moveq	#2,%d0	/* 1001e6d2:	7002 */
	cmpl	%a4@,%d0	/* 1001e6d4:	b094 */
	bnew	.L1001e63e	/* 1001e6d6:	6600 ff66 */
	jsr	%pc@(sub_1002548a)	/* 1001e6da:	4eba 6dae */
	moveal	%d0,%a0	/* 1001e6de:	2040 */
	lea	%a0@(464),%a0	/* 1001e6e0:	41e8 01d0 */
	movel	%a0,%fp@(-4)	/* 1001e6e4:	2d48 fffc */
	movel	%a4,%a0@	/* 1001e6e8:	208c */
	movel	%a3@(8),%sp@-	/* 1001e6ea:	2f2b 0008 */
	jsr	%pc@(sub_1001d72a)	/* 1001e6ee:	4eba f03a */
	movel	%d0,%fp@(-12)	/* 1001e6f2:	2d40 fff4 */
	jsr	%pc@(sub_1002548a)	/* 1001e6f6:	4eba 6d92 */
	moveal	%d0,%a0	/* 1001e6fa:	2040 */
	lea	%a0@(464),%a4	/* 1001e6fc:	49e8 01d0 */
	movel	%a3,%a4@	/* 1001e700:	288b */
	jsr	%pc@(sub_1002548a)	/* 1001e702:	4eba 6d86 */
	moveal	%d0,%a0	/* 1001e706:	2040 */
	lea	%a0@(464),%a3	/* 1001e708:	47e8 01d0 */
	moveal	%a3@,%a0	/* 1001e70c:	2053 */
	addql	#4,%a3@	/* 1001e70e:	5893 */
	movel	%fp@(-12),%a0@	/* 1001e710:	20ae fff4 */
	addqw	#4,%sp	/* 1001e714:	584f */
	moveml	%fp@(-36),%d3/%d7/%a3-%a4	/* 1001e716:	4cee 1888 ffdc */
	unlk	%fp	/* 1001e71c:	4e5e */
	rts	/* 1001e71e:	4e75 */
...
sub_1001e796:
	braw	sub_10025f4e	/* 1001e796:	6000 77b6 */

sub_1001e79a:
	linkw	%fp,#-24	/* 1001e79a:	4e56 ffe8 */
	moveml	%d7/%a3-%a4,%sp@-	/* 1001e79e:	48e7 0118 */
	moveal	%fp@(16),%a3	/* 1001e7a2:	266e 0010 */
	moveal	%fp@(12),%a4	/* 1001e7a6:	286e 000c */
	movel	%a3,%sp@-	/* 1001e7aa:	2f0b */
	movel	%a4,%sp@-	/* 1001e7ac:	2f0c */
	jsr	%pc@(sub_1001e002)	/* 1001e7ae:	4eba f852 */
	movel	%d0,%d7	/* 1001e7b2:	2e00 */
	addqw	#8,%sp	/* 1001e7b4:	504f */
	beqw	.L1001e842	/* 1001e7b6:	6700 008a */
	jsr	%pc@(sub_1002547e)	/* 1001e7ba:	4eba 6cc2 */
	moveal	%d0,%a0	/* 1001e7be:	2040 */
	pea	%a0@(434)	/* 1001e7c0:	4868 01b2 */
	jsr	%pc@(sub_1001740c)	/* 1001e7c4:	4eba 8c46 */
	movew	%d0,%fp@(-24)	/* 1001e7c8:	3d40 ffe8 */
	movel	%d1,%fp@(-22)	/* 1001e7cc:	2d41 ffea */
	movel	%a0,%fp@(-18)	/* 1001e7d0:	2d48 ffee */
	lea	%fp@(-24),%a0	/* 1001e7d4:	41ee ffe8 */
	lea	%fp@(-14),%a1	/* 1001e7d8:	43ee fff2 */
	movel	%a0@+,%a1@+	/* 1001e7dc:	22d8 */
	movel	%a0@+,%a1@+	/* 1001e7de:	22d8 */
	movew	%a0@+,%a1@+	/* 1001e7e0:	32d8 */
	lea	%fp@(-14),%a0	/* 1001e7e2:	41ee fff2 */
	lea	%fp@(-24),%a1	/* 1001e7e6:	43ee ffe8 */
	movel	%a0@+,%a1@+	/* 1001e7ea:	22d8 */
	movel	%a0@+,%a1@+	/* 1001e7ec:	22d8 */
	...
	jsr	%pc@(sub_1001f63c)	/* 1001e804:	4eba 0e36 */
	addql	#1,%d0	/* 1001e808:	5280 */
	addql	#4,%sp	/* 1001e80a:	588f */
	movel	%d0,%sp@-	/* 1001e80c:	2f00 */
	jsr	%pc@(sub_10016f08)	/* 1001e80e:	4eba 86f8 */
	movel	%fp@(24),%sp@-	/* 1001e812:	2f2e 0018 */
	movel	%fp@(20),%sp@-	/* 1001e816:	2f2e 0014 */
	jsr	%pc@(sub_1002548a)	/* 1001e81a:	4eba 6c6e */
	moveal	%d0,%a0	/* 1001e81e:	2040 */
	lea	%a0@(464),%a0	/* 1001e820:	41e8 01d0 */
	movel	%a0,%fp@(-4)	/* 1001e824:	2d48 fffc */
	subql	#4,%a0@	/* 1001e828:	5990 */
	moveal	%a0@,%a0	/* 1001e82a:	2050 */
	movel	%a0@,%sp@-	/* 1001e82c:	2f10 */
	movel	%a3,%sp@-	/* 1001e82e:	2f0b */
	movel	%a4,%sp@-	/* 1001e830:	2f0c */
	moveq	#0,%d0	/* 1001e832:	7000 */
	moveb	%fp@(11),%d0	/* 1001e834:	102e 000b */
	movel	%d0,%sp@-	/* 1001e838:	2f00 */
	jsr	%pc@(sub_100194b2)	/* 1001e83a:	4eba ac76 */
	lea	%sp@(32),%sp	/* 1001e83e:	4fef 0020 */

.L1001e842:
	moveml	%fp@(-36),%d7/%a3-%a4	/* 1001e842:	4cee 1880 ffdc */
	unlk	%fp	/* 1001e848:	4e5e */
	rts	/* 1001e84a:	4e75 */

sub_1001e84c:
	braw	sub_1002600a	/* 1001e84c:	6000 77bc */

sub_1001e850:
	braw	sub_1002600e	/* 1001e850:	6000 77bc */

sub_1001e854:
	braw	sub_10026012	/* 1001e854:	6000 77bc */

sub_1001e858:
	braw	sub_10026016	/* 1001e858:	6000 77bc */

sub_1001e85c:
	braw	sub_1001719a	/* 1001e85c:	6000 893c */

sub_1001e860:
	braw	sub_100171b2	/* 1001e860:	6000 8950 */

sub_1001e864:
	linkw	%fp,#0	/* 1001e864:	4e56 0000 */
	moveml	%d7/%a3-%a4,%sp@-	/* 1001e868:	48e7 0118 */
	moveal	%fp@(16),%a3	/* 1001e86c:	266e 0010 */
	moveal	%fp@(12),%a4	/* 1001e870:	286e 000c */
	movel	%a3,%sp@-	/* 1001e874:	2f0b */
	movel	%a4,%sp@-	/* 1001e876:	2f0c */
	jsr	%pc@(sub_1001e002)	/* 1001e878:	4eba f788 */
	movel	%d0,%d7	/* 1001e87c:	2e00 */
	movel	%fp@(24),%sp@-	/* 1001e87e:	2f2e 0018 */
	movel	%fp@(20),%sp@-	/* 1001e882:	2f2e 0014 */
	movel	%d7,%d0	/* 1001e886:	2007 */
	addql	#1,%d0	/* 1001e888:	5280 */
	asrl	#1,%d0	/* 1001e88a:	e280 */
	movel	%d0,%sp@-	/* 1001e88c:	2f00 */
	jsr	%pc@(sub_10016d36)	/* 1001e88e:	4eba 84a6 */
	addql	#4,%sp	/* 1001e892:	588f */
	movel	%d0,%sp@-	/* 1001e894:	2f00 */
	movel	%a3,%sp@-	/* 1001e896:	2f0b */
	movel	%a4,%sp@-	/* 1001e898:	2f0c */
	moveq	#0,%d0	/* 1001e89a:	7000 */
	moveb	%fp@(11),%d0	/* 1001e89c:	102e 000b */
	movel	%d0,%sp@-	/* 1001e8a0:	2f00 */
	jsr	%pc@(sub_100194b2)	/* 1001e8a2:	4eba ac0e */
	moveml	%fp@(-12),%d7/%a3-%a4	/* 1001e8a6:	4cee 1880 fff4 */
	unlk	%fp	/* 1001e8ac:	4e5e */
	rts	/* 1001e8ae:	4e75 */

sub_1001e8b0:
	braw	sub_1001f60e	/* 1001e8b0:	6000 0d5c */

sub_1001e8b4:
	linkw	%fp,#-4	/* 1001e8b4:	4e56 fffc */
	moveml	%d3-%d7/%a3-%a4,%sp@-	/* 1001e8b8:	48e7 1f18 */
	movel	%fp@(20),%sp@-	/* 1001e8bc:	2f2e 0014 */
	jsr	%pc@(sub_10025242)	/* 1001e8c0:	4eba 6980 */
	moveb	%d0,%d5	/* 1001e8c4:	1a00 */
	jsr	%pc@(sub_1002548a)	/* 1001e8c6:	4eba 6bc2 */
	moveal	%d0,%a0	/* 1001e8ca:	2040 */
	lea	%a0@(464),%a4	/* 1001e8cc:	49e8 01d0 */
	movel	%a4@,%d0	/* 1001e8d0:	2014 */
	moveq	#80,%d1	/* 1001e8d2:	7250 */
	addl	%d1,%d0	/* 1001e8d4:	d081 */
	cmpl	%a4@(4),%d0	/* 1001e8d6:	b0ac 0004 */
	bcss	.L1001e8e8	/* 1001e8da:	650c */
	movel	%a4,%sp@-	/* 1001e8dc:	2f0c */
	jsr	%pc@(sub_1001da1e)	/* 1001e8de:	4eba f13e */
	moveq	#0,%d0	/* 1001e8e2:	7000 */
	addqw	#4,%sp	/* 1001e8e4:	584f */
	bras	.L1001e8ea	/* 1001e8e6:	6002 */

.L1001e8e8:
	moveq	#0,%d0	/* 1001e8e8:	7000 */

.L1001e8ea:
	moveb	%d5,%d0	/* 1001e8ea:	1005 */
	subqb	#2,%d0	/* 1001e8ec:	5500 */
	addqw	#4,%sp	/* 1001e8ee:	584f */
	beqs	.L1001e90e	/* 1001e8f0:	671c */
	subqb	#1,%d0	/* 1001e8f2:	5300 */
	beqw	.L1001e9b0	/* 1001e8f4:	6700 00ba */
	subqb	#2,%d0	/* 1001e8f8:	5500 */
	beqw	.L1001e98a	/* 1001e8fa:	6700 008e */
	subqb	#2,%d0	/* 1001e8fe:	5500 */
	beqw	.L1001e9b0	/* 1001e900:	6700 00ae */
	subqb	#5,%d0	/* 1001e904:	5b00 */
	beqw	.L1001e98a	/* 1001e906:	6700 0082 */
	braw	.L1001ea88	/* 1001e90a:	6000 017c */

.L1001e90e:
	moveq	#2,%d0	/* 1001e90e:	7002 */
	cmpl	%fp@(20),%d0	/* 1001e910:	b0ae 0014 */
	bnes	.L1001e92c	/* 1001e914:	6616 */
	jsr	%pc@(sub_1002548a)	/* 1001e916:	4eba 6b72 */
	moveal	%d0,%a0	/* 1001e91a:	2040 */
	lea	%a0@(464),%a4	/* 1001e91c:	49e8 01d0 */
	moveal	%a4@,%a0	/* 1001e920:	2054 */
	addql	#4,%a4@	/* 1001e922:	5894 */
	movel	%fp@(12),%a0@	/* 1001e924:	20ae 000c */
	braw	.L1001ea88	/* 1001e928:	6000 015e */

.L1001e92c:
	movel	%fp@(28),%sp@-	/* 1001e92c:	2f2e 001c */
	movel	%fp@(24),%sp@-	/* 1001e930:	2f2e 0018 */
	moveq	#-8,%d0	/* 1001e934:	70f8 */
	andl	%fp@(20),%d0	/* 1001e936:	c0ae 0014 */
	moveal	%d0,%a0	/* 1001e93a:	2040 */
	movel	%a0@,%sp@-	/* 1001e93c:	2f10 */
	movel	%fp@(16),%sp@-	/* 1001e93e:	2f2e 0010 */
	movel	%fp@(12),%sp@-	/* 1001e942:	2f2e 000c */
	moveq	#2,%d0	/* 1001e946:	7002 */
	movel	%d0,%sp@-	/* 1001e948:	2f00 */
	jsr	%pc@(sub_1001e8b4)	/* 1001e94a:	4eba ff68 */
	movel	%fp@(28),%sp@-	/* 1001e94e:	2f2e 001c */
	movel	%fp@(24),%sp@-	/* 1001e952:	2f2e 0018 */
	moveq	#-8,%d0	/* 1001e956:	70f8 */
	andl	%fp@(20),%d0	/* 1001e958:	c0ae 0014 */
	moveal	%d0,%a0	/* 1001e95c:	2040 */
	movel	%a0@(4),%sp@-	/* 1001e95e:	2f28 0004 */
	movel	%fp@(16),%sp@-	/* 1001e962:	2f2e 0010 */
	jsr	%pc@(sub_1002548a)	/* 1001e966:	4eba 6b22 */
	moveal	%d0,%a0	/* 1001e96a:	2040 */
	lea	%a0@(464),%a4	/* 1001e96c:	49e8 01d0 */
	subql	#4,%a4@	/* 1001e970:	5994 */
	moveal	%a4@,%a0	/* 1001e972:	2054 */
	movel	%a0@,%sp@-	/* 1001e974:	2f10 */
	moveq	#0,%d0	/* 1001e976:	7000 */
	moveb	%fp@(11),%d0	/* 1001e978:	102e 000b */
	movel	%d0,%sp@-	/* 1001e97c:	2f00 */
	jsr	%pc@(sub_100194b2)	/* 1001e97e:	4eba ab32 */
	lea	%sp@(48),%sp	/* 1001e982:	4fef 0030 */
	braw	.L1001ea88	/* 1001e986:	6000 0100 */

.L1001e98a:
	moveq	#0,%d0	/* 1001e98a:	7000 */
	moveb	%d5,%d0	/* 1001e98c:	1005 */
	cmpiw	#3,%d0	/* 1001e98e:	0c40 0003 */
	beqs	.L1001e9b0	/* 1001e992:	671c */
	moveq	#25,%d0	/* 1001e994:	7019 */
	movel	%d0,%sp@-	/* 1001e996:	2f00 */
	pea	%fp@(20)	/* 1001e998:	486e 0014 */
	moveq	#0,%d1	/* 1001e99c:	7200 */
	moveb	%d5,%d1	/* 1001e99e:	1205 */
	movel	%d1,%sp@-	/* 1001e9a0:	2f01 */
	jsr	%pc@(sub_1001793c)	/* 1001e9a2:	4eba 8f98 */
	tstb	%d0	/* 1001e9a6:	4a00 */
	lea	%sp@(12),%sp	/* 1001e9a8:	4fef 000c */
	beqw	.L1001ea88	/* 1001e9ac:	6700 00da */

.L1001e9b0:
	movel	%fp@(20),%d5	/* 1001e9b0:	2a2e 0014 */
	asrl	#2,%d5	/* 1001e9b4:	e485 */
	tstl	%d5	/* 1001e9b6:	4a85 */
	beqw	.L1001ea88	/* 1001e9b8:	6700 00ce */
	clrb	%d4	/* 1001e9bc:	4204 */
	tstl	%d5	/* 1001e9be:	4a85 */
	bges	.L1001e9ca	/* 1001e9c0:	6c08 */
	movel	%d5,%d0	/* 1001e9c2:	2005 */
	negl	%d0	/* 1001e9c4:	4480 */
	movel	%d0,%d5	/* 1001e9c6:	2a00 */
	moveq	#1,%d4	/* 1001e9c8:	7801 */

.L1001e9ca:
	tstb	%d4	/* 1001e9ca:	4a04 */
	beqs	.L1001e9dc	/* 1001e9cc:	670e */
	movel	%fp@(12),%sp@-	/* 1001e9ce:	2f2e 000c */
	jsr	%pc@(sub_1001d72a)	/* 1001e9d2:	4eba ed56 */
	movel	%d0,%fp@(12)	/* 1001e9d6:	2d40 000c */
	addqw	#4,%sp	/* 1001e9da:	584f */

.L1001e9dc:
	moveq	#0,%d6	/* 1001e9dc:	7c00 */
	moveal	%fp@(12),%a4	/* 1001e9de:	286e 000c */
	braw	.L1001ea6c	/* 1001e9e2:	6000 0088 */

.L1001e9e6:
	movel	%a4,%d0	/* 1001e9e6:	200c */
	moveq	#-8,%d1	/* 1001e9e8:	72f8 */
	andl	%d0,%d1	/* 1001e9ea:	c280 */
	moveal	%d1,%a0	/* 1001e9ec:	2041 */
	moveal	%a0@,%a3	/* 1001e9ee:	2650 */
	movel	%a3,%sp@-	/* 1001e9f0:	2f0b */
	jsr	%pc@(sub_10025242)	/* 1001e9f2:	4eba 684e */
	moveb	%d0,%d7	/* 1001e9f6:	1e00 */
	moveq	#1,%d3	/* 1001e9f8:	7601 */
	moveq	#0,%d0	/* 1001e9fa:	7000 */
	moveb	%d7,%d0	/* 1001e9fc:	1007 */
	movel	%fp@(16),%d1	/* 1001e9fe:	222e 0010 */
	asrl	#3,%d1	/* 1001ea02:	e681 */
	cmpl	%d0,%d1	/* 1001ea04:	b280 */
	addqw	#4,%sp	/* 1001ea06:	584f */
	beqs	.L1001ea28	/* 1001ea08:	671e */
	movel	%d3,%sp@-	/* 1001ea0a:	2f03 */
	movel	%fp@(16),%sp@-	/* 1001ea0c:	2f2e 0010 */
	moveq	#0,%d0	/* 1001ea10:	7000 */
	moveb	%d7,%d0	/* 1001ea12:	1007 */
	movel	%d0,%sp@-	/* 1001ea14:	2f00 */
	movel	%a3,%sp@-	/* 1001ea16:	2f0b */
	jsr	%pc@(sub_1001765e)	/* 1001ea18:	4eba 8c44 */
	lea	%sp@(12),%sp	/* 1001ea1c:	4fef 000c */
	movel	%sp@+,%d3	/* 1001ea20:	261f */
	tstb	%d0	/* 1001ea22:	4a00 */
	bnes	.L1001ea28	/* 1001ea24:	6602 */
	moveq	#0,%d3	/* 1001ea26:	7600 */

.L1001ea28:
	tstb	%d3	/* 1001ea28:	4a03 */
	beqs	.L1001ea30	/* 1001ea2a:	6704 */
	movel	%d6,%d0	/* 1001ea2c:	2006 */
	addql	#1,%d6	/* 1001ea2e:	5286 */

.L1001ea30:
	cmpl	%d6,%d5	/* 1001ea30:	ba86 */
	bnes	.L1001ea60	/* 1001ea32:	662c */
	jsr	%pc@(sub_1002548a)	/* 1001ea34:	4eba 6a54 */
	moveal	%d0,%a0	/* 1001ea38:	2040 */
	lea	%a0@(464),%a0	/* 1001ea3a:	41e8 01d0 */
	movel	%a0,%fp@(-4)	/* 1001ea3e:	2d48 fffc */
	moveal	%a0@,%a1	/* 1001ea42:	2250 */
	addql	#4,%a0@	/* 1001ea44:	5890 */
	movel	%a3,%a1@	/* 1001ea46:	228b */
	movel	%a3,%sp@-	/* 1001ea48:	2f0b */
	jsr	%pc@(sub_10017f28)	/* 1001ea4a:	4eba 94dc */
	moveal	%fp@(28),%a0	/* 1001ea4e:	206e 001c */
	movel	%d0,%a0@	/* 1001ea52:	2080 */
	moveal	%fp@(24),%a0	/* 1001ea54:	206e 0018 */
	moveb	#1,%a0@	/* 1001ea58:	10bc 0001 */
	addqw	#4,%sp	/* 1001ea5c:	584f */
	bras	.L1001ea76	/* 1001ea5e:	6016 */

.L1001ea60:
	movel	%a4,%d0	/* 1001ea60:	200c */
	moveq	#-8,%d1	/* 1001ea62:	72f8 */
	andl	%d0,%d1	/* 1001ea64:	c280 */
	moveal	%d1,%a0	/* 1001ea66:	2041 */
	moveal	%a0@(4),%a4	/* 1001ea68:	2868 0004 */

.L1001ea6c:
	cmpal	#2,%a4	/* 1001ea6c:	b9fc 0000 0002 */
	bnew	.L1001e9e6	/* 1001ea72:	6600 ff72 */

.L1001ea76:
	tstb	%d4	/* 1001ea76:	4a04 */
	beqs	.L1001ea88	/* 1001ea78:	670e */
	movel	%fp@(12),%sp@-	/* 1001ea7a:	2f2e 000c */
	jsr	%pc@(sub_1001d72a)	/* 1001ea7e:	4eba ecaa */
	movel	%d0,%fp@(12)	/* 1001ea82:	2d40 000c */
	addqw	#4,%sp	/* 1001ea86:	584f */

.L1001ea88:
	moveml	%fp@(-32),%d3-%d7/%a3-%a4	/* 1001ea88:	4cee 18f8 ffe0 */
	unlk	%fp	/* 1001ea8e:	4e5e */
	rts	/* 1001ea90:	4e75 */

sub_1001ea92:
	braw	sub_10025070	/* 1001ea92:	6000 65dc */

sub_1001ea96:
	linkw	%fp,#-12	/* 1001ea96:	4e56 fff4 */
	moveml	%d3-%d7/%a3-%a4,%sp@-	/* 1001ea9a:	48e7 1f18 */
	moveb	%fp@(11),%d4	/* 1001ea9e:	182e 000b */
	movel	%fp@(20),%sp@-	/* 1001eaa2:	2f2e 0014 */
	jsr	%pc@(sub_10025242)	/* 1001eaa6:	4eba 679a */
	moveb	%d0,%d5	/* 1001eaaa:	1a00 */
	subqb	#2,%d0	/* 1001eaac:	5500 */
	addqw	#4,%sp	/* 1001eaae:	584f */
	beqs	.L1001eace	/* 1001eab0:	671c */
	subqb	#1,%d0	/* 1001eab2:	5300 */
	beqw	.L1001ebb0	/* 1001eab4:	6700 00fa */
	subqb	#2,%d0	/* 1001eab8:	5500 */
	beqw	.L1001eb8a	/* 1001eaba:	6700 00ce */
	subqb	#2,%d0	/* 1001eabe:	5500 */
	beqw	.L1001ebb0	/* 1001eac0:	6700 00ee */
	subqb	#5,%d0	/* 1001eac4:	5b00 */
	beqw	.L1001eb8a	/* 1001eac6:	6700 00c2 */
	braw	.L1001ec7a	/* 1001eaca:	6000 01ae */

.L1001eace:
	moveq	#2,%d0	/* 1001eace:	7002 */
	cmpl	%fp@(20),%d0	/* 1001ead0:	b0ae 0014 */
	beqw	.L1001ec7a	/* 1001ead4:	6700 01a4 */
	moveq	#-8,%d0	/* 1001ead8:	70f8 */
	andl	%fp@(20),%d0	/* 1001eada:	c0ae 0014 */
	moveal	%d0,%a0	/* 1001eade:	2040 */
	moveal	%a0@(4),%a4	/* 1001eae0:	2868 0004 */
	cmpal	#2,%a4	/* 1001eae4:	b9fc 0000 0002 */
	bnes	.L1001eb18	/* 1001eaea:	662c */
	movel	%fp@(28),%sp@-	/* 1001eaec:	2f2e 001c */
	movel	%fp@(24),%sp@-	/* 1001eaf0:	2f2e 0018 */
	moveq	#-8,%d0	/* 1001eaf4:	70f8 */
	andl	%fp@(20),%d0	/* 1001eaf6:	c0ae 0014 */
	moveal	%d0,%a0	/* 1001eafa:	2040 */
	movel	%a0@,%sp@-	/* 1001eafc:	2f10 */
	movel	%fp@(16),%sp@-	/* 1001eafe:	2f2e 0010 */
	movel	%fp@(12),%sp@-	/* 1001eb02:	2f2e 000c */
	moveq	#0,%d0	/* 1001eb06:	7000 */
	moveb	%d4,%d0	/* 1001eb08:	1004 */
	movel	%d0,%sp@-	/* 1001eb0a:	2f00 */
	jsr	%pc@(sub_1001ea96)	/* 1001eb0c:	4eba ff88 */
	lea	%sp@(24),%sp	/* 1001eb10:	4fef 0018 */
	braw	.L1001ec7a	/* 1001eb14:	6000 0164 */

.L1001eb18:
	moveq	#1,%d0	/* 1001eb18:	7001 */
	movel	%d0,%fp@(-4)	/* 1001eb1a:	2d40 fffc */
	pea	%fp@(-4)	/* 1001eb1e:	486e fffc */
	movel	%fp@(28),%sp@-	/* 1001eb22:	2f2e 001c */
	moveq	#-8,%d0	/* 1001eb26:	70f8 */
	andl	%fp@(20),%d0	/* 1001eb28:	c0ae 0014 */
	moveal	%d0,%a0	/* 1001eb2c:	2040 */
	movel	%a0@,%sp@-	/* 1001eb2e:	2f10 */
	movel	%fp@(16),%sp@-	/* 1001eb30:	2f2e 0010 */
	movel	%fp@(12),%sp@-	/* 1001eb34:	2f2e 000c */
	moveq	#2,%d0	/* 1001eb38:	7002 */
	movel	%d0,%sp@-	/* 1001eb3a:	2f00 */
	jsr	%pc@(sub_1001e8b4)	/* 1001eb3c:	4eba fd76 */
	moveal	%fp@(28),%a0	/* 1001eb40:	206e 001c */
	tstb	%a0@	/* 1001eb44:	4a10 */
	lea	%sp@(24),%sp	/* 1001eb46:	4fef 0018 */
	beqw	.L1001ec7a	/* 1001eb4a:	6700 012e */
	clrb	%a0@	/* 1001eb4e:	4210 */
	movel	%fp@(28),%sp@-	/* 1001eb50:	2f2e 001c */
	movel	%fp@(24),%sp@-	/* 1001eb54:	2f2e 0018 */
	moveq	#-8,%d0	/* 1001eb58:	70f8 */
	andl	%fp@(20),%d0	/* 1001eb5a:	c0ae 0014 */
	moveal	%d0,%a0	/* 1001eb5e:	2040 */
	movel	%a0@(4),%sp@-	/* 1001eb60:	2f28 0004 */
	movel	%fp@(16),%sp@-	/* 1001eb64:	2f2e 0010 */
	jsr	%pc@(sub_1002548a)	/* 1001eb68:	4eba 6920 */
	moveal	%d0,%a0	/* 1001eb6c:	2040 */
	lea	%a0@(464),%a4	/* 1001eb6e:	49e8 01d0 */
	subql	#4,%a4@	/* 1001eb72:	5994 */
	moveal	%a4@,%a0	/* 1001eb74:	2054 */
	movel	%a0@,%sp@-	/* 1001eb76:	2f10 */
	moveq	#0,%d0	/* 1001eb78:	7000 */
	moveb	%d4,%d0	/* 1001eb7a:	1004 */
	movel	%d0,%sp@-	/* 1001eb7c:	2f00 */
	jsr	%pc@(sub_1001a50c)	/* 1001eb7e:	4eba b98c */
	lea	%sp@(24),%sp	/* 1001eb82:	4fef 0018 */
	braw	.L1001ec7a	/* 1001eb86:	6000 00f2 */

.L1001eb8a:
	moveq	#0,%d0	/* 1001eb8a:	7000 */
	moveb	%d5,%d0	/* 1001eb8c:	1005 */
	cmpiw	#3,%d0	/* 1001eb8e:	0c40 0003 */
	beqs	.L1001ebb0	/* 1001eb92:	671c */
	moveq	#25,%d0	/* 1001eb94:	7019 */
	movel	%d0,%sp@-	/* 1001eb96:	2f00 */
	pea	%fp@(20)	/* 1001eb98:	486e 0014 */
	moveq	#0,%d1	/* 1001eb9c:	7200 */
	moveb	%d5,%d1	/* 1001eb9e:	1205 */
	movel	%d1,%sp@-	/* 1001eba0:	2f01 */
	jsr	%pc@(sub_1001793c)	/* 1001eba2:	4eba 8d98 */
	tstb	%d0	/* 1001eba6:	4a00 */
	lea	%sp@(12),%sp	/* 1001eba8:	4fef 000c */
	beqw	.L1001ec7a	/* 1001ebac:	6700 00cc */

.L1001ebb0:
	movel	%fp@(20),%d5	/* 1001ebb0:	2a2e 0014 */
	asrl	#2,%d5	/* 1001ebb4:	e485 */
	tstl	%d5	/* 1001ebb6:	4a85 */
	beqw	.L1001ec7a	/* 1001ebb8:	6700 00c0 */
	clrb	%d4	/* 1001ebbc:	4204 */
	tstl	%d5	/* 1001ebbe:	4a85 */
	bges	.L1001ebca	/* 1001ebc0:	6c08 */
	movel	%d5,%d0	/* 1001ebc2:	2005 */
	negl	%d0	/* 1001ebc4:	4480 */
	movel	%d0,%d5	/* 1001ebc6:	2a00 */
	moveq	#1,%d4	/* 1001ebc8:	7801 */

.L1001ebca:
	tstb	%d4	/* 1001ebca:	4a04 */
	beqs	.L1001ebdc	/* 1001ebcc:	670e */
	movel	%fp@(12),%sp@-	/* 1001ebce:	2f2e 000c */
	jsr	%pc@(sub_1001d72a)	/* 1001ebd2:	4eba eb56 */
	movel	%d0,%fp@(12)	/* 1001ebd6:	2d40 000c */
	addqw	#4,%sp	/* 1001ebda:	584f */

.L1001ebdc:
	moveq	#0,%d6	/* 1001ebdc:	7c00 */
	moveal	%fp@(12),%a4	/* 1001ebde:	286e 000c */
	bras	.L1001ec5e	/* 1001ebe2:	607a */

.L1001ebe4:
	movel	%a4,%d0	/* 1001ebe4:	200c */
	moveq	#-8,%d1	/* 1001ebe6:	72f8 */
	andl	%d0,%d1	/* 1001ebe8:	c280 */
	moveal	%d1,%a0	/* 1001ebea:	2041 */
	moveal	%a0@,%a3	/* 1001ebec:	2650 */
	movel	%a3,%sp@-	/* 1001ebee:	2f0b */
	jsr	%pc@(sub_10025242)	/* 1001ebf0:	4eba 6650 */
	moveb	%d0,%d7	/* 1001ebf4:	1e00 */
	moveq	#1,%d3	/* 1001ebf6:	7601 */
	moveq	#0,%d0	/* 1001ebf8:	7000 */
	moveb	%d7,%d0	/* 1001ebfa:	1007 */
	movel	%fp@(16),%d1	/* 1001ebfc:	222e 0010 */
	asrl	#3,%d1	/* 1001ec00:	e681 */
	cmpl	%d0,%d1	/* 1001ec02:	b280 */
	addqw	#4,%sp	/* 1001ec04:	584f */
	beqs	.L1001ec26	/* 1001ec06:	671e */
	movel	%d3,%sp@-	/* 1001ec08:	2f03 */
	movel	%fp@(16),%sp@-	/* 1001ec0a:	2f2e 0010 */
	moveq	#0,%d0	/* 1001ec0e:	7000 */
	moveb	%d7,%d0	/* 1001ec10:	1007 */
	movel	%d0,%sp@-	/* 1001ec12:	2f00 */
	movel	%a3,%sp@-	/* 1001ec14:	2f0b */
	jsr	%pc@(sub_1001765e)	/* 1001ec16:	4eba 8a46 */
	lea	%sp@(12),%sp	/* 1001ec1a:	4fef 000c */
	movel	%sp@+,%d3	/* 1001ec1e:	261f */
	tstb	%d0	/* 1001ec20:	4a00 */
	bnes	.L1001ec26	/* 1001ec22:	6602 */
	moveq	#0,%d3	/* 1001ec24:	7600 */

.L1001ec26:
	tstb	%d3	/* 1001ec26:	4a03 */
	beqs	.L1001ec2e	/* 1001ec28:	6704 */
	movel	%d6,%d0	/* 1001ec2a:	2006 */
	addql	#1,%d6	/* 1001ec2c:	5286 */

.L1001ec2e:
	cmpl	%d6,%d5	/* 1001ec2e:	ba86 */
	bnes	.L1001ec52	/* 1001ec30:	6620 */
	movel	%a4,%fp@(-12)	/* 1001ec32:	2d4c fff4 */
	movel	%fp@(24),%fp@(-8)	/* 1001ec36:	2d6e 0018 fff8 */
	moveq	#-8,%d0	/* 1001ec3c:	70f8 */
	andl	%fp@(-12),%d0	/* 1001ec3e:	c0ae fff4 */
	moveal	%d0,%a0	/* 1001ec42:	2040 */
	movel	%fp@(-8),%a0@	/* 1001ec44:	20ae fff8 */
	moveal	%fp@(28),%a0	/* 1001ec48:	206e 001c */
	moveb	#1,%a0@	/* 1001ec4c:	10bc 0001 */
	bras	.L1001ec68	/* 1001ec50:	6016 */

.L1001ec52:
	movel	%a4,%d0	/* 1001ec52:	200c */
	moveq	#-8,%d1	/* 1001ec54:	72f8 */
	andl	%d0,%d1	/* 1001ec56:	c280 */
	moveal	%d1,%a0	/* 1001ec58:	2041 */
	moveal	%a0@(4),%a4	/* 1001ec5a:	2868 0004 */

.L1001ec5e:
	cmpal	#2,%a4	/* 1001ec5e:	b9fc 0000 0002 */
	bnew	.L1001ebe4	/* 1001ec64:	6600 ff7e */

.L1001ec68:
	tstb	%d4	/* 1001ec68:	4a04 */
	beqs	.L1001ec7a	/* 1001ec6a:	670e */
	movel	%fp@(12),%sp@-	/* 1001ec6c:	2f2e 000c */
	jsr	%pc@(sub_1001d72a)	/* 1001ec70:	4eba eab8 */
	movel	%d0,%fp@(12)	/* 1001ec74:	2d40 000c */
	addqw	#4,%sp	/* 1001ec78:	584f */

.L1001ec7a:
	moveml	%fp@(-40),%d3-%d7/%a3-%a4	/* 1001ec7a:	4cee 18f8 ffd8 */
...
sub_1001ec84:
	...
	movel	%fp@(20),%sp@-	/* 1001ec90:	2f2e 0014 */
	jsr	%pc@(sub_10025242)	/* 1001ec94:	4eba 65ac */
	moveb	%d0,%d5	/* 1001ec98:	1a00 */
	moveq	#1,%d3	/* 1001ec9a:	7601 */
	moveq	#0,%d0	/* 1001ec9c:	7000 */
	moveb	%d5,%d0	/* 1001ec9e:	1005 */
	cmpiw	#3,%d0	/* 1001eca0:	0c40 0003 */
	addqw	#4,%sp	/* 1001eca4:	584f */
	beqs	.L1001ecc8	/* 1001eca6:	6720 */
	movel	%d3,%sp@-	/* 1001eca8:	2f03 */
	moveq	#25,%d0	/* 1001ecaa:	7019 */
	movel	%d0,%sp@-	/* 1001ecac:	2f00 */
	pea	%fp@(20)	/* 1001ecae:	486e 0014 */
	moveq	#0,%d1	/* 1001ecb2:	7200 */
	moveb	%d5,%d1	/* 1001ecb4:	1205 */
	movel	%d1,%sp@-	/* 1001ecb6:	2f01 */
	jsr	%pc@(sub_1001793c)	/* 1001ecb8:	4eba 8c82 */
	lea	%sp@(12),%sp	/* 1001ecbc:	4fef 000c */
	movel	%sp@+,%d3	/* 1001ecc0:	261f */
	tstb	%d0	/* 1001ecc2:	4a00 */
	bnes	.L1001ecc8	/* 1001ecc4:	6602 */
	moveq	#0,%d3	/* 1001ecc6:	7600 */

.L1001ecc8:
	tstb	%d3	/* 1001ecc8:	4a03 */
	bnes	.L1001ecd2	/* 1001ecca:	6606 */
	moveq	#0,%d0	/* 1001eccc:	7000 */
	braw	.L1001ee50	/* 1001ecce:	6000 0180 */

.L1001ecd2:
	movel	%fp@(20),%d5	/* 1001ecd2:	2a2e 0014 */
	asrl	#2,%d5	/* 1001ecd6:	e485 */
	moveq	#1,%d4	/* 1001ecd8:	7801 */
	tstl	%d5	/* 1001ecda:	4a85 */
	bges	.L1001ece6	/* 1001ecdc:	6c08 */
	movel	%d5,%d0	/* 1001ecde:	2005 */
	negl	%d0	/* 1001ece0:	4480 */
	movel	%d0,%d5	/* 1001ece2:	2a00 */
	clrb	%d4	/* 1001ece4:	4204 */

.L1001ece6:
	cmpl	%fp@(12),%d5	/* 1001ece6:	baae 000c */
	bles	.L1001ecf2	/* 1001ecea:	6f06 */
	moveq	#0,%d0	/* 1001ecec:	7000 */
	braw	.L1001ee50	/* 1001ecee:	6000 0160 */

.L1001ecf2:
	cmpal	#393,%a4	/* 1001ecf2:	b9fc 0000 0189 */
	beqs	.L1001ed02	/* 1001ecf8:	6708 */
	cmpal	#401,%a4	/* 1001ecfa:	b9fc 0000 0191 */
	bnes	.L1001ed1e	/* 1001ed00:	661c */

.L1001ed02:
	tstb	%d4	/* 1001ed02:	4a04 */
	beqs	.L1001ed0c	/* 1001ed04:	6706 */
	movel	%d5,%d0	/* 1001ed06:	2005 */
	subql	#1,%d0	/* 1001ed08:	5380 */
	bras	.L1001ed12	/* 1001ed0a:	6006 */

.L1001ed0c:
	movel	%fp@(12),%d0	/* 1001ed0c:	202e 000c */
	subl	%d5,%d0	/* 1001ed10:	9085 */

.L1001ed12:
	moveal	%fp@(24),%a0	/* 1001ed12:	206e 0018 */
	movel	%d0,%a0@	/* 1001ed16:	2080 */
	moveq	#1,%d0	/* 1001ed18:	7001 */
	braw	.L1001ee50	/* 1001ed1a:	6000 0134 */

.L1001ed1e:
	moveq	#0,%d7	/* 1001ed1e:	7e00 */
	tstb	%d4	/* 1001ed20:	4a04 */
	beqw	.L1001eda6	/* 1001ed22:	6700 0082 */
	moveq	#0,%d4	/* 1001ed26:	7800 */
	moveal	%fp@(8),%a3	/* 1001ed28:	266e 0008 */
	bras	.L1001ed9a	/* 1001ed2c:	606c */

.L1001ed2e:
	movel	%a3,%d0	/* 1001ed2e:	200b */
	moveq	#-8,%d1	/* 1001ed30:	72f8 */
	andl	%d0,%d1	/* 1001ed32:	c280 */
	moveal	%d1,%a0	/* 1001ed34:	2041 */
	movel	%a0@,%fp@(-4)	/* 1001ed36:	2d50 fffc */
	movel	%a3,%d0	/* 1001ed3a:	200b */
	moveq	#-8,%d1	/* 1001ed3c:	72f8 */
	andl	%d0,%d1	/* 1001ed3e:	c280 */
	moveal	%d1,%a0	/* 1001ed40:	2041 */
	moveal	%a0@(4),%a3	/* 1001ed42:	2668 0004 */
	movel	%fp@(-4),%sp@-	/* 1001ed46:	2f2e fffc */
	jsr	%pc@(sub_10025242)	/* 1001ed4a:	4eba 64f6 */
	moveb	%d0,%d6	/* 1001ed4e:	1c00 */
	moveq	#1,%d3	/* 1001ed50:	7601 */
	moveq	#0,%d0	/* 1001ed52:	7000 */
	moveb	%d6,%d0	/* 1001ed54:	1006 */
	movel	%a4,%d1	/* 1001ed56:	220c */
	asrl	#3,%d1	/* 1001ed58:	e681 */
	cmpl	%d0,%d1	/* 1001ed5a:	b280 */
	addqw	#4,%sp	/* 1001ed5c:	584f */
	beqs	.L1001ed7e	/* 1001ed5e:	671e */
	movel	%d3,%sp@-	/* 1001ed60:	2f03 */
	movel	%a4,%sp@-	/* 1001ed62:	2f0c */
	moveq	#0,%d0	/* 1001ed64:	7000 */
	moveb	%d6,%d0	/* 1001ed66:	1006 */
	movel	%d0,%sp@-	/* 1001ed68:	2f00 */
	movel	%fp@(-4),%sp@-	/* 1001ed6a:	2f2e fffc */
	jsr	%pc@(sub_1001765e)	/* 1001ed6e:	4eba 88ee */
	lea	%sp@(12),%sp	/* 1001ed72:	4fef 000c */
	movel	%sp@+,%d3	/* 1001ed76:	261f */
	tstb	%d0	/* 1001ed78:	4a00 */
	bnes	.L1001ed7e	/* 1001ed7a:	6602 */
	moveq	#0,%d3	/* 1001ed7c:	7600 */

.L1001ed7e:
	tstb	%d3	/* 1001ed7e:	4a03 */
	beqs	.L1001ed86	/* 1001ed80:	6704 */
	movel	%d7,%d0	/* 1001ed82:	2007 */
	addql	#1,%d7	/* 1001ed84:	5287 */

.L1001ed86:
	cmpl	%d7,%d5	/* 1001ed86:	ba87 */
	bnes	.L1001ed96	/* 1001ed88:	660c */
	moveal	%fp@(24),%a0	/* 1001ed8a:	206e 0018 */
	movel	%d4,%a0@	/* 1001ed8e:	2084 */
	moveq	#1,%d0	/* 1001ed90:	7001 */
	braw	.L1001ee50	/* 1001ed92:	6000 00bc */

.L1001ed96:
	movel	%d4,%d0	/* 1001ed96:	2004 */
	addql	#1,%d4	/* 1001ed98:	5284 */

.L1001ed9a:
	cmpal	#2,%a3	/* 1001ed9a:	b7fc 0000 0002 */
	bnes	.L1001ed2e	/* 1001eda0:	668c */
	braw	.L1001ee4e	/* 1001eda2:	6000 00aa */

.L1001eda6:
	movel	%fp@(8),%sp@-	/* 1001eda6:	2f2e 0008 */
	jsr	%pc@(sub_1001d72a)	/* 1001edaa:	4eba e97e */
	movel	%d0,%fp@(8)	/* 1001edae:	2d40 0008 */
	movel	%fp@(12),%d4	/* 1001edb2:	282e 000c */
	subql	#1,%d4	/* 1001edb6:	5384 */
	moveal	%fp@(8),%a3	/* 1001edb8:	266e 0008 */
	addqw	#4,%sp	/* 1001edbc:	584f */
	bras	.L1001ee38	/* 1001edbe:	6078 */

.L1001edc0:
	movel	%a3,%d0	/* 1001edc0:	200b */
	moveq	#-8,%d1	/* 1001edc2:	72f8 */
	andl	%d0,%d1	/* 1001edc4:	c280 */
	moveal	%d1,%a0	/* 1001edc6:	2041 */
	movel	%a0@,%fp@(-4)	/* 1001edc8:	2d50 fffc */
	movel	%a3,%d0	/* 1001edcc:	200b */
	moveq	#-8,%d1	/* 1001edce:	72f8 */
	andl	%d0,%d1	/* 1001edd0:	c280 */
	moveal	%d1,%a0	/* 1001edd2:	2041 */
	moveal	%a0@(4),%a3	/* 1001edd4:	2668 0004 */
	movel	%fp@(-4),%sp@-	/* 1001edd8:	2f2e fffc */
	jsr	%pc@(sub_10025242)	/* 1001eddc:	4eba 6464 */
	moveb	%d0,%d6	/* 1001ede0:	1c00 */
	moveq	#1,%d3	/* 1001ede2:	7601 */
	moveq	#0,%d0	/* 1001ede4:	7000 */
	moveb	%d6,%d0	/* 1001ede6:	1006 */
	movel	%a4,%d1	/* 1001ede8:	220c */
	asrl	#3,%d1	/* 1001edea:	e681 */
	cmpl	%d0,%d1	/* 1001edec:	b280 */
	addqw	#4,%sp	/* 1001edee:	584f */
	beqs	.L1001ee10	/* 1001edf0:	671e */
	movel	%d3,%sp@-	/* 1001edf2:	2f03 */
	movel	%a4,%sp@-	/* 1001edf4:	2f0c */
	moveq	#0,%d0	/* 1001edf6:	7000 */
	moveb	%d6,%d0	/* 1001edf8:	1006 */
	movel	%d0,%sp@-	/* 1001edfa:	2f00 */
	movel	%fp@(-4),%sp@-	/* 1001edfc:	2f2e fffc */
	jsr	%pc@(sub_1001765e)	/* 1001ee00:	4eba 885c */
	lea	%sp@(12),%sp	/* 1001ee04:	4fef 000c */
	movel	%sp@+,%d3	/* 1001ee08:	261f */
	tstb	%d0	/* 1001ee0a:	4a00 */
	bnes	.L1001ee10	/* 1001ee0c:	6602 */
	moveq	#0,%d3	/* 1001ee0e:	7600 */

.L1001ee10:
	tstb	%d3	/* 1001ee10:	4a03 */
	beqs	.L1001ee18	/* 1001ee12:	6704 */
	movel	%d7,%d0	/* 1001ee14:	2007 */
	addql	#1,%d7	/* 1001ee16:	5287 */

.L1001ee18:
	cmpl	%d7,%d5	/* 1001ee18:	ba87 */
	bnes	.L1001ee34	/* 1001ee1a:	6618 */
	moveal	%fp@(24),%a0	/* 1001ee1c:	206e 0018 */
	movel	%d4,%a0@	/* 1001ee20:	2084 */
	movel	%fp@(8),%sp@-	/* 1001ee22:	2f2e 0008 */
	jsr	%pc@(sub_1001d72a)	/* 1001ee26:	4eba e902 */
	movel	%d0,%fp@(8)	/* 1001ee2a:	2d40 0008 */
	moveq	#1,%d0	/* 1001ee2e:	7001 */
	addqw	#4,%sp	/* 1001ee30:	584f */
	bras	.L1001ee50	/* 1001ee32:	601c */

.L1001ee34:
	movel	%d4,%d0	/* 1001ee34:	2004 */
	subql	#1,%d4	/* 1001ee36:	5384 */

.L1001ee38:
	cmpal	#2,%a3	/* 1001ee38:	b7fc 0000 0002 */
	bnes	.L1001edc0	/* 1001ee3e:	6680 */
	movel	%fp@(8),%sp@-	/* 1001ee40:	2f2e 0008 */
	jsr	%pc@(sub_1001d72a)	/* 1001ee44:	4eba e8e4 */
	movel	%d0,%fp@(8)	/* 1001ee48:	2d40 0008 */
	addqw	#4,%sp	/* 1001ee4c:	584f */

.L1001ee4e:
	moveq	#0,%d0	/* 1001ee4e:	7000 */

.L1001ee50:
	moveml	%fp@(-32),%d3-%d7/%a3-%a4	/* 1001ee50:	4cee 18f8 ffe0 */
	unlk	%fp	/* 1001ee56:	4e5e */
	rts	/* 1001ee58:	4e75 */
