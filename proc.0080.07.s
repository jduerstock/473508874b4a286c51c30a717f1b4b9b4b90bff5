...
.L10019abe:
	.short	0x0098
	.short	0x00ea,0x0040,0x00ea,0x00ea,0x00ea,0x00ea,0x00ea,0x00ea
	.short	0x00ea,0x00ea,0x00ea,0x00ea,0x00ea,0x00ea,0x00ea,0x00ea
	.short	0x00ea,0x00e6,0x00e6,0x00e6,0x00e6,0x00e6,0x00e6,0x00e6
	.short	0x00e6,0x00e6,0x00e6,0x00e6,0x00e6,0x00e6
...
.L10019f24:
	.short	0x0014,0x00de,0x020e,0x020e,0x020e,0x020e
	.short	0x01aa,0x01c6,0x01e2
...
sub_1001a78e:
	linkw	%fp,#-8	/* 1001a78e:	4e56 fff8 */
	moveml	%d5-%d7/%a3-%a4,%sp@-	/* 1001a792:	48e7 0718 */
	moveb	%fp@(11),%d7	/* 1001a796:	1e2e 000b */
	moveal	%fp@(12),%a3	/* 1001a79a:	266e 000c */
	jsr	%pc@(sub_1001fe5c)	/* 1001a79e:	4eba 56bc */
	moveal	%d0,%a0	/* 1001a7a2:	2040 */
	lea	%a0@(464),%a4	/* 1001a7a4:	49e8 01d0 */
	moveal	%a4@,%a0	/* 1001a7a8:	2054 */
	movel	%a0@(-4),%fp@(-4)	/* 1001a7aa:	2d68 fffc fffc */
	movel	%fp@(-4),%sp@-	/* 1001a7b0:	2f2e fffc */
	jsr	%pc@(sub_1001fe54)	/* 1001a7b4:	4eba 569e */
	moveb	%d0,%d6	/* 1001a7b8:	1c00 */
	jsr	%pc@(sub_1001fe5c)	/* 1001a7ba:	4eba 56a0 */
	moveal	%d0,%a0	/* 1001a7be:	2040 */
	lea	%a0@(464),%a4	/* 1001a7c0:	49e8 01d0 */
	movel	%a4@,%d0	/* 1001a7c4:	2014 */
	moveq	#80,%d1	/* 1001a7c6:	7250 */
	addl	%d1,%d0	/* 1001a7c8:	d081 */
	cmpl	%a4@(4),%d0	/* 1001a7ca:	b0ac 0004 */
	bcss	.L1001a7dc	/* 1001a7ce:	650c */
	movel	%a4,%sp@-	/* 1001a7d0:	2f0c */
	jsr	%pc@(sub_1001da1e)	/* 1001a7d2:	4eba 324a */
	moveq	#0,%d0	/* 1001a7d6:	7000 */
	addqw	#4,%sp	/* 1001a7d8:	584f */
	bras	.L1001a7de	/* 1001a7da:	6002 */

.L1001a7dc:
	moveq	#0,%d0	/* 1001a7dc:	7000 */

.L1001a7de:
	moveb	%d6,%d0	/* 1001a7de:	1006 */
	subqb	#2,%d0	/* 1001a7e0:	5500 */
	addqw	#4,%sp	/* 1001a7e2:	584f */
	beqs	.L1001a7f8	/* 1001a7e4:	6712 */
	subqb	#2,%d0	/* 1001a7e6:	5500 */
	beqs	.L1001a7f8	/* 1001a7e8:	670e */
	subqb	#2,%d0	/* 1001a7ea:	5500 */
	beqs	.L1001a7f8	/* 1001a7ec:	670a */
	subqb	#7,%d0	/* 1001a7ee:	5f00 */
	beqs	.L1001a7f8	/* 1001a7f0:	6706 */
	subqb	#2,%d0	/* 1001a7f2:	5500 */
	bnew	.L1001a8aa	/* 1001a7f4:	6600 00b4 */

.L1001a7f8:
	moveq	#2,%d0	/* 1001a7f8:	7002 */
	cmpl	%fp@(-4),%d0	/* 1001a7fa:	b0ae fffc */
	beqw	.L1001a8aa	/* 1001a7fe:	6700 00aa */
	movel	%fp@(-4),%sp@-	/* 1001a802:	2f2e fffc */
	movel	%a3,%sp@-	/* 1001a806:	2f0b */
	jsr	%pc@(sub_10016b5a)	/* 1001a808:	4eba c350 */
	movel	%d0,%d5	/* 1001a80c:	2a00 */
	moveq	#-1,%d0	/* 1001a80e:	70ff */
	cmpl	%d5,%d0	/* 1001a810:	b085 */
	addqw	#8,%sp	/* 1001a812:	504f */
	beqs	.L1001a844	/* 1001a814:	672e */
	subql	#4,%sp	/* 1001a816:	598f */
	moveal	%a3@(8),%a0	/* 1001a818:	206b 0008 */
	movel	%a0@,%sp@-	/* 1001a81c:	2f10 */
	jsr	%pc@(sub_1001fe50)	/* 1001a81e:	4eba 5630 */
	movel	%d5,%d0	/* 1001a822:	2005 */
	addql	#1,%d0	/* 1001a824:	5280 */
	asll	#2,%d0	/* 1001a826:	e580 */
	addl	%sp@+,%d0	/* 1001a828:	d09f */
	moveal	%d0,%a0	/* 1001a82a:	2040 */
	movel	%a0@,%fp@(-8)	/* 1001a82c:	2d50 fff8 */
	jsr	%pc@(sub_1001fe5c)	/* 1001a830:	4eba 562a */
	moveal	%d0,%a0	/* 1001a834:	2040 */
	lea	%a0@(464),%a4	/* 1001a836:	49e8 01d0 */
	moveal	%a4@,%a0	/* 1001a83a:	2054 */
	movel	%fp@(-8),%a0@(-4)	/* 1001a83c:	216e fff8 fffc */
	bras	.L1001a8aa	/* 1001a842:	6066 */

.L1001a844:
	moveb	%d6,%d0	/* 1001a844:	1006 */
	subqb	#2,%d0	/* 1001a846:	5500 */
	beqs	.L1001a86c	/* 1001a848:	6722 */
	subqb	#2,%d0	/* 1001a84a:	5500 */
	beqs	.L1001a85c	/* 1001a84c:	670e */
	subqb	#2,%d0	/* 1001a84e:	5500 */
	beqs	.L1001a87c	/* 1001a850:	672a */
	subqb	#7,%d0	/* 1001a852:	5f00 */
	beqs	.L1001a89c	/* 1001a854:	6746 */
	subqb	#2,%d0	/* 1001a856:	5500 */
	beqs	.L1001a88c	/* 1001a858:	6732 */
	bras	.L1001a8aa	/* 1001a85a:	604e */

.L1001a85c:
	movel	%a3,%sp@-	/* 1001a85c:	2f0b */
	moveq	#0,%d0	/* 1001a85e:	7000 */
	moveb	%d7,%d0	/* 1001a860:	1007 */
	movel	%d0,%sp@-	/* 1001a862:	2f00 */
	jsr	%pc@(sub_10015ee2)	/* 1001a864:	4eba b67c */
	addqw	#8,%sp	/* 1001a868:	504f */
	bras	.L1001a8aa	/* 1001a86a:	603e */

.L1001a86c:
	movel	%a3,%sp@-	/* 1001a86c:	2f0b */
	moveq	#0,%d0	/* 1001a86e:	7000 */
	moveb	%d7,%d0	/* 1001a870:	1007 */
	movel	%d0,%sp@-	/* 1001a872:	2f00 */
	jsr	%pc@(sub_1001e0b0)	/* 1001a874:	4eba 383a */
	addqw	#8,%sp	/* 1001a878:	504f */
	bras	.L1001a8aa	/* 1001a87a:	602e */

.L1001a87c:
	movel	%a3,%sp@-	/* 1001a87c:	2f0b */
	moveq	#0,%d0	/* 1001a87e:	7000 */
	moveb	%d7,%d0	/* 1001a880:	1007 */
	movel	%d0,%sp@-	/* 1001a882:	2f00 */
	jsr	%pc@(sub_1001c420)	/* 1001a884:	4eba 1b9a */
	addqw	#8,%sp	/* 1001a888:	504f */
	bras	.L1001a8aa	/* 1001a88a:	601e */

.L1001a88c:
	movel	%a3,%sp@-	/* 1001a88c:	2f0b */
	moveq	#0,%d0	/* 1001a88e:	7000 */
	moveb	%d7,%d0	/* 1001a890:	1007 */
	movel	%d0,%sp@-	/* 1001a892:	2f00 */
	jsr	%pc@(sub_100131e6)	/* 1001a894:	4eba 8950 */
	addqw	#8,%sp	/* 1001a898:	504f */
	bras	.L1001a8aa	/* 1001a89a:	600e */

.L1001a89c:
	movel	%a3,%sp@-	/* 1001a89c:	2f0b */
	moveq	#0,%d0	/* 1001a89e:	7000 */
	moveb	%d7,%d0	/* 1001a8a0:	1007 */
	movel	%d0,%sp@-	/* 1001a8a2:	2f00 */
	jsr	%pc@(sub_10021a68)	/* 1001a8a4:	4eba 71c2 */
	addqw	#8,%sp	/* 1001a8a8:	504f */

.L1001a8aa:
	moveml	%fp@(-28),%d5-%d7/%a3-%a4	/* 1001a8aa:	4cee 18e0 ffe4 */
	unlk	%fp	/* 1001a8b0:	4e5e */
	rts	/* 1001a8b2:	4e75 */

sub_1001a8b4:
	braw	sub_10015ab2	/* 1001a8b4:	6000 b1fc */

sub_1001a8b8:
	linkw	%fp,#0	/* 1001a8b8:	4e56 0000 */
	moveml	%a3-%a4,%sp@-	/* 1001a8bc:	48e7 0018 */
	jsr	%pc@(sub_1001fe5c)	/* 1001a8c0:	4eba 559a */
	moveal	%d0,%a0	/* 1001a8c4:	2040 */
	lea	%a0@(264),%a3	/* 1001a8c6:	47e8 0108 */
	subql	#4,%sp	/* 1001a8ca:	598f */
	moveal	%a3@(8),%a0	/* 1001a8cc:	206b 0008 */
	movel	%a0@,%sp@-	/* 1001a8d0:	2f10 */
	jsr	%pc@(sub_1001fe50)	/* 1001a8d2:	4eba 557c */
	moveal	%sp@+,%a4	/* 1001a8d6:	285f */
	movel	%a4,%a3@	/* 1001a8d8:	268c */
	jsr	%pc@(sub_1001fe5c)	/* 1001a8da:	4eba 5580 */
	moveal	%d0,%a0	/* 1001a8de:	2040 */
	pea	%a0@(264)	/* 1001a8e0:	4868 0108 */
	moveq	#0,%d0	/* 1001a8e4:	7000 */
	moveb	%fp@(11),%d0	/* 1001a8e6:	102e 000b */
	movel	%d0,%sp@-	/* 1001a8ea:	2f00 */
	jsr	%pc@(sub_1001a78e)	/* 1001a8ec:	4eba fea0 */
	jsr	%pc@(sub_1001fe5c)	/* 1001a8f0:	4eba 556a */
	moveal	%d0,%a0	/* 1001a8f4:	2040 */
	lea	%a0@(264),%a3	/* 1001a8f6:	47e8 0108 */
	subql	#4,%sp	/* 1001a8fa:	598f */
	moveal	%a3@(8),%a0	/* 1001a8fc:	206b 0008 */
	movel	%a0@,%sp@-	/* 1001a900:	2f10 */
	jsr	%pc@(sub_1001fe50)	/* 1001a902:	4eba 554c */
	moveal	%sp@+,%a4	/* 1001a906:	285f */
	movel	%a4,%a3@	/* 1001a908:	268c */
	moveml	%fp@(-8),%a3-%a4	/* 1001a90a:	4cee 1800 fff8 */
	unlk	%fp	/* 1001a910:	4e5e */
	rts	/* 1001a912:	4e75 */

sub_1001a914:
	braw	sub_1001f352	/* 1001a914:	6000 4a3c */

sub_1001a918:
	braw	sub_1001f310	/* 1001a918:	6000 49f6 */

sub_1001a91c:
	braw	sub_10013352	/* 1001a91c:	6000 8a34 */

sub_1001a920:
	braw	sub_10017b0a	/* 1001a920:	6000 d1e8 */

sub_1001a924:
	braw	sub_10015294	/* 1001a924:	6000 a96e */

sub_1001a928:
	braw	sub_10015272	/* 1001a928:	6000 a948 */

sub_1001a92c:
	braw	sub_1001524c	/* 1001a92c:	6000 a91e */

sub_1001a930:
	braw	sub_1001520a	/* 1001a930:	6000 a8d8 */

sub_1001a934:
	braw	sub_10015232	/* 1001a934:	6000 a8fc */

sub_1001a938:
	braw	sub_100151e4	/* 1001a938:	6000 a8aa */

sub_1001a93c:
	braw	sub_100140a6	/* 1001a93c:	6000 9768 */

sub_1001a940:
	linkw	%fp,#-30	/* 1001a940:	4e56 ffe2 */
	moveml	%d3/%d5-%d7/%a3-%a4,%sp@-	/* 1001a944:	48e7 1718 */
	moveb	%fp@(19),%d5	/* 1001a948:	1a2e 0013 */
	jsr	%pc@(sub_1001fe5c)	/* 1001a94c:	4eba 550e */
	moveal	%d0,%a0	/* 1001a950:	2040 */
	lea	%a0@(464),%a4	/* 1001a952:	49e8 01d0 */
	moveal	%a4@,%a3	/* 1001a956:	2654 */
	lea	%a3@(-16),%a3	/* 1001a958:	47eb fff0 */
	moveal	%a3@,%a4	/* 1001a95c:	2853 */
	movel	%a4,%d0	/* 1001a95e:	200c */
	asrl	#2,%d0	/* 1001a960:	e480 */
	movel	%d0,%d6	/* 1001a962:	2c00 */
	moveq	#0,%d3	/* 1001a964:	7600 */
	tstl	%d6	/* 1001a966:	4a86 */
	bnes	.L1001a97e	/* 1001a968:	6614 */
	movel	%d3,%sp@-	/* 1001a96a:	2f03 */
	movel	%a3@(12),%sp@-	/* 1001a96c:	2f2b 000c */
	jsr	%pc@(sub_1002021c)	/* 1001a970:	4eba 58aa */
	addql	#4,%sp	/* 1001a974:	588f */
	movel	%sp@+,%d3	/* 1001a976:	261f */
	tstb	%d0	/* 1001a978:	4a00 */
	bnes	.L1001a97e	/* 1001a97a:	6602 */
	moveq	#1,%d3	/* 1001a97c:	7601 */

.L1001a97e:
	moveb	%d3,%d7	/* 1001a97e:	1e03 */
	tstb	%fp@(15)	/* 1001a980:	4a2e 000f */
	beqw	.L1001aa66	/* 1001a984:	6700 00e0 */
	moveq	#0,%d0	/* 1001a988:	7000 */
	moveb	%d5,%d0	/* 1001a98a:	1005 */
	cmpiw	#6,%d0	/* 1001a98c:	0c40 0006 */
	bnes	.L1001aa0a	/* 1001a990:	6678 */
	tstb	%d7	/* 1001a992:	4a07 */
	beqs	.L1001aa0a	/* 1001a994:	6774 */
	clrb	%fp@(-25)	/* 1001a996:	422e ffe7 */
	moveq	#1,%d0	/* 1001a99a:	7001 */
	movel	%d0,%fp@(-24)	/* 1001a99c:	2d40 ffe8 */
	pea	%fp@(-24)	/* 1001a9a0:	486e ffe8 */
	pea	%fp@(-25)	/* 1001a9a4:	486e ffe7 */
	movel	%a3@(12),%sp@-	/* 1001a9a8:	2f2b 000c */
	movel	%a3@(4),%sp@-	/* 1001a9ac:	2f2b 0004 */
	moveq	#0,%d0	/* 1001a9b0:	7000 */
	moveb	%d5,%d0	/* 1001a9b2:	1005 */
	movel	%d0,%sp@-	/* 1001a9b4:	2f00 */
	jsr	%pc@(sub_1001c8a6)	/* 1001a9b6:	4eba 1eee */
	tstb	%fp@(-25)	/* 1001a9ba:	4a2e ffe7 */
	lea	%sp@(20),%sp	/* 1001a9be:	4fef 0014 */
	beqs	.L1001aa0a	/* 1001a9c2:	6746 */
	jsr	%pc@(sub_1001fe5c)	/* 1001a9c4:	4eba 5496 */
	moveal	%d0,%a0	/* 1001a9c8:	2040 */
	lea	%a0@(464),%a4	/* 1001a9ca:	49e8 01d0 */
	moveal	%a4@,%a0	/* 1001a9ce:	2054 */
	movel	%a0@(-4),%fp@(-30)	/* 1001a9d0:	2d68 fffc ffe2 */
	jsr	%pc@(sub_1001fe5c)	/* 1001a9d6:	4eba 5484 */
	moveal	%d0,%a0	/* 1001a9da:	2040 */
	lea	%a0@(464),%a4	/* 1001a9dc:	49e8 01d0 */
	movel	%a3,%a4@	/* 1001a9e0:	288b */
	jsr	%pc@(sub_1001fe5c)	/* 1001a9e2:	4eba 5478 */
	moveal	%d0,%a0	/* 1001a9e6:	2040 */
	lea	%a0@(464),%a4	/* 1001a9e8:	49e8 01d0 */
	movel	%d6,%d0	/* 1001a9ec:	2006 */
	addql	#1,%d0	/* 1001a9ee:	5280 */
	asll	#2,%d0	/* 1001a9f0:	e580 */
	subl	%d0,%a4@	/* 1001a9f2:	9194 */
	jsr	%pc@(sub_1001fe5c)	/* 1001a9f4:	4eba 5466 */
	moveal	%d0,%a0	/* 1001a9f8:	2040 */
	lea	%a0@(464),%a4	/* 1001a9fa:	49e8 01d0 */
	moveal	%a4@,%a0	/* 1001a9fe:	2054 */
	addql	#4,%a4@	/* 1001aa00:	5894 */
	movel	%fp@(-30),%a0@	/* 1001aa02:	20ae ffe2 */
	braw	.L1001aaca	/* 1001aa06:	6000 00c2 */

.L1001aa0a:
	jsr	%pc@(sub_1001fe5c)	/* 1001aa0a:	4eba 5450 */
	moveal	%d0,%a0	/* 1001aa0e:	2040 */
	moveal	%a0@(140),%a4	/* 1001aa10:	2868 008c */
	movel	%a4,%d0	/* 1001aa14:	200c */
	moveq	#16,%d1	/* 1001aa16:	7210 */
	subl	%d1,%d0	/* 1001aa18:	9081 */
	movel	%d0,%fp@(-16)	/* 1001aa1a:	2d40 fff0 */
	moveal	%d0,%a0	/* 1001aa1e:	2040 */
	movel	%a0,%fp@(-12)	/* 1001aa20:	2d48 fff4 */
	addql	#8,%a0	/* 1001aa24:	5088 */
	movel	%a0@,%fp@(-20)	/* 1001aa26:	2d50 ffec */
	movel	%fp@(-20),%a3@(4)	/* 1001aa2a:	276e ffec 0004 */
	lea	%a3@,%a4	/* 1001aa30:	49d3 */
	movel	%a4@,%d6	/* 1001aa32:	2c14 */
	asrl	#2,%d6	/* 1001aa34:	e486 */
	movel	%d6,%d0	/* 1001aa36:	2006 */
	negl	%d0	/* 1001aa38:	4480 */
	asll	#2,%d0	/* 1001aa3a:	e580 */
	lea	%a4@(0,%d0:l),%a0	/* 1001aa3c:	41f4 0800 */
	movel	%fp@(-20),%a0@(-4)	/* 1001aa40:	216e ffec fffc */
	moveq	#0,%d0	/* 1001aa46:	7000 */
	movel	%d0,%sp@-	/* 1001aa48:	2f00 */
	moveq	#0,%d1	/* 1001aa4a:	7200 */
	moveb	%fp@(23),%d1	/* 1001aa4c:	122e 0017 */
	movel	%d1,%sp@-	/* 1001aa50:	2f01 */
	movel	%d0,%sp@-	/* 1001aa52:	2f00 */
	moveq	#0,%d1	/* 1001aa54:	7200 */
	moveb	%fp@(11),%d1	/* 1001aa56:	122e 000b */
	movel	%d1,%sp@-	/* 1001aa5a:	2f01 */
	jsr	%pc@(sub_1001acfa)	/* 1001aa5c:	4eba 029c */
	lea	%sp@(16),%sp	/* 1001aa60:	4fef 0010 */
	bras	.L1001aaca	/* 1001aa64:	6064 */

.L1001aa66:
	tstb	%d7	/* 1001aa66:	4a07 */
	beqs	.L1001aabc	/* 1001aa68:	6752 */
	movel	%a3@(4),%fp@(-8)	/* 1001aa6a:	2d6b 0004 fff8 */
	jsr	%pc@(sub_1001fe5c)	/* 1001aa70:	4eba 53ea */
	moveal	%d0,%a0	/* 1001aa74:	2040 */
	lea	%a0@(464),%a0	/* 1001aa76:	41e8 01d0 */
	movel	%a0,%fp@(-4)	/* 1001aa7a:	2d48 fffc */
	moveal	%a0@,%a1	/* 1001aa7e:	2250 */
	addql	#4,%a0@	/* 1001aa80:	5890 */
	movel	%fp@(-8),%a1@	/* 1001aa82:	22ae fff8 */
	movel	%a3@(12),%sp@-	/* 1001aa86:	2f2b 000c */
	jsr	%pc@(sub_100195ca)	/* 1001aa8a:	4eba eb3e */
	moveq	#3,%d0	/* 1001aa8e:	7003 */
	movel	%d0,%sp@-	/* 1001aa90:	2f00 */
	moveq	#21,%d1	/* 1001aa92:	7215 */
	movel	%d1,%sp@-	/* 1001aa94:	2f01 */
	jsr	%pc@(sub_10017534)	/* 1001aa96:	4eba ca9c */
	jsr	%pc@(sub_1001fe5c)	/* 1001aa9a:	4eba 53c0 */
	moveal	%d0,%a0	/* 1001aa9e:	2040 */
	lea	%a0@(464),%a4	/* 1001aaa0:	49e8 01d0 */
	subql	#4,%a4@	/* 1001aaa4:	5994 */
	moveal	%a4@,%a0	/* 1001aaa6:	2054 */
	lea	%sp@(12),%sp	/* 1001aaa8:	4fef 000c */
	movel	%a0@,%sp@-	/* 1001aaac:	2f10 */
	movel	#-1728,%sp@-	/* 1001aaae:	2f3c ffff f940 */
	jsr	%pc@(sub_1001ddd2)	/* 1001aab4:	4eba 331c */
	addqw	#8,%sp	/* 1001aab8:	504f */
	bras	.L1001aaca	/* 1001aaba:	600e */

.L1001aabc:
	movel	%a3@(12),%sp@-	/* 1001aabc:	2f2b 000c */
	movel	%a3@(4),%sp@-	/* 1001aac0:	2f2b 0004 */
	jsr	%pc@(sub_1001347a)	/* 1001aac4:	4eba 89b4 */
	addqw	#8,%sp	/* 1001aac8:	504f */

.L1001aaca:
	moveml	%fp@(-54),%d3/%d5-%d7/%a3-%a4	/* 1001aaca:	4cee 18e8 ffca */
	unlk	%fp	/* 1001aad0:	4e5e */
	rts	/* 1001aad2:	4e75 */

sub_1001aad4:
	braw	sub_10022188	/* 1001aad4:	6000 76b2 */

sub_1001aad8:
	braw	sub_10021fee	/* 1001aad8:	6000 7514 */

sub_1001aadc:
	braw	sub_1001f724	/* 1001aadc:	6000 4c46 */

sub_1001aae0:
	braw	sub_10021dbe	/* 1001aae0:	6000 72dc */

sub_1001aae4:
	braw	sub_10017b0e	/* 1001aae4:	6000 d028 */

sub_1001aae8:
	braw	sub_10013dba	/* 1001aae8:	6000 92d0 */

sub_1001aaec:
	braw	sub_10013dbe	/* 1001aaec:	6000 92d0 */

sub_1001aaf0:
	braw	sub_1001717a	/* 1001aaf0:	6000 c688 */

sub_1001aaf4:
	braw	sub_100157b6	/* 1001aaf4:	6000 acc0 */

sub_1001aaf8:
	linkw	%fp,#-8	/* 1001aaf8:	4e56 fff8 */
	moveml	%d5-%d7/%a2-%a4,%sp@-	/* 1001aafc:	48e7 0738 */
	moveb	%fp@(11),%d5	/* 1001ab00:	1a2e 000b */
	jsr	%pc@(sub_1001fe5c)	/* 1001ab04:	4eba 5356 */
	moveal	%d0,%a0	/* 1001ab08:	2040 */
	lea	%a0@(464),%a3	/* 1001ab0a:	47e8 01d0 */
	moveal	%a3@,%a2	/* 1001ab0e:	2453 */
	lea	%a2@(-16),%a2	/* 1001ab10:	45ea fff0 */
	jsr	%pc@(sub_1001fe5c)	/* 1001ab14:	4eba 5346 */
	moveal	%d0,%a0	/* 1001ab18:	2040 */
	lea	%a0@(464),%a3	/* 1001ab1a:	47e8 01d0 */
	moveal	%a3@,%a0	/* 1001ab1e:	2053 */
	addql	#4,%a3@	/* 1001ab20:	5893 */
	moveq	#1,%d0	/* 1001ab22:	7001 */
	movel	%d0,%a0@	/* 1001ab24:	2080 */
	jsr	%pc@(sub_1001fe5c)	/* 1001ab26:	4eba 5334 */
	moveal	%d0,%a0	/* 1001ab2a:	2040 */
	lea	%a0@(464),%a3	/* 1001ab2c:	47e8 01d0 */
	moveal	%a3@,%a0	/* 1001ab30:	2053 */
	addql	#4,%a3@	/* 1001ab32:	5893 */
	moveq	#1,%d0	/* 1001ab34:	7001 */
	movel	%d0,%a0@	/* 1001ab36:	2080 */
	jsr	%pc@(sub_1001fe5c)	/* 1001ab38:	4eba 5322 */
	moveal	%d0,%a0	/* 1001ab3c:	2040 */
	lea	%a0@(464),%a3	/* 1001ab3e:	47e8 01d0 */
	moveal	%a3@,%a0	/* 1001ab42:	2053 */
	addql	#4,%a3@	/* 1001ab44:	5893 */
	moveq	#1,%d0	/* 1001ab46:	7001 */
	movel	%d0,%a0@	/* 1001ab48:	2080 */
	jsr	%pc@(sub_1001fe5c)	/* 1001ab4a:	4eba 5310 */
	moveal	%d0,%a0	/* 1001ab4e:	2040 */
	lea	%a0@(464),%a3	/* 1001ab50:	47e8 01d0 */
	moveal	%a3@,%a4	/* 1001ab54:	2853 */
	lea	%a4@(-12),%a4	/* 1001ab56:	49ec fff4 */
	moveal	%a2@,%a3	/* 1001ab5a:	2652 */
	movel	%a3,%d0	/* 1001ab5c:	200b */
	asrl	#2,%d0	/* 1001ab5e:	e480 */
	movel	%d0,%d6	/* 1001ab60:	2c00 */
	pea	%a4@(8)	/* 1001ab62:	486c 0008 */
	pea	%a4@(4)	/* 1001ab66:	486c 0004 */
	movel	%a4,%sp@-	/* 1001ab6a:	2f0c */
	movel	%d6,%sp@-	/* 1001ab6c:	2f06 */
	movel	%a2,%sp@-	/* 1001ab6e:	2f0a */
	jsr	%pc@(sub_10022314)	/* 1001ab70:	4eba 77a2 */
	moveq	#1,%d0	/* 1001ab74:	7001 */
	cmpl	%a4@(8),%d0	/* 1001ab76:	b0ac 0008 */
	lea	%sp@(20),%sp	/* 1001ab7a:	4fef 0014 */
	bnew	.L1001ac3c	/* 1001ab7e:	6600 00bc */
	movel	%a4@(4),%sp@-	/* 1001ab82:	2f2c 0004 */
	jsr	%pc@(sub_1001fe54)	/* 1001ab86:	4eba 52cc */
	moveb	%d0,%d7	/* 1001ab8a:	1e00 */
	subqb	#2,%d0	/* 1001ab8c:	5500 */
	addqw	#4,%sp	/* 1001ab8e:	584f */
	beqs	.L1001abb0	/* 1001ab90:	671e */
	subqb	#2,%d0	/* 1001ab92:	5500 */
	beqs	.L1001aba0	/* 1001ab94:	670a */
	subqb	#2,%d0	/* 1001ab96:	5500 */
	beqs	.L1001abc0	/* 1001ab98:	6726 */
	subqb	#8,%d0	/* 1001ab9a:	5100 */
	beqs	.L1001abd0	/* 1001ab9c:	6732 */
	bras	.L1001abe0	/* 1001ab9e:	6040 */

.L1001aba0:
	movel	%a4@,%sp@-	/* 1001aba0:	2f14 */
	movel	%a4@(4),%sp@-	/* 1001aba2:	2f2c 0004 */
	jsr	%pc@(sub_10015e3a)	/* 1001aba6:	4eba b292 */
	movel	%d0,%d7	/* 1001abaa:	2e00 */
	addqw	#8,%sp	/* 1001abac:	504f */
	bras	.L1001ac14	/* 1001abae:	6064 */

.L1001abb0:
	movel	%a4@,%sp@-	/* 1001abb0:	2f14 */
	movel	%a4@(4),%sp@-	/* 1001abb2:	2f2c 0004 */
	jsr	%pc@(sub_1001e002)	/* 1001abb6:	4eba 344a */
	movel	%d0,%d7	/* 1001abba:	2e00 */
	addqw	#8,%sp	/* 1001abbc:	504f */
	bras	.L1001ac14	/* 1001abbe:	6054 */

.L1001abc0:
	movel	%a4@,%sp@-	/* 1001abc0:	2f14 */
	movel	%a4@(4),%sp@-	/* 1001abc2:	2f2c 0004 */
	jsr	%pc@(sub_1001c2d2)	/* 1001abc6:	4eba 170a */
	movel	%d0,%d7	/* 1001abca:	2e00 */
	addqw	#8,%sp	/* 1001abcc:	504f */
	bras	.L1001ac14	/* 1001abce:	6044 */

.L1001abd0:
	movel	%a4@,%sp@-	/* 1001abd0:	2f14 */
	movel	%a4@(4),%sp@-	/* 1001abd2:	2f2c 0004 */
	jsr	%pc@(sub_100223f6)	/* 1001abd6:	4eba 781e */
	movel	%d0,%d7	/* 1001abda:	2e00 */
	addqw	#8,%sp	/* 1001abdc:	504f */
	bras	.L1001ac14	/* 1001abde:	6034 */

.L1001abe0:
	jsr	%pc@(sub_1001fe5c)	/* 1001abe0:	4eba 527a */
	moveal	%d0,%a0	/* 1001abe4:	2040 */
	lea	%a0@(464),%a3	/* 1001abe6:	47e8 01d0 */
	movel	%a4,%a3@	/* 1001abea:	268c */
	moveq	#0,%d0	/* 1001abec:	7000 */
	moveb	%fp@(23),%d0	/* 1001abee:	102e 0017 */
	movel	%d0,%sp@-	/* 1001abf2:	2f00 */
	moveq	#0,%d0	/* 1001abf4:	7000 */
	moveb	%fp@(19),%d0	/* 1001abf6:	102e 0013 */
	movel	%d0,%sp@-	/* 1001abfa:	2f00 */
	moveq	#0,%d0	/* 1001abfc:	7000 */
	moveb	%fp@(15),%d0	/* 1001abfe:	102e 000f */
	movel	%d0,%sp@-	/* 1001ac02:	2f00 */
	moveq	#0,%d0	/* 1001ac04:	7000 */
	moveb	%d5,%d0	/* 1001ac06:	1005 */
	movel	%d0,%sp@-	/* 1001ac08:	2f00 */
	jsr	%pc@(sub_1001a940)	/* 1001ac0a:	4eba fd34 */
	lea	%sp@(16),%sp	/* 1001ac0e:	4fef 0010 */
	bras	.L1001ac80	/* 1001ac12:	606c */

.L1001ac14:
	jsr	%pc@(sub_1001fe5c)	/* 1001ac14:	4eba 5246 */
	moveal	%d0,%a0	/* 1001ac18:	2040 */
	lea	%a0@(464),%a3	/* 1001ac1a:	47e8 01d0 */
	movel	%a2,%a3@	/* 1001ac1e:	268a */
	jsr	%pc@(sub_1001fe5c)	/* 1001ac20:	4eba 523a */
	moveal	%d0,%a0	/* 1001ac24:	2040 */
	lea	%a0@(464),%a3	/* 1001ac26:	47e8 01d0 */
	movel	%d6,%d0	/* 1001ac2a:	2006 */
	addql	#1,%d0	/* 1001ac2c:	5280 */
	asll	#2,%d0	/* 1001ac2e:	e580 */
	subl	%d0,%a3@	/* 1001ac30:	9193 */
	movel	%d7,%sp@-	/* 1001ac32:	2f07 */
	jsr	%pc@(sub_10016f08)	/* 1001ac34:	4eba c2d2 */
	addqw	#4,%sp	/* 1001ac38:	584f */
	bras	.L1001ac80	/* 1001ac3a:	6044 */

.L1001ac3c:
	moveal	%a4@(8),%a1	/* 1001ac3c:	226c 0008 */
	movel	%a1,%sp@-	/* 1001ac40:	2f09 */
	jsr	%pc@(sub_1001fe5c)	/* 1001ac42:	4eba 5218 */
	moveal	%sp@+,%a1	/* 1001ac46:	225f */
	moveal	%d0,%a0	/* 1001ac48:	2040 */
	lea	%a0@(464),%a3	/* 1001ac4a:	47e8 01d0 */
	movel	%a4,%a3@	/* 1001ac4e:	268c */
	movel	%a1,%sp@-	/* 1001ac50:	2f09 */
	jsr	%pc@(sub_1001fe5c)	/* 1001ac52:	4eba 5208 */
	moveal	%sp@+,%a1	/* 1001ac56:	225f */
	moveal	%d0,%a0	/* 1001ac58:	2040 */
	lea	%a0@(464),%a4	/* 1001ac5a:	49e8 01d0 */
	moveal	%a4@,%a0	/* 1001ac5e:	2054 */
	addql	#4,%a4@	/* 1001ac60:	5894 */
	movel	%a1,%a0@	/* 1001ac62:	2089 */
	movel	%a1,%sp@-	/* 1001ac64:	2f09 */
	moveq	#0,%d0	/* 1001ac66:	7000 */
	movel	%d0,%sp@-	/* 1001ac68:	2f00 */
	movel	%d0,%sp@-	/* 1001ac6a:	2f00 */
	movel	%d0,%sp@-	/* 1001ac6c:	2f00 */
	movel	%d0,%sp@-	/* 1001ac6e:	2f00 */
	moveq	#0,%d1	/* 1001ac70:	7200 */
	moveb	%d5,%d1	/* 1001ac72:	1205 */
	movel	%d1,%sp@-	/* 1001ac74:	2f01 */
	jsr	%pc@(sub_1001e2f2)	/* 1001ac76:	4eba 367a */
	lea	%sp@(20),%sp	/* 1001ac7a:	4fef 0014 */
	moveal	%sp@+,%a1	/* 1001ac7e:	225f */

.L1001ac80:
	moveml	%fp@(-32),%d5-%d7/%a2-%a4	/* 1001ac80:	4cee 1ce0 ffe0 */
	unlk	%fp	/* 1001ac86:	4e5e */
	rts	/* 1001ac88:	4e75 */

sub_1001ac8a:
	braw	sub_1001f526	/* 1001ac8a:	6000 489a */

sub_1001ac8e:
	braw	sub_1001b6c2	/* 1001ac8e:	6000 0a32 */

sub_1001ac92:
	braw	sub_1001b06e	/* 1001ac92:	6000 03da */

sub_1001ac96:
	braw	sub_100223f2	/* 1001ac96:	6000 775a */

sub_1001ac9a:
	braw	sub_10013dc2	/* 1001ac9a:	6000 9126 */

sub_1001ac9e:
	braw	sub_10017d32	/* 1001ac9e:	6000 d092 */

sub_1001aca2:
	braw	sub_10013dc6	/* 1001aca2:	6000 9122 */

sub_1001aca6:
	braw	sub_1001512e	/* 1001aca6:	6000 a486 */

sub_1001acaa:
	braw	sub_10014200	/* 1001acaa:	6000 9554 */

sub_1001acae:
	braw	sub_10016fe0	/* 1001acae:	6000 c330 */

sub_1001acb2:
	braw	sub_10013dca	/* 1001acb2:	6000 9116 */

sub_1001acb6:
	braw	sub_10013dce	/* 1001acb6:	6000 9116 */

sub_1001acba:
	braw	sub_10013dd2	/* 1001acba:	6000 9116 */

sub_1001acbe:
	braw	sub_10015112	/* 1001acbe:	6000 a452 */

sub_1001acc2:
	braw	sub_100142ba	/* 1001acc2:	6000 95f6 */

sub_1001acc6:
	braw	sub_10016fd0	/* 1001acc6:	6000 c308 */

sub_1001acca:
	braw	sub_10013dd6	/* 1001acca:	6000 910a */

sub_1001acce:
	braw	sub_10013dda	/* 1001acce:	6000 910a */

sub_1001acd2:
	braw	sub_10013dde	/* 1001acd2:	6000 910a */

sub_1001acd6:
	braw	sub_10013de2	/* 1001acd6:	6000 910a */

sub_1001acda:
	braw	sub_10013de6	/* 1001acda:	6000 910a */

sub_1001acde:
	braw	sub_100174f0	/* 1001acde:	6000 c810 */

sub_1001ace2:
	braw	sub_10013dea	/* 1001ace2:	6000 9106 */

sub_1001ace6:
	braw	sub_10013dee	/* 1001ace6:	6000 9106 */

sub_1001acea:
	braw	sub_10013df2	/* 1001acea:	6000 9106 */

sub_1001acee:
	braw	sub_10013df6	/* 1001acee:	6000 9106 */

sub_1001acf2:
	braw	sub_10013dfa	/* 1001acf2:	6000 9106 */

sub_1001acf6:
	braw	sub_10013dfe	/* 1001acf6:	6000 9106 */

sub_1001acfa:
	linkw	%fp,#-52	/* 1001acfa:	4e56 ffcc */
	moveml	%d4-%d7/%a3-%a4,%sp@-	/* 1001acfe:	48e7 0f18 */
	moveb	%fp@(15),%d4	/* 1001ad02:	182e 000f */
	moveb	%fp@(19),%d5	/* 1001ad06:	1a2e 0013 */
	moveb	%fp@(11),%d6	/* 1001ad0a:	1c2e 000b */
	jsr	%pc@(sub_1001fe5c)	/* 1001ad0e:	4eba 514c */
	moveal	%d0,%a0	/* 1001ad12:	2040 */
	lea	%a0@(464),%a4	/* 1001ad14:	49e8 01d0 */
	moveal	%a4@,%a3	/* 1001ad18:	2654 */
	lea	%a3@(-16),%a3	/* 1001ad1a:	47eb fff0 */
	jsr	%pc@(sub_1001fe5c)	/* 1001ad1e:	4eba 513c */
	moveal	%d0,%a0	/* 1001ad22:	2040 */
	lea	%a0@(464),%a4	/* 1001ad24:	49e8 01d0 */
	movel	%a4@,%d0	/* 1001ad28:	2014 */
	moveq	#80,%d1	/* 1001ad2a:	7250 */
	addl	%d1,%d0	/* 1001ad2c:	d081 */
	cmpl	%a4@(4),%d0	/* 1001ad2e:	b0ac 0004 */
	bcss	.L1001ad40	/* 1001ad32:	650c */
	movel	%a4,%sp@-	/* 1001ad34:	2f0c */
	jsr	%pc@(sub_1001da1e)	/* 1001ad36:	4eba 2ce6 */
	moveq	#0,%d0	/* 1001ad3a:	7000 */
	addqw	#4,%sp	/* 1001ad3c:	584f */
	bras	.L1001ad42	/* 1001ad3e:	6002 */

.L1001ad40:
	moveq	#0,%d0	/* 1001ad40:	7000 */

.L1001ad42:
	pea	%a3@(4)	/* 1001ad42:	486b 0004 */
	jsr	%pc@(sub_10018030)	/* 1001ad46:	4eba d2e8 */
	movel	%a3@(4),%sp@-	/* 1001ad4a:	2f2b 0004 */
	jsr	%pc@(sub_1001fe54)	/* 1001ad4e:	4eba 5104 */
	moveb	%d0,%d7	/* 1001ad52:	1e00 */
	moveq	#0,%d0	/* 1001ad54:	7000 */
	moveb	%d7,%d0	/* 1001ad56:	1007 */
	cmpiw	#15,%d0	/* 1001ad58:	0c40 000f */
	addqw	#8,%sp	/* 1001ad5c:	504f */
	bnes	.L1001ad7e	/* 1001ad5e:	661e */
	moveq	#0,%d0	/* 1001ad60:	7000 */
	moveb	%d5,%d0	/* 1001ad62:	1005 */
	movel	%d0,%sp@-	/* 1001ad64:	2f00 */
	moveq	#0,%d0	/* 1001ad66:	7000 */
	moveb	%d4,%d0	/* 1001ad68:	1004 */
	movel	%d0,%sp@-	/* 1001ad6a:	2f00 */
	moveq	#0,%d0	/* 1001ad6c:	7000 */
	moveb	%d6,%d0	/* 1001ad6e:	1006 */
	movel	%d0,%sp@-	/* 1001ad70:	2f00 */
	jsr	%pc@(sub_1001a320)	/* 1001ad72:	4eba f5ac */
	lea	%sp@(12),%sp	/* 1001ad76:	4fef 000c */
	braw	.L1001b064	/* 1001ad7a:	6000 02e8 */

.L1001ad7e:
	moveq	#0,%d0	/* 1001ad7e:	7000 */
	moveb	%d7,%d0	/* 1001ad80:	1007 */
	cmpiw	#16,%d0	/* 1001ad82:	0c40 0010 */
	beqs	.L1001ad92	/* 1001ad86:	670a */
	moveq	#0,%d0	/* 1001ad88:	7000 */
	moveb	%d7,%d0	/* 1001ad8a:	1007 */
	cmpiw	#17,%d0	/* 1001ad8c:	0c40 0011 */
	bnes	.L1001ada4	/* 1001ad90:	6612 */

.L1001ad92:
	moveal	%a3@(4),%a0	/* 1001ad92:	206b 0004 */
	movel	%a0,%fp@(-4)	/* 1001ad96:	2d48 fffc */
	addql	#4,%a0	/* 1001ad9a:	5888 */
	movel	%a0@,%d0	/* 1001ad9c:	2010 */
	cmpl	%a3@(12),%d0	/* 1001ad9e:	b0ab 000c */
	beqs	.L1001adc8	/* 1001ada2:	6724 */

.L1001ada4:
	moveq	#0,%d0	/* 1001ada4:	7000 */
	moveb	%d7,%d0	/* 1001ada6:	1007 */
	cmpiw	#18,%d0	/* 1001ada8:	0c40 0012 */
	bnes	.L1001ae1c	/* 1001adac:	666e */
	moveal	%a3@(4),%a4	/* 1001adae:	286b 0004 */
	moveal	%a4,%a0	/* 1001adb2:	204c */
	addql	#4,%a0	/* 1001adb4:	5888 */
	movel	%a0@,%sp@-	/* 1001adb6:	2f10 */
	jsr	%pc@(sub_1001b692)	/* 1001adb8:	4eba 08d8 */
	moveal	%d0,%a0	/* 1001adbc:	2040 */
	movel	%a0@,%d0	/* 1001adbe:	2010 */
	cmpl	%a3@(12),%d0	/* 1001adc0:	b0ab 000c */
	addqw	#4,%sp	/* 1001adc4:	584f */
	bnes	.L1001ae1c	/* 1001adc6:	6654 */

.L1001adc8:
	movel	%a3@(4),%fp@(-16)	/* 1001adc8:	2d6b 0004 fff0 */
	jsr	%pc@(sub_1001fe5c)	/* 1001adce:	4eba 508c */
	moveal	%d0,%a0	/* 1001add2:	2040 */
	lea	%a0@(464),%a4	/* 1001add4:	49e8 01d0 */
	moveal	%a4@,%a0	/* 1001add8:	2054 */
	addql	#4,%a4@	/* 1001adda:	5894 */
	movel	%fp@(-16),%a0@	/* 1001addc:	20ae fff0 */
	jsr	%pc@(sub_1001fe5c)	/* 1001ade0:	4eba 507a */
	moveal	%d0,%a0	/* 1001ade4:	2040 */
	moveal	%a0@(140),%a0	/* 1001ade6:	2068 008c */
	movel	%a0,%fp@(-12)	/* 1001adea:	2d48 fff4 */
	lea	%a0@(12),%a0	/* 1001adee:	41e8 000c */
	movel	%a0@,%fp@(-8)	/* 1001adf2:	2d50 fff8 */
	jsr	%pc@(sub_1001fe5c)	/* 1001adf6:	4eba 5064 */
	moveal	%d0,%a0	/* 1001adfa:	2040 */
	lea	%a0@(464),%a4	/* 1001adfc:	49e8 01d0 */
	moveal	%a4@,%a0	/* 1001ae00:	2054 */
	addql	#4,%a4@	/* 1001ae02:	5894 */
	movel	%fp@(-8),%a0@	/* 1001ae04:	20ae fff8 */
	jsr	%pc@(sub_10013d9e)	/* 1001ae08:	4eba 8f94 */
	moveq	#0,%d0	/* 1001ae0c:	7000 */
	moveb	%d6,%d0	/* 1001ae0e:	1006 */
	movel	%d0,%sp@-	/* 1001ae10:	2f00 */
	jsr	%pc@(sub_10013d9a)	/* 1001ae12:	4eba 8f86 */
	addqw	#4,%sp	/* 1001ae16:	584f */
	braw	.L1001b064	/* 1001ae18:	6000 024a */

.L1001ae1c:
	cmpil	#497,%a3@(12)	/* 1001ae1c:	0cab 0000 01f1 */
		/* 1001ae22:	000c */
	bnes	.L1001ae4a	/* 1001ae24:	6624 */
	moveq	#0,%d0	/* 1001ae26:	7000 */
	moveb	%d5,%d0	/* 1001ae28:	1005 */
	movel	%d0,%sp@-	/* 1001ae2a:	2f00 */
	moveq	#0,%d0	/* 1001ae2c:	7000 */
	moveb	%d7,%d0	/* 1001ae2e:	1007 */
	movel	%d0,%sp@-	/* 1001ae30:	2f00 */
	moveq	#0,%d0	/* 1001ae32:	7000 */
	moveb	%d4,%d0	/* 1001ae34:	1004 */
	movel	%d0,%sp@-	/* 1001ae36:	2f00 */
	moveq	#0,%d0	/* 1001ae38:	7000 */
	moveb	%d6,%d0	/* 1001ae3a:	1006 */
	movel	%d0,%sp@-	/* 1001ae3c:	2f00 */
	jsr	%pc@(sub_1001aaf8)	/* 1001ae3e:	4eba fcb8 */
	lea	%sp@(16),%sp	/* 1001ae42:	4fef 0010 */
	braw	.L1001b064	/* 1001ae46:	6000 021c */

.L1001ae4a:
	moveq	#0,%d0	/* 1001ae4a:	7000 */
	moveb	%d7,%d0	/* 1001ae4c:	1007 */
	cmpiw	#8,%d0	/* 1001ae4e:	0c40 0008 */
	beqs	.L1001ae5e	/* 1001ae52:	670a */
	cmpil	#985,%a3@(4)	/* 1001ae54:	0cab 0000 03d9 */
		/* 1001ae5a:	0004 */
	bnes	.L1001ae96	/* 1001ae5c:	6638 */

.L1001ae5e:
	movel	%a3@(4),%fp@(-8)	/* 1001ae5e:	2d6b 0004 fff8 */
	jsr	%pc@(sub_1001fe5c)	/* 1001ae64:	4eba 4ff6 */
	moveal	%d0,%a0	/* 1001ae68:	2040 */
	lea	%a0@(464),%a4	/* 1001ae6a:	49e8 01d0 */
	moveal	%a4@,%a0	/* 1001ae6e:	2054 */
	addql	#4,%a4@	/* 1001ae70:	5894 */
	movel	%fp@(-8),%a0@	/* 1001ae72:	20ae fff8 */
	moveq	#0,%d0	/* 1001ae76:	7000 */
	movel	%d0,%sp@-	/* 1001ae78:	2f00 */
	moveq	#0,%d1	/* 1001ae7a:	7200 */
	moveb	%d5,%d1	/* 1001ae7c:	1205 */
	movel	%d1,%sp@-	/* 1001ae7e:	2f01 */
	movel	%d0,%sp@-	/* 1001ae80:	2f00 */
	movel	%d0,%sp@-	/* 1001ae82:	2f00 */
	moveq	#0,%d1	/* 1001ae84:	7200 */
	moveb	%d6,%d1	/* 1001ae86:	1206 */
	movel	%d1,%sp@-	/* 1001ae88:	2f01 */
	jsr	%pc@(sub_1001e2f2)	/* 1001ae8a:	4eba 3466 */
	lea	%sp@(20),%sp	/* 1001ae8e:	4fef 0014 */
	braw	.L1001b064	/* 1001ae92:	6000 01d0 */

.L1001ae96:
	cmpib	#21,%d7	/* 1001ae96:	0c07 0015 */
	bcsw	.L1001b044	/* 1001ae9a:	6500 01a8 */
	moveq	#0,%d0	/* 1001ae9e:	7000 */
	moveb	%d7,%d0	/* 1001aea0:	1007 */
	cmpib	#32,%d0	/* 1001aea2:	0c00 0020 */
	bhiw	.L1001b044	/* 1001aea6:	6200 019c */
	jsr	%pc@(sub_1001fe5c)	/* 1001aeaa:	4eba 4fb0 */
	moveal	%d0,%a0	/* 1001aeae:	2040 */
	lea	%a0@(464),%a4	/* 1001aeb0:	49e8 01d0 */
	moveal	%a4@,%a0	/* 1001aeb4:	2054 */
	addql	#4,%a4@	/* 1001aeb6:	5894 */
	moveq	#1,%d0	/* 1001aeb8:	7001 */
	movel	%d0,%a0@	/* 1001aeba:	2080 */
	jsr	%pc@(sub_1001fe5c)	/* 1001aebc:	4eba 4f9e */
	moveal	%d0,%a0	/* 1001aec0:	2040 */
	lea	%a0@(464),%a0	/* 1001aec2:	41e8 01d0 */
	movel	%a0,%fp@(-16)	/* 1001aec6:	2d48 fff0 */
	movel	%a0@,%d0	/* 1001aeca:	2010 */
	subql	#4,%d0	/* 1001aecc:	5980 */
	movel	%d0,%fp@(-24)	/* 1001aece:	2d40 ffe8 */
	movel	%a3@(4),%fp@(-12)	/* 1001aed2:	2d6b 0004 fff4 */
	jsr	%pc@(sub_1001fe5c)	/* 1001aed8:	4eba 4f82 */
	moveal	%d0,%a0	/* 1001aedc:	2040 */
	lea	%a0@(464),%a4	/* 1001aede:	49e8 01d0 */
	moveal	%a4@,%a0	/* 1001aee2:	2054 */
	addql	#4,%a4@	/* 1001aee4:	5894 */
	movel	%fp@(-12),%a0@	/* 1001aee6:	20ae fff4 */
	movel	%fp@(-24),%sp@-	/* 1001aeea:	2f2e ffe8 */
	jsr	%pc@(sub_10018b7c)	/* 1001aeee:	4eba dc8c */
	jsr	%pc@(sub_1001fe5c)	/* 1001aef2:	4eba 4f68 */
	moveal	%d0,%a0	/* 1001aef6:	2040 */
	lea	%a0@(464),%a4	/* 1001aef8:	49e8 01d0 */
	subql	#4,%a4@	/* 1001aefc:	5994 */
	moveal	%a4@,%a0	/* 1001aefe:	2054 */
	movel	%a0@,%fp@(-20)	/* 1001af00:	2d50 ffec */
	movel	%fp@(-20),%a3@(4)	/* 1001af04:	276e ffec 0004 */
	lea	%a3@,%a4	/* 1001af0a:	49d3 */
	movel	%a4@,%d0	/* 1001af0c:	2014 */
	asrl	#2,%d0	/* 1001af0e:	e480 */
	movel	%d0,%fp@(-8)	/* 1001af10:	2d40 fff8 */
	negl	%d0	/* 1001af14:	4480 */
	asll	#2,%d0	/* 1001af16:	e580 */
	lea	%a4@(0,%d0:l),%a0	/* 1001af18:	41f4 0800 */
	movel	%fp@(-20),%a0@(-4)	/* 1001af1c:	216e ffec fffc */
	moveal	%fp@(-24),%a0	/* 1001af22:	206e ffe8 */
	moveq	#1,%d0	/* 1001af26:	7001 */
	cmpl	%a0@,%d0	/* 1001af28:	b090 */
	addqw	#4,%sp	/* 1001af2a:	584f */
	bnes	.L1001af60	/* 1001af2c:	6632 */
	jsr	%pc@(sub_1001fe5c)	/* 1001af2e:	4eba 4f2c */
	moveal	%d0,%a0	/* 1001af32:	2040 */
	lea	%a0@(464),%a4	/* 1001af34:	49e8 01d0 */
	subql	#4,%a4@	/* 1001af38:	5994 */
	moveq	#0,%d0	/* 1001af3a:	7000 */
	moveb	%fp@(23),%d0	/* 1001af3c:	102e 0017 */
	movel	%d0,%sp@-	/* 1001af40:	2f00 */
	moveq	#0,%d0	/* 1001af42:	7000 */
	moveb	%d5,%d0	/* 1001af44:	1005 */
	movel	%d0,%sp@-	/* 1001af46:	2f00 */
	moveq	#0,%d0	/* 1001af48:	7000 */
	moveb	%d4,%d0	/* 1001af4a:	1004 */
	movel	%d0,%sp@-	/* 1001af4c:	2f00 */
	moveq	#0,%d0	/* 1001af4e:	7000 */
	moveb	%d6,%d0	/* 1001af50:	1006 */
	movel	%d0,%sp@-	/* 1001af52:	2f00 */
	jsr	%pc@(sub_1001acfa)	/* 1001af54:	4eba fda4 */
	lea	%sp@(16),%sp	/* 1001af58:	4fef 0010 */
	braw	.L1001b064	/* 1001af5c:	6000 0106 */

.L1001af60:
	moveq	#0,%d0	/* 1001af60:	7000 */
	moveb	%fp@(23),%d0	/* 1001af62:	102e 0017 */
	tstl	%d0	/* 1001af66:	4a80 */
	beqs	.L1001afe6	/* 1001af68:	677c */
	movel	%a3@(4),%fp@(-52)	/* 1001af6a:	2d6b 0004 ffcc */
	jsr	%pc@(sub_1001fe5c)	/* 1001af70:	4eba 4eea */
	moveal	%d0,%a0	/* 1001af74:	2040 */
	lea	%a0@(464),%a0	/* 1001af76:	41e8 01d0 */
	movel	%a0,%fp@(-48)	/* 1001af7a:	2d48 ffd0 */
	moveal	%a0@,%a1	/* 1001af7e:	2250 */
	addql	#4,%a0@	/* 1001af80:	5890 */
	movel	%fp@(-52),%a1@	/* 1001af82:	22ae ffcc */
	movel	%a3@(12),%sp@-	/* 1001af86:	2f2b 000c */
	jsr	%pc@(sub_100195ca)	/* 1001af8a:	4eba e63e */
	moveq	#3,%d0	/* 1001af8e:	7003 */
	movel	%d0,%sp@-	/* 1001af90:	2f00 */
	moveq	#21,%d1	/* 1001af92:	7215 */
	movel	%d1,%sp@-	/* 1001af94:	2f01 */
	jsr	%pc@(sub_10017534)	/* 1001af96:	4eba c59c */
	jsr	%pc@(sub_1001fe5c)	/* 1001af9a:	4eba 4ec0 */
	moveal	%d0,%a0	/* 1001af9e:	2040 */
	lea	%a0@(464),%a0	/* 1001afa0:	41e8 01d0 */
	movel	%a0,%fp@(-44)	/* 1001afa4:	2d48 ffd4 */
	subql	#4,%a0@	/* 1001afa8:	5990 */
	moveal	%a0@,%a0	/* 1001afaa:	2050 */
	moveal	%a0@,%a4	/* 1001afac:	2850 */
	jsr	%pc@(sub_1001fe5c)	/* 1001afae:	4eba 4eac */
	moveal	%d0,%a0	/* 1001afb2:	2040 */
	lea	%a0@(464),%a0	/* 1001afb4:	41e8 01d0 */
	movel	%a0,%fp@(-40)	/* 1001afb8:	2d48 ffd8 */
	movel	%a3,%a0@	/* 1001afbc:	208b */
	movel	%a3@,%d0	/* 1001afbe:	2013 */
	movel	%d0,%fp@(-36)	/* 1001afc0:	2d40 ffdc */
	asrl	#2,%d0	/* 1001afc4:	e480 */
	addql	#1,%d0	/* 1001afc6:	5280 */
	movel	%d0,%fp@(-32)	/* 1001afc8:	2d40 ffe0 */
	jsr	%pc@(sub_1001fe5c)	/* 1001afcc:	4eba 4e8e */
	moveal	%d0,%a0	/* 1001afd0:	2040 */
	lea	%a0@(464),%a0	/* 1001afd2:	41e8 01d0 */
	movel	%a0,%fp@(-28)	/* 1001afd6:	2d48 ffe4 */
	movel	%fp@(-32),%d0	/* 1001afda:	202e ffe0 */
	asll	#2,%d0	/* 1001afde:	e580 */
	subl	%d0,%a0@	/* 1001afe0:	9190 */
	lea	%sp@(12),%sp	/* 1001afe2:	4fef 000c */

.L1001afe6:
	moveq	#0,%d0	/* 1001afe6:	7000 */
	moveb	%fp@(23),%d0	/* 1001afe8:	102e 0017 */
	cmpiw	#1,%d0	/* 1001afec:	0c40 0001 */
	bnes	.L1001b004	/* 1001aff0:	6612 */
	jsr	%pc@(sub_1001fe5c)	/* 1001aff2:	4eba 4e68 */
	moveal	%d0,%a0	/* 1001aff6:	2040 */
	lea	%a0@(464),%a3	/* 1001aff8:	47e8 01d0 */
	moveal	%a3@,%a0	/* 1001affc:	2053 */
	addql	#4,%a3@	/* 1001affe:	5893 */
	movel	%a4,%a0@	/* 1001b000:	208c */
	bras	.L1001b064	/* 1001b002:	6060 */

.L1001b004:
	moveq	#0,%d0	/* 1001b004:	7000 */
	moveb	%fp@(23),%d0	/* 1001b006:	102e 0017 */
	cmpiw	#2,%d0	/* 1001b00a:	0c40 0002 */
	bnes	.L1001b026	/* 1001b00e:	6616 */
	moveq	#1,%d0	/* 1001b010:	7001 */
	movel	%d0,%sp@-	/* 1001b012:	2f00 */
	moveal	%fp@(-24),%a0	/* 1001b014:	206e ffe8 */
	movel	%a0@,%sp@-	/* 1001b018:	2f10 */
	movel	%a4,%sp@-	/* 1001b01a:	2f0c */
	jsr	%pc@(sub_1001ff78)	/* 1001b01c:	4eba 4f5a */
	lea	%sp@(12),%sp	/* 1001b020:	4fef 000c */
	bras	.L1001b064	/* 1001b024:	603e */

.L1001b026:
	moveq	#0,%d0	/* 1001b026:	7000 */
	movel	%d0,%sp@-	/* 1001b028:	2f00 */
	moveq	#0,%d1	/* 1001b02a:	7200 */
	moveb	%d5,%d1	/* 1001b02c:	1205 */
	movel	%d1,%sp@-	/* 1001b02e:	2f01 */
	movel	%d0,%sp@-	/* 1001b030:	2f00 */
	movel	%d0,%sp@-	/* 1001b032:	2f00 */
	moveq	#0,%d1	/* 1001b034:	7200 */
	moveb	%d6,%d1	/* 1001b036:	1206 */
	movel	%d1,%sp@-	/* 1001b038:	2f01 */
	jsr	%pc@(sub_1001e2f2)	/* 1001b03a:	4eba 32b6 */
	lea	%sp@(20),%sp	/* 1001b03e:	4fef 0014 */
	bras	.L1001b064	/* 1001b042:	6020 */

.L1001b044:
	moveq	#0,%d0	/* 1001b044:	7000 */
	moveb	%d5,%d0	/* 1001b046:	1005 */
	movel	%d0,%sp@-	/* 1001b048:	2f00 */
	moveq	#0,%d0	/* 1001b04a:	7000 */
	moveb	%d7,%d0	/* 1001b04c:	1007 */
	movel	%d0,%sp@-	/* 1001b04e:	2f00 */
	moveq	#0,%d0	/* 1001b050:	7000 */
	moveb	%d4,%d0	/* 1001b052:	1004 */
	movel	%d0,%sp@-	/* 1001b054:	2f00 */
	moveq	#0,%d0	/* 1001b056:	7000 */
	moveb	%d6,%d0	/* 1001b058:	1006 */
	movel	%d0,%sp@-	/* 1001b05a:	2f00 */
	jsr	%pc@(sub_1001a940)	/* 1001b05c:	4eba f8e2 */
	lea	%sp@(16),%sp	/* 1001b060:	4fef 0010 */

.L1001b064:
	moveml	%fp@(-76),%d4-%d7/%a3-%a4	/* 1001b064:	4cee 18f0 ffb4 */
	unlk	%fp	/* 1001b06a:	4e5e */
	rts	/* 1001b06c:	4e75 */

sub_1001b06e:
	linkw	%fp,#0	/* 1001b06e:	4e56 0000 */
	moveq	#0,%d0	/* 1001b072:	7000 */
	moveb	%fp@(15),%d0	/* 1001b074:	102e 000f */
	movel	%d0,%sp@-	/* 1001b078:	2f00 */
	moveq	#0,%d0	/* 1001b07a:	7000 */
	movel	%d0,%sp@-	/* 1001b07c:	2f00 */
	moveq	#1,%d1	/* 1001b07e:	7201 */
	movel	%d1,%sp@-	/* 1001b080:	2f01 */
	moveq	#0,%d2	/* 1001b082:	7400 */
	moveb	%fp@(11),%d2	/* 1001b084:	142e 000b */
	movel	%d2,%sp@-	/* 1001b088:	2f02 */
	jsr	%pc@(sub_1001acfa)	/* 1001b08a:	4eba fc6e */
	unlk	%fp	/* 1001b08e:	4e5e */
	rts	/* 1001b090:	4e75 */

sub_1001b092:
	braw	sub_10022558	/* 1001b092:	6000 74c4 */

sub_1001b096:
	braw	sub_1002255c	/* 1001b096:	6000 74c4 */

sub_1001b09a:
	linkw	%fp,#-78	/* 1001b09a:	4e56 ffb2 */
	moveml	%d7/%a3-%a4,%sp@-	/* 1001b09e:	48e7 0118 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b0a2:	4eba 4db8 */
	moveal	%d0,%a0	/* 1001b0a6:	2040 */
	lea	%a0@(464),%a4	/* 1001b0a8:	49e8 01d0 */
	movel	%a4@,%d0	/* 1001b0ac:	2014 */
	moveq	#100,%d1	/* 1001b0ae:	7264 */
	addl	%d1,%d0	/* 1001b0b0:	d081 */
	cmpl	%a4@(4),%d0	/* 1001b0b2:	b0ac 0004 */
	bcss	.L1001b0c4	/* 1001b0b6:	650c */
	movel	%a4,%sp@-	/* 1001b0b8:	2f0c */
	jsr	%pc@(sub_1001da1e)	/* 1001b0ba:	4eba 2962 */
	moveq	#0,%d0	/* 1001b0be:	7000 */
	addqw	#4,%sp	/* 1001b0c0:	584f */
	bras	.L1001b0c6	/* 1001b0c2:	6002 */

.L1001b0c4:
	moveq	#0,%d0	/* 1001b0c4:	7000 */

.L1001b0c6:
	jsr	%pc@(sub_1001fe5c)	/* 1001b0c6:	4eba 4d94 */
	moveal	%d0,%a0	/* 1001b0ca:	2040 */
	moveal	%a0@(212),%a4	/* 1001b0cc:	2868 00d4 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b0d0:	4eba 4d8a */
	moveal	%d0,%a0	/* 1001b0d4:	2040 */
	lea	%a0@(464),%a3	/* 1001b0d6:	47e8 01d0 */
	moveal	%a3@,%a0	/* 1001b0da:	2053 */
	addql	#4,%a3@	/* 1001b0dc:	5893 */
	movel	%a4,%a0@	/* 1001b0de:	208c */
	jsr	%pc@(sub_1001fe5c)	/* 1001b0e0:	4eba 4d7a */
	moveal	%d0,%a0	/* 1001b0e4:	2040 */
	movel	%a0@(88),%fp@(-52)	/* 1001b0e6:	2d68 0058 ffcc */
	lea	%fp@(-52),%a0	/* 1001b0ec:	41ee ffcc */
	movel	%a0,%sp@-	/* 1001b0f0:	2f08 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b0f2:	4eba 4d68 */
	moveal	%sp@+,%a0	/* 1001b0f6:	205f */
	moveal	%d0,%a1	/* 1001b0f8:	2240 */
	movel	%a0,%a1@(88)	/* 1001b0fa:	2348 0058 */
	lea	%fp@(-52),%a0	/* 1001b0fe:	41ee ffcc */
	lea	%fp@(-48),%a0	/* 1001b102:	41ee ffd0 */
	lea	%pc@(.L1001b110),%a1	/* 1001b106:	43fa 0008 */
	moveml	%d2-%d7/%a1-%a4/%fp-%sp,%a0@	/* 1001b10a:	48d0 defc */
	moveq	#0,%d0	/* 1001b10e:	7000 */

.L1001b110:
	movel	%d0,%d7	/* 1001b110:	2e00 */
	bnes	.L1001b16a	/* 1001b112:	6656 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b114:	4eba 4d46 */
	moveal	%d0,%a0	/* 1001b118:	2040 */
	movel	%fp@(16),%a0@(212)	/* 1001b11a:	216e 0010 00d4 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b120:	4eba 4d3a */
	moveal	%d0,%a0	/* 1001b124:	2040 */
	lea	%a0@(464),%a4	/* 1001b126:	49e8 01d0 */
	moveal	%a4@,%a0	/* 1001b12a:	2054 */
	addql	#4,%a4@	/* 1001b12c:	5894 */
	movel	%fp@(8),%a0@	/* 1001b12e:	20ae 0008 */
	pea	%fp@(-70)	/* 1001b132:	486e ffba */
	jsr	%pc@(sub_10022e42)	/* 1001b136:	4eba 7d0a */
	lea	%fp@(-70),%a0	/* 1001b13a:	41ee ffba */
	moveq	#0,%d0	/* 1001b13e:	7000 */
	moveb	%fp@(23),%d0	/* 1001b140:	102e 0017 */
	movel	%d0,%sp@-	/* 1001b144:	2f00 */
	pea	%fp@(-70)	/* 1001b146:	486e ffba */
	jsr	%pc@(sub_1001b490)	/* 1001b14a:	4eba 0344 */
	movel	%fp@(12),%sp@-	/* 1001b14e:	2f2e 000c */
	pea	%fp@(-70)	/* 1001b152:	486e ffba */
	jsr	%pc@(sub_10022e3a)	/* 1001b156:	4eba 7ce2 */
	moveq	#0,%d0	/* 1001b15a:	7000 */
	movel	%d0,%sp@-	/* 1001b15c:	2f00 */
	pea	%fp@(-70)	/* 1001b15e:	486e ffba */
	jsr	%pc@(sub_10022e3a)	/* 1001b162:	4eba 7cd6 */
	lea	%sp@(28),%sp	/* 1001b166:	4fef 001c */

.L1001b16a:
	jsr	%pc@(sub_1001fe5c)	/* 1001b16a:	4eba 4cf0 */
	moveal	%d0,%a0	/* 1001b16e:	2040 */
	movel	%fp@(-52),%a0@(88)	/* 1001b170:	216e ffcc 0058 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b176:	4eba 4ce4 */
	moveal	%d0,%a0	/* 1001b17a:	2040 */
	lea	%a0@(464),%a3	/* 1001b17c:	47e8 01d0 */
	subql	#4,%a3@	/* 1001b180:	5993 */
	moveal	%a3@,%a0	/* 1001b182:	2053 */
	movel	%a0,%fp@(-74)	/* 1001b184:	2d48 ffb6 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b188:	4eba 4cd2 */
	moveal	%d0,%a0	/* 1001b18c:	2040 */
	moveal	%fp@(-74),%a1	/* 1001b18e:	226e ffb6 */
	movel	%a1@,%a0@(212)	/* 1001b192:	2151 00d4 */
	tstl	%d7	/* 1001b196:	4a87 */
	beqs	.L1001b1b6	/* 1001b198:	671c */
	movel	%d7,%d0	/* 1001b19a:	2007 */
	movel	%d0,%fp@(-78)	/* 1001b19c:	2d40 ffb2 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b1a0:	4eba 4cba */
	moveal	%d0,%a0	/* 1001b1a4:	2040 */
	moveal	%a0@(88),%a0	/* 1001b1a6:	2068 0058 */
	addql	#4,%a0	/* 1001b1aa:	5888 */
	movel	%fp@(-78),%d0	/* 1001b1ac:	202e ffb2 */
	moveml	%a0@,%d2-%d7/%a1-%a4/%fp-%sp	/* 1001b1b0:	4cd0 defc */
	jmp	%a1@	/* 1001b1b4:	4ed1 */

.L1001b1b6:
	moveq	#2,%d0	/* 1001b1b6:	7002 */
	movel	%d0,%sp@-	/* 1001b1b8:	2f00 */
	pea	%fp@(-52)	/* 1001b1ba:	486e ffcc */
	jsr	%pc@(sub_100205da)	/* 1001b1be:	4eba 541a */
	addqw	#8,%sp	/* 1001b1c2:	504f */
	moveml	%fp@(-90),%d7/%a3-%a4	/* 1001b1c4:	4cee 1880 ffa6 */
	unlk	%fp	/* 1001b1ca:	4e5e */
	rts	/* 1001b1cc:	4e75 */

sub_1001b1ce:
	linkw	%fp,#-78	/* 1001b1ce:	4e56 ffb2 */
	moveml	%d7/%a3-%a4,%sp@-	/* 1001b1d2:	48e7 0118 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b1d6:	4eba 4c84 */
	moveal	%d0,%a0	/* 1001b1da:	2040 */
	moveal	%a0@(212),%a3	/* 1001b1dc:	2668 00d4 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b1e0:	4eba 4c7a */
	moveal	%d0,%a0	/* 1001b1e4:	2040 */
	lea	%a0@(464),%a4	/* 1001b1e6:	49e8 01d0 */
	moveal	%a4@,%a0	/* 1001b1ea:	2054 */
	addql	#4,%a4@	/* 1001b1ec:	5894 */
	movel	%a3,%a0@	/* 1001b1ee:	208b */
	jsr	%pc@(sub_1001fe5c)	/* 1001b1f0:	4eba 4c6a */
	moveal	%d0,%a0	/* 1001b1f4:	2040 */
	movel	%a0@(88),%fp@(-52)	/* 1001b1f6:	2d68 0058 ffcc */
	lea	%fp@(-52),%a0	/* 1001b1fc:	41ee ffcc */
	movel	%a0,%sp@-	/* 1001b200:	2f08 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b202:	4eba 4c58 */
	moveal	%sp@+,%a0	/* 1001b206:	205f */
	moveal	%d0,%a1	/* 1001b208:	2240 */
	movel	%a0,%a1@(88)	/* 1001b20a:	2348 0058 */
	lea	%fp@(-52),%a0	/* 1001b20e:	41ee ffcc */
	lea	%fp@(-48),%a0	/* 1001b212:	41ee ffd0 */
	lea	%pc@(.L1001b220),%a1	/* 1001b216:	43fa 0008 */
	moveml	%d2-%d7/%a1-%a4/%fp-%sp,%a0@	/* 1001b21a:	48d0 defc */
	moveq	#0,%d0	/* 1001b21e:	7000 */

.L1001b220:
	movel	%d0,%d7	/* 1001b220:	2e00 */
	bnes	.L1001b27a	/* 1001b222:	6656 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b224:	4eba 4c36 */
	moveal	%d0,%a0	/* 1001b228:	2040 */
	movel	%fp@(16),%a0@(212)	/* 1001b22a:	216e 0010 00d4 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b230:	4eba 4c2a */
	moveal	%d0,%a0	/* 1001b234:	2040 */
	lea	%a0@(464),%a4	/* 1001b236:	49e8 01d0 */
	moveal	%a4@,%a0	/* 1001b23a:	2054 */
	addql	#4,%a4@	/* 1001b23c:	5894 */
	movel	%fp@(8),%a0@	/* 1001b23e:	20ae 0008 */
	pea	%fp@(-70)	/* 1001b242:	486e ffba */
	jsr	%pc@(sub_10022e42)	/* 1001b246:	4eba 7bfa */
	lea	%fp@(-70),%a0	/* 1001b24a:	41ee ffba */
	moveq	#0,%d0	/* 1001b24e:	7000 */
	moveb	%fp@(23),%d0	/* 1001b250:	102e 0017 */
	movel	%d0,%sp@-	/* 1001b254:	2f00 */
	pea	%fp@(-70)	/* 1001b256:	486e ffba */
	jsr	%pc@(sub_1001b5ea)	/* 1001b25a:	4eba 038e */
	movel	%fp@(12),%sp@-	/* 1001b25e:	2f2e 000c */
	pea	%fp@(-70)	/* 1001b262:	486e ffba */
	jsr	%pc@(sub_10022e3a)	/* 1001b266:	4eba 7bd2 */
	moveq	#0,%d0	/* 1001b26a:	7000 */
	movel	%d0,%sp@-	/* 1001b26c:	2f00 */
	pea	%fp@(-70)	/* 1001b26e:	486e ffba */
	jsr	%pc@(sub_10022e3a)	/* 1001b272:	4eba 7bc6 */
	lea	%sp@(28),%sp	/* 1001b276:	4fef 001c */

.L1001b27a:
	jsr	%pc@(sub_1001fe5c)	/* 1001b27a:	4eba 4be0 */
	moveal	%d0,%a0	/* 1001b27e:	2040 */
	movel	%fp@(-52),%a0@(88)	/* 1001b280:	216e ffcc 0058 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b286:	4eba 4bd4 */
	moveal	%d0,%a0	/* 1001b28a:	2040 */
	lea	%a0@(464),%a3	/* 1001b28c:	47e8 01d0 */
	subql	#4,%a3@	/* 1001b290:	5993 */
	moveal	%a3@,%a0	/* 1001b292:	2053 */
	movel	%a0,%fp@(-74)	/* 1001b294:	2d48 ffb6 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b298:	4eba 4bc2 */
	moveal	%d0,%a0	/* 1001b29c:	2040 */
	moveal	%fp@(-74),%a1	/* 1001b29e:	226e ffb6 */
	movel	%a1@,%a0@(212)	/* 1001b2a2:	2151 00d4 */
	tstl	%d7	/* 1001b2a6:	4a87 */
	beqs	.L1001b2c6	/* 1001b2a8:	671c */
	movel	%d7,%d0	/* 1001b2aa:	2007 */
	movel	%d0,%fp@(-78)	/* 1001b2ac:	2d40 ffb2 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b2b0:	4eba 4baa */
	moveal	%d0,%a0	/* 1001b2b4:	2040 */
	moveal	%a0@(88),%a0	/* 1001b2b6:	2068 0058 */
	addql	#4,%a0	/* 1001b2ba:	5888 */
	movel	%fp@(-78),%d0	/* 1001b2bc:	202e ffb2 */
	moveml	%a0@,%d2-%d7/%a1-%a4/%fp-%sp	/* 1001b2c0:	4cd0 defc */
	jmp	%a1@	/* 1001b2c4:	4ed1 */

.L1001b2c6:
	moveq	#2,%d0	/* 1001b2c6:	7002 */
	movel	%d0,%sp@-	/* 1001b2c8:	2f00 */
	pea	%fp@(-52)	/* 1001b2ca:	486e ffcc */
	jsr	%pc@(sub_100205da)	/* 1001b2ce:	4eba 530a */
	addqw	#8,%sp	/* 1001b2d2:	504f */
	moveml	%fp@(-90),%d7/%a3-%a4	/* 1001b2d4:	4cee 1880 ffa6 */
	unlk	%fp	/* 1001b2da:	4e5e */
	rts	/* 1001b2dc:	4e75 */

sub_1001b2de:
	linkw	%fp,#0	/* 1001b2de:	4e56 0000 */
	movel	#-1750,%sp@-	/* 1001b2e2:	2f3c ffff f92a */
	jsr	%pc@(sub_1001e2e2)	/* 1001b2e8:	4eba 2ff8 */
	unlk	%fp	/* 1001b2ec:	4e5e */
	rts	/* 1001b2ee:	4e75 */

sub_1001b2f0:
	braw	sub_10021650	/* 1001b2f0:	6000 635e */

sub_1001b2f4:
	braw	sub_1002254c	/* 1001b2f4:	6000 7256 */

sub_1001b2f8:
	braw	sub_10022550	/* 1001b2f8:	6000 7256 */

sub_1001b2fc:
	braw	sub_10022554	/* 1001b2fc:	6000 7256 */

sub_1001b300:
	linkw	%fp,#0	/* 1001b300:	4e56 0000 */
	movel	%d7,%sp@-	/* 1001b304:	2f07 */
	movel	%fp@(8),%sp@-	/* 1001b306:	2f2e 0008 */
	jsr	%pc@(sub_1001fe54)	/* 1001b30a:	4eba 4b48 */
	moveb	%d0,%d7	/* 1001b30e:	1e00 */
	subqb	#1,%d0	/* 1001b310:	5300 */
	addqw	#4,%sp	/* 1001b312:	584f */
	bcsw	.L1001b47e	/* 1001b314:	6500 0168 */
	cmpib	#43,%d0	/* 1001b318:	0c00 002b */
	bhiw	.L1001b47e	/* 1001b31c:	6200 0160 */
	moveq	#0,%d1	/* 1001b320:	7200 */
	moveb	%d0,%d1	/* 1001b322:	1200 */
	addw	%d1,%d1	/* 1001b324:	d241 */
	movew	%pc@(.L1001b32e,%d1:w),%d1	/* 1001b326:	323b 1006 */
	jmp	%pc@(%d1:w)	/* 1001b32a:	4efb 1000 */
...
.L1001b32e:
	...
	.byte	0x01,0x42,0x01,0x42,0x01,0x4a

	.byte	0x41,0xfa,0x71,0xe8
	movel	%a0,%d0	/* 1001b38a:	2008 */
	braw	.L1001b484	/* 1001b38c:	6000 00f6 */

	lea	%pc@(sub_1001f20c),%a0	/* 1001b390:	41fa 3e7a */
	movel	%a0,%d0	/* 1001b394:	2008 */
	braw	.L1001b484	/* 1001b396:	6000 00ec */

	lea	%pc@(sub_10017286),%a0	/* 1001b39a:	41fa beea */
	movel	%a0,%d0	/* 1001b39e:	2008 */
	braw	.L1001b484	/* 1001b3a0:	6000 00e2 */

	lea	%pc@(sub_10016c24),%a0	/* 1001b3a4:	41fa b87e */
	movel	%a0,%d0	/* 1001b3a8:	2008 */
	braw	.L1001b484	/* 1001b3aa:	6000 00d8 */

	lea	%pc@(sub_100150a4),%a0	/* 1001b3ae:	41fa 9cf4 */
	movel	%a0,%d0	/* 1001b3b2:	2008 */
	braw	.L1001b484	/* 1001b3b4:	6000 00ce */

	lea	%pc@(sub_1001cc20),%a0	/* 1001b3b8:	41fa 1866 */
	movel	%a0,%d0	/* 1001b3bc:	2008 */
	braw	.L1001b484	/* 1001b3be:	6000 00c4 */

	lea	%pc@(sub_1002256c),%a0	/* 1001b3c2:	41fa 71a8 */
	movel	%a0,%d0	/* 1001b3c6:	2008 */
	braw	.L1001b484	/* 1001b3c8:	6000 00ba */

	lea	%pc@(sub_10021b20),%a0	/* 1001b3cc:	41fa 6752 */
	movel	%a0,%d0	/* 1001b3d0:	2008 */
	braw	.L1001b484	/* 1001b3d2:	6000 00b0 */

	lea	%pc@(sub_10022568),%a0	/* 1001b3d6:	41fa 7190 */
	movel	%a0,%d0	/* 1001b3da:	2008 */
	braw	.L1001b484	/* 1001b3dc:	6000 00a6 */

	lea	%pc@(sub_10013db2),%a0	/* 1001b3e0:	41fa 89d0 */
	movel	%a0,%d0	/* 1001b3e4:	2008 */
	braw	.L1001b484	/* 1001b3e6:	6000 009c */

	lea	%pc@(sub_10013dae),%a0	/* 1001b3ea:	41fa 89c2 */
	movel	%a0,%d0	/* 1001b3ee:	2008 */
	braw	.L1001b484	/* 1001b3f0:	6000 0092 */

	lea	%pc@(sub_10013daa),%a0	/* 1001b3f4:	41fa 89b4 */
	movel	%a0,%d0	/* 1001b3f8:	2008 */
	braw	.L1001b484	/* 1001b3fa:	6000 0088 */

	lea	%pc@(sub_10021e6c),%a0	/* 1001b3fe:	41fa 6a6c */
	movel	%a0,%d0	/* 1001b402:	2008 */
	bras	.L1001b484	/* 1001b404:	607e */

	lea	%pc@(sub_100206ba),%a0	/* 1001b406:	41fa 52b2 */
	movel	%a0,%d0	/* 1001b40a:	2008 */
	bras	.L1001b484	/* 1001b40c:	6076 */

	lea	%pc@(sub_10020848),%a0	/* 1001b40e:	41fa 5438 */
	movel	%a0,%d0	/* 1001b412:	2008 */
	bras	.L1001b484	/* 1001b414:	606e */

	lea	%pc@(sub_1002087c),%a0	/* 1001b416:	41fa 5464 */
	movel	%a0,%d0	/* 1001b41a:	2008 */
	bras	.L1001b484	/* 1001b41c:	6066 */

	lea	%pc@(sub_100208e8),%a0	/* 1001b41e:	41fa 54c8 */
	movel	%a0,%d0	/* 1001b422:	2008 */
	bras	.L1001b484	/* 1001b424:	605e */

	lea	%pc@(sub_10020c58),%a0	/* 1001b426:	41fa 5830 */
	movel	%a0,%d0	/* 1001b42a:	2008 */
	bras	.L1001b484	/* 1001b42c:	6056 */

	lea	%pc@(sub_100215a8),%a0	/* 1001b42e:	41fa 6178 */
	movel	%a0,%d0	/* 1001b432:	2008 */
	bras	.L1001b484	/* 1001b434:	604e */

	lea	%pc@(sub_10020d1a),%a0	/* 1001b436:	41fa 58e2 */
	movel	%a0,%d0	/* 1001b43a:	2008 */
	bras	.L1001b484	/* 1001b43c:	6046 */

	lea	%pc@(sub_10021050),%a0	/* 1001b43e:	41fa 5c10 */
	movel	%a0,%d0	/* 1001b442:	2008 */
	bras	.L1001b484	/* 1001b444:	603e */

	lea	%pc@(sub_100210d8),%a0	/* 1001b446:	41fa 5c90 */
	movel	%a0,%d0	/* 1001b44a:	2008 */
	bras	.L1001b484	/* 1001b44c:	6036 */

	lea	%pc@(sub_10021210),%a0	/* 1001b44e:	41fa 5dc0 */
	movel	%a0,%d0	/* 1001b452:	2008 */
	bras	.L1001b484	/* 1001b454:	602e */

	lea	%pc@(sub_10021258),%a0	/* 1001b456:	41fa 5e00 */
	movel	%a0,%d0	/* 1001b45a:	2008 */
	bras	.L1001b484	/* 1001b45c:	6026 */

	lea	%pc@(sub_100208b4),%a0	/* 1001b45e:	41fa 5454 */
	movel	%a0,%d0	/* 1001b462:	2008 */
	bras	.L1001b484	/* 1001b464:	601e */

	lea	%pc@(sub_1001f730),%a0	/* 1001b466:	41fa 42c8 */
	movel	%a0,%d0	/* 1001b46a:	2008 */
	bras	.L1001b484	/* 1001b46c:	6016 */

	lea	%pc@(sub_1001f8ee),%a0	/* 1001b46e:	41fa 447e */
	movel	%a0,%d0	/* 1001b472:	2008 */
	bras	.L1001b484	/* 1001b474:	600e */

	lea	%pc@(sub_1001fa9e),%a0	/* 1001b476:	41fa 4626 */
	movel	%a0,%d0	/* 1001b47a:	2008 */
	bras	.L1001b484	/* 1001b47c:	6006 */

.L1001b47e:
	lea	%pc@(sub_1001b2de),%a0	/* 1001b47e:	41fa fe5e */
	movel	%a0,%d0	/* 1001b482:	2008 */

.L1001b484:
	movel	%fp@(-4),%d7	/* 1001b484:	2e2e fffc */
	unlk	%fp	/* 1001b488:	4e5e */
	rts	/* 1001b48a:	4e75 */

sub_1001b48c:
	braw	sub_10022548	/* 1001b48c:	6000 70ba */

sub_1001b490:
	linkw	%fp,#-8	/* 1001b490:	4e56 fff8 */
	moveml	%d3/%d7/%a3-%a4,%sp@-	/* 1001b494:	48e7 1118 */
	pea	0x400	/* 1001b498:	4878 0400 */
	movel	#-2706,%sp@-	/* 1001b49c:	2f3c ffff f56e */
	jsr	%pc@(sub_1001da22)	/* 1001b4a2:	4eba 257e */
	jsr	%pc@(sub_1001fe5c)	/* 1001b4a6:	4eba 49b4 */
	moveal	%d0,%a0	/* 1001b4aa:	2040 */
	lea	%a0@(464),%a3	/* 1001b4ac:	47e8 01d0 */
	moveal	%a3@,%a4	/* 1001b4b0:	2853 */
	subqw	#4,%a4	/* 1001b4b2:	594c */
	jsr	%pc@(sub_1001fe5c)	/* 1001b4b4:	4eba 49a6 */
	moveal	%d0,%a0	/* 1001b4b8:	2040 */
	moveq	#1,%d0	/* 1001b4ba:	7001 */
	cmpl	%a0@(212),%d0	/* 1001b4bc:	b0a8 00d4 */
	addqw	#8,%sp	/* 1001b4c0:	504f */
	beqw	.L1001b5c2	/* 1001b4c2:	6700 00fe */
	movel	%a4@,%sp@-	/* 1001b4c6:	2f14 */
	jsr	%pc@(sub_1001fe54)	/* 1001b4c8:	4eba 498a */
	moveb	%d0,%d7	/* 1001b4cc:	1e00 */
	moveq	#0,%d3	/* 1001b4ce:	7600 */
	cmpib	#21,%d7	/* 1001b4d0:	0c07 0015 */
	addqw	#4,%sp	/* 1001b4d4:	584f */
	bcss	.L1001b4e4	/* 1001b4d6:	650c */
	moveq	#0,%d0	/* 1001b4d8:	7000 */
	moveb	%d7,%d0	/* 1001b4da:	1007 */
	cmpib	#32,%d0	/* 1001b4dc:	0c00 0020 */
	bhis	.L1001b4e4	/* 1001b4e0:	6202 */
	moveq	#1,%d3	/* 1001b4e2:	7601 */

.L1001b4e4:
	tstb	%d3	/* 1001b4e4:	4a03 */
	beqw	.L1001b5c2	/* 1001b4e6:	6700 00da */
	movel	%a4,%sp@-	/* 1001b4ea:	2f0c */
	jsr	%pc@(sub_10018030)	/* 1001b4ec:	4eba cb42 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b4f0:	4eba 496a */
	moveal	%d0,%a0	/* 1001b4f4:	2040 */
	lea	%a0@(464),%a3	/* 1001b4f6:	47e8 01d0 */
	moveal	%a3@,%a0	/* 1001b4fa:	2053 */
	addql	#4,%a3@	/* 1001b4fc:	5893 */
	moveq	#1,%d0	/* 1001b4fe:	7001 */
	movel	%d0,%a0@	/* 1001b500:	2080 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b502:	4eba 4958 */
	moveal	%d0,%a0	/* 1001b506:	2040 */
	lea	%a0@(464),%a3	/* 1001b508:	47e8 01d0 */
	moveal	%a3@,%a0	/* 1001b50c:	2053 */
	addql	#4,%a3@	/* 1001b50e:	5893 */
	movel	%a4@,%a0@	/* 1001b510:	2094 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b512:	4eba 4948 */
	moveal	%d0,%a0	/* 1001b516:	2040 */
	lea	%a0@(464),%a0	/* 1001b518:	41e8 01d0 */
	movel	%a0,%fp@(-4)	/* 1001b51c:	2d48 fffc */
	moveal	%a0@,%a3	/* 1001b520:	2650 */
	subqw	#8,%a3	/* 1001b522:	514b */
	movel	%a3,%sp@-	/* 1001b524:	2f0b */
	jsr	%pc@(sub_10018b7c)	/* 1001b526:	4eba d654 */
	moveq	#0,%d3	/* 1001b52a:	7600 */
	cmpil	#985,%a3@	/* 1001b52c:	0c93 0000 03d9 */
	addqw	#8,%sp	/* 1001b532:	504f */
	beqs	.L1001b55c	/* 1001b534:	6726 */
	moveq	#1,%d0	/* 1001b536:	7001 */
	cmpl	%a3@,%d0	/* 1001b538:	b093 */
	beqs	.L1001b55c	/* 1001b53a:	6720 */
	movel	%d3,%sp@-	/* 1001b53c:	2f03 */
	movel	%d3,%sp@-	/* 1001b53e:	2f03 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b540:	4eba 491a */
	movel	%sp@+,%d3	/* 1001b544:	261f */
	moveal	%d0,%a0	/* 1001b546:	2040 */
	movel	%a0@(212),%sp@-	/* 1001b548:	2f28 00d4 */
	movel	%a3@,%sp@-	/* 1001b54c:	2f13 */
	jsr	%pc@(sub_1001ff44)	/* 1001b54e:	4eba 49f4 */
	addql	#8,%sp	/* 1001b552:	508f */
	movel	%sp@+,%d3	/* 1001b554:	261f */
	tstb	%d0	/* 1001b556:	4a00 */
	bnes	.L1001b55c	/* 1001b558:	6602 */
	moveq	#1,%d3	/* 1001b55a:	7601 */

.L1001b55c:
	moveb	%d3,%d7	/* 1001b55c:	1e03 */
	beqs	.L1001b582	/* 1001b55e:	6722 */
	moveq	#1,%d0	/* 1001b560:	7001 */
	movel	%d0,%sp@-	/* 1001b562:	2f00 */
	movel	%a3@,%sp@-	/* 1001b564:	2f13 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b566:	4eba 48f4 */
	moveal	%d0,%a0	/* 1001b56a:	2040 */
	lea	%a0@(464),%a0	/* 1001b56c:	41e8 01d0 */
	movel	%a0,%fp@(-8)	/* 1001b570:	2d48 fff8 */
	subql	#4,%a0@	/* 1001b574:	5990 */
	moveal	%a0@,%a0	/* 1001b576:	2050 */
	movel	%a0@,%sp@-	/* 1001b578:	2f10 */
	jsr	%pc@(sub_1001ff78)	/* 1001b57a:	4eba 49fc */
	lea	%sp@(12),%sp	/* 1001b57e:	4fef 000c */

.L1001b582:
	jsr	%pc@(sub_1001fe5c)	/* 1001b582:	4eba 48d8 */
	moveal	%d0,%a0	/* 1001b586:	2040 */
	lea	%a0@(464),%a3	/* 1001b588:	47e8 01d0 */
	subql	#4,%a3@	/* 1001b58c:	5993 */
	moveal	%a3@,%a0	/* 1001b58e:	2053 */
	movel	%a0@,%a4@	/* 1001b590:	2890 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b592:	4eba 48c8 */
	moveal	%d0,%a0	/* 1001b596:	2040 */
	lea	%a0@(464),%a3	/* 1001b598:	47e8 01d0 */
	subql	#4,%a3@	/* 1001b59c:	5993 */
	tstb	%d7	/* 1001b59e:	4a07 */
	beqs	.L1001b5c2	/* 1001b5a0:	6720 */
	movel	%a4@,%sp@-	/* 1001b5a2:	2f14 */
	jsr	%pc@(sub_1001fe54)	/* 1001b5a4:	4eba 48ae */
	moveq	#0,%d1	/* 1001b5a8:	7200 */
	moveb	%d0,%d1	/* 1001b5aa:	1200 */
	cmpiw	#20,%d1	/* 1001b5ac:	0c41 0014 */
	addqw	#4,%sp	/* 1001b5b0:	584f */
	bnes	.L1001b5c2	/* 1001b5b2:	660e */
	movel	%a4@,%sp@-	/* 1001b5b4:	2f14 */
	movel	#-1700,%sp@-	/* 1001b5b6:	2f3c ffff f95c */
	jsr	%pc@(sub_1001ddd2)	/* 1001b5bc:	4eba 2814 */
	addqw	#8,%sp	/* 1001b5c0:	504f */

.L1001b5c2:
	movel	%a4@,%sp@-	/* 1001b5c2:	2f14 */
	jsr	%pc@(sub_1001b300)	/* 1001b5c4:	4eba fd3a */
	moveal	%d0,%a3	/* 1001b5c8:	2640 */
	moveq	#0,%d0	/* 1001b5ca:	7000 */
	moveb	%fp@(15),%d0	/* 1001b5cc:	102e 000f */
	movel	%d0,%sp@-	/* 1001b5d0:	2f00 */
	movel	%fp@(8),%sp@-	/* 1001b5d2:	2f2e 0008 */
	jsr	%a3@	/* 1001b5d6:	4e93 */
	lea	%sp@(12),%sp	/* 1001b5d8:	4fef 000c */
	moveml	%fp@(-24),%d3/%d7/%a3-%a4	/* 1001b5dc:	4cee 1888 ffe8 */
	unlk	%fp	/* 1001b5e2:	4e5e */
	rts	/* 1001b5e4:	4e75 */
...
sub_1001b5ea:
	linkw	%fp,#-4	/* 1001b5ea:	4e56 fffc */
	moveml	%d6-%d7/%a2-%a4,%sp@-	/* 1001b5ee:	48e7 0338 */
	moveb	%fp@(15),%d7	/* 1001b5f2:	1e2e 000f */
	moveal	%fp@(8),%a4	/* 1001b5f6:	286e 0008 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b5fa:	4eba 4860 */
	moveal	%d0,%a0	/* 1001b5fe:	2040 */
	lea	%a0@(464),%a3	/* 1001b600:	47e8 01d0 */
	moveal	%a3@,%a2	/* 1001b604:	2453 */
	subqw	#4,%a2	/* 1001b606:	594a */
	movel	%a2@,%sp@-	/* 1001b608:	2f12 */
	jsr	%pc@(sub_1001fe54)	/* 1001b60a:	4eba 4848 */
	moveb	%d0,%d6	/* 1001b60e:	1c00 */
	subib	#20,%d0	/* 1001b610:	0400 0014 */
	addqw	#4,%sp	/* 1001b614:	584f */
	beqs	.L1001b66a	/* 1001b616:	6752 */
	subqb	#8,%d0	/* 1001b618:	5100 */
	beqs	.L1001b62a	/* 1001b61a:	670e */
	subqb	#1,%d0	/* 1001b61c:	5300 */
	beqs	.L1001b63a	/* 1001b61e:	671a */
	subqb	#1,%d0	/* 1001b620:	5300 */
	beqs	.L1001b64a	/* 1001b622:	6726 */
	subqb	#1,%d0	/* 1001b624:	5300 */
	beqs	.L1001b65a	/* 1001b626:	6732 */
	bras	.L1001b67a	/* 1001b628:	6050 */

.L1001b62a:
	moveq	#0,%d0	/* 1001b62a:	7000 */
	moveb	%d7,%d0	/* 1001b62c:	1007 */
	movel	%d0,%sp@-	/* 1001b62e:	2f00 */
	movel	%a4,%sp@-	/* 1001b630:	2f0c */
	jsr	%pc@(sub_10021084)	/* 1001b632:	4eba 5a50 */
	addqw	#8,%sp	/* 1001b636:	504f */
	bras	.L1001b688	/* 1001b638:	604e */

.L1001b63a:
	moveq	#0,%d0	/* 1001b63a:	7000 */
	moveb	%d7,%d0	/* 1001b63c:	1007 */
	movel	%d0,%sp@-	/* 1001b63e:	2f00 */
	movel	%a4,%sp@-	/* 1001b640:	2f0c */
	jsr	%pc@(sub_1002110c)	/* 1001b642:	4eba 5ac8 */
	addqw	#8,%sp	/* 1001b646:	504f */
	bras	.L1001b688	/* 1001b648:	603e */

.L1001b64a:
	moveq	#0,%d0	/* 1001b64a:	7000 */
	moveb	%d7,%d0	/* 1001b64c:	1007 */
	movel	%d0,%sp@-	/* 1001b64e:	2f00 */
	movel	%a4,%sp@-	/* 1001b650:	2f0c */
	jsr	%pc@(sub_10021242)	/* 1001b652:	4eba 5bee */
	addqw	#8,%sp	/* 1001b656:	504f */
	bras	.L1001b688	/* 1001b658:	602e */

.L1001b65a:
	moveq	#0,%d0	/* 1001b65a:	7000 */
	moveb	%d7,%d0	/* 1001b65c:	1007 */
	movel	%d0,%sp@-	/* 1001b65e:	2f00 */
	movel	%a4,%sp@-	/* 1001b660:	2f0c */
	jsr	%pc@(sub_1002128e)	/* 1001b662:	4eba 5c2a */
	addqw	#8,%sp	/* 1001b666:	504f */
	bras	.L1001b688	/* 1001b668:	601e */

.L1001b66a:
	moveq	#0,%d0	/* 1001b66a:	7000 */
	moveb	%d7,%d0	/* 1001b66c:	1007 */
	movel	%d0,%sp@-	/* 1001b66e:	2f00 */
	movel	%a4,%sp@-	/* 1001b670:	2f0c */
	jsr	%pc@(sub_10021ea2)	/* 1001b672:	4eba 682e */
	addqw	#8,%sp	/* 1001b676:	504f */
	bras	.L1001b688	/* 1001b678:	600e */

.L1001b67a:
	moveq	#0,%d0	/* 1001b67a:	7000 */
	moveb	%d7,%d0	/* 1001b67c:	1007 */
	movel	%d0,%sp@-	/* 1001b67e:	2f00 */
	movel	%a4,%sp@-	/* 1001b680:	2f0c */
	jsr	%pc@(sub_1001b490)	/* 1001b682:	4eba fe0c */
	addqw	#8,%sp	/* 1001b686:	504f */

.L1001b688:
	moveml	%fp@(-24),%d6-%d7/%a2-%a4	/* 1001b688:	4cee 1cc0 ffe8 */
	unlk	%fp	/* 1001b68e:	4e5e */
	rts	/* 1001b690:	4e75 */

sub_1001b692:
	linkw	%fp,#0	/* 1001b692:	4e56 0000 */
	moveal	%fp@(8),%a0	/* 1001b696:	206e 0008 */
	addql	#4,%a0	/* 1001b69a:	5888 */
	movel	%a0,%d0	/* 1001b69c:	2008 */
	unlk	%fp	/* 1001b69e:	4e5e */
	rts	/* 1001b6a0:	4e75 */

sub_1001b6a2:
	linkw	%fp,#0	/* 1001b6a2:	4e56 0000 */
	movel	%a4,%sp@-	/* 1001b6a6:	2f0c */
	movel	%fp@(8),%sp@-	/* 1001b6a8:	2f2e 0008 */
	jsr	%pc@(sub_10021168)	/* 1001b6ac:	4eba 5aba */
	moveal	%d0,%a0	/* 1001b6b0:	2040 */
	moveal	%a0@,%a4	/* 1001b6b2:	2850 */
	moveal	%a4,%a0	/* 1001b6b4:	204c */
	addql	#8,%a0	/* 1001b6b6:	5088 */
	movel	%a0@,%d0	/* 1001b6b8:	2010 */
	moveal	%fp@(-4),%a4	/* 1001b6ba:	286e fffc */
	unlk	%fp	/* 1001b6be:	4e5e */
	rts	/* 1001b6c0:	4e75 */

sub_1001b6c2:
	linkw	%fp,#-28	/* 1001b6c2:	4e56 ffe4 */
	moveml	%a2-%a4,%sp@-	/* 1001b6c6:	48e7 0038 */
	moveq	#16,%d0	/* 1001b6ca:	7010 */
	movel	%d0,%sp@-	/* 1001b6cc:	2f00 */
	jsr	%pc@(sub_10022e2a)	/* 1001b6ce:	4eba 775a */
	moveal	%d0,%a4	/* 1001b6d2:	2840 */
	movel	%a4,%d0	/* 1001b6d4:	200c */
	moveq	#6,%d1	/* 1001b6d6:	7206 */
	orl	%d0,%d1	/* 1001b6d8:	8280 */
	moveal	%d1,%a3	/* 1001b6da:	2641 */
	moveal	%a3,%a2	/* 1001b6dc:	244b */
	moveaw	#1,%a4	/* 1001b6de:	387c 0001 */
	movel	%a2,%d0	/* 1001b6e2:	200a */
	moveq	#-8,%d1	/* 1001b6e4:	72f8 */
	andl	%d0,%d1	/* 1001b6e6:	c280 */
	moveal	%d1,%a0	/* 1001b6e8:	2041 */
	movel	%a4,%a0@(12)	/* 1001b6ea:	214c 000c */
	movel	%a3,%fp@(-24)	/* 1001b6ee:	2d4b ffe8 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b6f2:	4eba 4768 */
	moveal	%d0,%a0	/* 1001b6f6:	2040 */
	lea	%a0@(464),%a4	/* 1001b6f8:	49e8 01d0 */
	subql	#4,%a4@	/* 1001b6fc:	5994 */
	moveal	%a4@,%a0	/* 1001b6fe:	2054 */
	moveal	%a0@,%a2	/* 1001b700:	2450 */
	moveq	#-8,%d0	/* 1001b702:	70f8 */
	andl	%fp@(-24),%d0	/* 1001b704:	c0ae ffe8 */
	moveal	%d0,%a0	/* 1001b708:	2040 */
	movel	%a2,%a0@(8)	/* 1001b70a:	214a 0008 */
	moveal	%a3,%a2	/* 1001b70e:	244b */
	jsr	%pc@(sub_1001fe5c)	/* 1001b710:	4eba 474a */
	moveal	%d0,%a0	/* 1001b714:	2040 */
	lea	%a0@(464),%a4	/* 1001b716:	49e8 01d0 */
	subql	#4,%a4@	/* 1001b71a:	5994 */
	moveal	%a4@,%a0	/* 1001b71c:	2054 */
	movel	%a0@,%fp@(-12)	/* 1001b71e:	2d50 fff4 */
	movel	%a2,%d0	/* 1001b722:	200a */
	moveq	#-8,%d1	/* 1001b724:	72f8 */
	andl	%d0,%d1	/* 1001b726:	c280 */
	moveal	%d1,%a0	/* 1001b728:	2041 */
	movel	%fp@(-12),%a0@(4)	/* 1001b72a:	216e fff4 0004 */
	movel	%a3,%sp@-	/* 1001b730:	2f0b */
	jsr	%pc@(sub_1001fe5c)	/* 1001b732:	4eba 4728 */
	moveal	%sp@+,%a1	/* 1001b736:	225f */
	moveal	%d0,%a0	/* 1001b738:	2040 */
	lea	%a0@(464),%a4	/* 1001b73a:	49e8 01d0 */
	subql	#4,%a4@	/* 1001b73e:	5994 */
	moveal	%a4@,%a0	/* 1001b740:	2054 */
	moveal	%a0@,%a2	/* 1001b742:	2450 */
	movel	%a1,%d0	/* 1001b744:	2009 */
	moveq	#-8,%d1	/* 1001b746:	72f8 */
	andl	%d0,%d1	/* 1001b748:	c280 */
	moveal	%d1,%a0	/* 1001b74a:	2041 */
	movel	%a2,%a0@	/* 1001b74c:	208a */
	movel	%a1,%sp@-	/* 1001b74e:	2f09 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b750:	4eba 470a */
	moveal	%sp@+,%a1	/* 1001b754:	225f */
	moveal	%d0,%a0	/* 1001b756:	2040 */
	lea	%a0@(464),%a4	/* 1001b758:	49e8 01d0 */
	moveal	%a4@,%a0	/* 1001b75c:	2054 */
	addql	#4,%a4@	/* 1001b75e:	5894 */
	movel	%a3,%a0@	/* 1001b760:	208b */
	moveml	%fp@(-40),%a2-%a4	/* 1001b762:	4cee 1c00 ffd8 */
	unlk	%fp	/* 1001b768:	4e5e */
	rts	/* 1001b76a:	4e75 */

sub_1001b76c:
	braw	sub_10022f6e	/* 1001b76c:	6000 7800 */

sub_1001b770:
	braw	sub_1001a314	/* 1001b770:	6000 eba2 */

sub_1001b774:
	braw	sub_10015eda	/* 1001b774:	6000 a764 */

sub_1001b778:
	braw	sub_10014408	/* 1001b778:	6000 8c8e */

sub_1001b77c:
	braw	sub_10014286	/* 1001b77c:	6000 8b08 */

sub_1001b780:
	braw	sub_10016f34	/* 1001b780:	6000 b7b2 */

sub_1001b784:
	braw	sub_10017b1a	/* 1001b784:	6000 c394 */

sub_1001b788:
	braw	sub_1001740c	/* 1001b788:	6000 bc82 */

sub_1001b78c:
	linkw	%fp,#-28	/* 1001b78c:	4e56 ffe4 */
	moveml	%a2-%a4,%sp@-	/* 1001b790:	48e7 0038 */
	moveq	#16,%d0	/* 1001b794:	7010 */
	movel	%d0,%sp@-	/* 1001b796:	2f00 */
	jsr	%pc@(sub_10022e2a)	/* 1001b798:	4eba 7690 */
	moveal	%d0,%a4	/* 1001b79c:	2840 */
	movel	%a4,%d0	/* 1001b79e:	200c */
	moveq	#6,%d1	/* 1001b7a0:	7206 */
	orl	%d0,%d1	/* 1001b7a2:	8280 */
	moveal	%d1,%a3	/* 1001b7a4:	2641 */
	movel	%a3,%fp@(-28)	/* 1001b7a6:	2d4b ffe4 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b7aa:	4eba 46b0 */
	moveal	%d0,%a0	/* 1001b7ae:	2040 */
	lea	%a0@(464),%a4	/* 1001b7b0:	49e8 01d0 */
	subql	#4,%a4@	/* 1001b7b4:	5994 */
	moveal	%a4@,%a0	/* 1001b7b6:	2054 */
	moveal	%a0@,%a2	/* 1001b7b8:	2450 */
	moveq	#-8,%d0	/* 1001b7ba:	70f8 */
	andl	%fp@(-28),%d0	/* 1001b7bc:	c0ae ffe4 */
	moveal	%d0,%a0	/* 1001b7c0:	2040 */
	movel	%a2,%a0@	/* 1001b7c2:	208a */
	movel	%a3,%fp@(-20)	/* 1001b7c4:	2d4b ffec */
	jsr	%pc@(sub_1001fe5c)	/* 1001b7c8:	4eba 4692 */
	moveal	%d0,%a0	/* 1001b7cc:	2040 */
	lea	%a0@(464),%a4	/* 1001b7ce:	49e8 01d0 */
	subql	#4,%a4@	/* 1001b7d2:	5994 */
	moveal	%a4@,%a0	/* 1001b7d4:	2054 */
	moveal	%a0@,%a2	/* 1001b7d6:	2450 */
	moveq	#-8,%d0	/* 1001b7d8:	70f8 */
	andl	%fp@(-20),%d0	/* 1001b7da:	c0ae ffec */
	moveal	%d0,%a0	/* 1001b7de:	2040 */
	movel	%a2,%a0@(4)	/* 1001b7e0:	214a 0004 */
	movel	%a3,%fp@(-12)	/* 1001b7e4:	2d4b fff4 */
	movel	%a1,%sp@-	/* 1001b7e8:	2f09 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b7ea:	4eba 4670 */
	moveal	%sp@+,%a1	/* 1001b7ee:	225f */
	moveal	%d0,%a0	/* 1001b7f0:	2040 */
	lea	%a0@(464),%a4	/* 1001b7f2:	49e8 01d0 */
	subql	#4,%a4@	/* 1001b7f6:	5994 */
	moveal	%a4@,%a0	/* 1001b7f8:	2054 */
	moveal	%a0@,%a1	/* 1001b7fa:	2250 */
	moveq	#-8,%d0	/* 1001b7fc:	70f8 */
	andl	%fp@(-12),%d0	/* 1001b7fe:	c0ae fff4 */
	moveal	%d0,%a0	/* 1001b802:	2040 */
	movel	%a1,%a0@(8)	/* 1001b804:	2149 0008 */
	moveal	%a3,%a2	/* 1001b808:	244b */
	moveaw	#1,%a4	/* 1001b80a:	387c 0001 */
	movel	%a2,%d0	/* 1001b80e:	200a */
	moveq	#-8,%d1	/* 1001b810:	72f8 */
	andl	%d0,%d1	/* 1001b812:	c280 */
	moveal	%d1,%a0	/* 1001b814:	2041 */
	movel	%a4,%a0@(12)	/* 1001b816:	214c 000c */
	movel	%a1,%sp@-	/* 1001b81a:	2f09 */
	jsr	%pc@(sub_1001fe5c)	/* 1001b81c:	4eba 463e */
	moveal	%sp@+,%a1	/* 1001b820:	225f */
	moveal	%d0,%a0	/* 1001b822:	2040 */
	lea	%a0@(464),%a4	/* 1001b824:	49e8 01d0 */
	moveal	%a4@,%a0	/* 1001b828:	2054 */
	addql	#4,%a4@	/* 1001b82a:	5894 */
	movel	%a3,%a0@	/* 1001b82c:	208b */
	moveml	%fp@(-40),%a2-%a4	/* 1001b82e:	4cee 1c00 ffd8 */
	unlk	%fp	/* 1001b834:	4e5e */
	rts	/* 1001b836:	4e75 */
