...
sub_1000d2d8:
	...
	moveal	%d0,%a0	/* 1000d2e4:	2040 */
	lea	%a0@(464),%a4	/* 1000d2e6:	49e8 01d0 */
	moveal	%a4@,%a3	/* 1000d2ea:	2654 */
	lea	%a3@(-12),%a3	/* 1000d2ec:	47eb fff4 */
	moveal	%a3@,%a0	/* 1000d2f0:	2053 */
	movel	%a0@(4),%fp@(-32)	/* 1000d2f2:	2d68 0004 ffe0 */
	movel	%a3@,%d0	/* 1000d2f8:	2013 */
	addql	#8,%d0	/* 1000d2fa:	5080 */
	movel	%d0,%fp@(-28)	/* 1000d2fc:	2d40 ffe4 */
	moveal	%a3@,%a0	/* 1000d300:	2053 */
	moveal	%a0@(4),%a2	/* 1000d302:	2468 0004 */
	movel	%a2,%d0	/* 1000d306:	200a */
	subql	#4,%d0	/* 1000d308:	5980 */
	moveal	%d0,%a0	/* 1000d30a:	2040 */
	moveal	%a0@,%a4	/* 1000d30c:	2850 */
	movel	%a4,%d0	/* 1000d30e:	200c */
	lsrl	#5,%d0	/* 1000d310:	ea88 */
	subql	#1,%d0	/* 1000d312:	5380 */
	movel	%d0,%d7	/* 1000d314:	2e00 */
	movel	%a3@(8),%sp@-	/* 1000d316:	2f2b 0008 */
	movel	%a3@(4),%sp@-	/* 1000d31a:	2f2b 0004 */
	movel	%d7,%sp@-	/* 1000d31e:	2f07 */
	movel	%fp@(-28),%sp@-	/* 1000d320:	2f2e ffe4 */
	movel	%fp@(-32),%sp@-	/* 1000d324:	2f2e ffe0 */
	jsr	%pc@(sub_1000d224)	/* 1000d328:	4eba fefa */
	tstb	%d0	/* 1000d32c:	4a00 */
	lea	%sp@(20),%sp	/* 1000d32e:	4fef 0014 */
	beqs	.L1000d344	/* 1000d332:	6710 */
	jsr	%pc@(sub_1000ed90)	/* 1000d334:	4eba 1a5a */
	moveal	%d0,%a0	/* 1000d338:	2040 */
	lea	%a0@(464),%a4	/* 1000d33a:	49e8 01d0 */
	subql	#8,%a4@	/* 1000d33e:	5194 */
	braw	.L1000d4ca	/* 1000d340:	6000 0188 */

.L1000d344:
	movel	%d7,%d6	/* 1000d344:	2c07 */
	addl	%d6,%d6	/* 1000d346:	dc86 */
	moveq	#0,%d0	/* 1000d348:	7000 */
	movel	%d0,%sp@-	/* 1000d34a:	2f00 */
	movel	%d6,%sp@-	/* 1000d34c:	2f06 */
	jsr	%pc@(sub_1000eeec)	/* 1000d34e:	4eba 1b9c */
	jsr	%pc@(sub_1000ed90)	/* 1000d352:	4eba 1a3c */
	moveal	%d0,%a0	/* 1000d356:	2040 */
	lea	%a0@(464),%a4	/* 1000d358:	49e8 01d0 */
	subql	#4,%a4@	/* 1000d35c:	5994 */
	moveal	%a4@,%a0	/* 1000d35e:	2054 */
	movel	%a0@,%fp@(-24)	/* 1000d360:	2d50 ffe8 */
	movel	%d7,%d5	/* 1000d364:	2a07 */
	asll	#2,%d5	/* 1000d366:	e585 */
	movel	%d5,%sp@-	/* 1000d368:	2f05 */
	moveal	%a3@,%a0	/* 1000d36a:	2053 */
	movel	%a0@(4),%sp@-	/* 1000d36c:	2f28 0004 */
	movel	%fp@(-24),%sp@-	/* 1000d370:	2f2e ffe8 */
	jsr	%pc@(sub_10010ed0)	/* 1000d374:	4eba 3b5a */
	movel	%d7,%sp@-	/* 1000d378:	2f07 */
	movel	%d7,%sp@-	/* 1000d37a:	2f07 */
	movel	%fp@(-24),%sp@-	/* 1000d37c:	2f2e ffe8 */
	jsr	%pc@(sub_1000ef54)	/* 1000d380:	4eba 1bd2 */
	jsr	%pc@(sub_1000ed90)	/* 1000d384:	4eba 1a0a */
	moveal	%d0,%a0	/* 1000d388:	2040 */
	lea	%a0@(464),%a2	/* 1000d38a:	45e8 01d0 */
	moveal	%a2@,%a0	/* 1000d38e:	2052 */
	addql	#4,%a2@	/* 1000d390:	5892 */
	movel	%fp@(-24),%a0@	/* 1000d392:	20ae ffe8 */
	moveq	#0,%d0	/* 1000d396:	7000 */
	movel	%d0,%sp@-	/* 1000d398:	2f00 */
	movel	%d6,%sp@-	/* 1000d39a:	2f06 */
	jsr	%pc@(sub_1000cfce)	/* 1000d39c:	4eba fc30 */
	moveal	%d0,%a2	/* 1000d3a0:	2440 */
	movel	%d5,%d0	/* 1000d3a2:	2005 */
	addql	#8,%d0	/* 1000d3a4:	5080 */
	movel	%d0,%sp@-	/* 1000d3a6:	2f00 */
	movel	%a3@,%sp@-	/* 1000d3a8:	2f13 */
	movel	%a2,%sp@-	/* 1000d3aa:	2f0a */
	jsr	%pc@(sub_10010ed0)	/* 1000d3ac:	4eba 3b22 */
	movel	%a2,%d0	/* 1000d3b0:	200a */
	addql	#8,%d0	/* 1000d3b2:	5080 */
	movel	%d0,%fp@(-16)	/* 1000d3b4:	2d40 fff0 */
	movel	%d7,%sp@-	/* 1000d3b8:	2f07 */
	movel	%d7,%sp@-	/* 1000d3ba:	2f07 */
	movel	%fp@(-16),%sp@-	/* 1000d3bc:	2f2e fff0 */
	jsr	%pc@(sub_1000ef54)	/* 1000d3c0:	4eba 1b92 */
	jsr	%pc@(sub_1000ed90)	/* 1000d3c4:	4eba 19ca */
	moveal	%d0,%a0	/* 1000d3c8:	2040 */
	lea	%a0@(464),%a4	/* 1000d3ca:	49e8 01d0 */
	subql	#4,%a4@	/* 1000d3ce:	5994 */
	moveal	%a4@,%a0	/* 1000d3d0:	2054 */
	movel	%a0@,%fp@(-8)	/* 1000d3d2:	2d50 fff8 */
	movel	%fp@(-8),%a2@(4)	/* 1000d3d6:	256e fff8 0004 */
	movel	%a3@(8),%sp@-	/* 1000d3dc:	2f2b 0008 */
	movel	%a3@(4),%sp@-	/* 1000d3e0:	2f2b 0004 */
	movel	%d6,%sp@-	/* 1000d3e4:	2f06 */
	movel	%fp@(-16),%sp@-	/* 1000d3e6:	2f2e fff0 */
	movel	%a2@(4),%sp@-	/* 1000d3ea:	2f2a 0004 */
	jsr	%pc@(sub_1000d224)	/* 1000d3ee:	4eba fe34 */
	jsr	%pc@(sub_1000ed90)	/* 1000d3f2:	4eba 199c */
	moveal	%d0,%a0	/* 1000d3f6:	2040 */
	moveal	%a0@(136),%a4	/* 1000d3f8:	2868 0088 */
	movel	%a4,%d0	/* 1000d3fc:	200c */
	lea	%sp@(84),%sp	/* 1000d3fe:	4fef 0054 */
	beqw	.L1000d4a8	/* 1000d402:	6700 00a4 */
	jsr	%pc@(sub_1000ed90)	/* 1000d406:	4eba 1988 */
	moveal	%d0,%a0	/* 1000d40a:	2040 */
	movel	%a0@(88),%fp@(-84)	/* 1000d40c:	2d68 0058 ffac */
	lea	%fp@(-84),%a0	/* 1000d412:	41ee ffac */
	movel	%a0,%sp@-	/* 1000d416:	2f08 */
	jsr	%pc@(sub_1000ed90)	/* 1000d418:	4eba 1976 */
	moveal	%sp@+,%a0	/* 1000d41c:	205f */
	moveal	%d0,%a1	/* 1000d41e:	2240 */
	movel	%a0,%a1@(88)	/* 1000d420:	2348 0058 */
	lea	%fp@(-84),%a0	/* 1000d424:	41ee ffac */
	lea	%fp@(-80),%a0	/* 1000d428:	41ee ffb0 */
	lea	%pc@(.L1000d436),%a1	/* 1000d42c:	43fa 0008 */
	moveml	%d2-%d7/%a1-%a4/%fp-%sp,%a0@	/* 1000d430:	48d0 defc */
	moveq	#0,%d0	/* 1000d434:	7000 */

.L1000d436:
	movel	%d0,%d6	/* 1000d436:	2c00 */
	bnes	.L1000d46a	/* 1000d438:	6630 */

.L1000d43a:
	movel	#255,%d0	/* 1000d43a:	203c 0000 00ff */
	andl	%a4@,%d0	/* 1000d440:	c094 */
	movel	%d0,%d7	/* 1000d442:	2e00 */
	asrl	#2,%d7	/* 1000d444:	e487 */
	moveq	#0,%d0	/* 1000d446:	7000 */
	moveb	%d7,%d0	/* 1000d448:	1007 */
	tstl	%d0	/* 1000d44a:	4a80 */
	bnes	.L1000d45e	/* 1000d44c:	6610 */
	movel	%a2,%sp@-	/* 1000d44e:	2f0a */
	movel	%a3@,%sp@-	/* 1000d450:	2f13 */
	pea	%a4@(12)	/* 1000d452:	486c 000c */
	jsr	%pc@(sub_1000d28c)	/* 1000d456:	4eba fe34 */
	lea	%sp@(12),%sp	/* 1000d45a:	4fef 000c */

.L1000d45e:
	movel	%a4,%sp@-	/* 1000d45e:	2f0c */
	jsr	%pc@(sub_10007686)	/* 1000d460:	4eba a224 */
	moveal	%d0,%a4	/* 1000d464:	2840 */
	addqw	#4,%sp	/* 1000d466:	584f */
	bras	.L1000d43a	/* 1000d468:	60d0 */

.L1000d46a:
	jsr	%pc@(sub_1000ed90)	/* 1000d46a:	4eba 1924 */
	moveal	%d0,%a0	/* 1000d46e:	2040 */
	movel	%fp@(-84),%a0@(88)	/* 1000d470:	216e ffac 0058 */
	cmpil	#-2739,%d6	/* 1000d476:	0c86 ffff f54d */
	beqs	.L1000d49a	/* 1000d47c:	671c */
	movel	%d6,%d0	/* 1000d47e:	2006 */
	movel	%d0,%fp@(-88)	/* 1000d480:	2d40 ffa8 */
	jsr	%pc@(sub_1000ed90)	/* 1000d484:	4eba 190a */
	moveal	%d0,%a0	/* 1000d488:	2040 */
	moveal	%a0@(88),%a0	/* 1000d48a:	2068 0058 */
	addql	#4,%a0	/* 1000d48e:	5888 */
	movel	%fp@(-88),%d0	/* 1000d490:	202e ffa8 */
	moveml	%a0@,%d2-%d7/%a1-%a4/%fp-%sp	/* 1000d494:	4cd0 defc */
	jmp	%a1@	/* 1000d498:	4ed1 */

.L1000d49a:
	moveq	#2,%d0	/* 1000d49a:	7002 */
	movel	%d0,%sp@-	/* 1000d49c:	2f00 */
	pea	%fp@(-84)	/* 1000d49e:	486e ffac */
	jsr	%pc@(sub_1000f1f0)	/* 1000d4a2:	4eba 1d4c */
	addqw	#8,%sp	/* 1000d4a6:	504f */

.L1000d4a8:
	movel	%a2,%fp@(-36)	/* 1000d4a8:	2d4a ffdc */
	jsr	%pc@(sub_1000ed90)	/* 1000d4ac:	4eba 18e2 */
	moveal	%d0,%a0	/* 1000d4b0:	2040 */
	lea	%a0@(464),%a4	/* 1000d4b2:	49e8 01d0 */
	movel	%a3,%a4@	/* 1000d4b6:	288b */
	jsr	%pc@(sub_1000ed90)	/* 1000d4b8:	4eba 18d6 */
	moveal	%d0,%a0	/* 1000d4bc:	2040 */
	lea	%a0@(464),%a3	/* 1000d4be:	47e8 01d0 */
	moveal	%a3@,%a0	/* 1000d4c2:	2053 */
	addql	#4,%a3@	/* 1000d4c4:	5893 */
	movel	%fp@(-36),%a0@	/* 1000d4c6:	20ae ffdc */

.L1000d4ca:
	moveml	%fp@(-112),%d5-%d7/%a2-%a4	/* 1000d4ca:	4cee 1ce0 ff90 */
	unlk	%fp	/* 1000d4d0:	4e5e */
	rts	/* 1000d4d2:	4e75 */

sub_1000d4d4:
	linkw	%fp,#0	/* 1000d4d4:	4e56 0000 */
	moveml	%d6-%d7/%a3-%a4,%sp@-	/* 1000d4d8:	48e7 0318 */
	movel	%fp@(8),%d6	/* 1000d4dc:	2c2e 0008 */
	movel	%d6,%sp@-	/* 1000d4e0:	2f06 */
	jsr	%pc@(sub_100153fc)	/* 1000d4e2:	4eba 7f18 */
	jsr	%pc@(sub_1000ed90)	/* 1000d4e6:	4eba 18a8 */
	moveal	%d0,%a0	/* 1000d4ea:	2040 */
	lea	%a0@(464),%a4	/* 1000d4ec:	49e8 01d0 */
	moveal	%a4@,%a3	/* 1000d4f0:	2654 */
	subqw	#4,%a3	/* 1000d4f2:	594b */
	moveq	#0,%d7	/* 1000d4f4:	7e00 */
	addqw	#4,%sp	/* 1000d4f6:	584f */
	bras	.L1000d51a	/* 1000d4f8:	6020 */

.L1000d4fa:
	moveal	%fp@(12),%a0	/* 1000d4fa:	206e 000c */
	movel	%d7,%d0	/* 1000d4fe:	2007 */
	asll	#2,%d0	/* 1000d500:	e580 */
	moveal	%a3@,%a1	/* 1000d502:	2253 */
	moveal	%a1@(8),%a4	/* 1000d504:	2869 0008 */
	moveal	%a4,%a1	/* 1000d508:	224c */
	addql	#4,%a1	/* 1000d50a:	5889 */
	movel	%d7,%d1	/* 1000d50c:	2207 */
	asll	#2,%d1	/* 1000d50e:	e581 */
	movel	%a0@(%d0:l),%a1@(%d1:l)	/* 1000d510:	23b0 0800 1800 */
	movel	%d7,%d0	/* 1000d516:	2007 */
	addql	#1,%d7	/* 1000d518:	5287 */

.L1000d51a:
	cmpl	%d7,%d6	/* 1000d51a:	bc87 */
	bgts	.L1000d4fa	/* 1000d51c:	6edc */
	jsr	%pc@(sub_1000ed90)	/* 1000d51e:	4eba 1870 */
	moveal	%d0,%a0	/* 1000d522:	2040 */
	lea	%a0@(464),%a3	/* 1000d524:	47e8 01d0 */
	subql	#4,%a3@	/* 1000d528:	5993 */
	moveal	%a3@,%a0	/* 1000d52a:	2053 */
	movel	%a0@,%d0	/* 1000d52c:	2010 */
	moveml	%fp@(-16),%d6-%d7/%a3-%a4	/* 1000d52e:	4cee 18c0 fff0 */
	unlk	%fp	/* 1000d534:	4e5e */
	rts	/* 1000d536:	4e75 */

sub_1000d538:
	linkw	%fp,#-8	/* 1000d538:	4e56 fff8 */
	moveml	%a3-%a4,%sp@-	/* 1000d53c:	48e7 0018 */
	tstb	%fp@(23)	/* 1000d540:	4a2e 0017 */
	beqs	.L1000d574	/* 1000d544:	672e */
	jsr	%pc@(sub_1000ed90)	/* 1000d546:	4eba 1848 */
	moveal	%d0,%a0	/* 1000d54a:	2040 */
	moveq	#0,%d0	/* 1000d54c:	7000 */
	movel	%d0,%a0@(92)	/* 1000d54e:	2140 005c */
	movel	#-2737,%d0	/* 1000d552:	203c ffff f54f */
	movel	%d0,%fp@(-8)	/* 1000d558:	2d40 fff8 */
	jsr	%pc@(sub_1000ed90)	/* 1000d55c:	4eba 1832 */
	moveal	%d0,%a0	/* 1000d560:	2040 */
	moveal	%a0@(88),%a0	/* 1000d562:	2068 0058 */
	addql	#4,%a0	/* 1000d566:	5888 */
	movel	%fp@(-8),%d0	/* 1000d568:	202e fff8 */
	moveml	%a0@,%d2-%d7/%a1-%a4/%fp-%sp	/* 1000d56c:	4cd0 defc */
	jmp	%a1@	/* 1000d570:	4ed1 */
	bras	.L1000d5a6	/* 1000d572:	6032 */

.L1000d574:
	jsr	%pc@(sub_1000ed90)	/* 1000d574:	4eba 181a */
	moveal	%d0,%a0	/* 1000d578:	2040 */
	moveal	%a0@(140),%a4	/* 1000d57a:	2868 008c */
	movel	%a4,%d0	/* 1000d57e:	200c */
	moveq	#16,%d1	/* 1000d580:	7210 */
	subl	%d1,%d0	/* 1000d582:	9081 */
	movel	%d0,%fp@(-4)	/* 1000d584:	2d40 fffc */
	moveal	%d0,%a0	/* 1000d588:	2040 */
	moveal	%a0,%a3	/* 1000d58a:	2648 */
	lea	%a3@(12),%a0	/* 1000d58c:	41eb 000c */
	movel	%a0@,%sp@-	/* 1000d590:	2f10 */
	movel	%fp@(16),%sp@-	/* 1000d592:	2f2e 0010 */
	movel	%fp@(12),%sp@-	/* 1000d596:	2f2e 000c */
	movel	%fp@(8),%sp@-	/* 1000d59a:	2f2e 0008 */
	jsr	%pc@(sub_10014a1c)	/* 1000d59e:	4eba 747c */
	lea	%sp@(16),%sp	/* 1000d5a2:	4fef 0010 */

.L1000d5a6:
	moveml	%fp@(-16),%a3-%a4	/* 1000d5a6:	4cee 1800 fff0 */
	unlk	%fp	/* 1000d5ac:	4e5e */
	rts	/* 1000d5ae:	4e75 */
...
sub_1000d5b4:
	linkw	%fp,#-12	/* 1000d5b4:	4e56 fff4 */
	moveml	%d4-%d7/%a3-%a4,%sp@-	/* 1000d5b8:	48e7 0f18 */
	moveb	%fp@(11),%d4	/* 1000d5bc:	182e 000b */
	moveb	%fp@(23),%d6	/* 1000d5c0:	1c2e 0017 */
	movel	%fp@(12),%d7	/* 1000d5c4:	2e2e 000c */
	jsr	%pc@(sub_1000ed90)	/* 1000d5c8:	4eba 17c6 */
	moveal	%d0,%a0	/* 1000d5cc:	2040 */
	lea	%a0@(464),%a4	/* 1000d5ce:	49e8 01d0 */
	moveal	%a4@,%a3	/* 1000d5d2:	2654 */
	lea	%a3@(-20),%a3	/* 1000d5d4:	47eb ffec */
	moveq	#0,%d0	/* 1000d5d8:	7000 */
	moveb	%d6,%d0	/* 1000d5da:	1006 */
	movel	%d0,%sp@-	/* 1000d5dc:	2f00 */
	pea	%fp@(18)	/* 1000d5de:	486e 0012 */
	movel	%d7,%sp@-	/* 1000d5e2:	2f07 */
	moveq	#0,%d0	/* 1000d5e4:	7000 */
	moveb	%d4,%d0	/* 1000d5e6:	1004 */
	movel	%d0,%sp@-	/* 1000d5e8:	2f00 */
	jsr	%pc@(sub_1000d6e4)	/* 1000d5ea:	4eba 00f8 */
	moveb	%d0,%d5	/* 1000d5ee:	1a00 */
	lea	%sp@(16),%sp	/* 1000d5f0:	4fef 0010 */
	beqs	.L1000d60c	/* 1000d5f4:	6716 */
	jsr	%pc@(sub_1000ed90)	/* 1000d5f6:	4eba 1798 */
	moveal	%d0,%a0	/* 1000d5fa:	2040 */
	lea	%a0@(464),%a4	/* 1000d5fc:	49e8 01d0 */
	movel	%a3,%a4@	/* 1000d600:	288b */
	movew	%fp@(18),%d0	/* 1000d602:	302e 0012 */
	extl	%d0	/* 1000d606:	48c0 */
	braw	.L1000d6d2	/* 1000d608:	6000 00c8 */

.L1000d60c:
	movel	%a3@(12),%a3@(16)	/* 1000d60c:	276b 000c 0010 */
	moveq	#0,%d0	/* 1000d612:	7000 */
	moveb	%d6,%d0	/* 1000d614:	1006 */
	movel	%d0,%sp@-	/* 1000d616:	2f00 */
	pea	%fp@(18)	/* 1000d618:	486e 0012 */
	movel	%d7,%sp@-	/* 1000d61c:	2f07 */
	moveq	#0,%d0	/* 1000d61e:	7000 */
	moveb	%d4,%d0	/* 1000d620:	1004 */
	movel	%d0,%sp@-	/* 1000d622:	2f00 */
	jsr	%pc@(sub_1000d6e4)	/* 1000d624:	4eba 00be */
	moveb	%d0,%d5	/* 1000d628:	1a00 */
	lea	%sp@(16),%sp	/* 1000d62a:	4fef 0010 */
	beqs	.L1000d646	/* 1000d62e:	6716 */
	jsr	%pc@(sub_1000ed90)	/* 1000d630:	4eba 175e */
	moveal	%d0,%a0	/* 1000d634:	2040 */
	lea	%a0@(464),%a4	/* 1000d636:	49e8 01d0 */
	movel	%a3,%a4@	/* 1000d63a:	288b */
	movew	%fp@(18),%d0	/* 1000d63c:	302e 0012 */
	extl	%d0	/* 1000d640:	48c0 */
	braw	.L1000d6d2	/* 1000d642:	6000 008e */

.L1000d646:
	tstl	%d7	/* 1000d646:	4a87 */
	beqs	.L1000d6c0	/* 1000d648:	6776 */
	moveq	#2,%d0	/* 1000d64a:	7002 */
	cmpl	%a3@(16),%d0	/* 1000d64c:	b0ab 0010 */
	beqs	.L1000d69a	/* 1000d650:	6748 */
	moveq	#0,%d0	/* 1000d652:	7000 */
	moveb	%d6,%d0	/* 1000d654:	1006 */
	movel	%d0,%sp@-	/* 1000d656:	2f00 */
	jsr	%pc@(sub_1000ed90)	/* 1000d658:	4eba 1736 */
	moveal	%d0,%a0	/* 1000d65c:	2040 */
	moveal	%a0@(140),%a4	/* 1000d65e:	2868 008c */
	movel	%a4,%d0	/* 1000d662:	200c */
	moveq	#16,%d1	/* 1000d664:	7210 */
	subl	%d1,%d0	/* 1000d666:	9081 */
	movel	%d0,%fp@(-12)	/* 1000d668:	2d40 fff4 */
	moveal	%d0,%a0	/* 1000d66c:	2040 */
	movel	%a0,%fp@(-8)	/* 1000d66e:	2d48 fff8 */
	lea	%a0@(12),%a0	/* 1000d672:	41e8 000c */
	moveal	%a0@,%a0	/* 1000d676:	2050 */
	movel	%a0,%fp@(-4)	/* 1000d678:	2d48 fffc */
	addql	#4,%a0	/* 1000d67c:	5888 */
	movel	%a0@,%sp@-	/* 1000d67e:	2f10 */
	moveq	#-8,%d0	/* 1000d680:	70f8 */
	andl	%a3@(16),%d0	/* 1000d682:	c0ab 0010 */
	moveal	%d0,%a0	/* 1000d686:	2040 */
	movel	%a0@,%sp@-	/* 1000d688:	2f10 */
	movel	#-1701,%sp@-	/* 1000d68a:	2f3c ffff f95b */
	jsr	%pc@(sub_1000d538)	/* 1000d690:	4eba fea6 */
	lea	%sp@(16),%sp	/* 1000d694:	4fef 0010 */
	bras	.L1000d6c0	/* 1000d698:	6026 */

.L1000d69a:
	movel	%a3@(4),%sp@-	/* 1000d69a:	2f2b 0004 */
	movel	%d7,%sp@-	/* 1000d69e:	2f07 */
	jsr	%pc@(sub_1000d4d4)	/* 1000d6a0:	4eba fe32 */
	moveal	%d0,%a4	/* 1000d6a4:	2840 */
	moveq	#0,%d0	/* 1000d6a6:	7000 */
	moveb	%d6,%d0	/* 1000d6a8:	1006 */
	movel	%d0,%sp@-	/* 1000d6aa:	2f00 */
	movel	%a3@(16),%sp@-	/* 1000d6ac:	2f2b 0010 */
	movel	%a4,%sp@-	/* 1000d6b0:	2f0c */
	movel	#-1721,%sp@-	/* 1000d6b2:	2f3c ffff f947 */
	jsr	%pc@(sub_1000d538)	/* 1000d6b8:	4eba fe7e */
	lea	%sp@(24),%sp	/* 1000d6bc:	4fef 0018 */

.L1000d6c0:
	jsr	%pc@(sub_1000ed90)	/* 1000d6c0:	4eba 16ce */
	moveal	%d0,%a0	/* 1000d6c4:	2040 */
	lea	%a0@(464),%a4	/* 1000d6c6:	49e8 01d0 */
	movel	%a3,%a4@	/* 1000d6ca:	288b */
	movew	%fp@(18),%d0	/* 1000d6cc:	302e 0012 */
	extl	%d0	/* 1000d6d0:	48c0 */

.L1000d6d2:
	moveml	%fp@(-36),%d4-%d7/%a3-%a4	/* 1000d6d2:	4cee 18f0 ffdc */
	unlk	%fp	/* 1000d6d8:	4e5e */
	rts	/* 1000d6da:	4e75 */

sub_1000d6dc:
	braw	sub_10014cd4	/* 1000d6dc:	6000 75f6 */

sub_1000d6e0:
	braw	sub_10014cdc	/* 1000d6e0:	6000 75fa */

sub_1000d6e4:
	linkw	%fp,#-34	/* 1000d6e4:	4e56 ffde */
	moveml	%d3-%d7/%a2-%a4,%sp@-	/* 1000d6e8:	48e7 1f38 */
	moveal	%fp@(16),%a2	/* 1000d6ec:	246e 0010 */
	movel	%fp@(12),%d6	/* 1000d6f0:	2c2e 000c */
	moveb	%fp@(23),%d7	/* 1000d6f4:	1e2e 0017 */
	jsr	%pc@(sub_1000ed90)	/* 1000d6f8:	4eba 1696 */
	moveal	%d0,%a0	/* 1000d6fc:	2040 */
	lea	%a0@(464),%a3	/* 1000d6fe:	47e8 01d0 */
	moveal	%a3@,%a4	/* 1000d702:	2853 */
	lea	%a4@(-20),%a4	/* 1000d704:	49ec ffec */
	movel	%a4@(16),%sp@-	/* 1000d708:	2f2c 0010 */
	jsr	%pc@(sub_10014ce0)	/* 1000d70c:	4eba 75d2 */
	tstb	%d0	/* 1000d710:	4a00 */
	addqw	#4,%sp	/* 1000d712:	584f */
	beqw	.L1000d7be	/* 1000d714:	6700 00a8 */
	tstb	%fp@(11)	/* 1000d718:	4a2e 000b */
	bnew	.L1000d7b6	/* 1000d71c:	6600 0098 */
	movel	%a4@(4),%fp@(-10)	/* 1000d720:	2d6c 0004 fff6 */
	moveq	#-2,%d0	/* 1000d726:	70fe */
	movel	%d0,%fp@(-6)	/* 1000d728:	2d40 fffa */
	moveq	#0,%d0	/* 1000d72c:	7000 */
	moveb	%d7,%d0	/* 1000d72e:	1007 */
	movel	%d0,%sp@-	/* 1000d730:	2f00 */
	movel	%a2,%sp@-	/* 1000d732:	2f0a */
	movel	%a4@(8),%sp@-	/* 1000d734:	2f2c 0008 */
	movel	%a4@(12),%sp@-	/* 1000d738:	2f2c 000c */
	movel	%a4@(12),%sp@-	/* 1000d73c:	2f2c 000c */
	movel	%a4@,%sp@-	/* 1000d740:	2f14 */
	jsr	%pc@(sub_1000da02)	/* 1000d742:	4eba 02be */
	moveal	%a4@(16),%a3	/* 1000d746:	266c 0010 */
	lea	%sp@(24),%sp	/* 1000d74a:	4fef 0018 */
	bras	.L1000d7a4	/* 1000d74e:	6054 */

.L1000d750:
	movel	%a3,%d0	/* 1000d750:	200b */
	moveq	#-8,%d5	/* 1000d752:	7af8 */
	andl	%d0,%d5	/* 1000d754:	ca80 */
	moveal	%d5,%a0	/* 1000d756:	2045 */
	movel	%a0@,%fp@(-30)	/* 1000d758:	2d50 ffe2 */
	moveal	%d5,%a0	/* 1000d75c:	2045 */
	movel	%a0@(4),%fp@(-26)	/* 1000d75e:	2d68 0004 ffe6 */
	pea	%fp@(-6)	/* 1000d764:	486e fffa */
	movel	%fp@(-30),%sp@-	/* 1000d768:	2f2e ffe2 */
	movel	%d6,%sp@-	/* 1000d76c:	2f06 */
	movel	%fp@(-10),%sp@-	/* 1000d76e:	2f2e fff6 */
	jsr	%pc@(sub_10007996)	/* 1000d772:	4eba a222 */
	movel	%d0,%fp@(-22)	/* 1000d776:	2d40 ffea */
	moveq	#0,%d0	/* 1000d77a:	7000 */
	moveb	%d7,%d0	/* 1000d77c:	1007 */
	movel	%d0,%sp@-	/* 1000d77e:	2f00 */
	movel	%a2,%sp@-	/* 1000d780:	2f0a */
	movel	%fp@(-22),%sp@-	/* 1000d782:	2f2e ffea */
	movel	%fp@(-26),%sp@-	/* 1000d786:	2f2e ffe6 */
	movel	%fp@(-30),%sp@-	/* 1000d78a:	2f2e ffe2 */
	movel	%a4@,%sp@-	/* 1000d78e:	2f14 */
	jsr	%pc@(sub_1000da02)	/* 1000d790:	4eba 0270 */
	movel	%a3,%d0	/* 1000d794:	200b */
	moveq	#-8,%d1	/* 1000d796:	72f8 */
	andl	%d0,%d1	/* 1000d798:	c280 */
	moveal	%d1,%a0	/* 1000d79a:	2041 */
	moveal	%a0@(8),%a3	/* 1000d79c:	2668 0008 */
	lea	%sp@(40),%sp	/* 1000d7a0:	4fef 0028 */

.L1000d7a4:
	cmpal	#2,%a3	/* 1000d7a4:	b7fc 0000 0002 */
	bnes	.L1000d750	/* 1000d7aa:	66a4 */
	moveb	#1,%fp@(-1)	/* 1000d7ac:	1d7c 0001 ffff */
	braw	.L1000d9f0	/* 1000d7b2:	6000 023c */

.L1000d7b6:
	clrb	%fp@(-1)	/* 1000d7b6:	422e ffff */
	braw	.L1000d9f0	/* 1000d7ba:	6000 0234 */

.L1000d7be:
	movel	%a4@(16),%sp@-	/* 1000d7be:	2f2c 0010 */
	jsr	%pc@(sub_10014e72)	/* 1000d7c2:	4eba 76ae */
	tstb	%d0	/* 1000d7c6:	4a00 */
	addqw	#4,%sp	/* 1000d7c8:	584f */
	beqw	.L1000d89e	/* 1000d7ca:	6700 00d2 */
	tstb	%fp@(11)	/* 1000d7ce:	4a2e 000b */
	beqw	.L1000d876	/* 1000d7d2:	6700 00a2 */
	movel	%a4@(4),%fp@(-18)	/* 1000d7d6:	2d6c 0004 ffee */
	moveq	#0,%d3	/* 1000d7dc:	7600 */
	moveal	%a4@(16),%a0	/* 1000d7de:	206c 0010 */
	movel	%a0,%fp@(-10)	/* 1000d7e2:	2d48 fff6 */
	movel	%a0@(4),%d0	/* 1000d7e6:	2028 0004 */
	movel	%d0,%fp@(-6)	/* 1000d7ea:	2d40 fffa */
	asrl	#2,%d0	/* 1000d7ee:	e480 */
	movel	%d0,%d4	/* 1000d7f0:	2800 */
	moveq	#0,%d5	/* 1000d7f2:	7a00 */
	bras	.L1000d868	/* 1000d7f4:	6072 */

.L1000d7f6:
	movel	%d3,%d0	/* 1000d7f6:	2003 */
	addql	#1,%d3	/* 1000d7f8:	5283 */
	cmpl	%d0,%d6	/* 1000d7fa:	bc80 */
	bgts	.L1000d828	/* 1000d7fc:	6e2a */
	movel	%a4@(4),%sp@-	/* 1000d7fe:	2f2c 0004 */
	movel	%d6,%sp@-	/* 1000d802:	2f06 */
	jsr	%pc@(sub_1000d4d4)	/* 1000d804:	4eba fcce */
	movel	%d0,%fp@(-34)	/* 1000d808:	2d40 ffde */
	moveq	#0,%d0	/* 1000d80c:	7000 */
	moveb	%d7,%d0	/* 1000d80e:	1007 */
	movel	%d0,%sp@-	/* 1000d810:	2f00 */
	movel	%a4@(16),%sp@-	/* 1000d812:	2f2c 0010 */
	movel	%fp@(-34),%sp@-	/* 1000d816:	2f2e ffde */
	movel	#-1721,%sp@-	/* 1000d81a:	2f3c ffff f947 */
	jsr	%pc@(sub_1000d538)	/* 1000d820:	4eba fd16 */
	lea	%sp@(24),%sp	/* 1000d824:	4fef 0018 */

.L1000d828:
	moveal	%fp@(-18),%a0	/* 1000d828:	206e ffee */
	addql	#4,%fp@(-18)	/* 1000d82c:	58ae ffee */
	movel	%a0@,%fp@(-26)	/* 1000d830:	2d50 ffe6 */
	moveal	%a4@(16),%a0	/* 1000d834:	206c 0010 */
	moveal	%a0@(8),%a0	/* 1000d838:	2068 0008 */
	movel	%a0,%fp@(-22)	/* 1000d83c:	2d48 ffea */
	addql	#4,%a0	/* 1000d840:	5888 */
	movel	%d5,%d0	/* 1000d842:	2005 */
	asll	#2,%d0	/* 1000d844:	e580 */
	moveal	%a0@(0,%d0:l),%a3	/* 1000d846:	2670 0800 */
	moveq	#0,%d0	/* 1000d84a:	7000 */
	moveb	%d7,%d0	/* 1000d84c:	1007 */
	movel	%d0,%sp@-	/* 1000d84e:	2f00 */
	movel	%a2,%sp@-	/* 1000d850:	2f0a */
	movel	%fp@(-26),%sp@-	/* 1000d852:	2f2e ffe6 */
	movel	%a3,%sp@-	/* 1000d856:	2f0b */
	movel	%a3,%sp@-	/* 1000d858:	2f0b */
	movel	%a4@,%sp@-	/* 1000d85a:	2f14 */
	jsr	%pc@(sub_1000da02)	/* 1000d85c:	4eba 01a4 */
	lea	%sp@(24),%sp	/* 1000d860:	4fef 0018 */
	movel	%d5,%d0	/* 1000d864:	2005 */
	addql	#1,%d5	/* 1000d866:	5285 */

.L1000d868:
	cmpl	%d5,%d4	/* 1000d868:	b885 */
	bhis	.L1000d7f6	/* 1000d86a:	628a */
	moveb	#1,%fp@(-1)	/* 1000d86c:	1d7c 0001 ffff */
	braw	.L1000d9f0	/* 1000d872:	6000 017c */

.L1000d876:
	moveq	#0,%d0	/* 1000d876:	7000 */
	moveb	%d7,%d0	/* 1000d878:	1007 */
	movel	%d0,%sp@-	/* 1000d87a:	2f00 */
	movel	%a2,%sp@-	/* 1000d87c:	2f0a */
	movel	%a4@(8),%sp@-	/* 1000d87e:	2f2c 0008 */
	movel	%a4@(16),%sp@-	/* 1000d882:	2f2c 0010 */
	movel	%a4@(16),%sp@-	/* 1000d886:	2f2c 0010 */
	movel	%a4@,%sp@-	/* 1000d88a:	2f14 */
	jsr	%pc@(sub_1000da02)	/* 1000d88c:	4eba 0174 */
	moveb	#1,%fp@(-1)	/* 1000d890:	1d7c 0001 ffff */
	lea	%sp@(24),%sp	/* 1000d896:	4fef 0018 */
	braw	.L1000d9f0	/* 1000d89a:	6000 0154 */

.L1000d89e:
	movel	%a4@(16),%sp@-	/* 1000d89e:	2f2c 0010 */
	jsr	%pc@(sub_1000f1f8)	/* 1000d8a2:	4eba 1954 */
	moveb	%d0,%d4	/* 1000d8a6:	1800 */
	moveq	#0,%d0	/* 1000d8a8:	7000 */
	moveb	%d4,%d0	/* 1000d8aa:	1004 */
	cmpiw	#1,%d0	/* 1000d8ac:	0c40 0001 */
	addqw	#4,%sp	/* 1000d8b0:	584f */
	bnes	.L1000d922	/* 1000d8b2:	666e */
	movel	%a4@(4),%sp@-	/* 1000d8b4:	2f2c 0004 */
	movel	%d6,%sp@-	/* 1000d8b8:	2f06 */
	jsr	%pc@(sub_1000d4d4)	/* 1000d8ba:	4eba fc18 */
	moveal	%d0,%a3	/* 1000d8be:	2640 */
	tstw	%a2@	/* 1000d8c0:	4a52 */
	addqw	#8,%sp	/* 1000d8c2:	504f */
	bges	.L1000d90a	/* 1000d8c4:	6c44 */
	moveal	%a4@,%a0	/* 1000d8c6:	2054 */
	movel	%a0@(4),%d4	/* 1000d8c8:	2828 0004 */
	movel	%d4,%fp@(-18)	/* 1000d8cc:	2d44 ffee */
	movel	%a4@,%d0	/* 1000d8d0:	2014 */
	addql	#8,%d0	/* 1000d8d2:	5080 */
	movel	%d0,%fp@(-14)	/* 1000d8d4:	2d40 fff2 */
	movel	%d4,%fp@(-10)	/* 1000d8d8:	2d44 fff6 */
	movel	%d4,%d0	/* 1000d8dc:	2004 */
	subql	#4,%d0	/* 1000d8de:	5980 */
	moveal	%d0,%a0	/* 1000d8e0:	2040 */
	movel	%a0@,%d0	/* 1000d8e2:	2010 */
	movel	%d0,%fp@(-6)	/* 1000d8e4:	2d40 fffa */
	lsrl	#5,%d0	/* 1000d8e8:	ea88 */
	subql	#1,%d0	/* 1000d8ea:	5380 */
	movel	%d0,%d5	/* 1000d8ec:	2a00 */
	movel	%a3,%sp@-	/* 1000d8ee:	2f0b */
	movel	%a4@(16),%sp@-	/* 1000d8f0:	2f2c 0010 */
	movel	%d5,%sp@-	/* 1000d8f4:	2f05 */
	movel	%fp@(-14),%sp@-	/* 1000d8f6:	2f2e fff2 */
	movel	%fp@(-18),%sp@-	/* 1000d8fa:	2f2e ffee */
	jsr	%pc@(sub_1000d224)	/* 1000d8fe:	4eba f924 */
	lea	%sp@(20),%sp	/* 1000d902:	4fef 0014 */
	braw	.L1000d9f0	/* 1000d906:	6000 00e8 */

.L1000d90a:
	movel	%a3,%sp@-	/* 1000d90a:	2f0b */
	movew	%a2@,%d0	/* 1000d90c:	3012 */
	addqw	#1,%a2@	/* 1000d90e:	5252 */
	extl	%d0	/* 1000d910:	48c0 */
	movel	%d0,%sp@-	/* 1000d912:	2f00 */
	movel	%a4@,%sp@-	/* 1000d914:	2f14 */
	jsr	%pc@(sub_1000d072)	/* 1000d916:	4eba f75a */
	lea	%sp@(12),%sp	/* 1000d91a:	4fef 000c */
	braw	.L1000d9f0	/* 1000d91e:	6000 00d0 */

.L1000d922:
	movel	%a4@(16),%sp@-	/* 1000d922:	2f2c 0010 */
	jsr	%pc@(sub_1001345a)	/* 1000d926:	4eba 5b32 */
	tstb	%d0	/* 1000d92a:	4a00 */
	addqw	#4,%sp	/* 1000d92c:	584f */
	beqw	.L1000d9f0	/* 1000d92e:	6700 00c0 */
	tstb	%fp@(11)	/* 1000d932:	4a2e 000b */
	beqw	.L1000d9cc	/* 1000d936:	6700 0094 */
	movel	%a4@(4),%fp@(-6)	/* 1000d93a:	2d6c 0004 fffa */
	moveq	#0,%d5	/* 1000d940:	7a00 */
	moveal	%a4@(16),%a3	/* 1000d942:	266c 0010 */
	bras	.L1000d9bc	/* 1000d946:	6074 */

.L1000d948:
	movel	%a3,%d0	/* 1000d948:	200b */
	moveq	#-8,%d1	/* 1000d94a:	72f8 */
	andl	%d0,%d1	/* 1000d94c:	c280 */
	moveal	%d1,%a0	/* 1000d94e:	2041 */
	movel	%a0@,%fp@(-26)	/* 1000d950:	2d50 ffe6 */
	movel	%a3,%d0	/* 1000d954:	200b */
	moveq	#-8,%d1	/* 1000d956:	72f8 */
	andl	%d0,%d1	/* 1000d958:	c280 */
	moveal	%d1,%a0	/* 1000d95a:	2041 */
	moveal	%a0@(4),%a3	/* 1000d95c:	2668 0004 */
	movel	%d5,%d0	/* 1000d960:	2005 */
	addql	#1,%d5	/* 1000d962:	5285 */
	cmpl	%d0,%d6	/* 1000d964:	bc80 */
	bgts	.L1000d992	/* 1000d966:	6e2a */
	movel	%a4@(4),%sp@-	/* 1000d968:	2f2c 0004 */
	movel	%d6,%sp@-	/* 1000d96c:	2f06 */
	jsr	%pc@(sub_1000d4d4)	/* 1000d96e:	4eba fb64 */
	movel	%d0,%fp@(-34)	/* 1000d972:	2d40 ffde */
	moveq	#0,%d0	/* 1000d976:	7000 */
	moveb	%d7,%d0	/* 1000d978:	1007 */
	movel	%d0,%sp@-	/* 1000d97a:	2f00 */
	movel	%a4@(16),%sp@-	/* 1000d97c:	2f2c 0010 */
	movel	%fp@(-34),%sp@-	/* 1000d980:	2f2e ffde */
	movel	#-1721,%sp@-	/* 1000d984:	2f3c ffff f947 */
	jsr	%pc@(sub_1000d538)	/* 1000d98a:	4eba fbac */
	lea	%sp@(24),%sp	/* 1000d98e:	4fef 0018 */

.L1000d992:
	moveal	%fp@(-6),%a0	/* 1000d992:	206e fffa */
	addql	#4,%fp@(-6)	/* 1000d996:	58ae fffa */
	movel	%a0@,%fp@(-22)	/* 1000d99a:	2d50 ffea */
	moveq	#0,%d0	/* 1000d99e:	7000 */
	moveb	%d7,%d0	/* 1000d9a0:	1007 */
	movel	%d0,%sp@-	/* 1000d9a2:	2f00 */
	movel	%a2,%sp@-	/* 1000d9a4:	2f0a */
	movel	%fp@(-22),%sp@-	/* 1000d9a6:	2f2e ffea */
	movel	%fp@(-26),%sp@-	/* 1000d9aa:	2f2e ffe6 */
	movel	%fp@(-26),%sp@-	/* 1000d9ae:	2f2e ffe6 */
	movel	%a4@,%sp@-	/* 1000d9b2:	2f14 */
	jsr	%pc@(sub_1000da02)	/* 1000d9b4:	4eba 004c */
	lea	%sp@(24),%sp	/* 1000d9b8:	4fef 0018 */

.L1000d9bc:
	cmpal	#2,%a3	/* 1000d9bc:	b7fc 0000 0002 */
	bnes	.L1000d948	/* 1000d9c2:	6684 */
	moveb	#1,%fp@(-1)	/* 1000d9c4:	1d7c 0001 ffff */
	bras	.L1000d9f0	/* 1000d9ca:	6024 */

.L1000d9cc:
	moveq	#0,%d0	/* 1000d9cc:	7000 */
	moveb	%d7,%d0	/* 1000d9ce:	1007 */
	movel	%d0,%sp@-	/* 1000d9d0:	2f00 */
	movel	%a2,%sp@-	/* 1000d9d2:	2f0a */
	movel	%a4@(8),%sp@-	/* 1000d9d4:	2f2c 0008 */
	movel	%a4@(16),%sp@-	/* 1000d9d8:	2f2c 0010 */
	movel	%a4@(16),%sp@-	/* 1000d9dc:	2f2c 0010 */
	movel	%a4@,%sp@-	/* 1000d9e0:	2f14 */
	jsr	%pc@(sub_1000da02)	/* 1000d9e2:	4eba 001e */
	moveb	#1,%fp@(-1)	/* 1000d9e6:	1d7c 0001 ffff */
	lea	%sp@(24),%sp	/* 1000d9ec:	4fef 0018 */

.L1000d9f0:
	moveb	%fp@(-1),%d0	/* 1000d9f0:	102e ffff */
	moveml	%fp@(-66),%d3-%d7/%a2-%a4	/* 1000d9f4:	4cee 1cf8 ffbe */
	unlk	%fp	/* 1000d9fa:	4e5e */
	rts	/* 1000d9fc:	4e75 */

sub_1000d9fe:
	braw	sub_10015146	/* 1000d9fe:	6000 7746 */

sub_1000da02:
	linkw	%fp,#-64	/* 1000da02:	4e56 ffc0 */
	moveml	%d4-%d7/%a3-%a4,%sp@-	/* 1000da06:	48e7 0f18 */
	moveb	%fp@(31),%d7	/* 1000da0a:	1e2e 001f */
	moveal	%fp@(8),%a4	/* 1000da0e:	286e 0008 */
	moveq	#1,%d0	/* 1000da12:	7001 */
	cmpl	%fp@(16),%d0	/* 1000da14:	b0ae 0010 */
	beqw	.L1000de88	/* 1000da18:	6700 046e */
	moveq	#2,%d0	/* 1000da1c:	7002 */
	cmpl	%fp@(16),%d0	/* 1000da1e:	b0ae 0010 */
	beqw	.L1000de88	/* 1000da22:	6700 0464 */
	movel	%fp@(16),%sp@-	/* 1000da26:	2f2e 0010 */
	jsr	%pc@(sub_10014e72)	/* 1000da2a:	4eba 7446 */
	tstb	%d0	/* 1000da2e:	4a00 */
	addqw	#4,%sp	/* 1000da30:	584f */
	beqs	.L1000da48	/* 1000da32:	6714 */
	moveal	%fp@(16),%a0	/* 1000da34:	206e 0010 */
	movel	%a0@(4),%d0	/* 1000da38:	2028 0004 */
	movel	%d0,%fp@(-16)	/* 1000da3c:	2d40 fff0 */
	asrl	#2,%d0	/* 1000da40:	e480 */
	tstl	%d0	/* 1000da42:	4a80 */
	beqw	.L1000de88	/* 1000da44:	6700 0442 */

.L1000da48:
	moveq	#1,%d0	/* 1000da48:	7001 */
	cmpl	%fp@(20),%d0	/* 1000da4a:	b0ae 0014 */
	bnes	.L1000da90	/* 1000da4e:	6640 */
	moveq	#0,%d0	/* 1000da50:	7000 */
	moveb	%d7,%d0	/* 1000da52:	1007 */
	movel	%d0,%sp@-	/* 1000da54:	2f00 */
	jsr	%pc@(sub_1000ed90)	/* 1000da56:	4eba 1338 */
	moveal	%d0,%a0	/* 1000da5a:	2040 */
	moveal	%a0@(140),%a3	/* 1000da5c:	2668 008c */
	movel	%a3,%d0	/* 1000da60:	200b */
	moveq	#16,%d1	/* 1000da62:	7210 */
	subl	%d1,%d0	/* 1000da64:	9081 */
	movel	%d0,%fp@(-12)	/* 1000da66:	2d40 fff4 */
	moveal	%d0,%a0	/* 1000da6a:	2040 */
	movel	%a0,%fp@(-8)	/* 1000da6c:	2d48 fff8 */
	lea	%a0@(12),%a0	/* 1000da70:	41e8 000c */
	moveal	%a0@,%a0	/* 1000da74:	2050 */
	movel	%a0,%fp@(-4)	/* 1000da76:	2d48 fffc */
	addql	#4,%a0	/* 1000da7a:	5888 */
	movel	%a0@,%sp@-	/* 1000da7c:	2f10 */
	movel	%fp@(12),%sp@-	/* 1000da7e:	2f2e 000c */
	movel	#-1701,%sp@-	/* 1000da82:	2f3c ffff f95b */
	jsr	%pc@(sub_1000d538)	/* 1000da88:	4eba faae */
	lea	%sp@(16),%sp	/* 1000da8c:	4fef 0010 */

.L1000da90:
	movel	%fp@(16),%sp@-	/* 1000da90:	2f2e 0010 */
	jsr	%pc@(sub_1000f1f8)	/* 1000da94:	4eba 1762 */
	subqb	#1,%d0	/* 1000da98:	5300 */
	addqw	#4,%sp	/* 1000da9a:	584f */
	beqs	.L1000dab2	/* 1000da9c:	6714 */
	subqb	#1,%d0	/* 1000da9e:	5300 */
	beqw	.L1000dd0c	/* 1000daa0:	6700 026a */
	subqb	#2,%d0	/* 1000daa4:	5500 */
	beqw	.L1000dbb2	/* 1000daa6:	6700 010a */
	subqb	#2,%d0	/* 1000daaa:	5500 */
	beqs	.L1000db26	/* 1000daac:	6778 */
	braw	.L1000de5a	/* 1000daae:	6000 03aa */

.L1000dab2:
	moveal	%fp@(24),%a0	/* 1000dab2:	206e 0018 */
	tstw	%a0@	/* 1000dab6:	4a50 */
	bges	.L1000db08	/* 1000dab8:	6c4e */
	movel	%a4@(4),%fp@(-20)	/* 1000daba:	2d6c 0004 ffec */
	movel	%fp@(-20),%fp@(-40)	/* 1000dac0:	2d6e ffec ffd8 */
	movel	%a4,%d0	/* 1000dac6:	200c */
	addql	#8,%d0	/* 1000dac8:	5080 */
	movel	%d0,%fp@(-36)	/* 1000daca:	2d40 ffdc */
	movel	%fp@(-20),%d0	/* 1000dace:	202e ffec */
	movel	%d0,%fp@(-28)	/* 1000dad2:	2d40 ffe4 */
	subql	#4,%d0	/* 1000dad6:	5980 */
	moveal	%d0,%a0	/* 1000dad8:	2040 */
	movel	%a0@,%d0	/* 1000dada:	2010 */
	movel	%d0,%fp@(-24)	/* 1000dadc:	2d40 ffe8 */
	lsrl	#5,%d0	/* 1000dae0:	ea88 */
	subql	#1,%d0	/* 1000dae2:	5380 */
	movel	%d0,%fp@(-32)	/* 1000dae4:	2d40 ffe0 */
	movel	%fp@(20),%sp@-	/* 1000dae8:	2f2e 0014 */
	movel	%fp@(16),%sp@-	/* 1000daec:	2f2e 0010 */
	movel	%fp@(-32),%sp@-	/* 1000daf0:	2f2e ffe0 */
	movel	%fp@(-36),%sp@-	/* 1000daf4:	2f2e ffdc */
	movel	%fp@(-40),%sp@-	/* 1000daf8:	2f2e ffd8 */
	jsr	%pc@(sub_1000d224)	/* 1000dafc:	4eba f726 */
	lea	%sp@(20),%sp	/* 1000db00:	4fef 0014 */
	braw	.L1000de88	/* 1000db04:	6000 0382 */

.L1000db08:
	movel	%fp@(20),%sp@-	/* 1000db08:	2f2e 0014 */
	moveal	%fp@(24),%a0	/* 1000db0c:	206e 0018 */
	movew	%a0@,%d0	/* 1000db10:	3010 */
	addqw	#1,%a0@	/* 1000db12:	5250 */
	extl	%d0	/* 1000db14:	48c0 */
	movel	%d0,%sp@-	/* 1000db16:	2f00 */
	movel	%a4,%sp@-	/* 1000db18:	2f0c */
	jsr	%pc@(sub_1000d072)	/* 1000db1a:	4eba f556 */
	lea	%sp@(12),%sp	/* 1000db1e:	4fef 000c */
	braw	.L1000de88	/* 1000db22:	6000 0364 */

.L1000db26:
	movel	%fp@(20),%sp@-	/* 1000db26:	2f2e 0014 */
	jsr	%pc@(sub_10014ce0)	/* 1000db2a:	4eba 71b4 */
	tstb	%d0	/* 1000db2e:	4a00 */
	addqw	#4,%sp	/* 1000db30:	584f */
	bnes	.L1000db50	/* 1000db32:	661c */
	moveq	#0,%d0	/* 1000db34:	7000 */
	moveb	%d7,%d0	/* 1000db36:	1007 */
	movel	%d0,%sp@-	/* 1000db38:	2f00 */
	movel	%fp@(16),%sp@-	/* 1000db3a:	2f2e 0010 */
	movel	%fp@(20),%sp@-	/* 1000db3e:	2f2e 0014 */
	movel	#-1721,%sp@-	/* 1000db42:	2f3c ffff f947 */
	jsr	%pc@(sub_1000d538)	/* 1000db48:	4eba f9ee */
	lea	%sp@(16),%sp	/* 1000db4c:	4fef 0010 */

.L1000db50:
	moveal	%fp@(16),%a3	/* 1000db50:	266e 0010 */
	bras	.L1000dba6	/* 1000db54:	6050 */

.L1000db56:
	movel	%a3,%d0	/* 1000db56:	200b */
	moveq	#-8,%d6	/* 1000db58:	7cf8 */
	andl	%d0,%d6	/* 1000db5a:	cc80 */
	moveal	%d6,%a0	/* 1000db5c:	2046 */
	movel	%a0@,%fp@(-52)	/* 1000db5e:	2d50 ffcc */
	moveal	%d6,%a0	/* 1000db62:	2046 */
	movel	%a0@(4),%fp@(-48)	/* 1000db64:	2d68 0004 ffd0 */
	movel	%fp@(-52),%sp@-	/* 1000db6a:	2f2e ffcc */
	movel	%fp@(20),%sp@-	/* 1000db6e:	2f2e 0014 */
	jsr	%pc@(sub_1001522e)	/* 1000db72:	4eba 76ba */
	movel	%d0,%fp@(-44)	/* 1000db76:	2d40 ffd4 */
	moveq	#0,%d0	/* 1000db7a:	7000 */
	moveb	%d7,%d0	/* 1000db7c:	1007 */
	movel	%d0,%sp@-	/* 1000db7e:	2f00 */
	movel	%fp@(24),%sp@-	/* 1000db80:	2f2e 0018 */
	movel	%fp@(-44),%sp@-	/* 1000db84:	2f2e ffd4 */
	movel	%fp@(-48),%sp@-	/* 1000db88:	2f2e ffd0 */
	movel	%fp@(-52),%sp@-	/* 1000db8c:	2f2e ffcc */
	movel	%a4,%sp@-	/* 1000db90:	2f0c */
	jsr	%pc@(sub_1000da02)	/* 1000db92:	4eba fe6e */
	movel	%a3,%d0	/* 1000db96:	200b */
	moveq	#-8,%d1	/* 1000db98:	72f8 */
	andl	%d0,%d1	/* 1000db9a:	c280 */
	moveal	%d1,%a0	/* 1000db9c:	2041 */
	moveal	%a0@(8),%a3	/* 1000db9e:	2668 0008 */
	lea	%sp@(32),%sp	/* 1000dba2:	4fef 0020 */

.L1000dba6:
	cmpal	#2,%a3	/* 1000dba6:	b7fc 0000 0002 */
	bnes	.L1000db56	/* 1000dbac:	66a8 */
	braw	.L1000de88	/* 1000dbae:	6000 02d8 */

.L1000dbb2:
	movel	%fp@(20),%sp@-	/* 1000dbb2:	2f2e 0014 */
	jsr	%pc@(sub_1000f1f8)	/* 1000dbb6:	4eba 1640 */
	subqb	#2,%d0	/* 1000dbba:	5500 */
	addqw	#4,%sp	/* 1000dbbc:	584f */
	beqw	.L1000dc5a	/* 1000dbbe:	6700 009a */
	subqb	#2,%d0	/* 1000dbc2:	5500 */
	bnew	.L1000dcec	/* 1000dbc4:	6600 0126 */
	moveal	%fp@(20),%a0	/* 1000dbc8:	206e 0014 */
	moveal	%a0@(4),%a3	/* 1000dbcc:	2668 0004 */
	movel	%a3,%d0	/* 1000dbd0:	200b */
	asrl	#2,%d0	/* 1000dbd2:	e480 */
	movel	%d0,%d5	/* 1000dbd4:	2a00 */
	moveal	%fp@(16),%a0	/* 1000dbd6:	206e 0010 */
	moveal	%a0@(4),%a3	/* 1000dbda:	2668 0004 */
	movel	%a3,%d0	/* 1000dbde:	200b */
	asrl	#2,%d0	/* 1000dbe0:	e480 */
	movel	%d0,%d4	/* 1000dbe2:	2800 */
	moveq	#0,%d6	/* 1000dbe4:	7c00 */
	bras	.L1000dc52	/* 1000dbe6:	606a */

.L1000dbe8:
	cmpl	%d6,%d5	/* 1000dbe8:	ba86 */
	bhis	.L1000dc08	/* 1000dbea:	621c */
	moveq	#0,%d0	/* 1000dbec:	7000 */
	moveb	%d7,%d0	/* 1000dbee:	1007 */
	movel	%d0,%sp@-	/* 1000dbf0:	2f00 */
	movel	%fp@(16),%sp@-	/* 1000dbf2:	2f2e 0010 */
	movel	%fp@(20),%sp@-	/* 1000dbf6:	2f2e 0014 */
	movel	#-1721,%sp@-	/* 1000dbfa:	2f3c ffff f947 */
	jsr	%pc@(sub_1000d538)	/* 1000dc00:	4eba f936 */
	lea	%sp@(16),%sp	/* 1000dc04:	4fef 0010 */

.L1000dc08:
	moveal	%fp@(16),%a0	/* 1000dc08:	206e 0010 */
	moveal	%a0@(8),%a3	/* 1000dc0c:	2668 0008 */
	moveal	%a3,%a0	/* 1000dc10:	204b */
	addql	#4,%a0	/* 1000dc12:	5888 */
	movel	%d6,%d0	/* 1000dc14:	2006 */
	asll	#2,%d0	/* 1000dc16:	e580 */
	movel	%a0@(0,%d0:l),%fp@(-60)	/* 1000dc18:	2d70 0800 ffc4 */
	moveq	#0,%d0	/* 1000dc1e:	7000 */
	moveb	%d7,%d0	/* 1000dc20:	1007 */
	movel	%d0,%sp@-	/* 1000dc22:	2f00 */
	movel	%fp@(24),%sp@-	/* 1000dc24:	2f2e 0018 */
	moveal	%fp@(20),%a0	/* 1000dc28:	206e 0014 */
	moveal	%a0@(8),%a3	/* 1000dc2c:	2668 0008 */
	moveal	%a3,%a0	/* 1000dc30:	204b */
	addql	#4,%a0	/* 1000dc32:	5888 */
	movel	%d6,%d0	/* 1000dc34:	2006 */
	asll	#2,%d0	/* 1000dc36:	e580 */
	movel	%a0@(0,%d0:l),%sp@-	/* 1000dc38:	2f30 0800 */
	movel	%fp@(-60),%sp@-	/* 1000dc3c:	2f2e ffc4 */
	movel	%fp@(-60),%sp@-	/* 1000dc40:	2f2e ffc4 */
	movel	%a4,%sp@-	/* 1000dc44:	2f0c */
	jsr	%pc@(sub_1000da02)	/* 1000dc46:	4eba fdba */
	lea	%sp@(24),%sp	/* 1000dc4a:	4fef 0018 */
	movel	%d6,%d0	/* 1000dc4e:	2006 */
	addql	#1,%d6	/* 1000dc50:	5286 */

.L1000dc52:
	cmpl	%d6,%d4	/* 1000dc52:	b886 */
	bhis	.L1000dbe8	/* 1000dc54:	6292 */
	braw	.L1000de88	/* 1000dc56:	6000 0230 */

.L1000dc5a:
	moveal	%fp@(20),%a3	/* 1000dc5a:	266e 0014 */
	moveal	%fp@(16),%a0	/* 1000dc5e:	206e 0010 */
	movel	%a0@(4),%d0	/* 1000dc62:	2028 0004 */
	movel	%d0,%fp@(-44)	/* 1000dc66:	2d40 ffd4 */
	asrl	#2,%d0	/* 1000dc6a:	e480 */
	movel	%d0,%d4	/* 1000dc6c:	2800 */
	moveq	#0,%d6	/* 1000dc6e:	7c00 */
	bras	.L1000dce4	/* 1000dc70:	6072 */

.L1000dc72:
	cmpal	#2,%a3	/* 1000dc72:	b7fc 0000 0002 */
	bnes	.L1000dc96	/* 1000dc78:	661c */
	moveq	#0,%d0	/* 1000dc7a:	7000 */
	moveb	%d7,%d0	/* 1000dc7c:	1007 */
	movel	%d0,%sp@-	/* 1000dc7e:	2f00 */
	movel	%fp@(16),%sp@-	/* 1000dc80:	2f2e 0010 */
	movel	%fp@(20),%sp@-	/* 1000dc84:	2f2e 0014 */
	movel	#-1721,%sp@-	/* 1000dc88:	2f3c ffff f947 */
	jsr	%pc@(sub_1000d538)	/* 1000dc8e:	4eba f8a8 */
	lea	%sp@(16),%sp	/* 1000dc92:	4fef 0010 */

.L1000dc96:
	moveal	%fp@(16),%a0	/* 1000dc96:	206e 0010 */
	moveal	%a0@(8),%a0	/* 1000dc9a:	2068 0008 */
	movel	%a0,%fp@(-60)	/* 1000dc9e:	2d48 ffc4 */
	addql	#4,%a0	/* 1000dca2:	5888 */
	movel	%d6,%d0	/* 1000dca4:	2006 */
	asll	#2,%d0	/* 1000dca6:	e580 */
	movel	%a0@(0,%d0:l),%fp@(-64)	/* 1000dca8:	2d70 0800 ffc0 */
	moveq	#0,%d0	/* 1000dcae:	7000 */
	moveb	%d7,%d0	/* 1000dcb0:	1007 */
	movel	%d0,%sp@-	/* 1000dcb2:	2f00 */
	movel	%fp@(24),%sp@-	/* 1000dcb4:	2f2e 0018 */
	movel	%a3,%d0	/* 1000dcb8:	200b */
	moveq	#-8,%d1	/* 1000dcba:	72f8 */
	andl	%d0,%d1	/* 1000dcbc:	c280 */
	moveal	%d1,%a0	/* 1000dcbe:	2041 */
	movel	%a0@,%sp@-	/* 1000dcc0:	2f10 */
	movel	%fp@(-64),%sp@-	/* 1000dcc2:	2f2e ffc0 */
	movel	%fp@(-64),%sp@-	/* 1000dcc6:	2f2e ffc0 */
	movel	%a4,%sp@-	/* 1000dcca:	2f0c */
	jsr	%pc@(sub_1000da02)	/* 1000dccc:	4eba fd34 */
	movel	%a3,%d0	/* 1000dcd0:	200b */
	moveq	#-8,%d1	/* 1000dcd2:	72f8 */
	andl	%d0,%d1	/* 1000dcd4:	c280 */
	moveal	%d1,%a0	/* 1000dcd6:	2041 */
	moveal	%a0@(4),%a3	/* 1000dcd8:	2668 0004 */
	lea	%sp@(24),%sp	/* 1000dcdc:	4fef 0018 */
	movel	%d6,%d0	/* 1000dce0:	2006 */
	addql	#1,%d6	/* 1000dce2:	5286 */

.L1000dce4:
	cmpl	%d6,%d4	/* 1000dce4:	b886 */
	bhis	.L1000dc72	/* 1000dce6:	628a */
	braw	.L1000de88	/* 1000dce8:	6000 019e */

.L1000dcec:
	moveq	#0,%d0	/* 1000dcec:	7000 */
	moveb	%d7,%d0	/* 1000dcee:	1007 */
	movel	%d0,%sp@-	/* 1000dcf0:	2f00 */
	movel	%fp@(16),%sp@-	/* 1000dcf2:	2f2e 0010 */
	movel	%fp@(20),%sp@-	/* 1000dcf6:	2f2e 0014 */
	movel	#-1721,%sp@-	/* 1000dcfa:	2f3c ffff f947 */
	jsr	%pc@(sub_1000d538)	/* 1000dd00:	4eba f836 */
	lea	%sp@(16),%sp	/* 1000dd04:	4fef 0010 */
	braw	.L1000de88	/* 1000dd08:	6000 017e */

.L1000dd0c:
	movel	%fp@(20),%sp@-	/* 1000dd0c:	2f2e 0014 */
	jsr	%pc@(sub_1000f1f8)	/* 1000dd10:	4eba 14e6 */
	subqb	#2,%d0	/* 1000dd14:	5500 */
	addqw	#4,%sp	/* 1000dd16:	584f */
	beqw	.L1000ddb6	/* 1000dd18:	6700 009c */
	subqb	#2,%d0	/* 1000dd1c:	5500 */
	bnew	.L1000de3c	/* 1000dd1e:	6600 011c */
	moveq	#0,%d6	/* 1000dd22:	7c00 */
	moveal	%fp@(20),%a0	/* 1000dd24:	206e 0014 */
	movel	%a0@(4),%d0	/* 1000dd28:	2028 0004 */
	movel	%d0,%fp@(-44)	/* 1000dd2c:	2d40 ffd4 */
	asrl	#2,%d0	/* 1000dd30:	e480 */
	movel	%d0,%d4	/* 1000dd32:	2800 */
	moveal	%fp@(16),%a3	/* 1000dd34:	266e 0010 */
	bras	.L1000ddaa	/* 1000dd38:	6070 */

.L1000dd3a:
	movel	%a3,%d0	/* 1000dd3a:	200b */
	moveq	#-8,%d1	/* 1000dd3c:	72f8 */
	andl	%d0,%d1	/* 1000dd3e:	c280 */
	moveal	%d1,%a0	/* 1000dd40:	2041 */
	movel	%a0@,%fp@(-64)	/* 1000dd42:	2d50 ffc0 */
	movel	%a3,%d0	/* 1000dd46:	200b */
	moveq	#-8,%d1	/* 1000dd48:	72f8 */
	andl	%d0,%d1	/* 1000dd4a:	c280 */
	moveal	%d1,%a0	/* 1000dd4c:	2041 */
	moveal	%a0@(4),%a3	/* 1000dd4e:	2668 0004 */
	cmpl	%d6,%d4	/* 1000dd52:	b886 */
	bhis	.L1000dd72	/* 1000dd54:	621c */
	moveq	#0,%d0	/* 1000dd56:	7000 */
	moveb	%d7,%d0	/* 1000dd58:	1007 */
	movel	%d0,%sp@-	/* 1000dd5a:	2f00 */
	movel	%fp@(16),%sp@-	/* 1000dd5c:	2f2e 0010 */
	movel	%fp@(20),%sp@-	/* 1000dd60:	2f2e 0014 */
	movel	#-1721,%sp@-	/* 1000dd64:	2f3c ffff f947 */
	jsr	%pc@(sub_1000d538)	/* 1000dd6a:	4eba f7cc */
	lea	%sp@(16),%sp	/* 1000dd6e:	4fef 0010 */

.L1000dd72:
	moveq	#0,%d0	/* 1000dd72:	7000 */
	moveb	%d7,%d0	/* 1000dd74:	1007 */
	movel	%d0,%sp@-	/* 1000dd76:	2f00 */
	movel	%fp@(24),%sp@-	/* 1000dd78:	2f2e 0018 */
	movel	%d6,%d0	/* 1000dd7c:	2006 */
	addql	#1,%d6	/* 1000dd7e:	5286 */
	movel	%d0,%d5	/* 1000dd80:	2a00 */
	moveal	%fp@(20),%a0	/* 1000dd82:	206e 0014 */
	moveal	%a0@(8),%a0	/* 1000dd86:	2068 0008 */
	movel	%a0,%fp@(-60)	/* 1000dd8a:	2d48 ffc4 */
	addql	#4,%a0	/* 1000dd8e:	5888 */
	movel	%d5,%d0	/* 1000dd90:	2005 */
	asll	#2,%d0	/* 1000dd92:	e580 */
	movel	%a0@(0,%d0:l),%sp@-	/* 1000dd94:	2f30 0800 */
	movel	%fp@(-64),%sp@-	/* 1000dd98:	2f2e ffc0 */
	movel	%fp@(-64),%sp@-	/* 1000dd9c:	2f2e ffc0 */
	movel	%a4,%sp@-	/* 1000dda0:	2f0c */
	jsr	%pc@(sub_1000da02)	/* 1000dda2:	4eba fc5e */
	lea	%sp@(24),%sp	/* 1000dda6:	4fef 0018 */

.L1000ddaa:
	cmpal	#2,%a3	/* 1000ddaa:	b7fc 0000 0002 */
	bnes	.L1000dd3a	/* 1000ddb0:	6688 */
	braw	.L1000de88	/* 1000ddb2:	6000 00d4 */

.L1000ddb6:
	moveal	%fp@(20),%a3	/* 1000ddb6:	266e 0014 */
	movel	%fp@(16),%fp@(-56)	/* 1000ddba:	2d6e 0010 ffc8 */
	bras	.L1000de32	/* 1000ddc0:	6070 */

.L1000ddc2:
	moveq	#-8,%d0	/* 1000ddc2:	70f8 */
	andl	%fp@(-56),%d0	/* 1000ddc4:	c0ae ffc8 */
	moveal	%d0,%a0	/* 1000ddc8:	2040 */
	movel	%a0@,%fp@(-60)	/* 1000ddca:	2d50 ffc4 */
	moveq	#-8,%d0	/* 1000ddce:	70f8 */
	andl	%fp@(-56),%d0	/* 1000ddd0:	c0ae ffc8 */
	moveal	%d0,%a0	/* 1000ddd4:	2040 */
	movel	%a0@(4),%fp@(-56)	/* 1000ddd6:	2d68 0004 ffc8 */
	cmpal	#2,%a3	/* 1000dddc:	b7fc 0000 0002 */
	bnes	.L1000de00	/* 1000dde2:	661c */
	moveq	#0,%d0	/* 1000dde4:	7000 */
	moveb	%d7,%d0	/* 1000dde6:	1007 */
	movel	%d0,%sp@-	/* 1000dde8:	2f00 */
	movel	%fp@(16),%sp@-	/* 1000ddea:	2f2e 0010 */
	movel	%fp@(20),%sp@-	/* 1000ddee:	2f2e 0014 */
	movel	#-1721,%sp@-	/* 1000ddf2:	2f3c ffff f947 */
	jsr	%pc@(sub_1000d538)	/* 1000ddf8:	4eba f73e */
	lea	%sp@(16),%sp	/* 1000ddfc:	4fef 0010 */

.L1000de00:
	moveq	#0,%d0	/* 1000de00:	7000 */
	moveb	%d7,%d0	/* 1000de02:	1007 */
	movel	%d0,%sp@-	/* 1000de04:	2f00 */
	movel	%fp@(24),%sp@-	/* 1000de06:	2f2e 0018 */
	movel	%a3,%d0	/* 1000de0a:	200b */
	moveq	#-8,%d1	/* 1000de0c:	72f8 */
	andl	%d0,%d1	/* 1000de0e:	c280 */
	moveal	%d1,%a0	/* 1000de10:	2041 */
	movel	%a0@,%sp@-	/* 1000de12:	2f10 */
	movel	%fp@(-60),%sp@-	/* 1000de14:	2f2e ffc4 */
	movel	%fp@(-60),%sp@-	/* 1000de18:	2f2e ffc4 */
	movel	%a4,%sp@-	/* 1000de1c:	2f0c */
	jsr	%pc@(sub_1000da02)	/* 1000de1e:	4eba fbe2 */
	movel	%a3,%d0	/* 1000de22:	200b */
	moveq	#-8,%d1	/* 1000de24:	72f8 */
	andl	%d0,%d1	/* 1000de26:	c280 */
	moveal	%d1,%a0	/* 1000de28:	2041 */
	moveal	%a0@(4),%a3	/* 1000de2a:	2668 0004 */
	lea	%sp@(24),%sp	/* 1000de2e:	4fef 0018 */

.L1000de32:
	moveq	#2,%d0	/* 1000de32:	7002 */
	cmpl	%fp@(-56),%d0	/* 1000de34:	b0ae ffc8 */
	bnes	.L1000ddc2	/* 1000de38:	6688 */
	bras	.L1000de88	/* 1000de3a:	604c */

.L1000de3c:
	moveq	#0,%d0	/* 1000de3c:	7000 */
	moveb	%d7,%d0	/* 1000de3e:	1007 */
	movel	%d0,%sp@-	/* 1000de40:	2f00 */
	movel	%fp@(16),%sp@-	/* 1000de42:	2f2e 0010 */
	movel	%fp@(20),%sp@-	/* 1000de46:	2f2e 0014 */
	movel	#-1721,%sp@-	/* 1000de4a:	2f3c ffff f947 */
	jsr	%pc@(sub_1000d538)	/* 1000de50:	4eba f6e6 */
	lea	%sp@(16),%sp	/* 1000de54:	4fef 0010 */
	bras	.L1000de88	/* 1000de58:	602e */

.L1000de5a:
	movel	%fp@(20),%sp@-	/* 1000de5a:	2f2e 0014 */
	movel	%fp@(16),%sp@-	/* 1000de5e:	2f2e 0010 */
	jsr	%pc@(sub_100117d6)	/* 1000de62:	4eba 3972 */
	tstb	%d0	/* 1000de66:	4a00 */
	addqw	#8,%sp	/* 1000de68:	504f */
	bnes	.L1000de88	/* 1000de6a:	661c */
	moveq	#0,%d0	/* 1000de6c:	7000 */
	moveb	%d7,%d0	/* 1000de6e:	1007 */
	movel	%d0,%sp@-	/* 1000de70:	2f00 */
	movel	%fp@(16),%sp@-	/* 1000de72:	2f2e 0010 */
	movel	%fp@(20),%sp@-	/* 1000de76:	2f2e 0014 */
	movel	#-1721,%sp@-	/* 1000de7a:	2f3c ffff f947 */
	jsr	%pc@(sub_1000d538)	/* 1000de80:	4eba f6b6 */
	lea	%sp@(16),%sp	/* 1000de84:	4fef 0010 */

.L1000de88:
	moveml	%fp@(-88),%d4-%d7/%a3-%a4	/* 1000de88:	4cee 18f0 ffa8 */
	unlk	%fp	/* 1000de8e:	4e5e */
	rts	/* 1000de90:	4e75 */
