...
sub_1004e3b8:
	linkw	%fp,#0	/* 1004e3b8:	4e56 0000 */
	movel	%a4,%sp@-	/* 1004e3bc:	2f0c */
	moveal	%fp@(8),%a4	/* 1004e3be:	286e 0008 */
	moveq	#0,%d0	/* 1004e3c2:	7000 */
	moveb	%fp@(15),%d0	/* 1004e3c4:	102e 000f */
	movel	%d0,%sp@-	/* 1004e3c8:	2f00 */
	movel	%a4,%sp@-	/* 1004e3ca:	2f0c */
	jsr	%pc@(sub_10046930)	/* 1004e3cc:	4eba 8562 */
	movel	%a4,%d0	/* 1004e3d0:	200c */
	moveal	%fp@(-4),%a4	/* 1004e3d2:	286e fffc */
	unlk	%fp	/* 1004e3d6:	4e5e */
	rts	/* 1004e3d8:	4e75 */

sub_1004e3da:
	braw	sub_1004e774	/* 1004e3da:	6000 0398 */

sub_1004e3de:
	braw	sub_1004e89e	/* 1004e3de:	6000 04be */

sub_1004e3e2:
	braw	sub_1004e49e	/* 1004e3e2:	6000 00ba */

sub_1004e3e6:
	linkw	%fp,#-4	/* 1004e3e6:	4e56 fffc */
	moveml	%d7/%a3-%a4,%sp@-	/* 1004e3ea:	48e7 0118 */
	moveal	%fp@(8),%a4	/* 1004e3ee:	286e 0008 */
	moveal	%a4@,%a0	/* 1004e3f2:	2054 */
	moveal	%a0,%a1	/* 1004e3f4:	2248 */
	movel	%a0@(10),%d0	/* 1004e3f6:	2028 000a */
	cmpl	%a1@(6),%d0	/* 1004e3fa:	b0a9 0006 */
	bgts	.L1004e442	/* 1004e3fe:	6e42 */
	movel	%a0@(6),%d7	/* 1004e400:	2e28 0006 */
	moveq	#10,%d0	/* 1004e404:	700a */
	addl	%d0,%d7	/* 1004e406:	de80 */
	movel	%d7,%d1	/* 1004e408:	2207 */
	movel	%d1,%d0	/* 1004e40a:	2001 */
	muluw	#12,%d1	/* 1004e40c:	c2fc 000c */
	swap	%d0	/* 1004e410:	4840 */
	muluw	#12,%d0	/* 1004e412:	c0fc 000c */
	swap	%d0	/* 1004e416:	4840 */
	clrw	%d0	/* 1004e418:	4240 */
	addl	%d0,%d1	/* 1004e41a:	d280 */
	movel	%d1,%sp@-	/* 1004e41c:	2f01 */
	moveal	%a4@,%a0	/* 1004e41e:	2054 */
	movel	%a0@(2),%sp@-	/* 1004e420:	2f28 0002 */
	jsr	%pc@(sub_1004a228)	/* 1004e424:	4eba be02 */
	moveal	%a4@,%a0	/* 1004e428:	2054 */
	movel	%d7,%a0@(10)	/* 1004e42a:	2147 000a */
	moveal	%a4@,%a0	/* 1004e42e:	2054 */
	cmpl	%a0@(6),%d7	/* 1004e430:	bea8 0006 */
	bges	.L1004e43e	/* 1004e434:	6c08 */
	movel	%d7,%a0@(6)	/* 1004e436:	2147 0006 */
	moveq	#0,%d0	/* 1004e43a:	7000 */
	bras	.L1004e440	/* 1004e43c:	6002 */

.L1004e43e:
	moveq	#0,%d0	/* 1004e43e:	7000 */

.L1004e440:
	addqw	#8,%sp	/* 1004e440:	504f */

.L1004e442:
	moveal	%a4@,%a0	/* 1004e442:	2054 */
	movel	%a0,%fp@(-4)	/* 1004e444:	2d48 fffc */
	subql	#4,%sp	/* 1004e448:	598f */
	moveal	%a4@,%a0	/* 1004e44a:	2054 */
	moveal	%a0@(2),%a0	/* 1004e44c:	2068 0002 */
	movel	%a0@,%sp@-	/* 1004e450:	2f10 */
	jsr	%pc@(sub_1004aac4)	/* 1004e452:	4eba c670 */
	moveal	%sp@+,%a0	/* 1004e456:	205f */
	moveal	%fp@(-4),%a1	/* 1004e458:	226e fffc */
	movel	%a1@(6),%d0	/* 1004e45c:	2029 0006 */
	movel	%d0,%d1	/* 1004e460:	2200 */
	muluw	#12,%d0	/* 1004e462:	c0fc 000c */
	swap	%d1	/* 1004e466:	4841 */
	muluw	#12,%d1	/* 1004e468:	c2fc 000c */
	swap	%d1	/* 1004e46c:	4841 */
	clrw	%d1	/* 1004e46e:	4241 */
	addl	%d1,%d0	/* 1004e470:	d081 */
	lea	%a0@(0,%d0:l),%a3	/* 1004e472:	47f0 0800 */
	movew	%fp@(14),%a3@	/* 1004e476:	36ae 000e */
	movel	%fp@(20),%a3@(4)	/* 1004e47a:	276e 0014 0004 */
	movew	%fp@(18),%a3@(2)	/* 1004e480:	376e 0012 0002 */
	movel	%fp@(24),%a3@(8)	/* 1004e486:	276e 0018 0008 */
	moveal	%a4@,%a0	/* 1004e48c:	2054 */
	addql	#1,%a0@(6)	/* 1004e48e:	52a8 0006 */
	movel	%a3,%d0	/* 1004e492:	200b */
	moveml	%fp@(-16),%d7/%a3-%a4	/* 1004e494:	4cee 1880 fff0 */
	unlk	%fp	/* 1004e49a:	4e5e */
	rts	/* 1004e49c:	4e75 */

sub_1004e49e:
	linkw	%fp,#-482	/* 1004e49e:	4e56 fe1e */
	moveml	%d3-%d7/%a2-%a4,%sp@-	/* 1004e4a2:	48e7 1f38 */
	movel	%fp@(12),%d4	/* 1004e4a6:	282e 000c */
	moveal	%fp@(8),%a4	/* 1004e4aa:	286e 0008 */
	moveal	%a4@,%a0	/* 1004e4ae:	2054 */
	movel	%fp@(16),%a0@(14)	/* 1004e4b0:	216e 0010 000e */
	moveal	%a4@,%a0	/* 1004e4b6:	2054 */
	movel	%d4,%a0@(22)	/* 1004e4b8:	2144 0016 */
	moveal	%a4@,%a0	/* 1004e4bc:	2054 */
	moveq	#0,%d0	/* 1004e4be:	7000 */
	movel	%d0,%a0@(6)	/* 1004e4c0:	2140 0006 */
	moveal	%a4@,%a0	/* 1004e4c4:	2054 */
	moveq	#-1,%d1	/* 1004e4c6:	72ff */
	movel	%d1,%a0@(26)	/* 1004e4c8:	2141 001a */
	movel	%d4,%d3	/* 1004e4cc:	2604 */
	movel	%d3,%d2	/* 1004e4ce:	2403 */
	addl	%d3,%d3	/* 1004e4d0:	d683 */
	addl	%d2,%d3	/* 1004e4d2:	d682 */
	movel	%d3,%d0	/* 1004e4d4:	2003 */
	moveq	#2,%d1	/* 1004e4d6:	7202 */
	jsr	%pc@(sub_10049c48)	/* 1004e4d8:	4eba b76e */
	movel	%d0,%d5	/* 1004e4dc:	2a00 */
	addql	#1,%d5	/* 1004e4de:	5285 */
	movel	%d4,%d1	/* 1004e4e0:	2204 */
	movel	%d1,%d0	/* 1004e4e2:	2001 */
	muluw	#12,%d1	/* 1004e4e4:	c2fc 000c */
	swap	%d0	/* 1004e4e8:	4840 */
	muluw	#12,%d0	/* 1004e4ea:	c0fc 000c */
	swap	%d0	/* 1004e4ee:	4840 */
	clrw	%d0	/* 1004e4f0:	4240 */
	addl	%d0,%d1	/* 1004e4f2:	d280 */
	movel	%d1,%sp@-	/* 1004e4f4:	2f01 */
	moveal	%a4@,%a0	/* 1004e4f6:	2054 */
	movel	%a0@(2),%sp@-	/* 1004e4f8:	2f28 0002 */
	jsr	%pc@(sub_1004a228)	/* 1004e4fc:	4eba bd2a */
	moveal	%a4@,%a0	/* 1004e500:	2054 */
	movel	%d4,%a0@(10)	/* 1004e502:	2144 000a */
	moveal	%a4@,%a0	/* 1004e506:	2054 */
	cmpl	%a0@(6),%d4	/* 1004e508:	b8a8 0006 */
	bges	.L1004e516	/* 1004e50c:	6c08 */
	movel	%d4,%a0@(6)	/* 1004e50e:	2144 0006 */
	moveq	#0,%d0	/* 1004e512:	7000 */
	bras	.L1004e518	/* 1004e514:	6002 */

.L1004e516:
	moveq	#0,%d0	/* 1004e516:	7000 */

.L1004e518:
	moveal	%a4@,%a0	/* 1004e518:	2054 */
	movel	%a0@(22),%sp@-	/* 1004e51a:	2f28 0016 */
	movel	%a0@(14),%sp@-	/* 1004e51e:	2f28 000e */
	pea	%fp@(-136)	/* 1004e522:	486e ff78 */
	jsr	%pc@(sub_1004e914)	/* 1004e526:	4eba 03ec */
	lea	%fp@(-136),%a0	/* 1004e52a:	41ee ff78 */
	movel	%a0,%fp@(-96)	/* 1004e52e:	2d48 ffa0 */
	moveq	#0,%d0	/* 1004e532:	7000 */
	movel	%d0,%fp@(-80)	/* 1004e534:	2d40 ffb0 */
	moveq	#1,%d1	/* 1004e538:	7201 */
	movel	%d1,%fp@(-84)	/* 1004e53a:	2d41 ffac */
	movel	%d0,%fp@(-88)	/* 1004e53e:	2d40 ffa8 */
	jsr	%pc@(sub_1004958a)	/* 1004e542:	4eba b046 */
	movel	%d0,%sp@-	/* 1004e546:	2f00 */
	jsr	%pc@(sub_1004727a)	/* 1004e548:	4eba 8d30 */
	movel	%d0,%fp@(-100)	/* 1004e54c:	2d40 ff9c */
	moveq	#0,%d0	/* 1004e550:	7000 */
	movel	%d0,%fp@(-104)	/* 1004e552:	2d40 ff98 */
	clrw	%fp@(-404)	/* 1004e556:	426e fe6c */
	lea	%fp@(-404),%a0	/* 1004e55a:	41ee fe6c */
	lea	%fp@(-144),%a0	/* 1004e55e:	41ee ff70 */
	jsr	%pc@(sub_1004aacc)	/* 1004e562:	4eba c568 */
	moveal	%d0,%a0	/* 1004e566:	2040 */
	movel	%a0@(88),%fp@(-464)	/* 1004e568:	2d68 0058 fe30 */
	lea	%fp@(-464),%a0	/* 1004e56e:	41ee fe30 */
	movel	%a0,%sp@-	/* 1004e572:	2f08 */
	jsr	%pc@(sub_1004aacc)	/* 1004e574:	4eba c556 */
	moveal	%sp@+,%a0	/* 1004e578:	205f */
	moveal	%d0,%a1	/* 1004e57a:	2240 */
	movel	%a0,%a1@(88)	/* 1004e57c:	2348 0058 */
	lea	%fp@(-464),%a0	/* 1004e580:	41ee fe30 */
	lea	%fp@(-460),%a0	/* 1004e584:	41ee fe34 */
	lea	%pc@(.L1004e592),%a1	/* 1004e588:	43fa 0008 */
	moveml	%d2-%d7/%a1-%a4/%fp-%sp,%a0@	/* 1004e58c:	48d0 defc */
	moveq	#0,%d0	/* 1004e590:	7000 */

.L1004e592:
	movel	%d0,%fp@(-412)	/* 1004e592:	2d40 fe64 */
	lea	%sp@(24),%sp	/* 1004e596:	4fef 0018 */
	bnew	.L1004e714	/* 1004e59a:	6600 0178 */
	moveq	#0,%d0	/* 1004e59e:	7000 */
	movel	%d0,%fp@(-144)	/* 1004e5a0:	2d40 ff70 */
	movel	%d0,%fp@(-144)	/* 1004e5a4:	2d40 ff70 */
	movel	%d0,%fp@(-140)	/* 1004e5a8:	2d40 ff74 */
	movel	%d0,%fp@(-144)	/* 1004e5ac:	2d40 ff70 */
	moveq	#64,%d4	/* 1004e5b0:	7840 */
	movel	%d4,%sp@-	/* 1004e5b2:	2f04 */
	jsr	%pc@(sub_1004a176)	/* 1004e5b4:	4eba bbc0 */
	movel	%d0,%fp@(-144)	/* 1004e5b8:	2d40 ff70 */
	addqw	#4,%sp	/* 1004e5bc:	584f */

.L1004e5be:
	clrb	%fp@(-404)	/* 1004e5be:	422e fe6c */
	movel	#255,%fp@(-148)	/* 1004e5c2:	2d7c 0000 00ff */
		/* 1004e5c8:	ff6c */
	jsr	%pc@(sub_1004958a)	/* 1004e5ca:	4eba afbe */
	movel	%d0,%sp@-	/* 1004e5ce:	2f00 */
	jsr	%pc@(sub_10047272)	/* 1004e5d0:	4eba 8ca0 */
	movel	%d0,%fp@(-468)	/* 1004e5d4:	2d40 fe2c */
	pea	%fp@(-148)	/* 1004e5d8:	486e ff6c */
	pea	%fp@(-403)	/* 1004e5dc:	486e fe6d */
	pea	%fp@(-116)	/* 1004e5e0:	486e ff8c */
	moveal	%fp@(-468),%a0	/* 1004e5e4:	206e fe2c */
	jsr	%a0@	/* 1004e5e8:	4e90 */
	movew	%d0,%d5	/* 1004e5ea:	3a00 */
	tstl	%fp@(-148)	/* 1004e5ec:	4aae ff6c */
	lea	%sp@(16),%sp	/* 1004e5f0:	4fef 0010 */
	bges	.L1004e602	/* 1004e5f4:	6c0c */
	movel	#-1750,%sp@-	/* 1004e5f6:	2f3c ffff f92a */
	jsr	%pc@(sub_100489fc)	/* 1004e5fc:	4eba a3fe */
	addqw	#4,%sp	/* 1004e600:	584f */

.L1004e602:
	moveb	%fp@(-145),%fp@(-404)	/* 1004e602:	1d6e ff6f fe6c */
	tstw	%d5	/* 1004e608:	4a45 */
	beqw	.L1004e704	/* 1004e60a:	6700 00f8 */
	moveq	#-1,%d4	/* 1004e60e:	78ff */
	moveb	%fp@(-404),%d0	/* 1004e610:	102e fe6c */
	moveq	#0,%d1	/* 1004e614:	7200 */
	moveb	%d0,%d1	/* 1004e616:	1200 */
	tstl	%d1	/* 1004e618:	4a81 */
	blss	.L1004e68a	/* 1004e61a:	636e */
	movel	%fp@(-140),%fp@(-478)	/* 1004e61c:	2d6e ff74 fe22 */
	moveb	%fp@(-404),%d0	/* 1004e622:	102e fe6c */
	moveb	%d0,%fp@(-473)	/* 1004e626:	1d40 fe27 */
	moveq	#0,%d0	/* 1004e62a:	7000 */
	moveb	%fp@(-473),%d0	/* 1004e62c:	102e fe27 */
	movel	%d0,%sp@-	/* 1004e630:	2f00 */
	pea	%fp@(-144)	/* 1004e632:	486e ff70 */
	jsr	%pc@(sub_10046930)	/* 1004e636:	4eba 82f8 */
	lea	%fp@(-144),%a0	/* 1004e63a:	41ee ff70 */
	lea	%fp@(-403),%a0	/* 1004e63e:	41ee fe6d */
	movel	%a0,%fp@(-472)	/* 1004e642:	2d48 fe28 */
	moveq	#0,%d0	/* 1004e646:	7000 */
	moveb	%fp@(-473),%d0	/* 1004e648:	102e fe27 */
	movel	%d0,%sp@-	/* 1004e64c:	2f00 */
	movel	%a0,%sp@-	/* 1004e64e:	2f08 */
	pea	%fp@(-144)	/* 1004e650:	486e ff70 */
	jsr	%pc@(sub_10049c60)	/* 1004e654:	4eba b60a */
	lea	%fp@(-144),%a0	/* 1004e658:	41ee ff70 */
	movel	%fp@(-478),%d4	/* 1004e65c:	282e fe22 */
	movel	%d4,%sp@-	/* 1004e660:	2f04 */
	moveal	%a4@,%a0	/* 1004e662:	2054 */
	movel	%fp@(-108),%d0	/* 1004e664:	202e ff94 */
	addl	%a0@(14),%d0	/* 1004e668:	d0a8 000e */
	movel	%d0,%sp@-	/* 1004e66c:	2f00 */
	movew	%fp@(-110),%d0	/* 1004e66e:	302e ff92 */
	extl	%d0	/* 1004e672:	48c0 */
	movel	%d0,%sp@-	/* 1004e674:	2f00 */
	extl	%d5	/* 1004e676:	48c5 */
	movel	%d5,%sp@-	/* 1004e678:	2f05 */
	movel	%a4,%sp@-	/* 1004e67a:	2f0c */
	jsr	%pc@(sub_1004e3e6)	/* 1004e67c:	4eba fd68 */
	moveal	%d0,%a2	/* 1004e680:	2440 */
	lea	%sp@(40),%sp	/* 1004e682:	4fef 0028 */
	braw	.L1004e5be	/* 1004e686:	6000 ff36 */

.L1004e68a:
	cmpiw	#9,%d5	/* 1004e68a:	0c45 0009 */
	bnes	.L1004e6d8	/* 1004e68e:	6648 */
	movew	%fp@(-110),%d7	/* 1004e690:	3e2e ff92 */
	moveal	%a4@,%a0	/* 1004e694:	2054 */
	moveal	%fp@(-108),%a3	/* 1004e696:	266e ff94 */
	addal	%a0@(14),%a3	/* 1004e69a:	d7e8 000e */

.L1004e69e:
	cmpiw	#255,%d7	/* 1004e69e:	0c47 00ff */
	bges	.L1004e6aa	/* 1004e6a2:	6c06 */
	extl	%d7	/* 1004e6a4:	48c7 */
	movel	%d7,%d0	/* 1004e6a6:	2007 */
	bras	.L1004e6b0	/* 1004e6a8:	6006 */

.L1004e6aa:
	movel	#255,%d0	/* 1004e6aa:	203c 0000 00ff */

.L1004e6b0:
	movew	%d0,%d6	/* 1004e6b0:	3c00 */
	moveq	#-1,%d0	/* 1004e6b2:	70ff */
	movel	%d0,%sp@-	/* 1004e6b4:	2f00 */
	movel	%a3,%sp@-	/* 1004e6b6:	2f0b */
	extl	%d6	/* 1004e6b8:	48c6 */
	movel	%d6,%sp@-	/* 1004e6ba:	2f06 */
	extl	%d5	/* 1004e6bc:	48c5 */
	movel	%d5,%sp@-	/* 1004e6be:	2f05 */
	movel	%a4,%sp@-	/* 1004e6c0:	2f0c */
	jsr	%pc@(sub_1004e3e6)	/* 1004e6c2:	4eba fd22 */
	moveal	%d0,%a2	/* 1004e6c6:	2440 */
	subw	%d6,%d7	/* 1004e6c8:	9e46 */
	addaw	%d6,%a3	/* 1004e6ca:	d6c6 */
	lea	%sp@(20),%sp	/* 1004e6cc:	4fef 0014 */
	tstw	%d7	/* 1004e6d0:	4a47 */
	bgts	.L1004e69e	/* 1004e6d2:	6eca */
	braw	.L1004e5be	/* 1004e6d4:	6000 fee8 */

.L1004e6d8:
	moveq	#-1,%d0	/* 1004e6d8:	70ff */
	movel	%d0,%sp@-	/* 1004e6da:	2f00 */
	moveal	%a4@,%a0	/* 1004e6dc:	2054 */
	movel	%fp@(-108),%d1	/* 1004e6de:	222e ff94 */
	addl	%a0@(14),%d1	/* 1004e6e2:	d2a8 000e */
	movel	%d1,%sp@-	/* 1004e6e6:	2f01 */
	movew	%fp@(-110),%d1	/* 1004e6e8:	322e ff92 */
	extl	%d1	/* 1004e6ec:	48c1 */
	movel	%d1,%sp@-	/* 1004e6ee:	2f01 */
	extl	%d5	/* 1004e6f0:	48c5 */
	movel	%d5,%sp@-	/* 1004e6f2:	2f05 */
	movel	%a4,%sp@-	/* 1004e6f4:	2f0c */
	jsr	%pc@(sub_1004e3e6)	/* 1004e6f6:	4eba fcee */
	moveal	%d0,%a2	/* 1004e6fa:	2440 */
	lea	%sp@(20),%sp	/* 1004e6fc:	4fef 0014 */
	braw	.L1004e5be	/* 1004e700:	6000 febc */

.L1004e704:
	moveal	%fp@(-144),%a3	/* 1004e704:	266e ff70 */
	moveq	#0,%d0	/* 1004e708:	7000 */
	movel	%d0,%fp@(-144)	/* 1004e70a:	2d40 ff70 */
	moveal	%a4@,%a0	/* 1004e70e:	2054 */
	movel	%a3,%a0@(18)	/* 1004e710:	214b 0012 */

.L1004e714:
	jsr	%pc@(sub_1004aacc)	/* 1004e714:	4eba c3b6 */
	moveal	%d0,%a0	/* 1004e718:	2040 */
	movel	%fp@(-464),%a0@(88)	/* 1004e71a:	216e fe30 0058 */
	tstl	%fp@(-144)	/* 1004e720:	4aae ff70 */
	beqs	.L1004e736	/* 1004e724:	6710 */
	moveal	%fp@(-144),%a0	/* 1004e726:	206e ff70 */
	.short	0xa023	/* 1004e72a:	a023 */
	moveq	#0,%d0	/* 1004e72c:	7000 */
	movel	%d0,%fp@(-144)	/* 1004e72e:	2d40 ff70 */
	moveq	#0,%d1	/* 1004e732:	7200 */
	bras	.L1004e738	/* 1004e734:	6002 */

.L1004e736:
	moveq	#0,%d1	/* 1004e736:	7200 */

.L1004e738:
	tstl	%fp@(-412)	/* 1004e738:	4aae fe64 */
	beqs	.L1004e75c	/* 1004e73c:	671e */
	movel	%fp@(-412),%d0	/* 1004e73e:	202e fe64 */
	movel	%d0,%fp@(-482)	/* 1004e742:	2d40 fe1e */
	jsr	%pc@(sub_1004aacc)	/* 1004e746:	4eba c384 */
	moveal	%d0,%a0	/* 1004e74a:	2040 */
	moveal	%a0@(88),%a0	/* 1004e74c:	2068 0058 */
	addql	#4,%a0	/* 1004e750:	5888 */
	movel	%fp@(-482),%d0	/* 1004e752:	202e fe1e */
	moveml	%a0@,%d2-%d7/%a1-%a4/%fp-%sp	/* 1004e756:	4cd0 defc */
	jmp	%a1@	/* 1004e75a:	4ed1 */

.L1004e75c:
	moveq	#2,%d0	/* 1004e75c:	7002 */
	movel	%d0,%sp@-	/* 1004e75e:	2f00 */
	pea	%fp@(-464)	/* 1004e760:	486e fe30 */
	jsr	%pc@(sub_1004aac8)	/* 1004e764:	4eba c362 */
	addqw	#8,%sp	/* 1004e768:	504f */
	moveml	%fp@(-514),%d3-%d7/%a2-%a4	/* 1004e76a:	4cee 1cf8 fdfe */
	unlk	%fp	/* 1004e770:	4e5e */
	rts	/* 1004e772:	4e75 */
...
sub_1004e9e6:
	linkw	%fp,#-256	/* 1004e9e6:	4e56 ff00 */
	moveml	%a3-%a4,%sp@-	/* 1004e9ea:	48e7 0018 */
	lea	%fp@(-256),%a3	/* 1004e9ee:	47ee ff00 */
	moveal	%fp@(8),%a4	/* 1004e9f2:	286e 0008 */
	pea	256		/* 1004e9f6:	4878 0100 */
	movel	%a3,%sp@-	/* 1004e9fa:	2f0b */
	movel	%fp@(12),%sp@-	/* 1004e9fc:	2f2e 000c */
	movel	%a4,%sp@-	/* 1004ea00:	2f0c */
	jsr	%pc@(sub_1004ea12)	/* 1004ea02:	4eba 000e */
	movel	%a4,%d0	/* 1004ea06:	200c */
	moveml	%fp@(-264),%a3-%a4	/* 1004ea08:	4cee 1800 fef8 */
	unlk	%fp	/* 1004ea0e:	4e5e */
	rts	/* 1004ea10:	4e75 */

sub_1004ea12:
	linkw	%fp,#0	/* 1004ea12:	4e56 0000 */
	moveml	%d5-%d7/%a3-%a4,%sp@-	/* 1004ea16:	48e7 0718 */
	moveal	%fp@(16),%a3	/* 1004ea1a:	266e 0010 */
	movel	%fp@(20),%d6	/* 1004ea1e:	2c2e 0014 */
	movel	%fp@(12),%d7	/* 1004ea22:	2e2e 000c */
	moveal	%fp@(8),%a4	/* 1004ea26:	286e 0008 */
	tstl	%d7	/* 1004ea2a:	4a87 */
	slt	%d0	/* 1004ea2c:	5dc0 */
	andiw	#1,%d0	/* 1004ea2e:	0240 0001 */
	extl	%d0	/* 1004ea32:	48c0 */
	moveb	%d0,%d5	/* 1004ea34:	1a00 */
	beqs	.L1004ea3e	/* 1004ea36:	6706 */
	movel	%d7,%d0	/* 1004ea38:	2007 */
	negl	%d0	/* 1004ea3a:	4480 */
	movel	%d0,%d7	/* 1004ea3c:	2e00 */

.L1004ea3e:
	subql	#1,%d6	/* 1004ea3e:	5386 */
	clrb	%a3@(0,%d6:l)	/* 1004ea40:	4233 6800 */

.L1004ea44:
	tstl	%d6	/* 1004ea44:	4a86 */
	movel	%d7,%d0	/* 1004ea46:	2007 */
	moveq	#10,%d1	/* 1004ea48:	720a */
	jsr	%pc@(sub_1004742a)	/* 1004ea4a:	4eba 89de */
	moveq	#48,%d1	/* 1004ea4e:	7230 */
	addb	%d1,%d0	/* 1004ea50:	d001 */
	subql	#1,%d6	/* 1004ea52:	5386 */
	moveb	%d0,%a3@(0,%d6:l)	/* 1004ea54:	1780 6800 */
	movel	%d7,%d0	/* 1004ea58:	2007 */
	moveq	#10,%d1	/* 1004ea5a:	720a */
	jsr	%pc@(sub_10049c48)	/* 1004ea5c:	4eba b1ea */
	movel	%d0,%d7	/* 1004ea60:	2e00 */
	bnes	.L1004ea44	/* 1004ea62:	66e0 */
	tstb	%d5	/* 1004ea64:	4a05 */
	beqs	.L1004ea70	/* 1004ea66:	6708 */
	subql	#1,%d6	/* 1004ea68:	5386 */
	moveb	#45,%a3@(0,%d6:l)	/* 1004ea6a:	17bc 002d 6800 */

.L1004ea70:
	pea	%a3@(0,%d6:l)	/* 1004ea70:	4873 6800 */
	jsr	%pc@(sub_100474c0)	/* 1004ea74:	4eba 8a4a */
	movel	%d0,%d5	/* 1004ea78:	2a00 */
	movel	%d5,%sp@-	/* 1004ea7a:	2f05 */
	pea	%a3@(0,%d6:l)	/* 1004ea7c:	4873 6800 */
	movel	%a4,%sp@-	/* 1004ea80:	2f0c */
	jsr	%pc@(sub_10049c60)	/* 1004ea82:	4eba b1dc */
	lea	%sp@(16),%sp	/* 1004ea86:	4fef 0010 */
	moveml	%fp@(-20),%d5-%d7/%a3-%a4	/* 1004ea8a:	4cee 18e0 ffec */
	unlk	%fp	/* 1004ea90:	4e5e */
	rts	/* 1004ea92:	4e75 */

sub_1004ea94:
	linkw	%fp,#-56	/* 1004ea94:	4e56 ffc8 */
	moveml	%d7/%a3-%a4,%sp@-	/* 1004ea98:	48e7 0118 */
	moveal	%fp@(8),%a4	/* 1004ea9c:	286e 0008 */
	tstl	%a4@(8)	/* 1004eaa0:	4aac 0008 */
	beqw	.L1004eb78	/* 1004eaa4:	6700 00d2 */
	movel	%a4@(4),%d7	/* 1004eaa8:	2e2c 0004 */
	moveal	%a4@(8),%a0	/* 1004eaac:	206c 0008 */
	moveal	%a0@,%a0	/* 1004eab0:	2050 */
	movel	%d7,%a0@(16)	/* 1004eab2:	2147 0010 */
	moveq	#0,%d0	/* 1004eab6:	7000 */
	moveal	%d0,%a3	/* 1004eab8:	2640 */
	jsr	%pc@(sub_1004aacc)	/* 1004eaba:	4eba c010 */
	moveal	%d0,%a0	/* 1004eabe:	2040 */
	movel	%a0@(88),%fp@(-52)	/* 1004eac0:	2d68 0058 ffcc */
	lea	%fp@(-52),%a0	/* 1004eac6:	41ee ffcc */
	movel	%a0,%sp@-	/* 1004eaca:	2f08 */
	jsr	%pc@(sub_1004aacc)	/* 1004eacc:	4eba bffe */
	moveal	%sp@+,%a0	/* 1004ead0:	205f */
	moveal	%d0,%a1	/* 1004ead2:	2240 */
	movel	%a0,%a1@(88)	/* 1004ead4:	2348 0058 */
	lea	%fp@(-52),%a0	/* 1004ead8:	41ee ffcc */
	lea	%fp@(-48),%a0	/* 1004eadc:	41ee ffd0 */
	lea	%pc@(.L1004eaea),%a1	/* 1004eae0:	43fa 0008 */
	moveml	%d2-%d7/%a1-%a4/%fp-%sp,%a0@	/* 1004eae4:	48d0 defc */
	moveq	#0,%d0	/* 1004eae8:	7000 */

.L1004eaea:
	movel	%d0,%d7	/* 1004eaea:	2e00 */
	bnes	.L1004eb2e	/* 1004eaec:	6640 */
	moveq	#0,%d0	/* 1004eaee:	7000 */
	movel	%d0,%sp@-	/* 1004eaf0:	2f00 */
	...
	.short	0xa025	/* 1004eb10:	a025 */
	movel	%d0,%sp@-	/* 1004eb12:	2f00 */
	subql	#4,%sp	/* 1004eb14:	598f */
	movel	%a3@,%sp@-	/* 1004eb16:	2f13 */
	jsr	%pc@(sub_1004aac4)	/* 1004eb18:	4eba bfaa */
	movel	%a4@(4),%d0	/* 1004eb1c:	202c 0004 */
	movel	%d0,%sp@-	/* 1004eb20:	2f00 */
	moveal	%a4@,%a0	/* 1004eb22:	2054 */
	movel	%a0@,%sp@-	/* 1004eb24:	2f10 */
	jsr	%pc@(sub_100476aa)	/* 1004eb26:	4eba 8b82 */
	lea	%sp@(32),%sp	/* 1004eb2a:	4fef 0020 */

.L1004eb2e:
	jsr	%pc@(sub_1004aacc)	/* 1004eb2e:	4eba bf9c */
	moveal	%d0,%a0	/* 1004eb32:	2040 */
	movel	%fp@(-52),%a0@(88)	/* 1004eb34:	216e ffcc 0058 */
	movel	%a3,%d0	/* 1004eb3a:	200b */
	beqs	.L1004eb46	/* 1004eb3c:	6708 */
	moveal	%a3,%a0	/* 1004eb3e:	204b */
	.short	0xa023	/* 1004eb40:	a023 */
	moveq	#0,%d0	/* 1004eb42:	7000 */
	moveal	%d0,%a3	/* 1004eb44:	2640 */

.L1004eb46:
	moveal	%a4@,%a0	/* 1004eb46:	2054 */
	.short	0xa02a	/* 1004eb48:	a02a */
	tstl	%d7	/* 1004eb4a:	4a87 */
	beqs	.L1004eb6a	/* 1004eb4c:	671c */
	movel	%d7,%d0	/* 1004eb4e:	2007 */
	movel	%d0,%fp@(-56)	/* 1004eb50:	2d40 ffc8 */
	jsr	%pc@(sub_1004aacc)	/* 1004eb54:	4eba bf76 */
	moveal	%d0,%a0	/* 1004eb58:	2040 */
	moveal	%a0@(88),%a0	/* 1004eb5a:	2068 0058 */
	addql	#4,%a0	/* 1004eb5e:	5888 */
	movel	%fp@(-56),%d0	/* 1004eb60:	202e ffc8 */
	moveml	%a0@,%d2-%d7/%a1-%a4/%fp-%sp	/* 1004eb64:	4cd0 defc */
	jmp	%a1@	/* 1004eb68:	4ed1 */

.L1004eb6a:
	moveq	#2,%d0	/* 1004eb6a:	7002 */
	movel	%d0,%sp@-	/* 1004eb6c:	2f00 */
	pea	%fp@(-52)	/* 1004eb6e:	486e ffcc */
	jsr	%pc@(sub_1004aac8)	/* 1004eb72:	4eba bf54 */
	addqw	#8,%sp	/* 1004eb76:	504f */

.L1004eb78:
	moveml	%fp@(-68),%d7/%a3-%a4	/* 1004eb78:	4cee 1880 ffbc */
	unlk	%fp	/* 1004eb7e:	4e5e */
	rts	/* 1004eb80:	4e75 */

sub_1004eb82:
	linkw	%fp,#-22	/* 1004eb82:	4e56 ffea */
	pea	%fp@(-22)	/* 1004eb86:	486e ffea */
	subql	#2,%sp	/* 1004eb8a:	558f */
	moveq	#0,%d0	/* 1004eb8c:	7000 */
	movew	%d0,%sp@-	/* 1004eb8e:	3f00 */
	movel	#-2113798138,%sp@-	/* 1004eb90:	2f3c 8202 0006 */
	.short	0xa8b5	/* 1004eb96:	a8b5 */
	movew	%sp@+,%d0	/* 1004eb98:	301f */
	extl	%d0	/* 1004eb9a:	48c0 */
	movel	%d0,%sp@-	/* 1004eb9c:	2f00 */
	jsr	%pc@(sub_1004f9c8)	/* 1004eb9e:	4eba 0e28 */
	pea	%fp@(-20)	/* 1004eba2:	486e ffec */
	movel	%fp@(16),%sp@-	/* 1004eba6:	2f2e 0010 */
	movel	%fp@(12),%sp@-	/* 1004ebaa:	2f2e 000c */
	movel	%fp@(8),%sp@-	/* 1004ebae:	2f2e 0008 */
	jsr	%pc@(sub_1004ef9e)	/* 1004ebb2:	4eba 03ea */
	unlk	%fp	/* 1004ebb6:	4e5e */
	rts	/* 1004ebb8:	4e75 */

sub_1004ebba:
	linkw	%fp,#-16	/* 1004ebba:	4e56 fff0 */
	moveml	%d7/%a3-%a4,%sp@-	/* 1004ebbe:	48e7 0118 */
	movel	%fp@(12),%d7	/* 1004ebc2:	2e2e 000c */
	moveal	%fp@(8),%a4	/* 1004ebc6:	286e 0008 */
	tstl	%a4@(8)	/* 1004ebca:	4aac 0008 */
	beqw	.L1004ec66	/* 1004ebce:	6700 0096 */
	tstl	%a4@(18)	/* 1004ebd2:	4aac 0012 */
	beqw	.L1004ec66	/* 1004ebd6:	6700 008e */
	moveq	#-1,%d0	/* 1004ebda:	70ff */
	cmpl	%d7,%d0	/* 1004ebdc:	b087 */
	bgts	.L1004ebf2	/* 1004ebde:	6e12 */
	moveal	%a4@(18),%a3	/* 1004ebe0:	266c 0012 */
	moveal	%a3,%a0	/* 1004ebe4:	204b */
	.short	0xa025	/* 1004ebe6:	a025 */
	moveq	#18,%d1	/* 1004ebe8:	7212 */
	jsr	%pc@(sub_10049c48)	/* 1004ebea:	4eba b05c */
	cmpl	%d7,%d0	/* 1004ebee:	b087 */
	bgts	.L1004ebf4	/* 1004ebf0:	6e02 */

.L1004ebf2:
	moveq	#-1,%d7	/* 1004ebf2:	7eff */

.L1004ebf4:
	moveq	#-1,%d0	/* 1004ebf4:	70ff */
	cmpl	%d7,%d0	/* 1004ebf6:	b087 */
	bnes	.L1004ec30	/* 1004ebf8:	6636 */
	pea	%fp@(-2)	/* 1004ebfa:	486e fffe */
	pea	%fp@(-4)	/* 1004ebfe:	486e fffc */
	pea	%fp@(-16)	/* 1004ec02:	486e fff0 */
	jsr	%pc@(sub_1004eb82)	/* 1004ec06:	4eba ff7a */
	movel	%a4@(4),%sp@-	/* 1004ec0a:	2f2c 0004 */
	movew	%fp@(-2),%d0	/* 1004ec0e:	302e fffe */
	extl	%d0	/* 1004ec12:	48c0 */
	movel	%d0,%sp@-	/* 1004ec14:	2f00 */
	movew	%fp@(-4),%d0	/* 1004ec16:	302e fffc */
	extl	%d0	/* 1004ec1a:	48c0 */
	movel	%d0,%sp@-	/* 1004ec1c:	2f00 */
	pea	%fp@(-16)	/* 1004ec1e:	486e fff0 */
	movel	%a4@(8),%sp@-	/* 1004ec22:	2f2c 0008 */
	jsr	%pc@(sub_1004f23c)	/* 1004ec26:	4eba 0614 */
	lea	%sp@(32),%sp	/* 1004ec2a:	4fef 0020 */
	bras	.L1004ec66	/* 1004ec2e:	6036 */

.L1004ec30:
	movel	%a4@(4),%sp@-	/* 1004ec30:	2f2c 0004 */
	subql	#4,%sp	/* 1004ec34:	598f */
	moveal	%a4@(18),%a0	/* 1004ec36:	206c 0012 */
	movel	%a0@,%sp@-	/* 1004ec3a:	2f10 */
	jsr	%pc@(sub_1004aac4)	/* 1004ec3c:	4eba be86 */
	moveal	%sp@+,%a0	/* 1004ec40:	205f */
	movel	%d7,%d0	/* 1004ec42:	2007 */
	movel	%d0,%d1	/* 1004ec44:	2200 */
	muluw	#18,%d0	/* 1004ec46:	c0fc 0012 */
	swap	%d1	/* 1004ec4a:	4841 */
	muluw	#18,%d1	/* 1004ec4c:	c2fc 0012 */
	swap	%d1	/* 1004ec50:	4841 */
	clrw	%d1	/* 1004ec52:	4241 */
	addl	%d1,%d0	/* 1004ec54:	d081 */
	pea	%a0@(0,%d0:l)	/* 1004ec56:	4870 0800 */
	movel	%a4@(8),%sp@-	/* 1004ec5a:	2f2c 0008 */
	jsr	%pc@(sub_1004f2ec)	/* 1004ec5e:	4eba 068c */
	lea	%sp@(12),%sp	/* 1004ec62:	4fef 000c */

.L1004ec66:
	moveml	%fp@(-28),%d7/%a3-%a4	/* 1004ec66:	4cee 1880 ffe4 */
	unlk	%fp	/* 1004ec6c:	4e5e */
	rts	/* 1004ec6e:	4e75 */

sub_1004ec70:
	linkw	%fp,#0	/* 1004ec70:	4e56 0000 */
	moveml	%d7/%a4,%sp@-	/* 1004ec74:	48e7 0108 */
	moveal	%fp@(8),%a4	/* 1004ec78:	286e 0008 */
	tstl	%a4@(8)	/* 1004ec7c:	4aac 0008 */
	beqs	.L1004ec9e	/* 1004ec80:	671c */
	movel	%a4@(4),%d7	/* 1004ec82:	2e2c 0004 */
	moveal	%a4@(8),%a0	/* 1004ec86:	206c 0008 */
	moveal	%a0@,%a0	/* 1004ec8a:	2050 */
	movel	%d7,%a0@(16)	/* 1004ec8c:	2147 0010 */
	movel	%fp@(12),%sp@-	/* 1004ec90:	2f2e 000c */
	movel	%a4@(8),%sp@-	/* 1004ec94:	2f2c 0008 */
	jsr	%pc@(sub_1004f68a)	/* 1004ec98:	4eba 09f0 */
	addqw	#8,%sp	/* 1004ec9c:	504f */

.L1004ec9e:
	moveml	%fp@(-8),%d7/%a4	/* 1004ec9e:	4cee 1080 fff8 */
	unlk	%fp	/* 1004eca4:	4e5e */
	rts	/* 1004eca6:	4e75 */

sub_1004eca8:
	linkw	%fp,#-4	/* 1004eca8:	4e56 fffc */
	moveml	%d6-%d7/%a3-%a4,%sp@-	/* 1004ecac:	48e7 0318 */
	moveal	%fp@(8),%a4	/* 1004ecb0:	286e 0008 */
	tstl	%a4@(12)	/* 1004ecb4:	4aac 000c */
	beqs	.L1004ed10	/* 1004ecb8:	6756 */
	moveal	%a4@(12),%a3	/* 1004ecba:	266c 000c */
	moveal	%a3,%a0	/* 1004ecbe:	204b */
	.short	0xa025	/* 1004ecc0:	a025 */
	moveq	#4,%d1	/* 1004ecc2:	7204 */
	jsr	%pc@(sub_10049c48)	/* 1004ecc4:	4eba af82 */
	movew	%a4@(16),%d1	/* 1004ecc8:	322c 0010 */
	extl	%d1	/* 1004eccc:	48c1 */
	cmpl	%d1,%d0	/* 1004ecce:	b081 */
	bgts	.L1004ecec	/* 1004ecd0:	6e1a */
	moveal	%a4@(12),%a3	/* 1004ecd2:	266c 000c */
	moveq	#32,%d6	/* 1004ecd6:	7c20 */
	movel	%d6,%d7	/* 1004ecd8:	2e06 */
	asll	#2,%d7	/* 1004ecda:	e587 */
	moveal	%a3,%a0	/* 1004ecdc:	204b */
	.short	0xa025	/* 1004ecde:	a025 */
	addl	%d7,%d0	/* 1004ece0:	d087 */
	movel	%d0,%sp@-	/* 1004ece2:	2f00 */
	movel	%a3,%sp@-	/* 1004ece4:	2f0b */
	jsr	%pc@(sub_1004a228)	/* 1004ece6:	4eba b540 */
	addqw	#8,%sp	/* 1004ecea:	504f */

.L1004ecec:
	movew	%a4@(16),%d0	/* 1004ecec:	302c 0010 */
	extl	%d0	/* 1004ecf0:	48c0 */
	movel	%d0,%fp@(-4)	/* 1004ecf2:	2d40 fffc */
	subql	#4,%sp	/* 1004ecf6:	598f */
	moveal	%a4@(12),%a0	/* 1004ecf8:	206c 000c */
	movel	%a0@,%sp@-	/* 1004ecfc:	2f10 */
	jsr	%pc@(sub_1004aac4)	/* 1004ecfe:	4eba bdc4 */
	moveal	%sp@+,%a0	/* 1004ed02:	205f */
	movel	%fp@(-4),%d0	/* 1004ed04:	202e fffc */
	asll	#2,%d0	/* 1004ed08:	e580 */
	movel	%fp@(12),%a0@(0,%d0:l)	/* 1004ed0a:	21ae 000c 0800 */

.L1004ed10:
	addqw	#1,%a4@(16)	/* 1004ed10:	526c 0010 */
	moveml	%fp@(-20),%d6-%d7/%a3-%a4	/* 1004ed14:	4cee 18c0 ffec */
	unlk	%fp	/* 1004ed1a:	4e5e */
	rts	/* 1004ed1c:	4e75 */

sub_1004ed1e:
	linkw	%fp,#0	/* 1004ed1e:	4e56 0000 */
	moveml	%d7/%a4,%sp@-	/* 1004ed22:	48e7 0108 */
	movel	%fp@(12),%d7	/* 1004ed26:	2e2e 000c */
	moveal	%fp@(8),%a4	/* 1004ed2a:	286e 0008 */
	movel	%d7,%sp@-	/* 1004ed2e:	2f07 */
	movel	%a4,%sp@-	/* 1004ed30:	2f0c */
	jsr	%pc@(sub_1004ebba)	/* 1004ed32:	4eba fe86 */
	movel	%d7,%sp@-	/* 1004ed36:	2f07 */
	movel	%a4,%sp@-	/* 1004ed38:	2f0c */
	jsr	%pc@(sub_1004eca8)	/* 1004ed3a:	4eba ff6c */
	moveml	%fp@(-8),%d7/%a4	/* 1004ed3e:	4cee 1080 fff8 */
	unlk	%fp	/* 1004ed44:	4e5e */
	rts	/* 1004ed46:	4e75 */

sub_1004ed48:
	linkw	%fp,#-8	/* 1004ed48:	4e56 fff8 */
	moveml	%d3/%d7/%a3-%a4,%sp@-	/* 1004ed4c:	48e7 1118 */
	moveal	%fp@(8),%a4	/* 1004ed50:	286e 0008 */
	moveq	#0,%d3	/* 1004ed54:	7600 */
	tstl	%a4@(12)	/* 1004ed56:	4aac 000c */
	beqs	.L1004ed80	/* 1004ed5a:	6724 */
	tstw	%a4@(16)	/* 1004ed5c:	4a6c 0010 */
	bles	.L1004ed80	/* 1004ed60:	6f1e */
	moveal	%a4@(12),%a3	/* 1004ed62:	266c 000c */
	movel	%d3,%sp@-	/* 1004ed66:	2f03 */
	moveal	%a3,%a0	/* 1004ed68:	204b */
	.short	0xa025	/* 1004ed6a:	a025 */
	movel	%sp@+,%d3	/* 1004ed6c:	261f */
	moveq	#4,%d1	/* 1004ed6e:	7204 */
	jsr	%pc@(sub_10049c48)	/* 1004ed70:	4eba aed6 */
	movew	%a4@(16),%d1	/* 1004ed74:	322c 0010 */
	extl	%d1	/* 1004ed78:	48c1 */
	cmpl	%d1,%d0	/* 1004ed7a:	b081 */
	blts	.L1004ed80	/* 1004ed7c:	6d02 */
	moveq	#1,%d3	/* 1004ed7e:	7601 */

.L1004ed80:
	tstb	%d3	/* 1004ed80:	4a03 */
	beqs	.L1004edaa	/* 1004ed82:	6726 */
	movew	%a4@(16),%d0	/* 1004ed84:	302c 0010 */
	extl	%d0	/* 1004ed88:	48c0 */
	subql	#1,%d0	/* 1004ed8a:	5380 */
	movel	%d0,%fp@(-4)	/* 1004ed8c:	2d40 fffc */
	subql	#4,%sp	/* 1004ed90:	598f */
	moveal	%a4@(12),%a0	/* 1004ed92:	206c 000c */
	movel	%a0@,%sp@-	/* 1004ed96:	2f10 */
	jsr	%pc@(sub_1004aac4)	/* 1004ed98:	4eba bd2a */
	moveal	%sp@+,%a0	/* 1004ed9c:	205f */
	movel	%fp@(-4),%d0	/* 1004ed9e:	202e fffc */
	asll	#2,%d0	/* 1004eda2:	e580 */
	movel	%a0@(0,%d0:l),%d0	/* 1004eda4:	2030 0800 */
	bras	.L1004edac	/* 1004eda8:	6002 */

.L1004edaa:
	moveq	#-1,%d0	/* 1004edaa:	70ff */

.L1004edac:
	movel	%d0,%d7	/* 1004edac:	2e00 */
	tstw	%a4@(16)	/* 1004edae:	4a6c 0010 */
	bles	.L1004edbe	/* 1004edb2:	6f0a */
	subqw	#1,%a4@(16)	/* 1004edb4:	536c 0010 */
	movew	%a4@(16),%d0	/* 1004edb8:	302c 0010 */
	bras	.L1004edc0	/* 1004edbc:	6002 */

.L1004edbe:
	moveq	#0,%d0	/* 1004edbe:	7000 */

.L1004edc0:
	moveq	#0,%d3	/* 1004edc0:	7600 */
	tstl	%a4@(12)	/* 1004edc2:	4aac 000c */
	beqs	.L1004edec	/* 1004edc6:	6724 */
	tstw	%a4@(16)	/* 1004edc8:	4a6c 0010 */
	bles	.L1004edec	/* 1004edcc:	6f1e */
	moveal	%a4@(12),%a3	/* 1004edce:	266c 000c */
	movel	%d3,%sp@-	/* 1004edd2:	2f03 */
	moveal	%a3,%a0	/* 1004edd4:	204b */
	.short	0xa025	/* 1004edd6:	a025 */
	movel	%sp@+,%d3	/* 1004edd8:	261f */
	moveq	#4,%d1	/* 1004edda:	7204 */
	jsr	%pc@(sub_10049c48)	/* 1004eddc:	4eba ae6a */
	movew	%a4@(16),%d1	/* 1004ede0:	322c 0010 */
	extl	%d1	/* 1004ede4:	48c1 */
	cmpl	%d1,%d0	/* 1004ede6:	b081 */
	blts	.L1004edec	/* 1004ede8:	6d02 */
	moveq	#1,%d3	/* 1004edea:	7601 */

.L1004edec:
	tstb	%d3	/* 1004edec:	4a03 */
	beqs	.L1004ee16	/* 1004edee:	6726 */
	movew	%a4@(16),%d0	/* 1004edf0:	302c 0010 */
	extl	%d0	/* 1004edf4:	48c0 */
	subql	#1,%d0	/* 1004edf6:	5380 */
	movel	%d0,%fp@(-8)	/* 1004edf8:	2d40 fff8 */
	subql	#4,%sp	/* 1004edfc:	598f */
	moveal	%a4@(12),%a0	/* 1004edfe:	206c 000c */
	movel	%a0@,%sp@-	/* 1004ee02:	2f10 */
	jsr	%pc@(sub_1004aac4)	/* 1004ee04:	4eba bcbe */
	moveal	%sp@+,%a0	/* 1004ee08:	205f */
	movel	%fp@(-8),%d0	/* 1004ee0a:	202e fff8 */
	asll	#2,%d0	/* 1004ee0e:	e580 */
	movel	%a0@(0,%d0:l),%d0	/* 1004ee10:	2030 0800 */
	bras	.L1004ee18	/* 1004ee14:	6002 */

.L1004ee16:
	moveq	#-1,%d0	/* 1004ee16:	70ff */

.L1004ee18:
	movel	%d0,%sp@-	/* 1004ee18:	2f00 */
	movel	%a4,%sp@-	/* 1004ee1a:	2f0c */
	jsr	%pc@(sub_1004ebba)	/* 1004ee1c:	4eba fd9c */
	movel	%d7,%d0	/* 1004ee20:	2007 */
	addqw	#8,%sp	/* 1004ee22:	504f */
	moveml	%fp@(-24),%d3/%d7/%a3-%a4	/* 1004ee24:	4cee 1888 ffe8 */
	unlk	%fp	/* 1004ee2a:	4e5e */
	rts	/* 1004ee2c:	4e75 */

sub_1004ee2e:
	linkw	%fp,#0	/* 1004ee2e:	4e56 0000 */
	moveml	%d7/%a3-%a4,%sp@-	/* 1004ee32:	48e7 0118 */
	moveal	%fp@(8),%a4	/* 1004ee36:	286e 0008 */
	tstl	%a4@(8)	/* 1004ee3a:	4aac 0008 */
	beqs	.L1004ee4e	/* 1004ee3e:	670e */
	movel	%a4@(4),%d7	/* 1004ee40:	2e2c 0004 */
	moveal	%a4@(8),%a0	/* 1004ee44:	206c 0008 */
	moveal	%a0@,%a0	/* 1004ee48:	2050 */
	movel	%d7,%a0@(16)	/* 1004ee4a:	2147 0010 */

.L1004ee4e:
	movel	%fp@(16),%sp@-	/* 1004ee4e:	2f2e 0010 */
	movel	%fp@(12),%sp@-	/* 1004ee52:	2f2e 000c */
	movel	%a4,%sp@-	/* 1004ee56:	2f0c */
	jsr	%pc@(sub_10049c60)	/* 1004ee58:	4eba ae06 */
	tstl	%a4@(8)	/* 1004ee5c:	4aac 0008 */
	lea	%sp@(12),%sp	/* 1004ee60:	4fef 000c */
	beqs	.L1004ee88	/* 1004ee64:	6722 */
	moveal	%a4@(8),%a3	/* 1004ee66:	266c 0008 */
	movel	%a4@(4),%d7	/* 1004ee6a:	2e2c 0004 */
	moveal	%a3@,%a0	/* 1004ee6e:	2053 */
	movel	%a0@(16),%sp@-	/* 1004ee70:	2f28 0010 */
	movel	%fp@(20),%sp@-	/* 1004ee74:	2f2e 0014 */
	movel	%a3,%sp@-	/* 1004ee78:	2f0b */
	jsr	%pc@(sub_1004f376)	/* 1004ee7a:	4eba 04fa */
	moveal	%a3@,%a0	/* 1004ee7e:	2053 */
	movel	%d7,%a0@(16)	/* 1004ee80:	2147 0010 */
	lea	%sp@(12),%sp	/* 1004ee84:	4fef 000c */

.L1004ee88:
	movel	%a4,%d0	/* 1004ee88:	200c */
	moveml	%fp@(-12),%d7/%a3-%a4	/* 1004ee8a:	4cee 1880 fff4 */
	unlk	%fp	/* 1004ee90:	4e5e */
	rts	/* 1004ee92:	4e75 */
