...
sub_1004f756:
	linkw	%fp,#-4	/* 1004f756:	4e56 fffc */
	moveml	%d6-%d7/%a3-%a4,%sp@-	/* 1004f75a:	48e7 0318 */
	movel	%fp@(20),%d7	/* 1004f75e:	2e2e 0014 */
	moveal	%fp@(16),%a3	/* 1004f762:	266e 0010 */
	moveal	%fp@(8),%a4	/* 1004f766:	286e 0008 */
	pea	%fp@(-2)	/* 1004f76a:	486e fffe */
	pea	%fp@(-4)	/* 1004f76e:	486e fffc */
	movel	%a3,%sp@-	/* 1004f772:	2f0b */
	movel	%a4,%sp@-	/* 1004f774:	2f0c */
	jsr	%pc@(sub_1004f8ba)	/* 1004f776:	4eba 0142 */
	movew	%fp@(-2),%d6	/* 1004f77a:	3c2e fffe */
	subw	%fp@(-4),%d6	/* 1004f77e:	9c6e fffc */
	movew	%d6,%d1	/* 1004f782:	3206 */
	extl	%d1	/* 1004f784:	48c1 */
	lsll	#2,%d1	/* 1004f786:	e589 */
	movel	%d1,%d0	/* 1004f788:	2001 */
	lsll	#2,%d1	/* 1004f78a:	e589 */
	addl	%d0,%d1	/* 1004f78c:	d280 */
	addql	#2,%d1	/* 1004f78e:	5481 */
	cmpl	%d1,%d7	/* 1004f790:	be81 */
	bccs	.L1004f7a6	/* 1004f792:	6412 */
	movew	%d7,%d0	/* 1004f794:	3007 */
	subqw	#2,%d0	/* 1004f796:	5540 */
	extl	%d0	/* 1004f798:	48c0 */
	divsw	#20,%d0	/* 1004f79a:	81fc 0014 */
	addw	%fp@(-4),%d0	/* 1004f79e:	d06e fffc */
	movew	%d0,%fp@(-2)	/* 1004f7a2:	3d40 fffe */

.L1004f7a6:
	movel	%a3@,%sp@-	/* 1004f7a6:	2f13 */
	movew	%fp@(-2),%d0	/* 1004f7a8:	302e fffe */
	extl	%d0	/* 1004f7ac:	48c0 */
	movel	%d0,%sp@-	/* 1004f7ae:	2f00 */
	movew	%fp@(-4),%d0	/* 1004f7b0:	302e fffc */
	extl	%d0	/* 1004f7b4:	48c0 */
	movel	%d0,%sp@-	/* 1004f7b6:	2f00 */
	movel	%fp@(12),%sp@-	/* 1004f7b8:	2f2e 000c */
	movel	%a4,%sp@-	/* 1004f7bc:	2f0c */
	jsr	%pc@(sub_1004f806)	/* 1004f7be:	4eba 0046 */
	moveml	%fp@(-20),%d6-%d7/%a3-%a4	/* 1004f7c2:	4cee 18c0 ffec */
	unlk	%fp	/* 1004f7c8:	4e5e */
	rts	/* 1004f7ca:	4e75 */

sub_1004f7cc:
	linkw	%fp,#-4	/* 1004f7cc:	4e56 fffc */
	movel	%d7,%sp@-	/* 1004f7d0:	2f07 */
	pea	%fp@(-2)	/* 1004f7d2:	486e fffe */
	pea	%fp@(-4)	/* 1004f7d6:	486e fffc */
	movel	%fp@(12),%sp@-	/* 1004f7da:	2f2e 000c */
	movel	%fp@(8),%sp@-	/* 1004f7de:	2f2e 0008 */
	jsr	%pc@(sub_1004f8ba)	/* 1004f7e2:	4eba 00d6 */
	movew	%fp@(-2),%d7	/* 1004f7e6:	3e2e fffe */
	subw	%fp@(-4),%d7	/* 1004f7ea:	9e6e fffc */
	movew	%d7,%d1	/* 1004f7ee:	3207 */
	extl	%d1	/* 1004f7f0:	48c1 */
	lsll	#2,%d1	/* 1004f7f2:	e589 */
	movel	%d1,%d0	/* 1004f7f4:	2001 */
	lsll	#2,%d1	/* 1004f7f6:	e589 */
	addl	%d0,%d1	/* 1004f7f8:	d280 */
	addql	#2,%d1	/* 1004f7fa:	5481 */
	movel	%d1,%d0	/* 1004f7fc:	2001 */
	movel	%fp@(-8),%d7	/* 1004f7fe:	2e2e fff8 */
	unlk	%fp	/* 1004f802:	4e5e */
	rts	/* 1004f804:	4e75 */
...
sub_1004f8ba:
	linkw	%fp,#0	/* 1004f8ba:	4e56 0000 */
	moveml	%d5-%d7/%a2-%a4,%sp@-	/* 1004f8be:	48e7 0738 */
	moveal	%fp@(16),%a2	/* 1004f8c2:	246e 0010 */
	moveal	%fp@(12),%a3	/* 1004f8c6:	266e 000c */
	moveal	%fp@(8),%a4	/* 1004f8ca:	286e 0008 */
	moveal	%a4@,%a0	/* 1004f8ce:	2054 */
	tstw	%a0@(2)	/* 1004f8d0:	4a68 0002 */
	bgts	.L1004f8e2	/* 1004f8d4:	6e0c */
	moveal	%fp@(20),%a0	/* 1004f8d6:	206e 0014 */
	clrw	%a0@	/* 1004f8da:	4250 */
	clrw	%a2@	/* 1004f8dc:	4252 */
	braw	.L1004f9be	/* 1004f8de:	6000 00de */

.L1004f8e2:
	moveal	%a4@,%a0	/* 1004f8e2:	2054 */
	movel	%a3@,%d0	/* 1004f8e4:	2013 */
	cmpl	%a0@(16),%d0	/* 1004f8e6:	b0a8 0010 */
	bcss	.L1004f902	/* 1004f8ea:	6516 */
	movew	%a0@(2),%d0	/* 1004f8ec:	3028 0002 */
	subqw	#1,%d0	/* 1004f8f0:	5340 */
	movew	%d0,%a2@	/* 1004f8f2:	3480 */
	moveal	%a4@,%a0	/* 1004f8f4:	2054 */
	moveal	%fp@(20),%a1	/* 1004f8f6:	226e 0014 */
	movew	%a0@(2),%a1@	/* 1004f8fa:	32a8 0002 */
	braw	.L1004f9be	/* 1004f8fe:	6000 00be */

.L1004f902:
	tstl	%a3@(4)	/* 1004f902:	4aab 0004 */
	bhis	.L1004f916	/* 1004f906:	620e */
	clrw	%a2@	/* 1004f908:	4252 */
	moveal	%fp@(20),%a0	/* 1004f90a:	206e 0014 */
	movew	#1,%a0@	/* 1004f90e:	30bc 0001 */
	braw	.L1004f9be	/* 1004f912:	6000 00aa */

.L1004f916:
	clrw	%d7	/* 1004f916:	4247 */
	clrw	%d5	/* 1004f918:	4245 */
	moveal	%a4@,%a0	/* 1004f91a:	2054 */
	movew	%a0@(2),%d6	/* 1004f91c:	3c28 0002 */

.L1004f920:
	extl	%d5	/* 1004f920:	48c5 */
	extl	%d6	/* 1004f922:	48c6 */
	movel	%d5,%d0	/* 1004f924:	2005 */
	addl	%d6,%d0	/* 1004f926:	d086 */
	moveq	#2,%d1	/* 1004f928:	7202 */
	jsr	%pc@(sub_10049c48)	/* 1004f92a:	4eba a31c */
	movew	%d0,%d7	/* 1004f92e:	3e00 */
	extl	%d6	/* 1004f930:	48c6 */
	extl	%d5	/* 1004f932:	48c5 */
	movel	%d6,%d0	/* 1004f934:	2006 */
	subl	%d5,%d0	/* 1004f936:	9085 */
	moveq	#1,%d1	/* 1004f938:	7201 */
	cmpl	%d0,%d1	/* 1004f93a:	b280 */
	bges	.L1004f964	/* 1004f93c:	6c26 */
	extl	%d7	/* 1004f93e:	48c7 */
	subql	#4,%sp	/* 1004f940:	598f */
	moveal	%a4@,%a0	/* 1004f942:	2054 */
	moveal	%a0@(12),%a0	/* 1004f944:	2068 000c */
	movel	%a0@,%sp@-	/* 1004f948:	2f10 */
	jsr	%pc@(sub_1004aac4)	/* 1004f94a:	4eba b178 */
	moveal	%sp@+,%a0	/* 1004f94e:	205f */
	movel	%d7,%d0	/* 1004f950:	2007 */
	asll	#3,%d0	/* 1004f952:	e780 */
	movel	%a0@(4,%d0:l),%d0	/* 1004f954:	2030 0804 */
	cmpl	%a3@,%d0	/* 1004f958:	b093 */
	bhis	.L1004f960	/* 1004f95a:	6204 */
	movew	%d7,%d5	/* 1004f95c:	3a07 */
	bras	.L1004f920	/* 1004f95e:	60c0 */

.L1004f960:
	movew	%d7,%d6	/* 1004f960:	3c07 */
	bras	.L1004f920	/* 1004f962:	60bc */

.L1004f964:
	movew	%d7,%a2@	/* 1004f964:	3487 */
	movew	%d7,%d5	/* 1004f966:	3a07 */
	moveal	%a4@,%a0	/* 1004f968:	2054 */
	movew	%a0@(2),%d6	/* 1004f96a:	3c28 0002 */

.L1004f96e:
	extl	%d5	/* 1004f96e:	48c5 */
	extl	%d6	/* 1004f970:	48c6 */
	movel	%d5,%d0	/* 1004f972:	2005 */
	addl	%d6,%d0	/* 1004f974:	d086 */
	moveq	#2,%d1	/* 1004f976:	7202 */
	jsr	%pc@(sub_10049c48)	/* 1004f978:	4eba a2ce */
	movew	%d0,%d7	/* 1004f97c:	3e00 */
	extl	%d6	/* 1004f97e:	48c6 */
	extl	%d5	/* 1004f980:	48c5 */
	movel	%d6,%d0	/* 1004f982:	2006 */
	subl	%d5,%d0	/* 1004f984:	9085 */
	moveq	#1,%d1	/* 1004f986:	7201 */
	cmpl	%d0,%d1	/* 1004f988:	b280 */
	bges	.L1004f9b4	/* 1004f98a:	6c28 */
	extl	%d7	/* 1004f98c:	48c7 */
	subql	#4,%sp	/* 1004f98e:	598f */
	moveal	%a4@,%a0	/* 1004f990:	2054 */
	moveal	%a0@(12),%a0	/* 1004f992:	2068 000c */
	movel	%a0@,%sp@-	/* 1004f996:	2f10 */
	jsr	%pc@(sub_1004aac4)	/* 1004f998:	4eba b12a */
	moveal	%sp@+,%a0	/* 1004f99c:	205f */
	movel	%d7,%d0	/* 1004f99e:	2007 */
	asll	#3,%d0	/* 1004f9a0:	e780 */
	movel	%a0@(4,%d0:l),%d0	/* 1004f9a2:	2030 0804 */
	cmpl	%a3@(4),%d0	/* 1004f9a6:	b0ab 0004 */
	bccs	.L1004f9b0	/* 1004f9aa:	6404 */
	movew	%d7,%d5	/* 1004f9ac:	3a07 */
	bras	.L1004f96e	/* 1004f9ae:	60be */

.L1004f9b0:
	movew	%d7,%d6	/* 1004f9b0:	3c07 */
	bras	.L1004f96e	/* 1004f9b2:	60ba */

.L1004f9b4:
	movew	%d7,%d0	/* 1004f9b4:	3007 */
	addqw	#1,%d0	/* 1004f9b6:	5240 */
	moveal	%fp@(20),%a0	/* 1004f9b8:	206e 0014 */
	movew	%d0,%a0@	/* 1004f9bc:	3080 */

.L1004f9be:
	moveml	%fp@(-24),%d5-%d7/%a2-%a4	/* 1004f9be:	4cee 1ce0 ffe8 */
	unlk	%fp	/* 1004f9c4:	4e5e */
	rts	/* 1004f9c6:	4e75 */
...
sub_1004fc10:
	linkw	%fp,#-4	/* 1004fc10:	4e56 fffc */
	moveml	%d7/%a4,%sp@-	/* 1004fc14:	48e7 0108 */
	moveal	%fp@(8),%a4	/* 1004fc18:	286e 0008 */
	movew	%a4@(4),%d0	/* 1004fc1c:	302c 0004 */
	extl	%d0	/* 1004fc20:	48c0 */
	movel	%d0,%fp@(-4)	/* 1004fc22:	2d40 fffc */
	subql	#4,%sp	/* 1004fc26:	598f */
	moveal	%a4@,%a0	/* 1004fc28:	2054 */
	moveal	%a0@,%a0	/* 1004fc2a:	2050 */
	moveal	%a0@(12),%a0	/* 1004fc2c:	2068 000c */
	movel	%a0@,%sp@-	/* 1004fc30:	2f10 */
	jsr	%pc@(sub_1004aac4)	/* 1004fc32:	4eba ae90 */
	moveal	%sp@+,%a0	/* 1004fc36:	205f */
	movel	%fp@(-4),%d0	/* 1004fc38:	202e fffc */
	asll	#3,%d0	/* 1004fc3c:	e780 */
	movel	%a0@(0,%d0:l),%d7	/* 1004fc3e:	2e30 0800 */
	subql	#2,%sp	/* 1004fc42:	558f */
	subql	#4,%sp	/* 1004fc44:	598f */
	moveal	%a4@,%a0	/* 1004fc46:	2054 */
	moveal	%a0@,%a0	/* 1004fc48:	2050 */
	moveal	%a0@(8),%a0	/* 1004fc4a:	2068 0008 */
	movel	%a0@,%sp@-	/* 1004fc4e:	2f10 */
	jsr	%pc@(sub_1004aac4)	/* 1004fc50:	4eba ae72 */
	moveal	%sp@+,%a0	/* 1004fc54:	205f */
	movel	%d7,%d0	/* 1004fc56:	2007 */
	movel	%d0,%d1	/* 1004fc58:	2200 */
	muluw	#18,%d0	/* 1004fc5a:	c0fc 0012 */
	swap	%d1	/* 1004fc5e:	4841 */
	muluw	#18,%d1	/* 1004fc60:	c2fc 0012 */
	swap	%d1	/* 1004fc64:	4841 */
	clrw	%d1	/* 1004fc66:	4241 */
	addl	%d1,%d0	/* 1004fc68:	d081 */
	movew	%a0@(6,%d0:l),%sp@-	/* 1004fc6a:	3f30 0806 */
	movel	#-2113798138,%sp@-	/* 1004fc6e:	2f3c 8202 0006 */
	.short	0xa8b5	/* 1004fc74:	a8b5 */
	movew	%sp@+,%d0	/* 1004fc76:	301f */
	moveml	%fp@(-12),%d7/%a4	/* 1004fc78:	4cee 1080 fff4 */
	unlk	%fp	/* 1004fc7e:	4e5e */
	rts	/* 1004fc80:	4e75 */

sub_1004fc82:
	braw	sub_10050188	/* 1004fc82:	6000 0504 */

sub_1004fc86:
	linkw	%fp,#-312	/* 1004fc86:	4e56 fec8 */
	moveml	%d6-%d7/%a3-%a4,%sp@-	/* 1004fc8a:	48e7 0318 */
	moveal	%fp@(8),%a4	/* 1004fc8e:	286e 0008 */
	clrw	%fp@(-256)	/* 1004fc92:	426e ff00 */
	lea	%fp@(-256),%a0	/* 1004fc96:	41ee ff00 */
	jsr	%pc@(sub_1004958a)	/* 1004fc9a:	4eba 98ee */
	moveal	%d0,%a3	/* 1004fc9e:	2640 */
	moveal	%a3@,%a0	/* 1004fca0:	2053 */
	moveq	#0,%d7	/* 1004fca2:	7e00 */
	moveb	%a0@(404),%d7	/* 1004fca4:	1e28 0194 */
	movel	#128,%d0	/* 1004fca8:	203c 0000 0080 */
	andl	%d7,%d0	/* 1004fcae:	c087 */
	sne	%d0	/* 1004fcb0:	56c0 */
	andiw	#1,%d0	/* 1004fcb2:	0240 0001 */
	extl	%d0	/* 1004fcb6:	48c0 */
	moveal	%a4@,%a0	/* 1004fcb8:	2054 */
	moveb	%d0,%a0@(334)	/* 1004fcba:	1140 014e */
	moveq	#64,%d0	/* 1004fcbe:	7040 */
	andl	%d7,%d0	/* 1004fcc0:	c087 */
	sne	%d0	/* 1004fcc2:	56c0 */
	andiw	#1,%d0	/* 1004fcc4:	0240 0001 */
	extl	%d0	/* 1004fcc8:	48c0 */
	moveal	%a4@,%a0	/* 1004fcca:	2054 */
	moveb	%d0,%a0@(335)	/* 1004fccc:	1140 014f */
	moveal	%a4@,%a0	/* 1004fcd0:	2054 */
	moveq	#0,%d0	/* 1004fcd2:	7000 */
	movel	%d0,%a0@(326)	/* 1004fcd4:	2140 0146 */
	moveal	%a4@,%a0	/* 1004fcd8:	2054 */
	movel	%d0,%a0@(6)	/* 1004fcda:	2140 0006 */
	moveal	%a4@,%a0	/* 1004fcde:	2054 */
	movel	%fp@(12),%a0@(10)	/* 1004fce0:	216e 000c 000a */
	moveal	%a4@,%a0	/* 1004fce6:	2054 */
	movel	#1634952050,%a0@(14)	/* 1004fce8:	217c 6173 6372 */
		/* 1004fcee:	000e */
	moveal	%a4@,%a0	/* 1004fcf0:	2054 */
	movel	#1886610034,%a0@(18)	/* 1004fcf2:	217c 7073 6272 */
		/* 1004fcf8:	0012 */
	moveq	#30,%d0	/* 1004fcfa:	701e */
	movel	%d0,%sp@-	/* 1004fcfc:	2f00 */
	jsr	%pc@(sub_1004a176)	/* 1004fcfe:	4eba a476 */
	moveal	%a4@,%a0	/* 1004fd02:	2054 */
	movel	%d0,%a0@(2)	/* 1004fd04:	2140 0002 */
	jsr	%pc@(sub_1004aacc)	/* 1004fd08:	4eba adc2 */
	moveal	%d0,%a0	/* 1004fd0c:	2040 */
	movel	%a0@(88),%fp@(-308)	/* 1004fd0e:	2d68 0058 fecc */
	lea	%fp@(-308),%a0	/* 1004fd14:	41ee fecc */
	movel	%a0,%sp@-	/* 1004fd18:	2f08 */
	jsr	%pc@(sub_1004aacc)	/* 1004fd1a:	4eba adb0 */
	moveal	%sp@+,%a0	/* 1004fd1e:	205f */
	moveal	%d0,%a1	/* 1004fd20:	2240 */
	movel	%a0,%a1@(88)	/* 1004fd22:	2348 0058 */
	lea	%fp@(-308),%a0	/* 1004fd26:	41ee fecc */
	lea	%fp@(-304),%a0	/* 1004fd2a:	41ee fed0 */
	lea	%pc@(.L1004fd38),%a1	/* 1004fd2e:	43fa 0008 */
	moveml	%d2-%d7/%a1-%a4/%fp-%sp,%a0@	/* 1004fd32:	48d0 defc */
	moveq	#0,%d0	/* 1004fd36:	7000 */

.L1004fd38:
	movel	%d0,%d7	/* 1004fd38:	2e00 */
	addqw	#4,%sp	/* 1004fd3a:	584f */
	bnes	.L1004fd80	/* 1004fd3c:	6642 */
	moveal	%a4@,%a0	/* 1004fd3e:	2054 */
	moveal	%a0@(2),%a3	/* 1004fd40:	2668 0002 */
	moveq	#0,%d6	/* 1004fd44:	7c00 */
	moveal	%a3@,%a0	/* 1004fd46:	2053 */
	moveq	#0,%d0	/* 1004fd48:	7000 */
	movel	%d0,%a0@(6)	/* 1004fd4a:	2140 0006 */
	moveal	%a3@,%a0	/* 1004fd4e:	2053 */
	movel	%d6,%a0@(10)	/* 1004fd50:	2146 000a */
	movel	%d6,%d1	/* 1004fd54:	2206 */
	movel	%d1,%d0	/* 1004fd56:	2001 */
	muluw	#12,%d1	/* 1004fd58:	c2fc 000c */
	swap	%d0	/* 1004fd5c:	4840 */
	muluw	#12,%d0	/* 1004fd5e:	c0fc 000c */
	swap	%d0	/* 1004fd62:	4840 */
	clrw	%d0	/* 1004fd64:	4240 */
	addl	%d0,%d1	/* 1004fd66:	d280 */
	movel	%d1,%sp@-	/* 1004fd68:	2f01 */
	jsr	%pc@(sub_1004a176)	/* 1004fd6a:	4eba a40a */
	moveal	%a3@,%a0	/* 1004fd6e:	2053 */
	movel	%d0,%a0@(2)	/* 1004fd70:	2140 0002 */
	moveal	%a3@,%a0	/* 1004fd74:	2053 */
	moveq	#0,%d0	/* 1004fd76:	7000 */
	movel	%d0,%a0@(18)	/* 1004fd78:	2140 0012 */
	addqw	#4,%sp	/* 1004fd7c:	584f */
	bras	.L1004fdfc	/* 1004fd7e:	607c */

.L1004fd80:
	jsr	%pc@(sub_1004aacc)	/* 1004fd80:	4eba ad4a */
	moveal	%d0,%a0	/* 1004fd84:	2040 */
	movel	%fp@(-308),%a0@(88)	/* 1004fd86:	216e fecc 0058 */
	moveal	%a4@,%a0	/* 1004fd8c:	2054 */
	tstl	%a0@(2)	/* 1004fd8e:	4aa8 0002 */
	beqs	.L1004fde0	/* 1004fd92:	674c */
	moveal	%a0@(2),%a3	/* 1004fd94:	2668 0002 */
	moveal	%a3@,%a0	/* 1004fd98:	2053 */
	tstl	%a0@(18)	/* 1004fd9a:	4aa8 0012 */
	beqs	.L1004fdb2	/* 1004fd9e:	6712 */
	moveal	%a0@(18),%a0	/* 1004fda0:	2068 0012 */
	.short	0xa023	/* 1004fda4:	a023 */
	moveal	%a3@,%a0	/* 1004fda6:	2053 */
	moveq	#0,%d0	/* 1004fda8:	7000 */
	movel	%d0,%a0@(18)	/* 1004fdaa:	2140 0012 */
	moveq	#0,%d1	/* 1004fdae:	7200 */
	bras	.L1004fdb4	/* 1004fdb0:	6002 */

.L1004fdb2:
	moveq	#0,%d1	/* 1004fdb2:	7200 */

.L1004fdb4:
	moveal	%a3@,%a0	/* 1004fdb4:	2053 */
	tstl	%a0@(2)	/* 1004fdb6:	4aa8 0002 */
	beqs	.L1004fdce	/* 1004fdba:	6712 */
	moveal	%a0@(2),%a0	/* 1004fdbc:	2068 0002 */
	.short	0xa023	/* 1004fdc0:	a023 */
	moveal	%a3@,%a0	/* 1004fdc2:	2053 */
	moveq	#0,%d0	/* 1004fdc4:	7000 */
	movel	%d0,%a0@(2)	/* 1004fdc6:	2140 0002 */
	moveq	#0,%d1	/* 1004fdca:	7200 */
	bras	.L1004fdd0	/* 1004fdcc:	6002 */

.L1004fdce:
	moveq	#0,%d1	/* 1004fdce:	7200 */

.L1004fdd0:
	moveal	%a4@,%a0	/* 1004fdd0:	2054 */
	moveal	%a0@(2),%a0	/* 1004fdd2:	2068 0002 */
	.short	0xa023	/* 1004fdd6:	a023 */
	moveal	%a4@,%a0	/* 1004fdd8:	2054 */
	moveq	#0,%d0	/* 1004fdda:	7000 */
	movel	%d0,%a0@(2)	/* 1004fddc:	2140 0002 */

.L1004fde0:
	movel	%d7,%d0	/* 1004fde0:	2007 */
	movel	%d0,%fp@(-312)	/* 1004fde2:	2d40 fec8 */
	jsr	%pc@(sub_1004aacc)	/* 1004fde6:	4eba ace4 */
	moveal	%d0,%a0	/* 1004fdea:	2040 */
	moveal	%a0@(88),%a0	/* 1004fdec:	2068 0058 */
	addql	#4,%a0	/* 1004fdf0:	5888 */
	movel	%fp@(-312),%d0	/* 1004fdf2:	202e fec8 */
	moveml	%a0@,%d2-%d7/%a1-%a4/%fp-%sp	/* 1004fdf6:	4cd0 defc */
	jmp	%a1@	/* 1004fdfa:	4ed1 */

.L1004fdfc:
	moveq	#2,%d0	/* 1004fdfc:	7002 */
	movel	%d0,%sp@-	/* 1004fdfe:	2f00 */
	pea	%fp@(-308)	/* 1004fe00:	486e fecc */
	jsr	%pc@(sub_1004aac8)	/* 1004fe04:	4eba acc2 */
	moveal	%a4@,%a0	/* 1004fe08:	2054 */
	moveal	%a0@(2),%a3	/* 1004fe0a:	2668 0002 */
	subql	#4,%sp	/* 1004fe0e:	598f */
	moveal	%fp@(16),%a0	/* 1004fe10:	206e 0010 */
	movel	%a0@,%sp@-	/* 1004fe14:	2f10 */
	jsr	%pc@(sub_1004aac4)	/* 1004fe16:	4eba acac */
	moveal	%fp@(16),%a0	/* 1004fe1a:	206e 0010 */
	.short	0xa025	/* 1004fe1e:	a025 */
	movel	%d0,%sp@-	/* 1004fe20:	2f00 */
	movel	%a3,%sp@-	/* 1004fe22:	2f0b */
	jsr	%pc@(sub_1004e49e)	/* 1004fe24:	4eba e678 */
	moveal	%a4@,%a0	/* 1004fe28:	2054 */
	tstb	%a0@(335)	/* 1004fe2a:	4a28 014f */
	lea	%sp@(20),%sp	/* 1004fe2e:	4fef 0014 */
	beqs	.L1004fe46	/* 1004fe32:	6712 */
	pea	%pc@(.L1004fe6e)	/* 1004fe34:	487a 0038 */
	moveal	%a4@,%a0	/* 1004fe38:	2054 */
	pea	%a0@(336)	/* 1004fe3a:	4868 0150 */
	jsr	%pc@(sub_100489ec)	/* 1004fe3e:	4eba 8bac */
	addqw	#8,%sp	/* 1004fe42:	504f */
	bras	.L1004fe64	/* 1004fe44:	601e */

.L1004fe46:
	jsr	%pc@(sub_1004958a)	/* 1004fe46:	4eba 9742 */
	moveal	%d0,%a3	/* 1004fe4a:	2640 */
	jsr	%pc@(sub_1004a774)	/* 1004fe4c:	4eba a926 */
	moveal	%d0,%a0	/* 1004fe50:	2040 */
	lea	%a0@(468),%a0	/* 1004fe52:	41e8 01d4 */
	movel	%a0,%sp@-	/* 1004fe56:	2f08 */
	moveal	%a4@,%a0	/* 1004fe58:	2054 */
	pea	%a0@(336)	/* 1004fe5a:	4868 0150 */
	jsr	%pc@(sub_100489ec)	/* 1004fe5e:	4eba 8b8c */
	addqw	#8,%sp	/* 1004fe62:	504f */

.L1004fe64:
	moveml	%fp@(-328),%d6-%d7/%a3-%a4	/* 1004fe64:	4cee 18c0 feb8 */
	unlk	%fp	/* 1004fe6a:	4e5e */
	rts	/* 1004fe6c:	4e75 */
...
sub_1004fe70:
	...
	moveml	%d7/%a3-%a4,%sp@-	/* 1004fe74:	48e7 0118 */
	pea	%fp@(-1108)	/* 1004fe78:	486e fbac */
	jsr	%pc@(sub_10048a0c)	/* 1004fe7c:	4eba 8b8e */
	pea	%fp@(-554)	/* 1004fe80:	486e fdd6 */
	jsr	%pc@(sub_10048a0c)	/* 1004fe84:	4eba 8b86 */
	movel	%fp@(8),%sp@-	/* 1004fe88:	2f2e 0008 */
	jsr	%pc@(sub_10048a08)	/* 1004fe8c:	4eba 8b7a */
	moveal	%d0,%a0	/* 1004fe90:	2040 */
	moveal	%a0@,%a3	/* 1004fe92:	2650 */
	moveal	%a3,%a0	/* 1004fe94:	204b */
	addql	#4,%a0	/* 1004fe96:	5888 */
	movel	%a0@,%d7	/* 1004fe98:	2e10 */
	jsr	%pc@(sub_1004aacc)	/* 1004fe9a:	4eba ac30 */
	moveal	%d0,%a0	/* 1004fe9e:	2040 */
	moveal	%a0@(392),%a4	/* 1004fea0:	2868 0188 */
	moveal	%a4@,%a0	/* 1004fea4:	2054 */
	moveal	%a0,%a1	/* 1004fea6:	2248 */
	movel	%a0@(326),%d0	/* 1004fea8:	2028 0146 */
	lsll	#2,%d0	/* 1004feac:	e588 */
	movel	%d0,%d1	/* 1004feae:	2200 */
	lsll	#2,%d0	/* 1004feb0:	e588 */
	addl	%d1,%d0	/* 1004feb2:	d081 */
	moveal	%a1@(0xa,%d0:l),%a3	/* 1004feb4:	2671 080a */
	cmpil	#1885955192,%d7	/* 1004feb8:	0c87 7069 6478 */
	lea	%sp@(12),%sp	/* 1004febe:	4fef 000c */
	bnes	.L1004feca	/* 1004fec2:	6606 */
	movel	#1768842360,%d7	/* 1004fec4:	2e3c 696e 6478 */

.L1004feca:
	movel	#1801876077,%sp@-	/* 1004feca:	2f3c 6b66 726d */
	moveq	#0,%d0	/* 1004fed0:	7000 */
	movel	%d0,%sp@-	/* 1004fed2:	2f00 */
	movel	%d7,%sp@-	/* 1004fed4:	2f07 */
	moveq	#6,%d1	/* 1004fed6:	7206 */
	movel	%d1,%sp@-	/* 1004fed8:	2f01 */
	pea	%fp@(-1108)	/* 1004feda:	486e fbac */
	jsr	%pc@(sub_10048a04)	/* 1004fede:	4eba 8b24 */
	pea	%fp@(-1108)	/* 1004fee2:	486e fbac */
	pea	%fp@(-1108)	/* 1004fee6:	486e fbac */
	movel	%a3,%sp@-	/* 1004feea:	2f0b */
	jsr	%pc@(sub_1004a17a)	/* 1004feec:	4eba a28c */
	tstb	%d0	/* 1004fef0:	4a00 */
	lea	%sp@(32),%sp	/* 1004fef2:	4fef 0020 */
	beqs	.L1004ff18	/* 1004fef6:	6720 */
	movel	%d7,%sp@-	/* 1004fef8:	2f07 */
	movel	#1801876077,%sp@-	/* 1004fefa:	2f3c 6b66 726d */
	jsr	%pc@(sub_10049c54)	/* 1004ff00:	4eba 9d52 */
	jsr	%pc@(sub_1004aacc)	/* 1004ff04:	4eba abc6 */
	moveal	%d0,%a0	/* 1004ff08:	2040 */
	lea	%a0@(464),%a3	/* 1004ff0a:	47e8 01d0 */
	subql	#4,%a3@	/* 1004ff0e:	5993 */
	moveal	%a3@,%a0	/* 1004ff10:	2053 */
	movel	%a0@,%d0	/* 1004ff12:	2010 */
	addqw	#8,%sp	/* 1004ff14:	504f */
	bras	.L1004ff24	/* 1004ff16:	600c */

.L1004ff18:
	movel	#-10002,%sp@-	/* 1004ff18:	2f3c ffff d8ee */
	jsr	%pc@(sub_100489fc)	/* 1004ff1e:	4eba 8adc */
	addqw	#4,%sp	/* 1004ff22:	584f */

.L1004ff24:
	moveml	%fp@(-1120),%d7/%a3-%a4	/* 1004ff24:	4cee 1880 fba0 */
	unlk	%fp	/* 1004ff2a:	4e5e */
	rts	/* 1004ff2c:	4e75 */

sub_1004ff2e:
	linkw	%fp,#0	/* 1004ff2e:	4e56 0000 */
	movel	%fp@(8),%sp@-	/* 1004ff32:	2f2e 0008 */
	jsr	%pc@(sub_1004aacc)	/* 1004ff36:	4eba ab94 */
	moveal	%d0,%a0	/* 1004ff3a:	2040 */
	movel	%a0@(392),%sp@-	/* 1004ff3c:	2f28 0188 */
	jsr	%pc@(sub_1004ffb0)	/* 1004ff40:	4eba 006e */
	unlk	%fp	/* 1004ff44:	4e5e */
	rts	/* 1004ff46:	4e75 */

sub_1004ff48:
	linkw	%fp,#0	/* 1004ff48:	4e56 0000 */
	movel	%fp@(8),%sp@-	/* 1004ff4c:	2f2e 0008 */
	jsr	%pc@(sub_1004aacc)	/* 1004ff50:	4eba ab7a */
	moveal	%d0,%a0	/* 1004ff54:	2040 */
	movel	%a0@(392),%sp@-	/* 1004ff56:	2f28 0188 */
	jsr	%pc@(sub_1005003a)	/* 1004ff5a:	4eba 00de */
	unlk	%fp	/* 1004ff5e:	4e5e */
	rts	/* 1004ff60:	4e75 */
...
sub_1004ff96:
	linkw	%fp,#0	/* 1004ff96:	4e56 0000 */
	movel	%fp@(8),%sp@-	/* 1004ff9a:	2f2e 0008 */
	jsr	%pc@(sub_1004aacc)	/* 1004ff9e:	4eba ab2c */
	moveal	%d0,%a0	/* 1004ffa2:	2040 */
	movel	%a0@(392),%sp@-	/* 1004ffa4:	2f28 0188 */
	jsr	%pc@(sub_10050380)	/* 1004ffa8:	4eba 03d6 */
	unlk	%fp	/* 1004ffac:	4e5e */
	rts	/* 1004ffae:	4e75 */

sub_1004ffb0:
	linkw	%fp,#0	/* 1004ffb0:	4e56 0000 */
	movel	%a4,%sp@-	/* 1004ffb4:	2f0c */
	moveal	%fp@(8),%a4	/* 1004ffb6:	286e 0008 */
	moveal	%a4@,%a0	/* 1004ffba:	2054 */
	moveq	#15,%d0	/* 1004ffbc:	700f */
	cmpl	%a0@(326),%d0	/* 1004ffbe:	b0a8 0146 */
	bgts	.L1004ffd0	/* 1004ffc2:	6e0c */
	movel	#-2760,%sp@-	/* 1004ffc4:	2f3c ffff f538 */
	jsr	%pc@(sub_100489fc)	/* 1004ffca:	4eba 8a30 */
	addqw	#4,%sp	/* 1004ffce:	584f */

.L1004ffd0:
	moveal	%a4@,%a0	/* 1004ffd0:	2054 */
	addql	#1,%a0@(326)	/* 1004ffd2:	52a8 0146 */
	moveal	%a4@,%a0	/* 1004ffd6:	2054 */
	moveal	%a0,%a1	/* 1004ffd8:	2248 */
	movel	%a0@(326),%d0	/* 1004ffda:	2028 0146 */
	lsll	#2,%d0	/* 1004ffde:	e588 */
	movel	%d0,%d1	/* 1004ffe0:	2200 */
	lsll	#2,%d0	/* 1004ffe2:	e588 */
	addl	%d1,%d0	/* 1004ffe4:	d081 */
	moveq	#0,%d1	/* 1004ffe6:	7200 */
	movel	%d1,%a1@(6,%d0:l)	/* 1004ffe8:	2381 0806 */
	moveal	%a4@,%a0	/* 1004ffec:	2054 */
	moveal	%a0,%a1	/* 1004ffee:	2248 */
	movel	%a0@(326),%d0	/* 1004fff0:	2028 0146 */
	lsll	#2,%d0	/* 1004fff4:	e588 */
	movel	%d0,%d2	/* 1004fff6:	2400 */
	lsll	#2,%d0	/* 1004fff8:	e588 */
	addl	%d2,%d0	/* 1004fffa:	d082 */
	movel	%fp@(12),%a1@(0xa,%d0:l)	/* 1004fffc:	23ae 000c 080a */
	moveal	%a4@,%a0	/* 10050002:	2054 */
	moveal	%a0,%a1	/* 10050004:	2248 */
	movel	%a0@(326),%d0	/* 10050006:	2028 0146 */
	lsll	#2,%d0	/* 1005000a:	e588 */
	movel	%d0,%d2	/* 1005000c:	2400 */
	lsll	#2,%d0	/* 1005000e:	e588 */
	addl	%d2,%d0	/* 10050010:	d082 */
	movel	#1634952050,%a1@(0xe,%d0:l)	/* 10050012:	23bc 6173 6372 */
		/* 10050018:	080e */
	moveal	%a4@,%a0	/* 1005001a:	2054 */
	moveal	%a0,%a1	/* 1005001c:	2248 */
	movel	%a0@(326),%d0	/* 1005001e:	2028 0146 */
	lsll	#2,%d0	/* 10050022:	e588 */
	movel	%d0,%d2	/* 10050024:	2400 */
	lsll	#2,%d0	/* 10050026:	e588 */
	addl	%d2,%d0	/* 10050028:	d082 */
	movel	#1886610034,%a1@(0x12,%d0:l)	/* 1005002a:	23bc 7073 6272 */
		/* 10050030:	0812 */
	moveal	%fp@(-4),%a4	/* 10050032:	286e fffc */
	unlk	%fp	/* 10050036:	4e5e */
	rts	/* 10050038:	4e75 */

sub_1005003a:
	linkw	%fp,#-16	/* 1005003a:	4e56 fff0 */
	moveml	%a2-%a4,%sp@-	/* 1005003e:	48e7 0038 */
	moveal	%fp@(12),%a3	/* 10050042:	266e 000c */
	moveal	%fp@(8),%a4	/* 10050046:	286e 0008 */
	movel	%a3,%d0	/* 1005004a:	200b */
	bnes	.L10050060	/* 1005004c:	6612 */
	movel	#1634952050,%fp@(-8)	/* 1005004e:	2d7c 6173 6372 */
		/* 10050054:	fff8 */
	movel	#1886610034,%fp@(-4)	/* 10050056:	2d7c 7073 6272 */
		/* 1005005c:	fffc */
	bras	.L1005008a	/* 1005005e:	602a */

.L10050060:
	movel	%a3,%sp@-	/* 10050060:	2f0b */
	jsr	%pc@(sub_10048a08)	/* 10050062:	4eba 89a4 */
	moveal	%d0,%a0	/* 10050066:	2040 */
	moveal	%a0@,%a0	/* 10050068:	2050 */
	movel	%a0,%fp@(-16)	/* 1005006a:	2d48 fff0 */
	addql	#4,%a0	/* 1005006e:	5888 */
	movel	%a0@,%fp@(-8)	/* 10050070:	2d50 fff8 */
	movel	%a3,%sp@-	/* 10050074:	2f0b */
	jsr	%pc@(sub_10048a08)	/* 10050076:	4eba 8990 */
	moveal	%d0,%a0	/* 1005007a:	2040 */
	moveal	%a0@,%a0	/* 1005007c:	2050 */
	movel	%a0,%fp@(-12)	/* 1005007e:	2d48 fff4 */
	addql	#8,%a0	/* 10050082:	5088 */
	movel	%a0@,%fp@(-4)	/* 10050084:	2d50 fffc */
	addqw	#8,%sp	/* 10050088:	504f */

.L1005008a:
	moveal	%a4@,%a0	/* 1005008a:	2054 */
	moveal	%a0,%a1	/* 1005008c:	2248 */
	movel	%a0@(326),%d0	/* 1005008e:	2028 0146 */
	lsll	#2,%d0	/* 10050092:	e588 */
	movel	%d0,%d1	/* 10050094:	2200 */
	lsll	#2,%d0	/* 10050096:	e588 */
	addl	%d1,%d0	/* 10050098:	d081 */
	movel	%a1@(0xe,%d0:l),%d0	/* 1005009a:	2031 080e */
	cmpl	%fp@(-8),%d0	/* 1005009e:	b0ae fff8 */
	bnes	.L100500d8	/* 100500a2:	6634 */
	moveal	%a4@,%a0	/* 100500a4:	2054 */
	moveal	%a0,%a1	/* 100500a6:	2248 */
	movel	%a0@(326),%d0	/* 100500a8:	2028 0146 */
	lsll	#2,%d0	/* 100500ac:	e588 */
	movel	%d0,%d1	/* 100500ae:	2200 */
	lsll	#2,%d0	/* 100500b0:	e588 */
	addl	%d1,%d0	/* 100500b2:	d081 */
	movel	%a1@(0x12,%d0:l),%d0	/* 100500b4:	2031 0812 */
	cmpl	%fp@(-4),%d0	/* 100500b8:	b0ae fffc */
	bnes	.L100500d8	/* 100500bc:	661a */
	moveal	%a4@,%a0	/* 100500be:	2054 */
	moveal	%a0,%a1	/* 100500c0:	2248 */
	movel	%a0@(326),%d0	/* 100500c2:	2028 0146 */
	lsll	#2,%d0	/* 100500c6:	e588 */
	movel	%d0,%d1	/* 100500c8:	2200 */
	lsll	#2,%d0	/* 100500ca:	e588 */
	addl	%d1,%d0	/* 100500cc:	d081 */
	movel	%a1@(6,%d0:l),%d1	/* 100500ce:	2231 0806 */
	addql	#1,%a1@(6,%d0:l)	/* 100500d2:	52b1 0806 */
	bras	.L1005014c	/* 100500d6:	6074 */

.L100500d8:
	moveal	%a4@,%a0	/* 100500d8:	2054 */
	moveq	#15,%d0	/* 100500da:	700f */
	cmpl	%a0@(326),%d0	/* 100500dc:	b0a8 0146 */
	bgts	.L100500ee	/* 100500e0:	6e0c */
	movel	#-2760,%sp@-	/* 100500e2:	2f3c ffff f538 */
	jsr	%pc@(sub_100489fc)	/* 100500e8:	4eba 8912 */
	addqw	#4,%sp	/* 100500ec:	584f */

.L100500ee:
	moveal	%a4@,%a0	/* 100500ee:	2054 */
	addql	#1,%a0@(326)	/* 100500f0:	52a8 0146 */
	moveal	%a4@,%a0	/* 100500f4:	2054 */
	moveal	%a0,%a1	/* 100500f6:	2248 */
	movel	%a0@(326),%d0	/* 100500f8:	2028 0146 */
	lsll	#2,%d0	/* 100500fc:	e588 */
	movel	%d0,%d1	/* 100500fe:	2200 */
	lsll	#2,%d0	/* 10050100:	e588 */
	addl	%d1,%d0	/* 10050102:	d081 */
	moveq	#0,%d1	/* 10050104:	7200 */
	movel	%d1,%a1@(6,%d0:l)	/* 10050106:	2381 0806 */
	moveal	%a4@,%a3	/* 1005010a:	2654 */
	movel	%a3@(326),%d0	/* 1005010c:	202b 0146 */
	subql	#1,%d0	/* 10050110:	5380 */
	lsll	#2,%d0	/* 10050112:	e588 */
	movel	%d0,%d2	/* 10050114:	2400 */
	lsll	#2,%d0	/* 10050116:	e588 */
	addl	%d2,%d0	/* 10050118:	d082 */
	moveal	%a3@(0xa,%d0:l),%a2	/* 1005011a:	2473 080a */
	moveal	%a4@,%a0	/* 1005011e:	2054 */
	moveal	%a0,%a1	/* 10050120:	2248 */
	movel	%a0@(326),%d0	/* 10050122:	2028 0146 */
	lsll	#2,%d0	/* 10050126:	e588 */
	movel	%d0,%d2	/* 10050128:	2400 */
	lsll	#2,%d0	/* 1005012a:	e588 */
	addl	%d2,%d0	/* 1005012c:	d082 */
	movel	%a2,%a1@(0xa,%d0:l)	/* 1005012e:	238a 080a */
	moveal	%a4@,%a3	/* 10050132:	2654 */
	movel	%a3@(326),%d0	/* 10050134:	202b 0146 */
	lsll	#2,%d0	/* 10050138:	e588 */
	movel	%d0,%d2	/* 1005013a:	2400 */
	lsll	#2,%d0	/* 1005013c:	e588 */
	addl	%d2,%d0	/* 1005013e:	d082 */
	lea	%fp@(-8),%a0	/* 10050140:	41ee fff8 */
	lea	%a3@(0xe,%d0:l),%a1	/* 10050144:	43f3 080e */
	movel	%a0@+,%a1@+	/* 10050148:	22d8 */
	movel	%a0@+,%a1@+	/* 1005014a:	22d8 */

.L1005014c:
	moveml	%fp@(-28),%a2-%a4	/* 1005014c:	4cee 1c00 ffe4 */
	unlk	%fp	/* 10050152:	4e5e */
	rts	/* 10050154:	4e75 */

sub_10050156:
	linkw	%fp,#0	/* 10050156:	4e56 0000 */
	movel	%a4,%sp@-	/* 1005015a:	2f0c */
	moveal	%fp@(8),%a4	/* 1005015c:	286e 0008 */
	moveal	%a4@,%a0	/* 10050160:	2054 */
	moveal	%a0,%a1	/* 10050162:	2248 */
	movel	%a0@(326),%d0	/* 10050164:	2028 0146 */
	lsll	#2,%d0	/* 10050168:	e588 */
	movel	%d0,%d1	/* 1005016a:	2200 */
	lsll	#2,%d0	/* 1005016c:	e588 */
	addl	%d1,%d0	/* 1005016e:	d081 */
	subql	#1,%a1@(6,%d0:l)	/* 10050170:	53b1 0806 */
	tstl	%a1@(6,%d0:l)	/* 10050174:	4ab1 0806 */
	bges	.L10050180	/* 10050178:	6c06 */
	moveal	%a4@,%a0	/* 1005017a:	2054 */
	subql	#1,%a0@(326)	/* 1005017c:	53a8 0146 */

.L10050180:
	moveal	%fp@(-4),%a4	/* 10050180:	286e fffc */
	unlk	%fp	/* 10050184:	4e5e */
	rts	/* 10050186:	4e75 */

sub_10050188:
	linkw	%fp,#-8	/* 10050188:	4e56 fff8 */
	moveml	%a3-%a4,%sp@-	/* 1005018c:	48e7 0018 */
	moveal	%fp@(8),%a4	/* 10050190:	286e 0008 */
	moveal	%a4@,%a3	/* 10050194:	2654 */
	movel	%a3@(326),%d0	/* 10050196:	202b 0146 */
	lsll	#2,%d0	/* 1005019a:	e588 */
	movel	%d0,%d1	/* 1005019c:	2200 */
	lsll	#2,%d0	/* 1005019e:	e588 */
	addl	%d1,%d0	/* 100501a0:	d081 */
	lea	%a3@(0xe,%d0:l),%a0	/* 100501a2:	41f3 080e */
	lea	%fp@(-8),%a1	/* 100501a6:	43ee fff8 */
	movel	%a0@+,%a1@+	/* 100501aa:	22d8 */
	movel	%a0@+,%a1@+	/* 100501ac:	22d8 */
	movel	#36864,%sp@-	/* 100501ae:	2f3c 0000 9000 */
	movel	#707406378,%sp@-	/* 100501b4:	2f3c 2a2a 2a2a */
	moveq	#0,%d0	/* 100501ba:	7000 */
	movel	%d0,%sp@-	/* 100501bc:	2f00 */
	movel	#707406378,%sp@-	/* 100501be:	2f3c 2a2a 2a2a */
	movel	%fp@(-4),%sp@-	/* 100501c4:	2f2e fffc */
	movel	%fp@(-8),%sp@-	/* 100501c8:	2f2e fff8 */
	jsr	%pc@(sub_10049124)	/* 100501cc:	4eba 8f56 */
	jsr	%pc@(sub_1004aacc)	/* 100501d0:	4eba a8fa */
	moveal	%d0,%a0	/* 100501d4:	2040 */
	lea	%a0@(464),%a3	/* 100501d6:	47e8 01d0 */
	subql	#4,%a3@	/* 100501da:	5993 */
	moveal	%a3@,%a0	/* 100501dc:	2053 */
	movel	%a0@,%d0	/* 100501de:	2010 */
	moveml	%fp@(-16),%a3-%a4	/* 100501e0:	4cee 1800 fff0 */
	unlk	%fp	/* 100501e6:	4e5e */
	rts	/* 100501e8:	4e75 */
...
sub_1005125c:
	linkw	%fp,#0	/* 1005125c:	4e56 0000 */
	moveml	%d5-%d7/%a3-%a4,%sp@-	/* 10051260:	48e7 0718 */
	moveal	%fp@(16),%a3	/* 10051264:	266e 0010 */
	movel	%fp@(12),%d5	/* 10051268:	2a2e 000c */
	moveal	%fp@(8),%a4	/* 1005126c:	286e 0008 */
	moveq	#0,%d7	/* 10051270:	7e00 */
	bras	.L100512ae	/* 10051272:	603a */

.L10051274:
	moveb	%a4@(0,%d7:l),%d0	/* 10051274:	1034 7800 */
	extw	%d0	/* 10051278:	4880 */
	extl	%d0	/* 1005127a:	48c0 */
	movel	%d0,%sp@-	/* 1005127c:	2f00 */
	jsr	%pc@(sub_1005120c)	/* 1005127e:	4eba ff8c */
	moveq	#0,%d1	/* 10051282:	7200 */
	moveb	%d0,%d1	/* 10051284:	1200 */
	movel	%d1,%d6	/* 10051286:	2c01 */
	lsll	#4,%d6	/* 10051288:	e98e */
	movel	%d7,%d0	/* 1005128a:	2007 */
	addql	#1,%d0	/* 1005128c:	5280 */
	cmpl	%d0,%d5	/* 1005128e:	ba80 */
	addqw	#4,%sp	/* 10051290:	584f */
	blss	.L100512aa	/* 10051292:	6316 */
	movel	%d7,%d0	/* 10051294:	2007 */
	addql	#1,%d0	/* 10051296:	5280 */
	moveb	%a4@(0,%d0:l),%d0	/* 10051298:	1034 0800 */
	extw	%d0	/* 1005129c:	4880 */
	extl	%d0	/* 1005129e:	48c0 */
	movel	%d0,%sp@-	/* 100512a0:	2f00 */
	jsr	%pc@(sub_1005120c)	/* 100512a2:	4eba ff68 */
	orb	%d0,%d6	/* 100512a6:	8c00 */
	addqw	#4,%sp	/* 100512a8:	584f */

.L100512aa:
	moveb	%d6,%a3@+	/* 100512aa:	16c6 */
	addql	#2,%d7	/* 100512ac:	5487 */

.L100512ae:
	cmpl	%d7,%d5	/* 100512ae:	ba87 */
	bhis	.L10051274	/* 100512b0:	62c2 */
	moveml	%fp@(-20),%d5-%d7/%a3-%a4	/* 100512b2:	4cee 18e0 ffec */
	unlk	%fp	/* 100512b8:	4e5e */
	rts	/* 100512ba:	4e75 */

sub_100512bc:
	linkw	%fp,#0	/* 100512bc:	4e56 0000 */
	movel	%a4,%sp@-	/* 100512c0:	2f0c */
	moveal	%fp@(8),%a4	/* 100512c2:	286e 0008 */
	movew	%fp@(14),%d0	/* 100512c6:	302e 000e */
	extl	%d0	/* 100512ca:	48c0 */
	movel	%d0,%sp@-	/* 100512cc:	2f00 */
	movel	%a4,%sp@-	/* 100512ce:	2f0c */
	jsr	%pc@(sub_100520de)	/* 100512d0:	4eba 0e0c */
	jsr	%pc@(sub_1004958a)	/* 100512d4:	4eba 82b4 */
	movel	%d0,%sp@-	/* 100512d8:	2f00 */
	jsr	%pc@(sub_10049f60)	/* 100512da:	4eba 8c84 */
	moveal	%a4@,%a0	/* 100512de:	2054 */
	movel	%d0,%a0@(82)	/* 100512e0:	2140 0052 */
	moveal	%fp@(-4),%a4	/* 100512e4:	286e fffc */
	unlk	%fp	/* 100512e8:	4e5e */
	rts	/* 100512ea:	4e75 */

sub_100512ec:
	linkw	%fp,#-8	/* 100512ec:	4e56 fff8 */
	moveml	%d5-%d7/%a2-%a4,%sp@-	/* 100512f0:	48e7 0738 */
	movel	%fp@(12),%d5	/* 100512f4:	2a2e 000c */
	moveq	#1,%d0	/* 100512f8:	7001 */
	movel	%d0,%fp@(-4)	/* 100512fa:	2d40 fffc */
	subql	#4,%sp	/* 100512fe:	598f */
	moveal	%fp@(8),%a0	/* 10051300:	206e 0008 */
	movel	%a0@,%sp@-	/* 10051304:	2f10 */
	jsr	%pc@(sub_1004aac4)	/* 10051306:	4eba 97bc */
	moveal	%sp@+,%a4	/* 1005130a:	285f */
	movew	%a4@,%d6	/* 1005130c:	3c14 */
	movel	%a4,%d0	/* 1005130e:	200c */
	addql	#2,%d0	/* 10051310:	5480 */
	moveal	%d0,%a4	/* 10051312:	2840 */
	bras	.L1005135a	/* 10051314:	6044 */

.L10051316:
	movel	%a4,%d0	/* 10051316:	200c */
	btst	#0,%d0	/* 10051318:	0800 0000 */
	beqs	.L10051324	/* 1005131c:	6706 */
	movel	%a4,%d0	/* 1005131e:	200c */
	addql	#1,%d0	/* 10051320:	5280 */
	moveal	%d0,%a4	/* 10051322:	2840 */

.L10051324:
	movew	%a4@,%d0	/* 10051324:	3014 */
	extl	%d0	/* 10051326:	48c0 */
	cmpl	%d0,%d5	/* 10051328:	ba80 */
	bnes	.L10051348	/* 1005132a:	661c */
	pea	%a4@(2)	/* 1005132c:	486c 0002 */
	jsr	%pc@(sub_10049f64)	/* 10051330:	4eba 8c32 */
	jsr	%pc@(sub_1004aacc)	/* 10051334:	4eba 9796 */
	moveal	%d0,%a0	/* 10051338:	2040 */
	lea	%a0@(464),%a2	/* 1005133a:	45e8 01d0 */
	subql	#4,%a2@	/* 1005133e:	5992 */
	moveal	%a2@,%a0	/* 10051340:	2052 */
	movel	%a0@,%d0	/* 10051342:	2010 */
	addqw	#4,%sp	/* 10051344:	584f */
	bras	.L10051366	/* 10051346:	601e */

.L10051348:
	lea	%a4@(2),%a3	/* 10051348:	47ec 0002 */
	moveb	%a3@,%d0	/* 1005134c:	1013 */
	addqb	#3,%d0	/* 1005134e:	5600 */
	moveb	%d0,%d7	/* 10051350:	1e00 */
	moveq	#0,%d0	/* 10051352:	7000 */
	moveb	%d7,%d0	/* 10051354:	1007 */
	addl	%a4,%d0	/* 10051356:	d08c */
	moveal	%d0,%a4	/* 10051358:	2840 */

.L1005135a:
	movew	%d6,%d0	/* 1005135a:	3006 */
	subqw	#1,%d6	/* 1005135c:	5346 */
	tstw	%d0	/* 1005135e:	4a40 */
	bnes	.L10051316	/* 10051360:	66b4 */
	movel	%fp@(-4),%d0	/* 10051362:	202e fffc */

.L10051366:
	moveml	%fp@(-32),%d5-%d7/%a2-%a4	/* 10051366:	4cee 1ce0 ffe0 */
	unlk	%fp	/* 1005136c:	4e5e */
	rts	/* 1005136e:	4e75 */

sub_10051370:
	linkw	%fp,#0	/* 10051370:	4e56 0000 */
	movel	%fp@(8),%sp@-	/* 10051374:	2f2e 0008 */
	jsr	%pc@(sub_1004958a)	/* 10051378:	4eba 8210 */
	movel	%d0,%sp@-	/* 1005137c:	2f00 */
	jsr	%pc@(sub_10049f68)	/* 1005137e:	4eba 8be8 */
	addql	#4,%sp	/* 10051382:	588f */
	movel	%d0,%sp@-	/* 10051384:	2f00 */
	jsr	%pc@(sub_100512ec)	/* 10051386:	4eba ff64 */
	moveal	%fp@(12),%a0	/* 1005138a:	206e 000c */
	movel	%d0,%a0@	/* 1005138e:	2080 */
	unlk	%fp	/* 10051390:	4e5e */
	rts	/* 10051392:	4e75 */

sub_10051394:
	linkw	%fp,#0	/* 10051394:	4e56 0000 */
	movel	%fp@(8),%sp@-	/* 10051398:	2f2e 0008 */
	jsr	%pc@(sub_1004958a)	/* 1005139c:	4eba 81ec */
	movel	%d0,%sp@-	/* 100513a0:	2f00 */
	jsr	%pc@(sub_10049f6c)	/* 100513a2:	4eba 8bc8 */
	addql	#4,%sp	/* 100513a6:	588f */
	movel	%d0,%sp@-	/* 100513a8:	2f00 */
	jsr	%pc@(sub_100512ec)	/* 100513aa:	4eba ff40 */
	unlk	%fp	/* 100513ae:	4e5e */
	rts	/* 100513b0:	4e75 */
