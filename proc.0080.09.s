...
sub_10021c76:
	braw	sub_100212a4	/* 10021c76:	6000 f62c */

sub_10021c7a:
	linkw	%fp,#0	/* 10021c7a:	4e56 0000 */
	moveml	%d3/%d7/%a3-%a4,%sp@-	/* 10021c7e:	48e7 1118 */
	moveal	%fp@(8),%a4	/* 10021c82:	286e 0008 */
	movel	%a4,%sp@-	/* 10021c86:	2f0c */
	jsr	%pc@(sub_10025242)	/* 10021c88:	4eba 35b8 */
	moveb	%d0,%d7	/* 10021c8c:	1e00 */
	moveq	#0,%d3	/* 10021c8e:	7600 */
	cmpib	#21,%d7	/* 10021c90:	0c07 0015 */
	addqw	#4,%sp	/* 10021c94:	584f */
	bcss	.L10021ca4	/* 10021c96:	650c */
	moveq	#0,%d0	/* 10021c98:	7000 */
	moveb	%d7,%d0	/* 10021c9a:	1007 */
	cmpib	#32,%d0	/* 10021c9c:	0c00 0020 */
	bhis	.L10021ca4	/* 10021ca0:	6202 */
	moveq	#1,%d3	/* 10021ca2:	7601 */

.L10021ca4:
	tstb	%d3	/* 10021ca4:	4a03 */
	beqs	.L10021cd8	/* 10021ca6:	6730 */
	jsr	%pc@(sub_1002548a)	/* 10021ca8:	4eba 37e0 */
	moveal	%d0,%a0	/* 10021cac:	2040 */
	lea	%a0@(464),%a3	/* 10021cae:	47e8 01d0 */
	moveal	%a3@,%a0	/* 10021cb2:	2053 */
	addql	#4,%a3@	/* 10021cb4:	5893 */
	movel	%a4,%a0@	/* 10021cb6:	208c */
	moveq	#2,%d0	/* 10021cb8:	7002 */
	movel	%d0,%sp@-	/* 10021cba:	2f00 */
	moveq	#20,%d1	/* 10021cbc:	7214 */
	movel	%d1,%sp@-	/* 10021cbe:	2f01 */
	jsr	%pc@(sub_1002844c)	/* 10021cc0:	4eba 678a */
	jsr	%pc@(sub_1002548a)	/* 10021cc4:	4eba 37c4 */
	moveal	%d0,%a0	/* 10021cc8:	2040 */
	lea	%a0@(464),%a3	/* 10021cca:	47e8 01d0 */
	subql	#4,%a3@	/* 10021cce:	5993 */
	moveal	%a3@,%a0	/* 10021cd0:	2053 */
	movel	%a0@,%d0	/* 10021cd2:	2010 */
	addqw	#8,%sp	/* 10021cd4:	504f */
	bras	.L10021cda	/* 10021cd6:	6002 */

.L10021cd8:
	movel	%a4,%d0	/* 10021cd8:	200c */

.L10021cda:
	moveml	%fp@(-16),%d3/%d7/%a3-%a4	/* 10021cda:	4cee 1888 fff0 */
	unlk	%fp	/* 10021ce0:	4e5e */
	rts	/* 10021ce2:	4e75 */

sub_10021ce4:
	braw	sub_1001a724	/* 10021ce4:	6000 8a3e */

sub_10021ce8:
	braw	sub_1001a728	/* 10021ce8:	6000 8a3e */

sub_10021cec:
	braw	sub_1001a72c	/* 10021cec:	6000 8a3e */

sub_10021cf0:
	linkw	%fp,#-20	/* 10021cf0:	4e56 ffec */
	moveml	%a2-%a4,%sp@-	/* 10021cf4:	48e7 0038 */
	moveal	%fp@(8),%a4	/* 10021cf8:	286e 0008 */
	jsr	%pc@(sub_1002548a)	/* 10021cfc:	4eba 378c */
	moveal	%d0,%a0	/* 10021d00:	2040 */
	lea	%a0@(464),%a0	/* 10021d02:	41e8 01d0 */
	movel	%a0,%fp@(-4)	/* 10021d06:	2d48 fffc */
	moveal	%a0@,%a3	/* 10021d0a:	2650 */
	subqw	#4,%a3	/* 10021d0c:	594b */
	moveal	%a3@,%a0	/* 10021d0e:	2053 */
	movel	%a0@(12),%sp@-	/* 10021d10:	2f28 000c */
	jsr	%pc@(sub_1001a6b4)	/* 10021d14:	4eba 899e */
	moveal	%d0,%a2	/* 10021d18:	2440 */
	movel	%a2,%sp@-	/* 10021d1a:	2f0a */
	jsr	%pc@(sub_10025242)	/* 10021d1c:	4eba 3524 */
	moveq	#0,%d1	/* 10021d20:	7200 */
	moveb	%d0,%d1	/* 10021d22:	1200 */
	cmpiw	#111,%d1	/* 10021d24:	0c41 006f */
	addqw	#8,%sp	/* 10021d28:	504f */
	bnes	.L10021d50	/* 10021d2a:	6624 */
	moveq	#41,%d0	/* 10021d2c:	7029 */
	movel	%d0,%sp@-	/* 10021d2e:	2f00 */
	movel	%a4,%sp@-	/* 10021d30:	2f0c */
	jsr	%pc@(sub_100257fc)	/* 10021d32:	4eba 3ac8 */
	movel	%a2@(12),%sp@-	/* 10021d36:	2f2a 000c */
	movel	%a4,%sp@-	/* 10021d3a:	2f0c */
	jsr	%pc@(sub_1001a6b0)	/* 10021d3c:	4eba 8972 */
	moveq	#44,%d0	/* 10021d40:	702c */
	movel	%d0,%sp@-	/* 10021d42:	2f00 */
	movel	%a4,%sp@-	/* 10021d44:	2f0c */
	jsr	%pc@(sub_100257fc)	/* 10021d46:	4eba 3ab4 */
	lea	%sp@(24),%sp	/* 10021d4a:	4fef 0018 */
	bras	.L10021da4	/* 10021d4e:	6054 */

.L10021d50:
	moveal	%a3@,%a0	/* 10021d50:	2053 */
	movel	%a0@(12),%fp@(-20)	/* 10021d52:	2d68 000c ffec */
	jsr	%pc@(sub_1002548a)	/* 10021d58:	4eba 3730 */
	moveal	%d0,%a0	/* 10021d5c:	2040 */
	lea	%a0@(464),%a2	/* 10021d5e:	45e8 01d0 */
	moveal	%a2@,%a0	/* 10021d62:	2052 */
	addql	#4,%a2@	/* 10021d64:	5892 */
	movel	%fp@(-20),%a0@	/* 10021d66:	20ae ffec */
	movel	%fp@(24),%sp@-	/* 10021d6a:	2f2e 0018 */
	movel	%fp@(20),%sp@-	/* 10021d6e:	2f2e 0014 */
	moveq	#0,%d0	/* 10021d72:	7000 */
	movel	%d0,%sp@-	/* 10021d74:	2f00 */
	moveq	#0,%d1	/* 10021d76:	7200 */
	moveb	%fp@(15),%d1	/* 10021d78:	122e 000f */
	movel	%d1,%sp@-	/* 10021d7c:	2f01 */
	movel	%a4,%sp@-	/* 10021d7e:	2f0c */
	movel	%d0,%sp@-	/* 10021d80:	2f00 */
	movel	%d0,%sp@-	/* 10021d82:	2f00 */
	jsr	%pc@(sub_1001a6ac)	/* 10021d84:	4eba 8926 */
	jsr	%pc@(sub_1002548a)	/* 10021d88:	4eba 3700 */
	moveal	%d0,%a0	/* 10021d8c:	2040 */
	lea	%a0@(464),%a0	/* 10021d8e:	41e8 01d0 */
	movel	%a0,%fp@(-12)	/* 10021d92:	2d48 fff4 */
	subql	#4,%a0@	/* 10021d96:	5990 */
	moveal	%a0@,%a0	/* 10021d98:	2050 */
	moveal	%a3@,%a1	/* 10021d9a:	2253 */
	movel	%a0@,%a1@(12)	/* 10021d9c:	2350 000c */
	lea	%sp@(28),%sp	/* 10021da0:	4fef 001c */

.L10021da4:
	moveq	#17,%d0	/* 10021da4:	7011 */
	movel	%d0,%sp@-	/* 10021da6:	2f00 */
	movel	%a4,%sp@-	/* 10021da8:	2f0c */
	jsr	%pc@(sub_100257fc)	/* 10021daa:	4eba 3a50 */
	addqw	#8,%sp	/* 10021dae:	504f */
	moveml	%fp@(-32),%a2-%a4	/* 10021db0:	4cee 1c00 ffe0 */
	unlk	%fp	/* 10021db6:	4e5e */
	rts	/* 10021db8:	4e75 */

sub_10021dba:
	braw	sub_1001a920	/* 10021dba:	6000 8b64 */

sub_10021dbe:
	linkw	%fp,#0	/* 10021dbe:	4e56 0000 */
	moveml	%d3/%d7/%a3-%a4,%sp@-	/* 10021dc2:	48e7 1118 */
	jsr	%pc@(sub_1002548a)	/* 10021dc6:	4eba 36c2 */
	moveal	%d0,%a0	/* 10021dca:	2040 */
	lea	%a0@(464),%a4	/* 10021dcc:	49e8 01d0 */
	moveal	%a4@,%a0	/* 10021dd0:	2054 */
	moveal	%a0@(-4),%a3	/* 10021dd2:	2668 fffc */
	movel	%a3,%sp@-	/* 10021dd6:	2f0b */
	jsr	%pc@(sub_10025242)	/* 10021dd8:	4eba 3468 */
	moveb	%d0,%d7	/* 10021ddc:	1e00 */
	moveq	#0,%d3	/* 10021dde:	7600 */
	cmpib	#21,%d7	/* 10021de0:	0c07 0015 */
	addqw	#4,%sp	/* 10021de4:	584f */
	bcss	.L10021df4	/* 10021de6:	650c */
	moveq	#0,%d0	/* 10021de8:	7000 */
	moveb	%d7,%d0	/* 10021dea:	1007 */
	cmpib	#32,%d0	/* 10021dec:	0c00 0020 */
	bhis	.L10021df4	/* 10021df0:	6202 */
	moveq	#1,%d3	/* 10021df2:	7601 */

.L10021df4:
	tstb	%d3	/* 10021df4:	4a03 */
	beqs	.L10021e06	/* 10021df6:	670e */
	moveq	#2,%d0	/* 10021df8:	7002 */
	movel	%d0,%sp@-	/* 10021dfa:	2f00 */
	moveq	#20,%d1	/* 10021dfc:	7214 */
	movel	%d1,%sp@-	/* 10021dfe:	2f01 */
	jsr	%pc@(sub_1002844c)	/* 10021e00:	4eba 664a */
	addqw	#8,%sp	/* 10021e04:	504f */

.L10021e06:
	moveml	%fp@(-16),%d3/%d7/%a3-%a4	/* 10021e06:	4cee 1888 fff0 */
	unlk	%fp	/* 10021e0c:	4e5e */
	rts	/* 10021e0e:	4e75 */

sub_10021e10:
	braw	sub_1001dcbe	/* 10021e10:	6000 beac */

sub_10021e14:
	braw	sub_1001a93c	/* 10021e14:	6000 8b26 */

sub_10021e18:
	linkw	%fp,#0	/* 10021e18:	4e56 0000 */
	moveml	%d3/%d7/%a3-%a4,%sp@-	/* 10021e1c:	48e7 1118 */
	moveal	%fp@(16),%a3	/* 10021e20:	266e 0010 */
	moveal	%fp@(12),%a4	/* 10021e24:	286e 000c */
	movel	%a4,%sp@-	/* 10021e28:	2f0c */
	jsr	%pc@(sub_1002104c)	/* 10021e2a:	4eba f220 */
	movel	%a4@,%sp@-	/* 10021e2e:	2f14 */
	jsr	%pc@(sub_10025242)	/* 10021e30:	4eba 3410 */
	moveb	%d0,%d7	/* 10021e34:	1e00 */
	moveq	#1,%d3	/* 10021e36:	7601 */
	moveq	#0,%d0	/* 10021e38:	7000 */
	moveb	%d7,%d0	/* 10021e3a:	1007 */
	movel	%a3,%d1	/* 10021e3c:	220b */
	asrl	#3,%d1	/* 10021e3e:	e681 */
	cmpl	%d0,%d1	/* 10021e40:	b280 */
	beqs	.L10021e60	/* 10021e42:	671c */
	movel	%d3,%sp@-	/* 10021e44:	2f03 */
	movel	%a3,%sp@-	/* 10021e46:	2f0b */
	movel	%a4,%sp@-	/* 10021e48:	2f0c */
	moveq	#0,%d0	/* 10021e4a:	7000 */
	moveb	%d7,%d0	/* 10021e4c:	1007 */
	movel	%d0,%sp@-	/* 10021e4e:	2f00 */
	jsr	%pc@(sub_1001a6ee)	/* 10021e50:	4eba 889c */
	lea	%sp@(12),%sp	/* 10021e54:	4fef 000c */
	movel	%sp@+,%d3	/* 10021e58:	261f */
	tstb	%d0	/* 10021e5a:	4a00 */
	bnes	.L10021e60	/* 10021e5c:	6602 */
	moveq	#0,%d3	/* 10021e5e:	7600 */

.L10021e60:
	moveb	%d3,%d0	/* 10021e60:	1003 */
	moveml	%fp@(-16),%d3/%d7/%a3-%a4	/* 10021e62:	4cee 1888 fff0 */
	unlk	%fp	/* 10021e68:	4e5e */
	rts	/* 10021e6a:	4e75 */

sub_10021e6c:
	linkw	%fp,#0	/* 10021e6c:	4e56 0000 */
	moveml	%a3-%a4,%sp@-	/* 10021e70:	48e7 0018 */
	jsr	%pc@(sub_1002548a)	/* 10021e74:	4eba 3614 */
	moveal	%d0,%a0	/* 10021e78:	2040 */
	lea	%a0@(464),%a4	/* 10021e7a:	49e8 01d0 */
	moveal	%a4@,%a3	/* 10021e7e:	2654 */
	subqw	#4,%a3	/* 10021e80:	594b */
	movel	%a3,%sp@-	/* 10021e82:	2f0b */
	jsr	%pc@(sub_1002104c)	/* 10021e84:	4eba f1c6 */
	moveq	#0,%d0	/* 10021e88:	7000 */
	moveb	%fp@(15),%d0	/* 10021e8a:	102e 000f */
	movel	%d0,%sp@-	/* 10021e8e:	2f00 */
	movel	%fp@(8),%sp@-	/* 10021e90:	2f2e 0008 */
	jsr	%pc@(sub_1001b490)	/* 10021e94:	4eba 95fa */
	moveml	%fp@(-8),%a3-%a4	/* 10021e98:	4cee 1800 fff8 */
	unlk	%fp	/* 10021e9e:	4e5e */
	rts	/* 10021ea0:	4e75 */

sub_10021ea2:
	linkw	%fp,#0	/* 10021ea2:	4e56 0000 */
	moveml	%a3-%a4,%sp@-	/* 10021ea6:	48e7 0018 */
	jsr	%pc@(sub_1002548a)	/* 10021eaa:	4eba 35de */
	moveal	%d0,%a0	/* 10021eae:	2040 */
	lea	%a0@(464),%a4	/* 10021eb0:	49e8 01d0 */
	moveal	%a4@,%a3	/* 10021eb4:	2654 */
	subqw	#4,%a3	/* 10021eb6:	594b */
	movel	%a3,%sp@-	/* 10021eb8:	2f0b */
	jsr	%pc@(sub_1002104c)	/* 10021eba:	4eba f190 */
	moveq	#0,%d0	/* 10021ebe:	7000 */
	moveb	%fp@(15),%d0	/* 10021ec0:	102e 000f */
	movel	%d0,%sp@-	/* 10021ec4:	2f00 */
	movel	%fp@(8),%sp@-	/* 10021ec6:	2f2e 0008 */
	jsr	%pc@(sub_1001b5ea)	/* 10021eca:	4eba 971e */
	moveml	%fp@(-8),%a3-%a4	/* 10021ece:	4cee 1800 fff8 */
	unlk	%fp	/* 10021ed4:	4e5e */
	rts	/* 10021ed6:	4e75 */

sub_10021ed8:
	braw	sub_1001a924	/* 10021ed8:	6000 8a4a */

sub_10021edc:
	braw	sub_1001a928	/* 10021edc:	6000 8a4a */

sub_10021ee0:
	braw	sub_1001a92c	/* 10021ee0:	6000 8a4a */

sub_10021ee4:
	braw	sub_1001a930	/* 10021ee4:	6000 8a4a */

sub_10021ee8:
	braw	sub_1001a934	/* 10021ee8:	6000 8a4a */

sub_10021eec:
	braw	sub_1001a938	/* 10021eec:	6000 8a4a */

sub_10021ef0:
	braw	sub_1001b920	/* 10021ef0:	6000 9a2e */

sub_10021ef4:
	linkw	%fp,#-20	/* 10021ef4:	4e56 ffec */
	moveml	%d7/%a2-%a4,%sp@-	/* 10021ef8:	48e7 0138 */
	moveb	%fp@(15),%d7	/* 10021efc:	1e2e 000f */
	moveal	%fp@(8),%a4	/* 10021f00:	286e 0008 */
	jsr	%pc@(sub_1002548a)	/* 10021f04:	4eba 3584 */
	moveal	%d0,%a0	/* 10021f08:	2040 */
	lea	%a0@(464),%a2	/* 10021f0a:	45e8 01d0 */
	moveal	%a2@,%a3	/* 10021f0e:	2652 */
	subqw	#4,%a3	/* 10021f10:	594b */
	moveal	%a3@,%a0	/* 10021f12:	2053 */
	movel	%a0@(16),%fp@(-20)	/* 10021f14:	2d68 0010 ffec */
	jsr	%pc@(sub_1002548a)	/* 10021f1a:	4eba 356e */
	moveal	%d0,%a0	/* 10021f1e:	2040 */
	lea	%a0@(464),%a0	/* 10021f20:	41e8 01d0 */
	movel	%a0,%fp@(-16)	/* 10021f24:	2d48 fff0 */
	moveal	%a0@,%a1	/* 10021f28:	2250 */
	addql	#4,%a0@	/* 10021f2a:	5890 */
	movel	%fp@(-20),%a1@	/* 10021f2c:	22ae ffec */
	movel	%fp@(24),%sp@-	/* 10021f30:	2f2e 0018 */
	movel	%fp@(20),%sp@-	/* 10021f34:	2f2e 0014 */
	moveq	#0,%d0	/* 10021f38:	7000 */
	movel	%d0,%sp@-	/* 10021f3a:	2f00 */
	moveq	#0,%d1	/* 10021f3c:	7200 */
	moveb	%d7,%d1	/* 10021f3e:	1207 */
	movel	%d1,%sp@-	/* 10021f40:	2f01 */
	movel	%a4,%sp@-	/* 10021f42:	2f0c */
	jsr	%pc@(sub_1001a8b4)	/* 10021f44:	4eba 896e */
	jsr	%pc@(sub_1002548a)	/* 10021f48:	4eba 3540 */
	moveal	%d0,%a0	/* 10021f4c:	2040 */
	lea	%a0@(464),%a2	/* 10021f4e:	45e8 01d0 */
	subql	#4,%a2@	/* 10021f52:	5992 */
	moveal	%a2@,%a0	/* 10021f54:	2052 */
	moveal	%a3@,%a1	/* 10021f56:	2253 */
	movel	%a0@,%a1@(16)	/* 10021f58:	2350 0010 */
	moveq	#110,%d0	/* 10021f5c:	706e */
	movel	%d0,%sp@-	/* 10021f5e:	2f00 */
	movel	%a4,%sp@-	/* 10021f60:	2f0c */
	jsr	%pc@(sub_100257fc)	/* 10021f62:	4eba 3898 */
	moveal	%a3@,%a0	/* 10021f66:	2053 */
	movel	%a0@(12),%fp@(-8)	/* 10021f68:	2d68 000c fff8 */
	jsr	%pc@(sub_1002548a)	/* 10021f6e:	4eba 351a */
	moveal	%d0,%a0	/* 10021f72:	2040 */
	lea	%a0@(464),%a0	/* 10021f74:	41e8 01d0 */
	movel	%a0,%fp@(-16)	/* 10021f78:	2d48 fff0 */
	moveal	%a0@,%a1	/* 10021f7c:	2250 */
	addql	#4,%a0@	/* 10021f7e:	5890 */
	movel	%fp@(-8),%a1@	/* 10021f80:	22ae fff8 */
	movel	%fp@(24),%sp@-	/* 10021f84:	2f2e 0018 */
	movel	%fp@(20),%sp@-	/* 10021f88:	2f2e 0014 */
	moveq	#0,%d0	/* 10021f8c:	7000 */
	movel	%d0,%sp@-	/* 10021f8e:	2f00 */
	moveq	#0,%d1	/* 10021f90:	7200 */
	moveb	%d7,%d1	/* 10021f92:	1207 */
	movel	%d1,%sp@-	/* 10021f94:	2f01 */
	movel	%a4,%sp@-	/* 10021f96:	2f0c */
	jsr	%pc@(sub_1001a8b4)	/* 10021f98:	4eba 891a */
	jsr	%pc@(sub_1002548a)	/* 10021f9c:	4eba 34ec */
	moveal	%d0,%a0	/* 10021fa0:	2040 */
	lea	%a0@(464),%a2	/* 10021fa2:	45e8 01d0 */
	subql	#4,%a2@	/* 10021fa6:	5992 */
	moveal	%a2@,%a0	/* 10021fa8:	2052 */
	moveal	%a3@,%a1	/* 10021faa:	2253 */
	movel	%a0@,%a1@(12)	/* 10021fac:	2350 000c */
	moveal	%fp@(24),%a0	/* 10021fb0:	206e 0018 */
	tstb	%a0@	/* 10021fb4:	4a10 */
	lea	%sp@(48),%sp	/* 10021fb6:	4fef 0030 */
	beqs	.L10021fc8	/* 10021fba:	670c */
	moveq	#1,%d0	/* 10021fbc:	7001 */
	movel	%d0,%sp@-	/* 10021fbe:	2f00 */
	movel	%a4,%sp@-	/* 10021fc0:	2f0c */
	jsr	%pc@(sub_1001a6b0)	/* 10021fc2:	4eba 86ec */
	addqw	#8,%sp	/* 10021fc6:	504f */

.L10021fc8:
	moveq	#111,%d0	/* 10021fc8:	706f */
	movel	%d0,%sp@-	/* 10021fca:	2f00 */
	movel	%a4,%sp@-	/* 10021fcc:	2f0c */
	jsr	%pc@(sub_100257fc)	/* 10021fce:	4eba 382c */
	addqw	#8,%sp	/* 10021fd2:	504f */
	moveml	%fp@(-36),%d7/%a2-%a4	/* 10021fd4:	4cee 1c80 ffdc */
	unlk	%fp	/* 10021fda:	4e5e */
	rts	/* 10021fdc:	4e75 */
...
sub_10021fee:
	linkw	%fp,#-44	/* 10021fee:	4e56 ffd4 */
	moveml	%d7/%a3-%a4,%sp@-	/* 10021ff2:	48e7 0118 */
	moveq	#1,%d0	/* 10021ff6:	7001 */
	movel	%d0,%sp@-	/* 10021ff8:	2f00 */
	moveq	#2,%d1	/* 10021ffa:	7202 */
	movel	%d1,%sp@-	/* 10021ffc:	2f01 */
	jsr	%pc@(sub_10025804)	/* 10021ffe:	4eba 3804 */
	moveq	#0,%d0	/* 10022002:	7000 */
	movel	%d0,%sp@-	/* 10022004:	2f00 */
	moveq	#2,%d1	/* 10022006:	7202 */
	movel	%d1,%sp@-	/* 10022008:	2f01 */
	jsr	%pc@(sub_1002548a)	/* 1002200a:	4eba 347e */
	moveal	%d0,%a0	/* 1002200e:	2040 */
	lea	%a0@(464),%a4	/* 10022010:	49e8 01d0 */
	moveal	%a4@,%a0	/* 10022014:	2054 */
	movel	%a0@(-4),%sp@-	/* 10022016:	2f28 fffc */
	jsr	%pc@(sub_10025800)	/* 1002201a:	4eba 37e4 */
	jsr	%pc@(sub_1002548a)	/* 1002201e:	4eba 346a */
	moveal	%d0,%a0	/* 10022022:	2040 */
	lea	%a0@(464),%a3	/* 10022024:	47e8 01d0 */
	subql	#4,%a3@	/* 10022028:	5993 */
	moveal	%a3@,%a0	/* 1002202a:	2053 */
	lea	%sp@(20),%sp	/* 1002202c:	4fef 0014 */
	movel	%a0@,%sp@-	/* 10022030:	2f10 */
	jsr	%pc@(sub_100221fe)	/* 10022032:	4eba 01ca */
	jsr	%pc@(sub_1002548a)	/* 10022036:	4eba 3452 */
	moveal	%d0,%a0	/* 1002203a:	2040 */
	lea	%a0@(464),%a3	/* 1002203c:	47e8 01d0 */
	moveal	%a3@,%a4	/* 10022040:	2853 */
	lea	%a4@(-12),%a4	/* 10022042:	49ec fff4 */
	moveq	#97,%d0	/* 10022046:	7061 */
	movel	%d0,%sp@-	/* 10022048:	2f00 */
	movel	%a4,%sp@-	/* 1002204a:	2f0c */
	jsr	%pc@(sub_10021dba)	/* 1002204c:	4eba fd6c */
	movel	%a4@,%sp@-	/* 10022050:	2f14 */
	jsr	%pc@(sub_1002016a)	/* 10022052:	4eba e116 */
	movew	%d0,%fp@(-18)	/* 10022056:	3d40 ffee */
	movel	%d1,%fp@(-16)	/* 1002205a:	2d41 fff0 */
	movel	%a0,%fp@(-12)	/* 1002205e:	2d48 fff4 */
	pea	%fp@(-18)	/* 10022062:	486e ffee */
	pea	%fp@(-8)	/* 10022066:	486e fff8 */
	movew	#2064,%sp@-	/* 1002206a:	3f3c 0810 */
	.short	0xa9eb	/* 1002206e:	a9eb */
	pea	%fp@(-8)	/* 10022070:	486e fff8 */
	pea	%fp@(-18)	/* 10022074:	486e ffee */
	movew	#2062,%sp@-	/* 10022078:	3f3c 080e */
	.short	0xa9eb	/* 1002207c:	a9eb */
	moveq	#60,%d0	/* 1002207e:	703c */
	movew	%d0,%fp@(-30)	/* 10022080:	3d40 ffe2 */
	pea	%fp@(-30)	/* 10022084:	486e ffe2 */
	pea	%fp@(-28)	/* 10022088:	486e ffe4 */
	movew	#8206,%sp@-	/* 1002208c:	3f3c 200e */
	.short	0xa9eb	/* 10022090:	a9eb */
	pea	%fp@(-28)	/* 10022092:	486e ffe4 */
	pea	%fp@(-18)	/* 10022096:	486e ffee */
	movew	#4,%sp@-	/* 1002209a:	3f3c 0004 */
	.short	0xa9eb	/* 1002209e:	a9eb */
	lea	%fp@(-18),%a0	/* 100220a0:	41ee ffee */
	lea	%fp@(-40),%a1	/* 100220a4:	43ee ffd8 */
	movel	%a0@+,%a1@+	/* 100220a8:	22d8 */
	movel	%a0@+,%a1@+	/* 100220aa:	22d8 */
	movew	%a0@+,%a1@+	/* 100220ac:	32d8 */
	pea	%fp@(-40)	/* 100220ae:	486e ffd8 */
	movew	#22,%sp@-	/* 100220b2:	3f3c 0016 */
	.short	0xa9eb	/* 100220b6:	a9eb */
	pea	%fp@(-40)	/* 100220b8:	486e ffd8 */
	jsr	%pc@(sub_1001f6ea)	/* 100220bc:	4eba d62c */
	movel	%d0,%d7	/* 100220c0:	2e00 */
	movel	%d7,%sp@-	/* 100220c2:	2f07 */
	jsr	%pc@(sub_10022e52)	/* 100220c4:	4eba 0d8c */
	movel	%d0,%fp@(-44)	/* 100220c8:	2d40 ffd4 */
	jsr	%pc@(sub_1002548a)	/* 100220cc:	4eba 33bc */
	moveal	%d0,%a0	/* 100220d0:	2040 */
	movel	%fp@(-44),%d0	/* 100220d2:	202e ffd4 */
	movel	%d0,%a0@(168)	/* 100220d6:	2140 00a8 */
	moveml	%fp@(-56),%d7/%a3-%a4	/* 100220da:	4cee 1880 ffc8 */
	unlk	%fp	/* 100220e0:	4e5e */
	rts	/* 100220e2:	4e75 */

sub_100220e4:
	braw	sub_1001b89c	/* 100220e4:	6000 97b6 */

sub_100220e8:
	braw	sub_1001d072	/* 100220e8:	6000 af88 */

sub_100220ec:
	braw	sub_1001b9bc	/* 100220ec:	6000 98ce */

sub_100220f0:
	braw	sub_1001b996	/* 100220f0:	6000 98a4 */

sub_100220f4:
	braw	sub_1001b972	/* 100220f4:	6000 987c */

sub_100220f8:
	braw	sub_1001d0c0	/* 100220f8:	6000 afc6 */

sub_100220fc:
	braw	sub_1001d098	/* 100220fc:	6000 af9a */

sub_10022100:
	braw	sub_1001f3ba	/* 10022100:	6000 d2b8 */

sub_10022104:
	braw	sub_1001ba6e	/* 10022104:	6000 9968 */

sub_10022108:
	braw	sub_1001b9ea	/* 10022108:	6000 98e0 */

sub_1002210c:
	braw	sub_1001f43c	/* 1002210c:	6000 d32e */

sub_10022110:
	braw	sub_1001ac9e	/* 10022110:	6000 8b8c */

sub_10022114:
	braw	sub_1001aca2	/* 10022114:	6000 8b8c */

sub_10022118:
	braw	sub_1001f4a6	/* 10022118:	6000 d38c */

sub_1002211c:
	braw	sub_1001f494	/* 1002211c:	6000 d376 */

sub_10022120:
	braw	sub_1001f47e	/* 10022120:	6000 d35c */

sub_10022124:
	braw	sub_1001aca6	/* 10022124:	6000 8b80 */

sub_10022128:
	braw	sub_1001b95e	/* 10022128:	6000 9834 */

sub_1002212c:
	braw	sub_1001b946	/* 1002212c:	6000 9818 */

sub_10022130:
	braw	sub_1001b934	/* 10022130:	6000 9802 */

sub_10022134:
	braw	sub_1001d0ea	/* 10022134:	6000 afb4 */

sub_10022138:
	braw	sub_1001d086	/* 10022138:	6000 af4c */

sub_1002213c:
	braw	sub_1001acaa	/* 1002213c:	6000 8b6c */

sub_10022140:
	braw	sub_1001acae	/* 10022140:	6000 8b6c */

sub_10022144:
	braw	sub_1001acb2	/* 10022144:	6000 8b6c */

sub_10022148:
	braw	sub_1001acb6	/* 10022148:	6000 8b6c */

sub_1002214c:
	braw	sub_1001acba	/* 1002214c:	6000 8b6c */

sub_10022150:
	braw	sub_1001f422	/* 10022150:	6000 d2d0 */

sub_10022154:
	braw	sub_1001f40a	/* 10022154:	6000 d2b4 */

sub_10022158:
	braw	sub_1001f3ea	/* 10022158:	6000 d290 */

sub_1002215c:
	braw	sub_1001acbe	/* 1002215c:	6000 8b60 */

sub_10022160:
	braw	sub_1001b892	/* 10022160:	6000 9730 */

sub_10022164:
	braw	sub_1001ac8e	/* 10022164:	6000 8b28 */

sub_10022168:
	braw	sub_1001d068	/* 10022168:	6000 aefe */

sub_1002216c:
	braw	sub_10020402	/* 1002216c:	6000 e294 */

sub_10022170:
	braw	sub_1001acc2	/* 10022170:	6000 8b50 */

sub_10022174:
	braw	sub_1001acc6	/* 10022174:	6000 8b50 */

sub_10022178:
	braw	sub_1001acca	/* 10022178:	6000 8b50 */

sub_1002217c:
	braw	sub_1001acce	/* 1002217c:	6000 8b50 */

sub_10022180:
	braw	sub_1001acd2	/* 10022180:	6000 8b50 */

sub_10022184:
	braw	sub_1001acd6	/* 10022184:	6000 8b50 */

sub_10022188:
	linkw	%fp,#-4	/* 10022188:	4e56 fffc */
	moveml	%a2-%a4,%sp@-	/* 1002218c:	48e7 0038 */
	jsr	%pc@(sub_1002548a)	/* 10022190:	4eba 32f8 */
	moveal	%d0,%a0	/* 10022194:	2040 */
	lea	%a0@(464),%a3	/* 10022196:	47e8 01d0 */
	moveal	%a3@,%a4	/* 1002219a:	2853 */
	lea	%a4@(-16),%a4	/* 1002219c:	49ec fff0 */
	pea	%a4@(4)	/* 100221a0:	486c 0004 */
	jsr	%pc@(sub_1002222c)	/* 100221a4:	4eba 0086 */
	jsr	%pc@(sub_1002548a)	/* 100221a8:	4eba 32e0 */
	moveal	%d0,%a0	/* 100221ac:	2040 */
	lea	%a0@(464),%a3	/* 100221ae:	47e8 01d0 */
	moveal	%a3@,%a0	/* 100221b2:	2053 */
	moveal	%a0@(-4),%a2	/* 100221b4:	2468 fffc */
	jsr	%pc@(sub_1002548a)	/* 100221b8:	4eba 32d0 */
	moveal	%d0,%a0	/* 100221bc:	2040 */
	lea	%a0@(464),%a3	/* 100221be:	47e8 01d0 */
	movel	%a4,%a3@	/* 100221c2:	268c */
	jsr	%pc@(sub_1002548a)	/* 100221c4:	4eba 32c4 */
	moveal	%d0,%a0	/* 100221c8:	2040 */
	lea	%a0@(464),%a4	/* 100221ca:	49e8 01d0 */
	moveal	%a4@,%a0	/* 100221ce:	2054 */
	addql	#4,%a4@	/* 100221d0:	5894 */
	movel	%a2,%a0@	/* 100221d2:	208a */
	moveml	%fp@(-16),%a2-%a4	/* 100221d4:	4cee 1c00 fff0 */
...
sub_100221fe:
	linkw	%fp,#0	/* 100221fe:	4e56 0000 */
	moveml	%a3-%a4,%sp@-	/* 10022202:	48e7 0018 */
	moveal	%fp@(8),%a4	/* 10022206:	286e 0008 */
	moveq	#5,%d0	/* 1002220a:	7005 */
	movel	%d0,%sp@-	/* 1002220c:	2f00 */
	movel	%a4,%sp@-	/* 1002220e:	2f0c */
	jsr	%pc@(sub_1001aae8)	/* 10022210:	4eba 88d6 */
	jsr	%pc@(sub_1002548a)	/* 10022214:	4eba 3274 */
	moveal	%d0,%a0	/* 10022218:	2040 */
	moveal	%a0@(168),%a3	/* 1002221a:	2668 00a8 */
	movel	%a3,%a4@(4)	/* 1002221e:	294b 0004 */
	moveml	%fp@(-8),%a3-%a4	/* 10022222:	4cee 1800 fff8 */
	unlk	%fp	/* 10022228:	4e5e */
	rts	/* 1002222a:	4e75 */

sub_1002222c:
	linkw	%fp,#0	/* 1002222c:	4e56 0000 */
	movel	%a4,%sp@-	/* 10022230:	2f0c */
	moveal	%fp@(8),%a4	/* 10022232:	286e 0008 */
	jsr	%pc@(sub_1002548a)	/* 10022236:	4eba 3252 */
	moveal	%d0,%a0	/* 1002223a:	2040 */
	movel	%a4@(4),%a0@(168)	/* 1002223c:	216c 0004 00a8 */
	movel	%a4,%sp@-	/* 10022242:	2f0c */
	jsr	%pc@(sub_1001aaec)	/* 10022244:	4eba 88a6 */
	moveal	%fp@(-4),%a4	/* 10022248:	286e fffc */
	unlk	%fp	/* 1002224c:	4e5e */
	rts	/* 1002224e:	4e75 */

sub_10022250:
	linkw	%fp,#0	/* 10022250:	4e56 0000 */
	moveml	%d6-%d7/%a3-%a4,%sp@-	/* 10022254:	48e7 0318 */
	moveal	%fp@(20),%a3	/* 10022258:	266e 0014 */
	moveal	%fp@(8),%a4	/* 1002225c:	286e 0008 */
	moveq	#1,%d6	/* 10022260:	7c01 */
	cmpal	#1,%a4	/* 10022262:	b9fc 0000 0001 */
	bnes	.L10022270	/* 10022268:	6606 */
	moveal	%fp@(12),%a4	/* 1002226a:	286e 000c */
	clrb	%d6	/* 1002226e:	4206 */

.L10022270:
	movel	%a4,%sp@-	/* 10022270:	2f0c */
	jsr	%pc@(sub_10025242)	/* 10022272:	4eba 2fce */
	moveb	%d0,%d7	/* 10022276:	1e00 */
	moveq	#0,%d0	/* 10022278:	7000 */
	moveb	%d7,%d0	/* 1002227a:	1007 */
	cmpiw	#22,%d0	/* 1002227c:	0c40 0016 */
	addqw	#4,%sp	/* 10022280:	584f */
	bnes	.L10022292	/* 10022282:	660e */
	moveal	%fp@(16),%a0	/* 10022284:	206e 0010 */
	movel	%a4@(8),%a0@	/* 10022288:	20ac 0008 */
	movel	%a4@(4),%a3@	/* 1002228c:	26ac 0004 */
	bras	.L100222e0	/* 10022290:	604e */

.L10022292:
	moveq	#0,%d0	/* 10022292:	7000 */
	moveb	%d7,%d0	/* 10022294:	1007 */
	cmpiw	#21,%d0	/* 10022296:	0c40 0015 */
	bnes	.L100222b8	/* 1002229a:	661c */
	movel	%a4@(8),%sp@-	/* 1002229c:	2f2c 0008 */
	jsr	%pc@(sub_1001fe68)	/* 100222a0:	4eba dbc6 */
	tstb	%d0	/* 100222a4:	4a00 */
	addqw	#4,%sp	/* 100222a6:	584f */
	beqs	.L100222b8	/* 100222a8:	670e */
	moveal	%fp@(16),%a0	/* 100222aa:	206e 0010 */
	movel	%a4@(8),%a0@	/* 100222ae:	20ac 0008 */
	movel	%a4@(4),%a3@	/* 100222b2:	26ac 0004 */
	bras	.L100222e0	/* 100222b6:	6028 */

.L100222b8:
	tstb	%d6	/* 100222b8:	4a06 */
	beqs	.L100222d4	/* 100222ba:	6718 */
	movel	%a4,%sp@-	/* 100222bc:	2f0c */
	jsr	%pc@(sub_1001fe68)	/* 100222be:	4eba dba8 */
	tstb	%d0	/* 100222c2:	4a00 */
	addqw	#4,%sp	/* 100222c4:	584f */
	beqs	.L100222d4	/* 100222c6:	670c */
	moveal	%fp@(16),%a0	/* 100222c8:	206e 0010 */
	movel	%a4,%a0@	/* 100222cc:	208c */
	movel	%fp@(12),%a3@	/* 100222ce:	26ae 000c */
	bras	.L100222e0	/* 100222d2:	600c */

.L100222d4:
	moveal	%fp@(16),%a0	/* 100222d4:	206e 0010 */
	movel	#393,%a0@	/* 100222d8:	20bc 0000 0189 */
	movel	%a4,%a3@	/* 100222de:	268c */

.L100222e0:
	jsr	%pc@(sub_1002548a)	/* 100222e0:	4eba 31a8 */
	moveal	%d0,%a0	/* 100222e4:	2040 */
	lea	%a0@(464),%a4	/* 100222e6:	49e8 01d0 */
	moveal	%a4@,%a0	/* 100222ea:	2054 */
	addql	#4,%a4@	/* 100222ec:	5894 */
	movel	%a3@,%a0@	/* 100222ee:	2093 */
	movel	%fp@(24),%sp@-	/* 100222f0:	2f2e 0018 */
	jsr	%pc@(sub_1001aaf0)	/* 100222f4:	4eba 87fa */
	jsr	%pc@(sub_1002548a)	/* 100222f8:	4eba 3190 */
	moveal	%d0,%a0	/* 100222fc:	2040 */
	lea	%a0@(464),%a4	/* 100222fe:	49e8 01d0 */
	subql	#4,%a4@	/* 10022302:	5994 */
	moveal	%a4@,%a0	/* 10022304:	2054 */
	movel	%a0@,%a3@	/* 10022306:	2690 */
	addqw	#4,%sp	/* 10022308:	584f */
	moveml	%fp@(-16),%d6-%d7/%a3-%a4	/* 1002230a:	4cee 18c0 fff0 */
	unlk	%fp	/* 10022310:	4e5e */
	rts	/* 10022312:	4e75 */
