...
sub_10033308:
	linkw	%fp,#-10	/* 10033308:	4e56 fff6 */
	moveml	%d6-%d7/%a3-%a4,%sp@-	/* 1003330c:	48e7 0318 */
	movel	%fp@(16),%sp@-	/* 10033310:	2f2e 0010 */
	jsr	%pc@(sub_1003a7f4)	/* 10033314:	4eba 74de */
	moveal	%d0,%a0	/* 10033318:	2040 */
	moveal	%a0@,%a4	/* 1003331a:	2850 */
	moveal	%a4,%a0	/* 1003331c:	204c */
	addql	#4,%a0	/* 1003331e:	5888 */
	movel	%a0@,%d7	/* 10033320:	2e10 */
	cmpil	#1668244074,%d7	/* 10033322:	0c87 636f 626a */
	bnes	.L10033332	/* 10033328:	6608 */
	movel	#1667784992,%d0	/* 1003332a:	203c 6368 6120 */
	bras	.L10033334	/* 10033330:	6002 */

.L10033332:
	movel	%d7,%d0	/* 10033332:	2007 */

.L10033334:
	movel	%d0,%d6	/* 10033334:	2c00 */
	movel	%d6,%fp@(-10)	/* 10033336:	2d46 fff6 */
	moveb	#1,%fp@(-6)	/* 1003333a:	1d7c 0001 fffa */
	moveq	#0,%d0	/* 10033340:	7000 */
	movel	%d0,%fp@(-4)	/* 10033342:	2d40 fffc */
	lea	%fp@(-10),%a0	/* 10033346:	41ee fff6 */
	jsr	%pc@(sub_1003b17a)	/* 1003334a:	4eba 7e2e */
	moveal	%d0,%a0	/* 1003334e:	2040 */
	lea	%a0@(464),%a3	/* 10033350:	47e8 01d0 */
	moveal	%a3@,%a0	/* 10033354:	2053 */
	addql	#4,%a3@	/* 10033356:	5893 */
	movel	%fp@(12),%a0@	/* 10033358:	20ae 000c */
	movel	%fp@(20),%sp@-	/* 1003335c:	2f2e 0014 */
	pea	%fp@(-10)	/* 10033360:	486e fff6 */
	movel	%d6,%sp@-	/* 10033364:	2f06 */
	jsr	%pc@(sub_10032300)	/* 10033366:	4eba ef98 */
	lea	%sp@(16),%sp	/* 1003336a:	4fef 0010 */
	moveml	%fp@(-26),%d6-%d7/%a3-%a4	/* 1003336e:	4cee 18c0 ffe6 */
	unlk	%fp	/* 10033374:	4e5e */
	rts	/* 10033376:	4e75 */
