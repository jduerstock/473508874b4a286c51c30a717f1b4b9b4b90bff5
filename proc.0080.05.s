...
.L100118d0:
	...
	movel	#0x2d2d2d2d,%sp@-	/* 100118d4:	2f3c 2d2d 2d2d */
	movel	#0x2a2a2a2a,%sp@-	/* 100118da:	2f3c 2a2a 2a2a */
...
.L1001279a:
	...
	movel	#0x2a2a2a2a,%sp@-	/* 1001280a:	2f3c 2a2a 2a2a */
...
sub_10014404:
	braw	sub_1000cf64	/* 10014404:	6000 8b5e */

sub_10014408:
	linkw	%fp,#-278	/* 10014408:	4e56 feea */
	moveml	%a2-%a4,%sp@-	/* 1001440c:	48e7 0038 */
	moveal	%fp@(16),%a3	/* 10014410:	266e 0010 */
	moveal	%fp@(12),%a4	/* 10014414:	286e 000c */
	cmpal	#433,%a3	/* 10014418:	b7fc 0000 01b1 */
	bnes	.L10014426	/* 1001441e:	6606 */
	moveq	#1,%d0	/* 10014420:	7001 */
	braw	.L10014546	/* 10014422:	6000 0122 */

.L10014426:
	cmpal	#25,%a3	/* 10014426:	b7fc 0000 0019 */
	beqs	.L10014438	/* 1001442c:	670a */
	cmpal	#57,%a3	/* 1001442e:	b7fc 0000 0039 */
	bnew	.L100144f8	/* 10014434:	6600 00c2 */

.L10014438:
	movel	%a4@,%sp@-	/* 10014438:	2f14 */
	jsr	%pc@(sub_100141dc)	/* 1001443a:	4eba fda0 */
	movew	%d0,%fp@(-270)	/* 1001443e:	3d40 fef2 */
	movel	%d1,%fp@(-268)	/* 10014442:	2d41 fef4 */
	movel	%a0,%fp@(-264)	/* 10014446:	2d48 fef8 */
	lea	%fp@(-270),%a0	/* 1001444a:	41ee fef2 */
	lea	%fp@(-20),%a1	/* 1001444e:	43ee ffec */
	movel	%a0@+,%a1@+	/* 10014452:	22d8 */
	movel	%a0@+,%a1@+	/* 10014454:	22d8 */
	movew	%a0@+,%a1@+	/* 10014456:	32d8 */
	lea	%fp@(-10),%a0	/* 10014458:	41ee fff6 */
	movel	%a0@-,%sp@-	/* 1001445c:	2f20 */
	movel	%a0@-,%sp@-	/* 1001445e:	2f20 */
	movew	%a0@-,%sp@-	/* 10014460:	3f20 */
	jsr	%pc@(sub_100143ae)	/* 10014462:	4eba ff4a */
	movew	%d0,%fp@(-270)	/* 10014466:	3d40 fef2 */
	movel	%d1,%fp@(-268)	/* 1001446a:	2d41 fef4 */
	movel	%a0,%fp@(-264)	/* 1001446e:	2d48 fef8 */
	lea	%fp@(-270),%a0	/* 10014472:	41ee fef2 */
	lea	%fp@(-10),%a1	/* 10014476:	43ee fff6 */
	movel	%a0@+,%a1@+	/* 1001447a:	22d8 */
	movel	%a0@+,%a1@+	/* 1001447c:	22d8 */
	movew	%a0@+,%a1@+	/* 1001447e:	32d8 */
	pea	%fp@(-10)	/* 10014480:	486e fff6 */
	pea	%fp@(-20)	/* 10014484:	486e ffec */
	movew	#8,%sp@-	/* 10014488:	3f3c 0008 */
	.short	0xa9eb	/* 1001448c:	a9eb */
	lea	%sp@(14),%sp	/* 1001448e:	4fef 000e */
	bnes	.L100144f8	/* 10014492:	6664 */
	movel	#536870911,%d0	/* 10014494:	203c 1fff ffff */
	movel	%d0,%fp@(-274)	/* 1001449a:	2d40 feee */
	pea	%fp@(-274)	/* 1001449e:	486e feee */
	pea	%fp@(-10)	/* 100144a2:	486e fff6 */
	movew	#10250,%sp@-	/* 100144a6:	3f3c 280a */
	.short	0xa9eb	/* 100144aa:	a9eb */
	bhis	.L100144f8	/* 100144ac:	624a */
	movel	#-536870912,%d0	/* 100144ae:	203c e000 0000 */
	movel	%d0,%fp@(-278)	/* 100144b4:	2d40 feea */
	pea	%fp@(-278)	/* 100144b8:	486e feea */
	pea	%fp@(-10)	/* 100144bc:	486e fff6 */
	movew	#10250,%sp@-	/* 100144c0:	3f3c 280a */
	.short	0xa9eb	/* 100144c4:	a9eb */
	blts	.L100144f8	/* 100144c6:	6d30 */
	lea	%fp@(-10),%a0	/* 100144c8:	41ee fff6 */
	lea	%fp@(-270),%a1	/* 100144cc:	43ee fef2 */
	movel	%a0@+,%a1@+	/* 100144d0:	22d8 */
	movel	%a0@+,%a1@+	/* 100144d2:	22d8 */
	movew	%a0@+,%a1@+	/* 100144d4:	32d8 */
	pea	%fp@(-270)	/* 100144d6:	486e fef2 */
	movew	#22,%sp@-	/* 100144da:	3f3c 0016 */
	.short	0xa9eb	/* 100144de:	a9eb */
	pea	%fp@(-270)	/* 100144e0:	486e fef2 */
	jsr	%pc@(sub_10016e5c)	/* 100144e4:	4eba 2976 */
	addql	#4,%sp	/* 100144e8:	588f */
	movel	%d0,%sp@-	/* 100144ea:	2f00 */
	jsr	%pc@(sub_10016d36)	/* 100144ec:	4eba 2848 */
	movel	%d0,%a4@	/* 100144f0:	2880 */
	moveq	#1,%d0	/* 100144f2:	7001 */
	addqw	#4,%sp	/* 100144f4:	584f */
	bras	.L10014546	/* 100144f6:	604e */

.L100144f8:
	cmpal	#113,%a3	/* 100144f8:	b7fc 0000 0071 */
	bnes	.L10014532	/* 100144fe:	6632 */
	clrw	%fp@(-260)	/* 10014500:	426e fefc */
	lea	%fp@(-260),%a0	/* 10014504:	41ee fefc */
	pea	%fp@(-260)	/* 10014508:	486e fefc */
	movel	%a4@,%sp@-	/* 1001450c:	2f14 */
	jsr	%pc@(sub_10014306)	/* 1001450e:	4eba fdf6 */
	pea	%fp@(-260)	/* 10014512:	486e fefc */
	jsr	%pc@(sub_10017c22)	/* 10014516:	4eba 370a */
	jsr	%pc@(sub_100164fa)	/* 1001451a:	4eba 1fde */
	moveal	%d0,%a0	/* 1001451e:	2040 */
	lea	%a0@(464),%a2	/* 10014520:	45e8 01d0 */
	subql	#4,%a2@	/* 10014524:	5992 */
	moveal	%a2@,%a0	/* 10014526:	2052 */
	movel	%a0@,%a4@	/* 10014528:	2890 */
	moveq	#1,%d0	/* 1001452a:	7001 */
	lea	%sp@(12),%sp	/* 1001452c:	4fef 000c */
	bras	.L10014546	/* 10014530:	6014 */

.L10014532:
	movel	%a3,%sp@-	/* 10014532:	2f0b */
	movel	%a4,%sp@-	/* 10014534:	2f0c */
	moveq	#0,%d0	/* 10014536:	7000 */
	moveb	%fp@(11),%d0	/* 10014538:	102e 000b */
	movel	%d0,%sp@-	/* 1001453c:	2f00 */
	jsr	%pc@(sub_10017796)	/* 1001453e:	4eba 3256 */
	lea	%sp@(12),%sp	/* 10014542:	4fef 000c */

.L10014546:
	moveml	%fp@(-290),%a2-%a4	/* 10014546:	4cee 1c00 fede */
	unlk	%fp	/* 1001454c:	4e5e */
	rts	/* 1001454e:	4e75 */

sub_10014550:
	braw	sub_1000cf68	/* 10014550:	6000 8a16 */

sub_10014554:
	linkw	%fp,#-256	/* 10014554:	4e56 ff00 */
	moveml	%d7/%a3-%a4,%sp@-	/* 10014558:	48e7 0118 */
	moveal	%fp@(16),%a4	/* 1001455c:	286e 0010 */
	clrw	%fp@(-256)	/* 10014560:	426e ff00 */
	lea	%fp@(-256),%a0	/* 10014564:	41ee ff00 */
	pea	%fp@(-256)	/* 10014568:	486e ff00 */
	movel	%fp@(8),%sp@-	/* 1001456c:	2f2e 0008 */
	jsr	%pc@(sub_10014306)	/* 10014570:	4eba fd94 */
	lea	%fp@(-255),%a3	/* 10014574:	47ee ff01 */
	moveb	%fp@(-256),%d0	/* 10014578:	102e ff00 */
	moveq	#0,%d7	/* 1001457c:	7e00 */
	moveb	%d0,%d7	/* 1001457e:	1e00 */
	movel	%d7,%sp@-	/* 10014580:	2f07 */
	movel	%a3,%sp@-	/* 10014582:	2f0b */
	movel	%a4,%sp@-	/* 10014584:	2f0c */
	jsr	%pc@(sub_10016774)	/* 10014586:	4eba 21ec */
	moveq	#1,%d0	/* 1001458a:	7001 */
	moveml	%fp@(-268),%d7/%a3-%a4	/* 1001458c:	4cee 1880 fef4 */
	unlk	%fp	/* 10014592:	4e5e */
	rts	/* 10014594:	4e75 */

sub_10014596:
	braw	sub_1000cf6c	/* 10014596:	6000 89d4 */

sub_1001459a:
	linkw	%fp,#-24	/* 1001459a:	4e56 ffe8 */
	moveml	%a2-%a4,%sp@-	/* 1001459e:	48e7 0038 */
	jsr	%pc@(sub_100164fa)	/* 100145a2:	4eba 1f56 */
	moveal	%d0,%a0	/* 100145a6:	2040 */
	lea	%a0@(464),%a3	/* 100145a8:	47e8 01d0 */
	moveal	%a3@,%a4	/* 100145ac:	2853 */
	subqw	#8,%a4	/* 100145ae:	514c */
	pea	0x1b1	/* 100145b0:	4878 01b1 */
	moveq	#97,%d0	/* 100145b4:	7061 */
	movel	%d0,%sp@-	/* 100145b6:	2f00 */
	pea	%a4@(4)	/* 100145b8:	486c 0004 */
	jsr	%pc@(sub_10017bc0)	/* 100145bc:	4eba 3602 */
	movel	%a4@,%sp@-	/* 100145c0:	2f14 */
	jsr	%pc@(sub_100141dc)	/* 100145c2:	4eba fc18 */
	movew	%d0,%fp@(-14)	/* 100145c6:	3d40 fff2 */
	movel	%d1,%fp@(-12)	/* 100145ca:	2d41 fff4 */
	movel	%a0,%fp@(-8)	/* 100145ce:	2d48 fff8 */
	movel	%a4@(4),%sp@-	/* 100145d2:	2f2c 0004 */
	jsr	%pc@(sub_100141dc)	/* 100145d6:	4eba fc04 */
	movew	%d0,%fp@(-24)	/* 100145da:	3d40 ffe8 */
	movel	%d1,%fp@(-22)	/* 100145de:	2d41 ffea */
	movel	%a0,%fp@(-18)	/* 100145e2:	2d48 ffee */
	pea	%fp@(-24)	/* 100145e6:	486e ffe8 */
	pea	%fp@(-14)	/* 100145ea:	486e fff2 */
	clrw	%sp@-	/* 100145ee:	4267 */
	.short	0xa9eb	/* 100145f0:	a9eb */
	addql	#8,%sp	/* 100145f2:	508f */
	lea	%fp@(-4),%a0	/* 100145f4:	41ee fffc */
	movel	%a0@-,%sp@-	/* 100145f8:	2f20 */
	movel	%a0@-,%sp@-	/* 100145fa:	2f20 */
	movew	%a0@-,%sp@-	/* 100145fc:	3f20 */
	jsr	%pc@(sub_10014102)	/* 100145fe:	4eba fb02 */
	jsr	%pc@(sub_100164fa)	/* 10014602:	4eba 1ef6 */
	moveal	%d0,%a0	/* 10014606:	2040 */
	lea	%a0@(464),%a3	/* 10014608:	47e8 01d0 */
	moveal	%a3@,%a0	/* 1001460c:	2053 */
	moveal	%a0@(-4),%a2	/* 1001460e:	2468 fffc */
	jsr	%pc@(sub_100164fa)	/* 10014612:	4eba 1ee6 */
	moveal	%d0,%a0	/* 10014616:	2040 */
	lea	%a0@(464),%a3	/* 10014618:	47e8 01d0 */
	movel	%a4,%a3@	/* 1001461c:	268c */
	jsr	%pc@(sub_100164fa)	/* 1001461e:	4eba 1eda */
	moveal	%d0,%a0	/* 10014622:	2040 */
	lea	%a0@(464),%a4	/* 10014624:	49e8 01d0 */
	moveal	%a4@,%a0	/* 10014628:	2054 */
	addql	#4,%a4@	/* 1001462a:	5894 */
	movel	%a2,%a0@	/* 1001462c:	208a */
	moveml	%fp@(-36),%a2-%a4	/* 1001462e:	4cee 1c00 ffdc */
	unlk	%fp	/* 10014634:	4e5e */
	rts	/* 10014636:	4e75 */

sub_10014638:
	linkw	%fp,#-24	/* 10014638:	4e56 ffe8 */
	moveml	%a2-%a4,%sp@-	/* 1001463c:	48e7 0038 */
	jsr	%pc@(sub_100164fa)	/* 10014640:	4eba 1eb8 */
	moveal	%d0,%a0	/* 10014644:	2040 */
	lea	%a0@(464),%a3	/* 10014646:	47e8 01d0 */
	moveal	%a3@,%a4	/* 1001464a:	2853 */
	subqw	#8,%a4	/* 1001464c:	514c */
	pea	0x1b1	/* 1001464e:	4878 01b1 */
	moveq	#97,%d0	/* 10014652:	7061 */
	movel	%d0,%sp@-	/* 10014654:	2f00 */
	pea	%a4@(4)	/* 10014656:	486c 0004 */
	jsr	%pc@(sub_10017bc0)	/* 1001465a:	4eba 3564 */
	movel	%a4@,%sp@-	/* 1001465e:	2f14 */
	jsr	%pc@(sub_100141dc)	/* 10014660:	4eba fb7a */
	movew	%d0,%fp@(-14)	/* 10014664:	3d40 fff2 */
	movel	%d1,%fp@(-12)	/* 10014668:	2d41 fff4 */
	movel	%a0,%fp@(-8)	/* 1001466c:	2d48 fff8 */
	movel	%a4@(4),%sp@-	/* 10014670:	2f2c 0004 */
	jsr	%pc@(sub_100141dc)	/* 10014674:	4eba fb66 */
	movew	%d0,%fp@(-24)	/* 10014678:	3d40 ffe8 */
	movel	%d1,%fp@(-22)	/* 1001467c:	2d41 ffea */
	movel	%a0,%fp@(-18)	/* 10014680:	2d48 ffee */
	pea	%fp@(-24)	/* 10014684:	486e ffe8 */
	pea	%fp@(-14)	/* 10014688:	486e fff2 */
	movew	#2,%sp@-	/* 1001468c:	3f3c 0002 */
	.short	0xa9eb	/* 10014690:	a9eb */
	addql	#8,%sp	/* 10014692:	508f */
	lea	%fp@(-4),%a0	/* 10014694:	41ee fffc */
	movel	%a0@-,%sp@-	/* 10014698:	2f20 */
	movel	%a0@-,%sp@-	/* 1001469a:	2f20 */
	movew	%a0@-,%sp@-	/* 1001469c:	3f20 */
	jsr	%pc@(sub_10014102)	/* 1001469e:	4eba fa62 */
	jsr	%pc@(sub_100164fa)	/* 100146a2:	4eba 1e56 */
	moveal	%d0,%a0	/* 100146a6:	2040 */
	lea	%a0@(464),%a3	/* 100146a8:	47e8 01d0 */
	moveal	%a3@,%a0	/* 100146ac:	2053 */
	moveal	%a0@(-4),%a2	/* 100146ae:	2468 fffc */
	jsr	%pc@(sub_100164fa)	/* 100146b2:	4eba 1e46 */
	moveal	%d0,%a0	/* 100146b6:	2040 */
	lea	%a0@(464),%a3	/* 100146b8:	47e8 01d0 */
	movel	%a4,%a3@	/* 100146bc:	268c */
	jsr	%pc@(sub_100164fa)	/* 100146be:	4eba 1e3a */
	moveal	%d0,%a0	/* 100146c2:	2040 */
	lea	%a0@(464),%a4	/* 100146c4:	49e8 01d0 */
	moveal	%a4@,%a0	/* 100146c8:	2054 */
	addql	#4,%a4@	/* 100146ca:	5894 */
	movel	%a2,%a0@	/* 100146cc:	208a */
	moveml	%fp@(-36),%a2-%a4	/* 100146ce:	4cee 1c00 ffdc */
	unlk	%fp	/* 100146d4:	4e5e */
	rts	/* 100146d6:	4e75 */

sub_100146d8:
	linkw	%fp,#-24	/* 100146d8:	4e56 ffe8 */
	moveml	%a2-%a4,%sp@-	/* 100146dc:	48e7 0038 */
	jsr	%pc@(sub_100164fa)	/* 100146e0:	4eba 1e18 */
	moveal	%d0,%a0	/* 100146e4:	2040 */
	lea	%a0@(464),%a3	/* 100146e6:	47e8 01d0 */
	moveal	%a3@,%a4	/* 100146ea:	2853 */
	subqw	#8,%a4	/* 100146ec:	514c */
	pea	0x1b1	/* 100146ee:	4878 01b1 */
	moveq	#97,%d0	/* 100146f2:	7061 */
	movel	%d0,%sp@-	/* 100146f4:	2f00 */
	pea	%a4@(4)	/* 100146f6:	486c 0004 */
	jsr	%pc@(sub_10017bc0)	/* 100146fa:	4eba 34c4 */
	movel	%a4@,%sp@-	/* 100146fe:	2f14 */
	jsr	%pc@(sub_100141dc)	/* 10014700:	4eba fada */
	movew	%d0,%fp@(-14)	/* 10014704:	3d40 fff2 */
	movel	%d1,%fp@(-12)	/* 10014708:	2d41 fff4 */
	movel	%a0,%fp@(-8)	/* 1001470c:	2d48 fff8 */
	movel	%a4@(4),%sp@-	/* 10014710:	2f2c 0004 */
	jsr	%pc@(sub_100141dc)	/* 10014714:	4eba fac6 */
	movew	%d0,%fp@(-24)	/* 10014718:	3d40 ffe8 */
	movel	%d1,%fp@(-22)	/* 1001471c:	2d41 ffea */
	movel	%a0,%fp@(-18)	/* 10014720:	2d48 ffee */
	pea	%fp@(-24)	/* 10014724:	486e ffe8 */
	pea	%fp@(-14)	/* 10014728:	486e fff2 */
	movew	#4,%sp@-	/* 1001472c:	3f3c 0004 */
	.short	0xa9eb	/* 10014730:	a9eb */
	addql	#8,%sp	/* 10014732:	508f */
	lea	%fp@(-4),%a0	/* 10014734:	41ee fffc */
	movel	%a0@-,%sp@-	/* 10014738:	2f20 */
	movel	%a0@-,%sp@-	/* 1001473a:	2f20 */
	movew	%a0@-,%sp@-	/* 1001473c:	3f20 */
	jsr	%pc@(sub_10014102)	/* 1001473e:	4eba f9c2 */
	jsr	%pc@(sub_100164fa)	/* 10014742:	4eba 1db6 */
	moveal	%d0,%a0	/* 10014746:	2040 */
	lea	%a0@(464),%a3	/* 10014748:	47e8 01d0 */
	moveal	%a3@,%a0	/* 1001474c:	2053 */
	moveal	%a0@(-4),%a2	/* 1001474e:	2468 fffc */
	jsr	%pc@(sub_100164fa)	/* 10014752:	4eba 1da6 */
	moveal	%d0,%a0	/* 10014756:	2040 */
	lea	%a0@(464),%a3	/* 10014758:	47e8 01d0 */
	movel	%a4,%a3@	/* 1001475c:	268c */
	jsr	%pc@(sub_100164fa)	/* 1001475e:	4eba 1d9a */
	moveal	%d0,%a0	/* 10014762:	2040 */
	lea	%a0@(464),%a4	/* 10014764:	49e8 01d0 */
	moveal	%a4@,%a0	/* 10014768:	2054 */
	addql	#4,%a4@	/* 1001476a:	5894 */
	movel	%a2,%a0@	/* 1001476c:	208a */
	moveml	%fp@(-36),%a2-%a4	/* 1001476e:	4cee 1c00 ffdc */
	unlk	%fp	/* 10014774:	4e5e */
	rts	/* 10014776:	4e75 */

sub_10014778:
	braw	sub_10013db6	/* 10014778:	6000 f63c */

sub_1001477c:
	linkw	%fp,#-24	/* 1001477c:	4e56 ffe8 */
	moveml	%a2-%a4,%sp@-	/* 10014780:	48e7 0038 */
	jsr	%pc@(sub_100164fa)	/* 10014784:	4eba 1d74 */
	moveal	%d0,%a0	/* 10014788:	2040 */
	lea	%a0@(464),%a3	/* 1001478a:	47e8 01d0 */
	moveal	%a3@,%a4	/* 1001478e:	2853 */
	subqw	#8,%a4	/* 10014790:	514c */
	pea	0x1b1	/* 10014792:	4878 01b1 */
	moveq	#97,%d0	/* 10014796:	7061 */
	movel	%d0,%sp@-	/* 10014798:	2f00 */
	pea	%a4@(4)	/* 1001479a:	486c 0004 */
	jsr	%pc@(sub_10017bc0)	/* 1001479e:	4eba 3420 */
	movel	%a4@(4),%sp@-	/* 100147a2:	2f2c 0004 */
	jsr	%pc@(sub_100141dc)	/* 100147a6:	4eba fa34 */
	movew	%d0,%fp@(-14)	/* 100147aa:	3d40 fff2 */
	movel	%d1,%fp@(-12)	/* 100147ae:	2d41 fff4 */
	movel	%a0,%fp@(-8)	/* 100147b2:	2d48 fff8 */
	pea	%pc@(.L10014856)	/* 100147b6:	487a 009e */
	pea	%fp@(-14)	/* 100147ba:	486e fff2 */
	movew	#8,%sp@-	/* 100147be:	3f3c 0008 */
	.short	0xa9eb	/* 100147c2:	a9eb */
	lea	%sp@(16),%sp	/* 100147c4:	4fef 0010 */
	bnes	.L100147d8	/* 100147c8:	660e */
	movel	%a4@,%sp@-	/* 100147ca:	2f14 */
	movel	#-2701,%sp@-	/* 100147cc:	2f3c ffff f573 */
	jsr	%pc@(sub_100164f6)	/* 100147d2:	4eba 1d22 */
	addqw	#8,%sp	/* 100147d6:	504f */

.L100147d8:
	movel	%a4@,%sp@-	/* 100147d8:	2f14 */
	jsr	%pc@(sub_100141dc)	/* 100147da:	4eba fa00 */
	movew	%d0,%fp@(-14)	/* 100147de:	3d40 fff2 */
	movel	%d1,%fp@(-12)	/* 100147e2:	2d41 fff4 */
	movel	%a0,%fp@(-8)	/* 100147e6:	2d48 fff8 */
	movel	%a4@(4),%sp@-	/* 100147ea:	2f2c 0004 */
	jsr	%pc@(sub_100141dc)	/* 100147ee:	4eba f9ec */
	movew	%d0,%fp@(-24)	/* 100147f2:	3d40 ffe8 */
	movel	%d1,%fp@(-22)	/* 100147f6:	2d41 ffea */
	movel	%a0,%fp@(-18)	/* 100147fa:	2d48 ffee */
	pea	%fp@(-24)	/* 100147fe:	486e ffe8 */
	pea	%fp@(-14)	/* 10014802:	486e fff2 */
	movew	#6,%sp@-	/* 10014806:	3f3c 0006 */
	.short	0xa9eb	/* 1001480a:	a9eb */
	addql	#8,%sp	/* 1001480c:	508f */
	lea	%fp@(-4),%a0	/* 1001480e:	41ee fffc */
	movel	%a0@-,%sp@-	/* 10014812:	2f20 */
	movel	%a0@-,%sp@-	/* 10014814:	2f20 */
	movew	%a0@-,%sp@-	/* 10014816:	3f20 */
	jsr	%pc@(sub_10014102)	/* 10014818:	4eba f8e8 */
	jsr	%pc@(sub_100164fa)	/* 1001481c:	4eba 1cdc */
	moveal	%d0,%a0	/* 10014820:	2040 */
	lea	%a0@(464),%a3	/* 10014822:	47e8 01d0 */
	moveal	%a3@,%a0	/* 10014826:	2053 */
	moveal	%a0@(-4),%a2	/* 10014828:	2468 fffc */
	jsr	%pc@(sub_100164fa)	/* 1001482c:	4eba 1ccc */
	moveal	%d0,%a0	/* 10014830:	2040 */
	lea	%a0@(464),%a3	/* 10014832:	47e8 01d0 */
	movel	%a4,%a3@	/* 10014836:	268c */
	jsr	%pc@(sub_100164fa)	/* 10014838:	4eba 1cc0 */
	moveal	%d0,%a0	/* 1001483c:	2040 */
	lea	%a0@(464),%a4	/* 1001483e:	49e8 01d0 */
	moveal	%a4@,%a0	/* 10014842:	2054 */
	addql	#4,%a4@	/* 10014844:	5894 */
	movel	%a2,%a0@	/* 10014846:	208a */
	lea	%sp@(10),%sp	/* 10014848:	4fef 000a */
	moveml	%fp@(-36),%a2-%a4	/* 1001484c:	4cee 1c00 ffdc */
	unlk	%fp	/* 10014852:	4e5e */
	rts	/* 10014854:	4e75 */
...
sub_10014864:
	linkw	%fp,#-30	/* 10014864::	4e56 ffe2 */
	lea	%fp@(18),%a0	/* 10014868:	41ee 0012 */
	movel	%a0@-,%sp@-	/* 1001486c:	2f20 */
	movel	%a0@-,%sp@-	/* 1001486e:	2f20 */
	movew	%a0@-,%sp@-	/* 10014870:	3f20 */
	moveq	#48,%d0	/* 10014872:	7030 */
	movel	%d0,%sp@-	/* 10014874:	2f00 */
	jsr	%pc@(sub_100173de)	/* 10014876:	4eba 2b66 */
	movew	%d0,%fp@(-10)	/* 1001487a:	3d40 fff6 */
	movel	%d1,%fp@(-8)	/* 1001487e:	2d41 fff8 */
	movel	%a0,%fp@(-4)	/* 10014882:	2d48 fffc */
	lea	%sp@(14),%sp	/* 10014886:	4fef 000e */
	.short	0x41ee,0x0000	/* lea	%fp@(0),%a0	/* 1001488a:	41ee 0000 */
	movel	%a0@-,%sp@-	/* 1001488e:	2f20 */
	movel	%a0@-,%sp@-	/* 10014890:	2f20 */
	movew	%a0@-,%sp@-	/* 10014892:	3f20 */
	jsr	%pc@(sub_100173f8)	/* 10014894:	4eba 2b62 */
	movew	%d0,%fp@(-20)	/* 10014898:	3d40 ffec */
	movel	%d1,%fp@(-18)	/* 1001489c:	2d41 ffee */
	movel	%a0,%fp@(-14)	/* 100148a0:	2d48 fff2 */
	lea	%sp@(10),%sp	/* 100148a4:	4fef 000a */
	lea	%fp@(-10),%a0	/* 100148a8:	41ee fff6 */
	movel	%a0@-,%sp@-	/* 100148ac:	2f20 */
	movel	%a0@-,%sp@-	/* 100148ae:	2f20 */
	movew	%a0@-,%sp@-	/* 100148b0:	3f20 */
	moveq	#-48,%d0	/* 100148b2:	70d0 */
	movel	%d0,%sp@-	/* 100148b4:	2f00 */
	jsr	%pc@(sub_100173de)	/* 100148b6:	4eba 2b26 */
	movew	%d0,%fp@(-30)	/* 100148ba:	3d40 ffe2 */
	movel	%d1,%fp@(-28)	/* 100148be:	2d41 ffe4 */
	movel	%a0,%fp@(-24)	/* 100148c2:	2d48 ffe8 */
	lea	%fp@(-30),%a0	/* 100148c6:	41ee ffe2 */
	movew	%a0@+,%d0	/* 100148ca:	3018 */
	movel	%a0@+,%d1	/* 100148cc:	2218 */
	moveal	%a0@,%a0	/* 100148ce:	2050 */
	unlk	%fp	/* 100148d0:	4e5e */
	rts	/* 100148d2:	4e75 */

sub_100148d4:
	linkw	%fp,#-48	/* 100148d4:	4e56 ffd0 */
	moveml	%a2-%a4,%sp@-	/* 100148d8:	48e7 0038 */
	jsr	%pc@(sub_100164fa)	/* 100148dc:	4eba 1c1c */
	moveal	%d0,%a0	/* 100148e0:	2040 */
	lea	%a0@(464),%a3	/* 100148e2:	47e8 01d0 */
	moveal	%a3@,%a4	/* 100148e6:	2853 */
	subqw	#8,%a4	/* 100148e8:	514c */
	pea	0x1b1	/* 100148ea:	4878 01b1 */
	moveq	#97,%d0	/* 100148ee:	7061 */
	movel	%d0,%sp@-	/* 100148f0:	2f00 */
	pea	%a4@(4)	/* 100148f2:	486c 0004 */
	jsr	%pc@(sub_10017bc0)	/* 100148f6:	4eba 32c8 */
	movel	%a4@(4),%sp@-	/* 100148fa:	2f2c 0004 */
	jsr	%pc@(sub_100141dc)	/* 100148fe:	4eba f8dc */
	movew	%d0,%fp@(-18)	/* 10014902:	3d40 ffee */
	movel	%d1,%fp@(-16)	/* 10014906:	2d41 fff0 */
	movel	%a0,%fp@(-12)	/* 1001490a:	2d48 fff4 */
	pea	%pc@(.L10014a12)	/* 1001490e:	487a 0102 */
	pea	%fp@(-18)	/* 10014912:	486e ffee */
	movew	#8,%sp@-	/* 10014916:	3f3c 0008 */
	.short	0xa9eb	/* 1001491a:	a9eb */
	lea	%sp@(16),%sp	/* 1001491c:	4fef 0010 */
	bnes	.L10014930	/* 10014920:	660e */
	movel	%a4@,%sp@-	/* 10014922:	2f14 */
	movel	#-2701,%sp@-	/* 10014924:	2f3c ffff f573 */
	jsr	%pc@(sub_100164f6)	/* 1001492a:	4eba 1bca */
	addqw	#8,%sp	/* 1001492e:	504f */

.L10014930:
	movel	%a4@,%sp@-	/* 10014930:	2f14 */
	jsr	%pc@(sub_100141dc)	/* 10014932:	4eba f8a8 */
	movew	%d0,%fp@(-18)	/* 10014936:	3d40 ffee */
	movel	%d1,%fp@(-16)	/* 1001493a:	2d41 fff0 */
	movel	%a0,%fp@(-12)	/* 1001493e:	2d48 fff4 */
	movel	%a4@(4),%sp@-	/* 10014942:	2f2c 0004 */
	jsr	%pc@(sub_100141dc)	/* 10014946:	4eba f894 */
	movew	%d0,%fp@(-28)	/* 1001494a:	3d40 ffe4 */
	movel	%d1,%fp@(-26)	/* 1001494e:	2d41 ffe6 */
	movel	%a0,%fp@(-22)	/* 10014952:	2d48 ffea */
	pea	%fp@(-28)	/* 10014956:	486e ffe4 */
	pea	%fp@(-18)	/* 1001495a:	486e ffee */
	movew	#6,%sp@-	/* 1001495e:	3f3c 0006 */
	.short	0xa9eb	/* 10014962:	a9eb */
	addql	#8,%sp	/* 10014964:	508f */
	lea	%fp@(-8),%a0	/* 10014966:	41ee fff8 */
	movel	%a0@-,%sp@-	/* 1001496a:	2f20 */
	movel	%a0@-,%sp@-	/* 1001496c:	2f20 */
	movew	%a0@-,%sp@-	/* 1001496e:	3f20 */
	jsr	%pc@(sub_10014864)	/* 10014970:	4eba fef2 */
	movew	%d0,%fp@(-38)	/* 10014974:	3d40 ffda */
	movel	%d1,%fp@(-36)	/* 10014978:	2d41 ffdc */
	movel	%a0,%fp@(-32)	/* 1001497c:	2d48 ffe0 */
	lea	%sp@(10),%sp	/* 10014980:	4fef 000a */
	lea	%fp@(-28),%a0	/* 10014984:	41ee ffe4 */
	movel	%a0@-,%sp@-	/* 10014988:	2f20 */
	movel	%a0@-,%sp@-	/* 1001498a:	2f20 */
	movew	%a0@-,%sp@-	/* 1001498c:	3f20 */
	jsr	%pc@(sub_10014354)	/* 1001498e:	4eba f9c4 */
	movew	%d0,%fp@(-48)	/* 10014992:	3d40 ffd0 */
	movel	%d1,%fp@(-46)	/* 10014996:	2d41 ffd2 */
	movel	%a0,%fp@(-42)	/* 1001499a:	2d48 ffd6 */
	lea	%sp@(10),%sp	/* 1001499e:	4fef 000a */
	lea	%fp@(-38),%a0	/* 100149a2:	41ee ffda */
	movel	%a0@-,%sp@-	/* 100149a6:	2f20 */
	movel	%a0@-,%sp@-	/* 100149a8:	2f20 */
	movew	%a0@-,%sp@-	/* 100149aa:	3f20 */
	jsr	%pc@(sub_10014102)	/* 100149ac:	4eba f754 */
	jsr	%pc@(sub_100164fa)	/* 100149b0:	4eba 1b48 */
	moveal	%d0,%a0	/* 100149b4:	2040 */
	lea	%a0@(464),%a3	/* 100149b6:	47e8 01d0 */
	subql	#4,%a3@	/* 100149ba:	5993 */
	moveal	%a3@,%a0	/* 100149bc:	2053 */
	movel	%a0@,%fp@(-4)	/* 100149be:	2d50 fffc */
	moveq	#0,%d0	/* 100149c2:	7000 */
	movel	%d0,%sp@-	/* 100149c4:	2f00 */
	moveq	#25,%d1	/* 100149c6:	7219 */
	movel	%d1,%sp@-	/* 100149c8:	2f01 */
	pea	%fp@(-4)	/* 100149ca:	486e fffc */
	moveq	#12,%d1	/* 100149ce:	720c */
	movel	%d1,%sp@-	/* 100149d0:	2f01 */
	jsr	%pc@(sub_1001793c)	/* 100149d2:	4eba 2f68 */
	lea	%sp@(12),%sp	/* 100149d6:	4fef 000c */
	movel	%d0,%d1	/* 100149da:	2200 */
	movel	%sp@+,%d0	/* 100149dc:	201f */
	tstb	%d1	/* 100149de:	4a01 */
	sne	%d0	/* 100149e0:	56c0 */
	negb	%d0	/* 100149e2:	4400 */
	moveal	%fp@(-4),%a2	/* 100149e4:	246e fffc */
	jsr	%pc@(sub_100164fa)	/* 100149e8:	4eba 1b10 */
	moveal	%d0,%a0	/* 100149ec:	2040 */
	lea	%a0@(464),%a3	/* 100149ee:	47e8 01d0 */
	movel	%a4,%a3@	/* 100149f2:	268c */
	jsr	%pc@(sub_100164fa)	/* 100149f4:	4eba 1b04 */
	moveal	%d0,%a0	/* 100149f8:	2040 */
	lea	%a0@(464),%a4	/* 100149fa:	49e8 01d0 */
	moveal	%a4@,%a0	/* 100149fe:	2054 */
	addql	#4,%a4@	/* 10014a00:	5894 */
	movel	%a2,%a0@	/* 10014a02:	208a */
	lea	%sp@(10),%sp	/* 10014a04:	4fef 000a */
	moveml	%fp@(-60),%a2-%a4	/* 10014a08:	4cee 1c00 ffc4 */
	unlk	%fp	/* 10014a0e:	4e5e */
	rts	/* 10014a10:	4e75 */
...
sub_10014a20:
	linkw	%fp,#-88	/* 10014a20:	4e56 ffa8 */
	moveml	%a2-%a4,%sp@-	/* 10014a24:	48e7 0038 */
	jsr	%pc@(sub_100164fa)	/* 10014a28:	4eba 1ad0 */
	moveal	%d0,%a0	/* 10014a2c:	2040 */
	lea	%a0@(464),%a3	/* 10014a2e:	47e8 01d0 */
	moveal	%a3@,%a4	/* 10014a32:	2853 */
	subqw	#8,%a4	/* 10014a34:	514c */
	pea	0x1b1	/* 10014a36:	4878 01b1 */
	moveq	#97,%d0	/* 10014a3a:	7061 */
	movel	%d0,%sp@-	/* 10014a3c:	2f00 */
	pea	%a4@(4)	/* 10014a3e:	486c 0004 */
	jsr	%pc@(sub_10017bc0)	/* 10014a42:	4eba 317c */
	movel	%a4@(4),%sp@-	/* 10014a46:	2f2c 0004 */
	jsr	%pc@(sub_100141dc)	/* 10014a4a:	4eba f790 */
	movew	%d0,%fp@(-54)	/* 10014a4e:	3d40 ffca */
	movel	%d1,%fp@(-52)	/* 10014a52:	2d41 ffcc */
	movel	%a0,%fp@(-48)	/* 10014a56:	2d48 ffd0 */
	pea	%pc@(.L10014cc0)	/* 10014a5a:	487a 0264 */
	pea	%fp@(-54)	/* 10014a5e:	486e ffca */
	movew	#8,%sp@-	/* 10014a62:	3f3c 0008 */
	.short	0xa9eb	/* 10014a66:	a9eb */
	lea	%sp@(16),%sp	/* 10014a68:	4fef 0010 */
	bnes	.L10014a7c	/* 10014a6c:	660e */
	movel	%a4@,%sp@-	/* 10014a6e:	2f14 */
	movel	#-2701,%sp@-	/* 10014a70:	2f3c ffff f573 */
	jsr	%pc@(sub_100164f6)	/* 10014a76:	4eba 1a7e */
	addqw	#8,%sp	/* 10014a7a:	504f */

.L10014a7c:
	movel	%a4@,%sp@-	/* 10014a7c:	2f14 */
	jsr	%pc@(sub_100141dc)	/* 10014a7e:	4eba f75c */
	movew	%d0,%fp@(-54)	/* 10014a82:	3d40 ffca */
	movel	%d1,%fp@(-52)	/* 10014a86:	2d41 ffcc */
	movel	%a0,%fp@(-48)	/* 10014a8a:	2d48 ffd0 */
	lea	%fp@(-54),%a0	/* 10014a8e:	41ee ffca */
	lea	%fp@(-40),%a1	/* 10014a92:	43ee ffd8 */
	movel	%a0@+,%a1@+	/* 10014a96:	22d8 */
	movel	%a0@+,%a1@+	/* 10014a98:	22d8 */
	movew	%a0@+,%a1@+	/* 10014a9a:	32d8 */
	movel	%a4@(4),%sp@-	/* 10014a9c:	2f2c 0004 */
	jsr	%pc@(sub_100141dc)	/* 10014aa0:	4eba f73a */
	movew	%d0,%fp@(-54)	/* 10014aa4:	3d40 ffca */
	movel	%d1,%fp@(-52)	/* 10014aa8:	2d41 ffcc */
	movel	%a0,%fp@(-48)	/* 10014aac:	2d48 ffd0 */
	lea	%fp@(-54),%a0	/* 10014ab0:	41ee ffca */
	lea	%fp@(-30),%a1	/* 10014ab4:	43ee ffe2 */
	movel	%a0@+,%a1@+	/* 10014ab8:	22d8 */
	movel	%a0@+,%a1@+	/* 10014aba:	22d8 */
	movew	%a0@+,%a1@+	/* 10014abc:	32d8 */
	pea	%fp@(-30)	/* 10014abe:	486e ffe2 */
	lea	%fp@(-54),%a0	/* 10014ac2:	41ee ffca */
	lea	%fp@(-40),%a1	/* 10014ac6:	43ee ffd8 */
	movel	%a1@+,%a0@+	/* 10014aca:	20d9 */
	movel	%a1@+,%a0@+	/* 10014acc:	20d9 */
	movew	%a1@+,%a0@+	/* 10014ace:	30d9 */
	pea	%fp@(-54)	/* 10014ad0:	486e ffca */
	movew	#6,%sp@-	/* 10014ad4:	3f3c 0006 */
	.short	0xa9eb	/* 10014ad8:	a9eb */
	lea	%fp@(-44),%a0	/* 10014ada:	41ee ffd4 */
	movel	%a0@-,%sp@-	/* 10014ade:	2f20 */
	movel	%a0@-,%sp@-	/* 10014ae0:	2f20 */
	movew	%a0@-,%sp@-	/* 10014ae2:	3f20 */
	jsr	%pc@(sub_10014354)	/* 10014ae4:	4eba f86e */
	movew	%d0,%fp@(-64)	/* 10014ae8:	3d40 ffc0 */
	movel	%d1,%fp@(-62)	/* 10014aec:	2d41 ffc2 */
	movel	%a0,%fp@(-58)	/* 10014af0:	2d48 ffc6 */
	lea	%fp@(-64),%a0	/* 10014af4:	41ee ffc0 */
	lea	%fp@(-20),%a1	/* 10014af8:	43ee ffec */
	movel	%a0@+,%a1@+	/* 10014afc:	22d8 */
	movel	%a0@+,%a1@+	/* 10014afe:	22d8 */
	movew	%a0@+,%a1@+	/* 10014b00:	32d8 */
	pea	%fp@(-20)	/* 10014b02:	486e ffec */
	lea	%fp@(-54),%a0	/* 10014b06:	41ee ffca */
	lea	%fp@(-30),%a1	/* 10014b0a:	43ee ffe2 */
	movel	%a1@+,%a0@+	/* 10014b0e:	20d9 */
	movel	%a1@+,%a0@+	/* 10014b10:	20d9 */
	movew	%a1@+,%a0@+	/* 10014b12:	30d9 */
	pea	%fp@(-54)	/* 10014b14:	486e ffca */
	movew	#4,%sp@-	/* 10014b18:	3f3c 0004 */
	.short	0xa9eb	/* 10014b1c:	a9eb */
	pea	%fp@(-54)	/* 10014b1e:	486e ffca */
	lea	%fp@(-64),%a0	/* 10014b22:	41ee ffc0 */
	lea	%fp@(-40),%a1	/* 10014b26:	43ee ffd8 */
	movel	%a1@+,%a0@+	/* 10014b2a:	20d9 */
	movel	%a1@+,%a0@+	/* 10014b2c:	20d9 */
	movew	%a1@+,%a0@+	/* 10014b2e:	30d9 */
	pea	%fp@(-64)	/* 10014b30:	486e ffc0 */
	movew	#2,%sp@-	/* 10014b34:	3f3c 0002 */
	.short	0xa9eb	/* 10014b38:	a9eb */
	lea	%fp@(-64),%a0	/* 10014b3a:	41ee ffc0 */
	lea	%fp@(-10),%a1	/* 10014b3e:	43ee fff6 */
	movel	%a0@+,%a1@+	/* 10014b42:	22d8 */
	movel	%a0@+,%a1@+	/* 10014b44:	22d8 */
	movew	%a0@+,%a1@+	/* 10014b46:	32d8 */
	pea	%fp@(-30)	/* 10014b48:	486e ffe2 */
	lea	%fp@(-54),%a0	/* 10014b4c:	41ee ffca */
	lea	%fp@(-10),%a1	/* 10014b50:	43ee fff6 */
	movel	%a1@+,%a0@+	/* 10014b54:	20d9 */
	movel	%a1@+,%a0@+	/* 10014b56:	20d9 */
	movew	%a1@+,%a0@+	/* 10014b58:	30d9 */
	pea	%fp@(-54)	/* 10014b5a:	486e ffca */
	movew	#6,%sp@-	/* 10014b5e:	3f3c 0006 */
	.short	0xa9eb	/* 10014b62:	a9eb */
	lea	%fp@(-44),%a0	/* 10014b64:	41ee ffd4 */
	movel	%a0@-,%sp@-	/* 10014b68:	2f20 */
	movel	%a0@-,%sp@-	/* 10014b6a:	2f20 */
	movew	%a0@-,%sp@-	/* 10014b6c:	3f20 */
	jsr	%pc@(sub_10014864)	/* 10014b6e:	4eba fcf4 */
	movew	%d0,%fp@(-64)	/* 10014b72:	3d40 ffc0 */
	movel	%d1,%fp@(-62)	/* 10014b76:	2d41 ffc2 */
	movel	%a0,%fp@(-58)	/* 10014b7a:	2d48 ffc6 */
	moveq	#0,%d0	/* 10014b7e:	7000 */
	movew	%d0,%fp@(-76)	/* 10014b80:	3d40 ffb4 */
	pea	%fp@(-76)	/* 10014b84:	486e ffb4 */
	pea	%fp@(-74)	/* 10014b88:	486e ffb6 */
	movew	#8206,%sp@-	/* 10014b8c:	3f3c 200e */
	.short	0xa9eb	/* 10014b90:	a9eb */
	pea	%fp@(-74)	/* 10014b92:	486e ffb6 */
	pea	%fp@(-64)	/* 10014b96:	486e ffc0 */
	movew	#8,%sp@-	/* 10014b9a:	3f3c 0008 */
	.short	0xa9eb	/* 10014b9e:	a9eb */
	lea	%sp@(28),%sp	/* 10014ba0:	4fef 001c */
	bnes	.L10014bb8	/* 10014ba4:	6612 */
	lea	%pc@(.L10014cc0),%a0	/* 10014ba6:	41fa 0118 */
	lea	%fp@(-10),%a1	/* 10014baa:	43ee fff6 */
	movel	%a0@+,%a1@+	/* 10014bae:	22d8 */
	movel	%a0@+,%a1@+	/* 10014bb0:	22d8 */
	movew	%a0@+,%a1@+	/* 10014bb2:	32d8 */
	braw	.L10014c78	/* 10014bb4:	6000 00c2 */

.L10014bb8:
	.short	0x41ee,0x0000	/* lea	%fp@(0),%a0	/* 10014bb8:	41ee 0000 */
	movel	%a0@-,%sp@-	/* 10014bbc:	2f20 */
	movel	%a0@-,%sp@-	/* 10014bbe:	2f20 */
	movew	%a0@-,%sp@-	/* 10014bc0:	3f20 */
	lea	%pc@(.L10014cca),%a0	/* 10014bc2:	41fa 0106 */
	lea	%a0@(10),%a0	/* 10014bc6:	41e8 000a */
	movel	%a0@-,%sp@-	/* 10014bca:	2f20 */
	movel	%a0@-,%sp@-	/* 10014bcc:	2f20 */
	movew	%a0@-,%sp@-	/* 10014bce:	3f20 */
	jsr	%pc@(sub_100174d8)	/* 10014bd0:	4eba 2906 */
	movew	%d0,%fp@(-54)	/* 10014bd4:	3d40 ffca */
	movel	%d1,%fp@(-52)	/* 10014bd8:	2d41 ffcc */
	movel	%a0,%fp@(-48)	/* 10014bdc:	2d48 ffd0 */
	lea	%fp@(-20),%a0	/* 10014be0:	41ee ffec */
	movel	%a0@-,%sp@-	/* 10014be4:	2f20 */
	movel	%a0@-,%sp@-	/* 10014be6:	2f20 */
	movew	%a0@-,%sp@-	/* 10014be8:	3f20 */
	lea	%pc@(.L10014cca),%a0	/* 10014bea:	41fa 00de */
	lea	%a0@(10),%a0	/* 10014bee:	41e8 000a */
	movel	%a0@-,%sp@-	/* 10014bf2:	2f20 */
	movel	%a0@-,%sp@-	/* 10014bf4:	2f20 */
	movew	%a0@-,%sp@-	/* 10014bf6:	3f20 */
	jsr	%pc@(sub_100174d8)	/* 10014bf8:	4eba 28de */
	movew	%d0,%fp@(-64)	/* 10014bfc:	3d40 ffc0 */
	movel	%d1,%fp@(-62)	/* 10014c00:	2d41 ffc2 */
	movel	%a0,%fp@(-58)	/* 10014c04:	2d48 ffc6 */
	pea	%fp@(-64)	/* 10014c08:	486e ffc0 */
	pea	%fp@(-54)	/* 10014c0c:	486e ffca */
	movew	#2,%sp@-	/* 10014c10:	3f3c 0002 */
	.short	0xa9eb	/* 10014c14:	a9eb */
	pea	%fp@(-30)	/* 10014c16:	486e ffe2 */
	pea	%fp@(-54)	/* 10014c1a:	486e ffca */
	movew	#6,%sp@-	/* 10014c1e:	3f3c 0006 */
	.short	0xa9eb	/* 10014c22:	a9eb */
	lea	%sp@(40),%sp	/* 10014c24:	4fef 0028 */
	lea	%fp@(-44),%a0	/* 10014c28:	41ee ffd4 */
	movel	%a0@-,%sp@-	/* 10014c2c:	2f20 */
	movel	%a0@-,%sp@-	/* 10014c2e:	2f20 */
	movew	%a0@-,%sp@-	/* 10014c30:	3f20 */
	jsr	%pc@(sub_10014864)	/* 10014c32:	4eba fc30 */
	movew	%d0,%fp@(-74)	/* 10014c36:	3d40 ffb6 */
	movel	%d1,%fp@(-72)	/* 10014c3a:	2d41 ffb8 */
	movel	%a0,%fp@(-68)	/* 10014c3e:	2d48 ffbc */
	moveq	#0,%d0	/* 10014c42:	7000 */
	movew	%d0,%fp@(-88)	/* 10014c44:	3d40 ffa8 */
	pea	%fp@(-88)	/* 10014c48:	486e ffa8 */
	pea	%fp@(-86)	/* 10014c4c:	486e ffaa */
	movew	#8206,%sp@-	/* 10014c50:	3f3c 200e */
	.short	0xa9eb	/* 10014c54:	a9eb */
	pea	%fp@(-86)	/* 10014c56:	486e ffaa */
	pea	%fp@(-74)	/* 10014c5a:	486e ffb6 */
	movew	#8,%sp@-	/* 10014c5e:	3f3c 0008 */
	.short	0xa9eb	/* 10014c62:	a9eb */
	lea	%sp@(10),%sp	/* 10014c64:	4fef 000a */
	bnes	.L10014c78	/* 10014c68:	660e */
	lea	%pc@(.L10014cc0),%a0	/* 10014c6a:	41fa 0054 */
	lea	%fp@(-10),%a1	/* 10014c6e:	43ee fff6 */
	movel	%a0@+,%a1@+	/* 10014c72:	22d8 */
	movel	%a0@+,%a1@+	/* 10014c74:	22d8 */
	movew	%a0@+,%a1@+	/* 10014c76:	32d8 */

.L10014c78:
	.short	0x41ee,0x0000	/* lea	%fp@(0),%a0	/* 10014c78:	41ee 0000 */
	movel	%a0@-,%sp@-	/* 10014c7c:	2f20 */
	movel	%a0@-,%sp@-	/* 10014c7e:	2f20 */
	movew	%a0@-,%sp@-	/* 10014c80:	3f20 */
	jsr	%pc@(sub_10014102)	/* 10014c82:	4eba f47e */
	jsr	%pc@(sub_100164fa)	/* 10014c86:	4eba 1872 */
	moveal	%d0,%a0	/* 10014c8a:	2040 */
	lea	%a0@(464),%a3	/* 10014c8c:	47e8 01d0 */
	moveal	%a3@,%a0	/* 10014c90:	2053 */
	moveal	%a0@(-4),%a2	/* 10014c92:	2468 fffc */
	jsr	%pc@(sub_100164fa)	/* 10014c96:	4eba 1862 */
	moveal	%d0,%a0	/* 10014c9a:	2040 */
	lea	%a0@(464),%a3	/* 10014c9c:	47e8 01d0 */
	movel	%a4,%a3@	/* 10014ca0:	268c */
	jsr	%pc@(sub_100164fa)	/* 10014ca2:	4eba 1856 */
	moveal	%d0,%a0	/* 10014ca6:	2040 */
	lea	%a0@(464),%a4	/* 10014ca8:	49e8 01d0 */
	moveal	%a4@,%a0	/* 10014cac:	2054 */
	addql	#4,%a4@	/* 10014cae:	5894 */
	movel	%a2,%a0@	/* 10014cb0:	208a */
	lea	%sp@(10),%sp	/* 10014cb2:	4fef 000a */
	moveml	%fp@(-100),%a2-%a4	/* 10014cb6:	4cee 1c00 ff9c */
	unlk	%fp	/* 10014cbc:	4e5e */
	rts	/* 10014cbe:	4e75 */
...
.L10014cca:
	.byte	0x3f,0xff,0x80,0x00,0x00,0x00,0x00,0x00,0x00,0x00

sub_10014cd4:
	.byte	0x60,0x00,0x77,0x2e

sub_10014cd8:
	braw	sub_100152cc	/* 10014cd8:	6000 05f2 */

sub_10014cdc:
	braw	sub_1001c408	/* 10014cdc:	6000 772a */

sub_10014ce0:
	braw	sub_1001c410	/* 10014ce0:	6000 772e */

sub_10014ce4:
	linkw	%fp,#-38	/* 10014ce4:	4e56 ffda */
	moveml	%d3/%d6-%d7/%a3-%a4,%sp@-	/* 10014ce8:	48e7 1318 */
	jsr	%pc@(sub_100164fa)	/* 10014cec:	4eba 180c */
	moveal	%d0,%a0	/* 10014cf0:	2040 */
	lea	%a0@(464),%a3	/* 10014cf2:	47e8 01d0 */
	moveal	%a3@,%a4	/* 10014cf6:	2853 */
	subqw	#8,%a4	/* 10014cf8:	514c */
	movel	%a4@(4),%d6	/* 10014cfa:	2c2c 0004 */
	asrl	#2,%d6	/* 10014cfe:	e486 */
	lea	%a4@(4),%a3	/* 10014d00:	47ec 0004 */
	movel	%a3@,%sp@-	/* 10014d04:	2f13 */
	jsr	%pc@(sub_10016a14)	/* 10014d06:	4eba 1d0c */
	moveb	%d0,%d7	/* 10014d0a:	1e00 */
	moveq	#1,%d3	/* 10014d0c:	7601 */
	moveq	#0,%d0	/* 10014d0e:	7000 */
	moveb	%d7,%d0	/* 10014d10:	1007 */
	cmpiw	#3,%d0	/* 10014d12:	0c40 0003 */
	addqw	#4,%sp	/* 10014d16:	584f */
	beqs	.L10014d38	/* 10014d18:	671e */
	movel	%d3,%sp@-	/* 10014d1a:	2f03 */
	moveq	#25,%d0	/* 10014d1c:	7019 */
	movel	%d0,%sp@-	/* 10014d1e:	2f00 */
	movel	%a3,%sp@-	/* 10014d20:	2f0b */
	moveq	#0,%d1	/* 10014d22:	7200 */
	moveb	%d7,%d1	/* 10014d24:	1207 */
	movel	%d1,%sp@-	/* 10014d26:	2f01 */
	jsr	%pc@(sub_1001793c)	/* 10014d28:	4eba 2c12 */
	lea	%sp@(12),%sp	/* 10014d2c:	4fef 000c */
	movel	%sp@+,%d3	/* 10014d30:	261f */
	tstb	%d0	/* 10014d32:	4a00 */
	bnes	.L10014d38	/* 10014d34:	6602 */
	moveq	#0,%d3	/* 10014d36:	7600 */

.L10014d38:
	tstb	%d3	/* 10014d38:	4a03 */
	beqw	.L10014dc4	/* 10014d3a:	6700 0088 */
	movel	%d6,%d0	/* 10014d3e:	2006 */
	swap	%d0	/* 10014d40:	4840 */
	extl	%d0	/* 10014d42:	48c0 */
	bnes	.L10014dc4	/* 10014d44:	667e */
	movew	%d6,%d0	/* 10014d46:	3006 */
	extl	%d0	/* 10014d48:	48c0 */
	movel	%d0,%sp@-	/* 10014d4a:	2f00 */
	movel	%a4@,%sp@-	/* 10014d4c:	2f14 */
	jsr	%pc@(sub_100141dc)	/* 10014d4e:	4eba f48c */
	movew	%d0,%fp@(-18)	/* 10014d52:	3d40 ffee */
	movel	%d1,%fp@(-16)	/* 10014d56:	2d41 fff0 */
	movel	%a0,%fp@(-12)	/* 10014d5a:	2d48 fff4 */
	addql	#4,%sp	/* 10014d5e:	588f */
	lea	%fp@(-8),%a0	/* 10014d60:	41ee fff8 */
	movel	%a0@-,%sp@-	/* 10014d64:	2f20 */
	movel	%a0@-,%sp@-	/* 10014d66:	2f20 */
	movew	%a0@-,%sp@-	/* 10014d68:	3f20 */
	jsr	%pc@(sub_1001742a)	/* 10014d6a:	4eba 26be */
	movew	%d0,%fp@(-28)	/* 10014d6e:	3d40 ffe4 */
	movel	%d1,%fp@(-26)	/* 10014d72:	2d41 ffe6 */
	movel	%a0,%fp@(-22)	/* 10014d76:	2d48 ffea */
	lea	%sp@(14),%sp	/* 10014d7a:	4fef 000e */
	lea	%fp@(-18),%a0	/* 10014d7e:	41ee ffee */
	movel	%a0@-,%sp@-	/* 10014d82:	2f20 */
	movel	%a0@-,%sp@-	/* 10014d84:	2f20 */
	movew	%a0@-,%sp@-	/* 10014d86:	3f20 */
	jsr	%pc@(sub_10014102)	/* 10014d88:	4eba f378 */
	jsr	%pc@(sub_100164fa)	/* 10014d8c:	4eba 176c */
	moveal	%d0,%a0	/* 10014d90:	2040 */
	lea	%a0@(464),%a3	/* 10014d92:	47e8 01d0 */
	moveal	%a3@,%a0	/* 10014d96:	2053 */
	movel	%a0@(-4),%fp@(-8)	/* 10014d98:	2d68 fffc fff8 */
	jsr	%pc@(sub_100164fa)	/* 10014d9e:	4eba 175a */
	moveal	%d0,%a0	/* 10014da2:	2040 */
	lea	%a0@(464),%a3	/* 10014da4:	47e8 01d0 */
	movel	%a4,%a3@	/* 10014da8:	268c */
	jsr	%pc@(sub_100164fa)	/* 10014daa:	4eba 174e */
	moveal	%d0,%a0	/* 10014dae:	2040 */
	lea	%a0@(464),%a3	/* 10014db0:	47e8 01d0 */
	moveal	%a3@,%a0	/* 10014db4:	2053 */
	addql	#4,%a3@	/* 10014db6:	5893 */
	movel	%fp@(-8),%a0@	/* 10014db8:	20ae fff8 */
	lea	%sp@(10),%sp	/* 10014dbc:	4fef 000a */
	braw	.L10014e68	/* 10014dc0:	6000 00a6 */

.L10014dc4:
	pea	0x1b1	/* 10014dc4:	4878 01b1 */
	moveq	#97,%d0	/* 10014dc8:	7061 */
	movel	%d0,%sp@-	/* 10014dca:	2f00 */
	pea	%a4@(4)	/* 10014dcc:	486c 0004 */
	jsr	%pc@(sub_10017bc0)	/* 10014dd0:	4eba 2dee */
	movel	%a4@(4),%sp@-	/* 10014dd4:	2f2c 0004 */
	jsr	%pc@(sub_100141dc)	/* 10014dd8:	4eba f402 */
	movew	%d0,%fp@(-18)	/* 10014ddc:	3d40 ffee */
	movel	%d1,%fp@(-16)	/* 10014de0:	2d41 fff0 */
	movel	%a0,%fp@(-12)	/* 10014de4:	2d48 fff4 */
	addql	#4,%sp	/* 10014de8:	588f */
	lea	%fp@(-8),%a0	/* 10014dea:	41ee fff8 */
	movel	%a0@-,%sp@-	/* 10014dee:	2f20 */
	movel	%a0@-,%sp@-	/* 10014df0:	2f20 */
	movew	%a0@-,%sp@-	/* 10014df2:	3f20 */
	movel	%a4@,%sp@-	/* 10014df4:	2f14 */
	jsr	%pc@(sub_100141dc)	/* 10014df6:	4eba f3e4 */
	movew	%d0,%fp@(-28)	/* 10014dfa:	3d40 ffe4 */
	movel	%d1,%fp@(-26)	/* 10014dfe:	2d41 ffe6 */
	movel	%a0,%fp@(-22)	/* 10014e02:	2d48 ffea */
	addql	#4,%sp	/* 10014e06:	588f */
	lea	%fp@(-18),%a0	/* 10014e08:	41ee ffee */
	movel	%a0@-,%sp@-	/* 10014e0c:	2f20 */
	movel	%a0@-,%sp@-	/* 10014e0e:	2f20 */
	movew	%a0@-,%sp@-	/* 10014e10:	3f20 */
	jsr	%pc@(sub_10017442)	/* 10014e12:	4eba 262e */
	movew	%d0,%fp@(-38)	/* 10014e16:	3d40 ffda */
	movel	%d1,%fp@(-36)	/* 10014e1a:	2d41 ffdc */
	movel	%a0,%fp@(-32)	/* 10014e1e:	2d48 ffe0 */
	lea	%sp@(20),%sp	/* 10014e22:	4fef 0014 */
	lea	%fp@(-28),%a0	/* 10014e26:	41ee ffe4 */
	movel	%a0@-,%sp@-	/* 10014e2a:	2f20 */
	movel	%a0@-,%sp@-	/* 10014e2c:	2f20 */
	movew	%a0@-,%sp@-	/* 10014e2e:	3f20 */
	jsr	%pc@(sub_10014102)	/* 10014e30:	4eba f2d0 */
	jsr	%pc@(sub_100164fa)	/* 10014e34:	4eba 16c4 */
	moveal	%d0,%a0	/* 10014e38:	2040 */
	lea	%a0@(464),%a3	/* 10014e3a:	47e8 01d0 */
	moveal	%a3@,%a0	/* 10014e3e:	2053 */
	movel	%a0@(-4),%fp@(-4)	/* 10014e40:	2d68 fffc fffc */
	jsr	%pc@(sub_100164fa)	/* 10014e46:	4eba 16b2 */
	moveal	%d0,%a0	/* 10014e4a:	2040 */
	lea	%a0@(464),%a3	/* 10014e4c:	47e8 01d0 */
	movel	%a4,%a3@	/* 10014e50:	268c */
	jsr	%pc@(sub_100164fa)	/* 10014e52:	4eba 16a6 */
	moveal	%d0,%a0	/* 10014e56:	2040 */
	lea	%a0@(464),%a4	/* 10014e58:	49e8 01d0 */
	moveal	%a4@,%a0	/* 10014e5c:	2054 */
	addql	#4,%a4@	/* 10014e5e:	5894 */
	movel	%fp@(-4),%a0@	/* 10014e60:	20ae fffc */
	lea	%sp@(22),%sp	/* 10014e64:	4fef 0016 */

.L10014e68:
	moveml	%fp@(-58),%d3/%d6-%d7/%a3-%a4	/* 10014e68:	4cee 18c8 ffc6 */
	unlk	%fp	/* 10014e6e:	4e5e */
	rts	/* 10014e70:	4e75 */
