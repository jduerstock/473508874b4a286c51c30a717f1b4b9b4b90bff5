...
sub_10043e6e:
	braw	sub_1004b688	/* 10043e6e:	6000 7818 */

sub_10043e72:
	braw	sub_1004b68c	/* 10043e72:	6000 7818 */

sub_10043e76:
	braw	sub_1004b690	/* 10043e76:	6000 7818 */

sub_10043e7a:
	braw	sub_1004b694	/* 10043e7a:	6000 7818 */

sub_10043e7e:
	linkw	%fp,#-110	/* 10043e7e:	4e56 ff92 */
	moveml	%d7/%a3-%a4,%sp@-	/* 10043e82:	48e7 0118 */
	moveal	%fp@(8),%a4	/* 10043e86:	286e 0008 */
	moveq	#3,%d0	/* 10043e8a:	7003 */
	movel	%d0,%sp@-	/* 10043e8c:	2f00 */
	jsr	%pc@(sub_1004aacc)	/* 10043e8e:	4eba 6c3c */
	moveal	%d0,%a0	/* 10043e92:	2040 */
	lea	%a0@(464),%a3	/* 10043e94:	47e8 01d0 */
	moveal	%a3@,%a0	/* 10043e98:	2053 */
	movel	%a0@(-4),%sp@-	/* 10043e9a:	2f28 fffc */
	movel	%a4,%sp@-	/* 10043e9e:	2f0c */
	jsr	%pc@(sub_10042b6c)	/* 10043ea0:	4eba ecca */
	jsr	%pc@(sub_1004aacc)	/* 10043ea4:	4eba 6c26 */
	moveal	%d0,%a0	/* 10043ea8:	2040 */
	lea	%a0@(464),%a0	/* 10043eaa:	41e8 01d0 */
	movel	%a0,%fp@(-8)	/* 10043eae:	2d48 fff8 */
	moveal	%a0@,%a3	/* 10043eb2:	2650 */
	subqw	#4,%a3	/* 10043eb4:	594b */
	movel	%a4@(2),%fp@(-24)	/* 10043eb6:	2d6c 0002 ffe8 */
	movel	%a3@,%d0	/* 10043ebc:	2013 */
	subql	#4,%d0	/* 10043ebe:	5980 */
	moveal	%d0,%a0	/* 10043ec0:	2040 */
	movel	%a0@,%d0	/* 10043ec2:	2010 */
	movel	%d0,%fp@(-4)	/* 10043ec4:	2d40 fffc */
	lsrl	#5,%d0	/* 10043ec8:	ea88 */
	subqw	#1,%d0	/* 10043eca:	5340 */
	movew	%d0,%d7	/* 10043ecc:	3e00 */
	moveq	#16,%d0	/* 10043ece:	7010 */
	movel	%d0,%sp@-	/* 10043ed0:	2f00 */
	movel	%a4@(2),%sp@-	/* 10043ed2:	2f2c 0002 */
	jsr	%pc@(sub_1004531e)	/* 10043ed6:	4eba 1446 */
	movel	%a4@(2),%fp@(-20)	/* 10043eda:	2d6c 0002 ffec */
	movew	%fp@(14),%fp@(-16)	/* 10043ee0:	3d6e 000e fff0 */
	moveq	#2,%d0	/* 10043ee6:	7002 */
	movel	%d0,%sp@-	/* 10043ee8:	2f00 */
	pea	%fp@(-16)	/* 10043eea:	486e fff0 */
	movel	%fp@(-20),%sp@-	/* 10043eee:	2f2e ffec */
	jsr	%pc@(sub_100452b2)	/* 10043ef2:	4eba 13be */
	movel	%fp@(-20),%fp@(-14)	/* 10043ef6:	2d6e ffec fff2 */
	movew	%d7,%fp@(-10)	/* 10043efc:	3d47 fff6 */
	moveq	#2,%d0	/* 10043f00:	7002 */
	movel	%d0,%sp@-	/* 10043f02:	2f00 */
	pea	%fp@(-10)	/* 10043f04:	486e fff6 */
	movel	%fp@(-14),%sp@-	/* 10043f08:	2f2e fff2 */
	jsr	%pc@(sub_100452b2)	/* 10043f0c:	4eba 13a4 */
	moveq	#2,%d0	/* 10043f10:	7002 */
	movel	%d0,%sp@-	/* 10043f12:	2f00 */
	extl	%d7	/* 10043f14:	48c7 */
	movel	%d7,%sp@-	/* 10043f16:	2f07 */
	pea	%fp@(-40)	/* 10043f18:	486e ffd8 */
	jsr	%pc@(sub_10042c7c)	/* 10043f1c:	4eba ed5e */
	movel	%a4,%fp@(-32)	/* 10043f20:	2d4c ffe0 */
	lea	%fp@(-40),%a0	/* 10043f24:	41ee ffd8 */
	pea	%fp@(-40)	/* 10043f28:	486e ffd8 */
	jsr	%pc@(sub_10042cae)	/* 10043f2c:	4eba ed80 */
	jsr	%pc@(sub_1004aacc)	/* 10043f30:	4eba 6b9a */
	moveal	%d0,%a0	/* 10043f34:	2040 */
	movel	%a0@(88),%fp@(-92)	/* 10043f36:	2d68 0058 ffa4 */
	lea	%fp@(-92),%a0	/* 10043f3c:	41ee ffa4 */
	movel	%a0,%sp@-	/* 10043f40:	2f08 */
	jsr	%pc@(sub_1004aacc)	/* 10043f42:	4eba 6b88 */
	moveal	%sp@+,%a0	/* 10043f46:	205f */
	moveal	%d0,%a1	/* 10043f48:	2240 */
	movel	%a0,%a1@(88)	/* 10043f4a:	2348 0058 */
	lea	%fp@(-92),%a0	/* 10043f4e:	41ee ffa4 */
	lea	%fp@(-88),%a0	/* 10043f52:	41ee ffa8 */
	lea	%pc@(.L10043f60),%a1	/* 10043f56:	43fa 0008 */
	moveml	%d2-%d7/%a1-%a4/%fp-%sp,%a0@	/* 10043f5a:	48d0 defc */
	moveq	#0,%d0	/* 10043f5e:	7000 */

.L10043f60:
	movel	%d0,%d7	/* 10043f60:	2e00 */
	lea	%sp@(60),%sp	/* 10043f62:	4fef 003c */
	bnew	.L1004409a	/* 10043f66:	6600 0132 */
	moveal	%a3@,%a0	/* 10043f6a:	2053 */
	moveq	#1,%d0	/* 10043f6c:	7001 */
	cmpl	%a0@,%d0	/* 10043f6e:	b090 */
	bnes	.L10043f80	/* 10043f70:	660e */
	movel	%a4,%sp@-	/* 10043f72:	2f0c */
	jsr	%pc@(sub_10044cb2)	/* 10043f74:	4eba 0d3c */
	movew	%d0,%fp@(-28)	/* 10043f78:	3d40 ffe4 */
	addqw	#4,%sp	/* 10043f7c:	584f */
	bras	.L10043f92	/* 10043f7e:	6012 */

.L10043f80:
	pea	%fp@(-28)	/* 10043f80:	486e ffe4 */
	moveal	%a3@,%a0	/* 10043f84:	2053 */
	movel	%a0@,%sp@-	/* 10043f86:	2f10 */
	movel	%a4,%sp@-	/* 10043f88:	2f0c */
	jsr	%pc@(sub_1004509e)	/* 10043f8a:	4eba 1112 */
	lea	%sp@(12),%sp	/* 10043f8e:	4fef 000c */

.L10043f92:
	pea	%fp@(-26)	/* 10043f92:	486e ffe6 */
	moveal	%a3@,%a0	/* 10043f96:	2053 */
	movel	%a0@(4),%sp@-	/* 10043f98:	2f28 0004 */
	movel	%a4,%sp@-	/* 10043f9c:	2f0c */
	jsr	%pc@(sub_1004509e)	/* 10043f9e:	4eba 10fe */
	pea	%fp@(-40)	/* 10043fa2:	486e ffd8 */
	jsr	%pc@(sub_1004515a)	/* 10043fa6:	4eba 11b2 */
	movew	%fp@(-26),%d0	/* 10043faa:	302e ffe6 */
	extl	%d0	/* 10043fae:	48c0 */
	movel	%d0,%sp@-	/* 10043fb0:	2f00 */
	movew	%fp@(-28),%fp@(-106)	/* 10043fb2:	3d6e ffe4 ff96 */
	moveq	#2,%d0	/* 10043fb8:	7002 */
	movel	%d0,%sp@-	/* 10043fba:	2f00 */
	pea	%fp@(-106)	/* 10043fbc:	486e ff96 */
	movel	%fp@(-24),%sp@-	/* 10043fc0:	2f2e ffe8 */
	jsr	%pc@(sub_100452b2)	/* 10043fc4:	4eba 12ec */
	lea	%sp@(12),%sp	/* 10043fc8:	4fef 000c */
	movel	%fp@(-24),%sp@-	/* 10043fcc:	2f2e ffe8 */
	jsr	%pc@(sub_10045262)	/* 10043fd0:	4eba 1290 */
	pea	%fp@(-40)	/* 10043fd4:	486e ffd8 */
	jsr	%pc@(sub_100451e0)	/* 10043fd8:	4eba 1206 */
	moveal	%a3@,%a0	/* 10043fdc:	2053 */
	moveq	#1,%d0	/* 10043fde:	7001 */
	cmpl	%a0@,%d0	/* 10043fe0:	b090 */
	lea	%sp@(28),%sp	/* 10043fe2:	4fef 001c */
	bnes	.L10044010	/* 10043fe6:	6628 */
	jsr	%pc@(sub_1004aacc)	/* 10043fe8:	4eba 6ae2 */
	moveal	%d0,%a0	/* 10043fec:	2040 */
	lea	%a0@(464),%a0	/* 10043fee:	41e8 01d0 */
	movel	%a0,%fp@(-104)	/* 10043ff2:	2d48 ff98 */
	moveal	%a0@,%a1	/* 10043ff6:	2250 */
	addql	#4,%a0@	/* 10043ff8:	5890 */
	moveq	#1,%d0	/* 10043ffa:	7001 */
	movel	%d0,%a1@	/* 10043ffc:	2280 */
	movew	%fp@(-28),%d0	/* 10043ffe:	302e ffe4 */
	extl	%d0	/* 10044002:	48c0 */
	movel	%d0,%sp@-	/* 10044004:	2f00 */
	movel	%a4,%sp@-	/* 10044006:	2f0c */
	jsr	%pc@(sub_1004342c)	/* 10044008:	4eba f422 */
	addqw	#8,%sp	/* 1004400c:	504f */
	bras	.L1004404e	/* 1004400e:	603e */

.L10044010:
	moveal	%a3@,%a0	/* 10044010:	2053 */
	movel	%a0@,%sp@-	/* 10044012:	2f10 */
	movel	%a4,%sp@-	/* 10044014:	2f0c */
	jsr	%pc@(sub_10042b22)	/* 10044016:	4eba eb0a */
	cmpiw	#3,%d0	/* 1004401a:	0c40 0003 */
	addqw	#8,%sp	/* 1004401e:	504f */
	beqs	.L1004404e	/* 10044020:	672c */
	moveal	%a3@,%a0	/* 10044022:	2053 */
	movel	%a0@,%fp@(-100)	/* 10044024:	2d50 ff9c */
	jsr	%pc@(sub_1004aacc)	/* 10044028:	4eba 6aa2 */
	moveal	%d0,%a0	/* 1004402c:	2040 */
	lea	%a0@(464),%a0	/* 1004402e:	41e8 01d0 */
	movel	%a0,%fp@(-104)	/* 10044032:	2d48 ff98 */
	moveal	%a0@,%a1	/* 10044036:	2250 */
	addql	#4,%a0@	/* 10044038:	5890 */
	movel	%fp@(-100),%a1@	/* 1004403a:	22ae ff9c */
	movew	%fp@(-28),%d0	/* 1004403e:	302e ffe4 */
	extl	%d0	/* 10044042:	48c0 */
	movel	%d0,%sp@-	/* 10044044:	2f00 */
	movel	%a4,%sp@-	/* 10044046:	2f0c */
	jsr	%pc@(sub_10043e7e)	/* 10044048:	4eba fe34 */
	addqw	#8,%sp	/* 1004404c:	504f */

.L1004404e:
	moveal	%a3@,%a0	/* 1004404e:	2053 */
	movel	%a0@(4),%sp@-	/* 10044050:	2f28 0004 */
	movel	%a4,%sp@-	/* 10044054:	2f0c */
	jsr	%pc@(sub_10042b22)	/* 10044056:	4eba eaca */
	cmpiw	#3,%d0	/* 1004405a:	0c40 0003 */
	addqw	#8,%sp	/* 1004405e:	504f */
	beqs	.L10044090	/* 10044060:	672e */
	moveal	%a3@,%a0	/* 10044062:	2053 */
	movel	%a0@(4),%fp@(-96)	/* 10044064:	2d68 0004 ffa0 */
	jsr	%pc@(sub_1004aacc)	/* 1004406a:	4eba 6a60 */
	moveal	%d0,%a0	/* 1004406e:	2040 */
	lea	%a0@(464),%a0	/* 10044070:	41e8 01d0 */
	movel	%a0,%fp@(-104)	/* 10044074:	2d48 ff98 */
	moveal	%a0@,%a1	/* 10044078:	2250 */
	addql	#4,%a0@	/* 1004407a:	5890 */
	movel	%fp@(-96),%a1@	/* 1004407c:	22ae ffa0 */
	movew	%fp@(-26),%d0	/* 10044080:	302e ffe6 */
	extl	%d0	/* 10044084:	48c0 */
	movel	%d0,%sp@-	/* 10044086:	2f00 */
	movel	%a4,%sp@-	/* 10044088:	2f0c */
	jsr	%pc@(sub_10043042)	/* 1004408a:	4eba efb6 */
	addqw	#8,%sp	/* 1004408e:	504f */

.L10044090:
	pea	%fp@(-40)	/* 10044090:	486e ffd8 */
	jsr	%pc@(sub_100450e4)	/* 10044094:	4eba 104e */
	addqw	#4,%sp	/* 10044098:	584f */

.L1004409a:
	jsr	%pc@(sub_1004aacc)	/* 1004409a:	4eba 6a30 */
	moveal	%d0,%a0	/* 1004409e:	2040 */
	movel	%fp@(-92),%a0@(88)	/* 100440a0:	216e ffa4 0058 */
	pea	%fp@(-40)	/* 100440a6:	486e ffd8 */
	jsr	%pc@(sub_10042d08)	/* 100440aa:	4eba ec5c */
	tstl	%d7	/* 100440ae:	4a87 */
	addqw	#4,%sp	/* 100440b0:	584f */
	beqs	.L100440d0	/* 100440b2:	671c */
	movel	%d7,%d0	/* 100440b4:	2007 */
	movel	%d0,%fp@(-110)	/* 100440b6:	2d40 ff92 */
	jsr	%pc@(sub_1004aacc)	/* 100440ba:	4eba 6a10 */
	moveal	%d0,%a0	/* 100440be:	2040 */
	moveal	%a0@(88),%a0	/* 100440c0:	2068 0058 */
	addql	#4,%a0	/* 100440c4:	5888 */
	movel	%fp@(-110),%d0	/* 100440c6:	202e ff92 */
	moveml	%a0@,%d2-%d7/%a1-%a4/%fp-%sp	/* 100440ca:	4cd0 defc */
	jmp	%a1@	/* 100440ce:	4ed1 */

.L100440d0:
	moveq	#2,%d0	/* 100440d0:	7002 */
	movel	%d0,%sp@-	/* 100440d2:	2f00 */
	pea	%fp@(-92)	/* 100440d4:	486e ffa4 */
	jsr	%pc@(sub_1004aac8)	/* 100440d8:	4eba 69ee */
	jsr	%pc@(sub_1004aacc)	/* 100440dc:	4eba 69ee */
	moveal	%d0,%a0	/* 100440e0:	2040 */
	lea	%a0@(464),%a4	/* 100440e2:	49e8 01d0 */
	subql	#4,%a4@	/* 100440e6:	5994 */
	moveal	%a4@,%a0	/* 100440e8:	2054 */
	jsr	%pc@(sub_1004aacc)	/* 100440ea:	4eba 69e0 */
	moveal	%d0,%a0	/* 100440ee:	2040 */
	lea	%a0@(464),%a4	/* 100440f0:	49e8 01d0 */
	movel	%a3,%a4@	/* 100440f4:	288b */
	addqw	#8,%sp	/* 100440f6:	504f */
	moveml	%fp@(-122),%d7/%a3-%a4	/* 100440f8:	4cee 1880 ff86 */
	unlk	%fp	/* 100440fe:	4e5e */
	rts	/* 10044100:	4e75 */

sub_10044102:
	braw	sub_1004b8a0	/* 10044102:	6000 779c */

sub_10044106:
	braw	sub_1004b8a4	/* 10044106:	6000 779c */

sub_1004410a:
	braw	sub_1004b8a8	/* 1004410a:	6000 779c */

sub_1004410e:
	braw	sub_10048590	/* 1004410e:	6000 4480 */

sub_10044112:
	braw	sub_1003cb60	/* 10044112:	6000 8a4c */

sub_10044116:
	braw	sub_100432c4	/* 10044116:	6000 f1ac */

sub_1004411a:
	braw	sub_1003d2c8	/* 1004411a:	6000 91ac */

sub_1004411e:
	braw	sub_10042a72	/* 1004411e:	6000 e952 */

sub_10044122:
	braw	sub_1003d286	/* 10044122:	6000 9162 */

sub_10044126:
	braw	sub_1003d678	/* 10044126:	6000 9550 */

sub_1004412a:
	braw	sub_1004280c	/* 1004412a:	6000 e6e0 */

sub_1004412e:
	braw	sub_100433fc	/* 1004412e:	6000 f2cc */

sub_10044132:
	linkw	%fp,#-40	/* 10044132:	4e56 ffd8 */
	moveml	%d6-%d7/%a3-%a4,%sp@-	/* 10044136:	48e7 0318 */
	movew	%fp@(14),%d6	/* 1004413a:	3c2e 000e */
	moveal	%fp@(8),%a4	/* 1004413e:	286e 0008 */
	jsr	%pc@(sub_1004aacc)	/* 10044142:	4eba 6988 */
	moveal	%d0,%a0	/* 10044146:	2040 */
	lea	%a0@(464),%a0	/* 10044148:	41e8 01d0 */
	movel	%a0,%fp@(-4)	/* 1004414c:	2d48 fffc */
	moveal	%a0@,%a3	/* 10044150:	2650 */
	subqw	#4,%a3	/* 10044152:	594b */
	moveb	%fp@(19),%d7	/* 10044154:	1e2e 0013 */
	movel	%a4@(2),%fp@(-8)	/* 10044158:	2d6c 0002 fff8 */
	jsr	%pc@(sub_1004aacc)	/* 1004415e:	4eba 696c */
	moveal	%d0,%a0	/* 10044162:	2040 */
	movel	%a3@,%d0	/* 10044164:	2013 */
	cmpl	%a0@(204),%d0	/* 10044166:	b0a8 00cc */
	bnes	.L100441c2	/* 1004416a:	6656 */
	moveq	#14,%d0	/* 1004416c:	700e */
	movel	%d0,%sp@-	/* 1004416e:	2f00 */
	movel	%a4@(2),%sp@-	/* 10044170:	2f2c 0002 */
	jsr	%pc@(sub_1004531e)	/* 10044174:	4eba 11a8 */
	movel	%a4@(2),%fp@(-28)	/* 10044178:	2d6c 0002 ffe4 */
	movew	%d6,%fp@(-24)	/* 1004417e:	3d46 ffe8 */
	moveq	#2,%d0	/* 10044182:	7002 */
	movel	%d0,%sp@-	/* 10044184:	2f00 */
	pea	%fp@(-24)	/* 10044186:	486e ffe8 */
	movel	%fp@(-28),%sp@-	/* 1004418a:	2f2e ffe4 */
	jsr	%pc@(sub_100452b2)	/* 1004418e:	4eba 1122 */
	movel	%fp@(-28),%fp@(-22)	/* 10044192:	2d6e ffe4 ffea */
	clrw	%fp@(-18)	/* 10044198:	426e ffee */
	moveq	#2,%d0	/* 1004419c:	7002 */
	movel	%d0,%sp@-	/* 1004419e:	2f00 */
	pea	%fp@(-18)	/* 100441a0:	486e ffee */
	movel	%fp@(-22),%sp@-	/* 100441a4:	2f2e ffea */
	jsr	%pc@(sub_100452b2)	/* 100441a8:	4eba 1108 */
	moveq	#0,%d0	/* 100441ac:	7000 */
	moveb	%d7,%d0	/* 100441ae:	1007 */
	movel	%d0,%sp@-	/* 100441b0:	2f00 */
	movel	%fp@(-8),%sp@-	/* 100441b2:	2f2e fff8 */
	jsr	%pc@(sub_1004531e)	/* 100441b6:	4eba 1166 */
	lea	%sp@(40),%sp	/* 100441ba:	4fef 0028 */
	braw	.L1004441e	/* 100441be:	6000 025e */

.L100441c2:
	pea	%fp@(-16)	/* 100441c2:	486e fff0 */
	moveal	%a3@,%a0	/* 100441c6:	2053 */
	movel	%a0@(4),%sp@-	/* 100441c8:	2f28 0004 */
	movel	%a4,%sp@-	/* 100441cc:	2f0c */
	jsr	%pc@(sub_10045040)	/* 100441ce:	4eba 0e70 */
	jsr	%pc@(sub_1004aacc)	/* 100441d2:	4eba 68f8 */
	moveal	%d0,%a0	/* 100441d6:	2040 */
	moveq	#1,%d0	/* 100441d8:	7001 */
	andl	%a0@(68),%d0	/* 100441da:	c0a8 0044 */
	moveq	#1,%d1	/* 100441de:	7201 */
	cmpl	%d0,%d1	/* 100441e0:	b280 */
	lea	%sp@(12),%sp	/* 100441e2:	4fef 000c */
	bnes	.L100441f6	/* 100441e6:	660e */
	movel	%a4,%sp@-	/* 100441e8:	2f0c */
	jsr	%pc@(sub_10044cb2)	/* 100441ea:	4eba 0ac6 */
	movew	%d0,%fp@(-14)	/* 100441ee:	3d40 fff2 */
	addqw	#4,%sp	/* 100441f2:	584f */
	bras	.L1004420a	/* 100441f4:	6014 */

.L100441f6:
	pea	%fp@(-14)	/* 100441f6:	486e fff2 */
	moveal	%a3@,%a0	/* 100441fa:	2053 */
	movel	%a0@(8),%sp@-	/* 100441fc:	2f28 0008 */
	movel	%a4,%sp@-	/* 10044200:	2f0c */
	jsr	%pc@(sub_10045040)	/* 10044202:	4eba 0e3c */
	lea	%sp@(12),%sp	/* 10044206:	4fef 000c */

.L1004420a:
	pea	%fp@(-12)	/* 1004420a:	486e fff4 */
	moveal	%a3@,%a0	/* 1004420e:	2053 */
	movel	%a0@(12),%sp@-	/* 10044210:	2f28 000c */
	movel	%a4,%sp@-	/* 10044214:	2f0c */
	jsr	%pc@(sub_10045040)	/* 10044216:	4eba 0e28 */
	moveal	%a3@,%a0	/* 1004421a:	2053 */
	moveq	#1,%d0	/* 1004421c:	7001 */
	cmpl	%a0@(16),%d0	/* 1004421e:	b0a8 0010 */
	lea	%sp@(12),%sp	/* 10044222:	4fef 000c */
	bnes	.L10044236	/* 10044226:	660e */
	movel	%a4,%sp@-	/* 10044228:	2f0c */
	jsr	%pc@(sub_10044cb2)	/* 1004422a:	4eba 0a86 */
	movew	%d0,%fp@(-10)	/* 1004422e:	3d40 fff6 */
	addqw	#4,%sp	/* 10044232:	584f */
	bras	.L1004424a	/* 10044234:	6014 */

.L10044236:
	pea	%fp@(-10)	/* 10044236:	486e fff6 */
	moveal	%a3@,%a0	/* 1004423a:	2053 */
	movel	%a0@(16),%sp@-	/* 1004423c:	2f28 0010 */
	movel	%a4,%sp@-	/* 10044240:	2f0c */
	jsr	%pc@(sub_1004509e)	/* 10044242:	4eba 0e5a */
	lea	%sp@(12),%sp	/* 10044246:	4fef 000c */

.L1004424a:
	moveq	#14,%d0	/* 1004424a:	700e */
	movel	%d0,%sp@-	/* 1004424c:	2f00 */
	movel	%a4@(2),%sp@-	/* 1004424e:	2f2c 0002 */
	jsr	%pc@(sub_1004531e)	/* 10044252:	4eba 10ca */
	movel	%a4@(2),%fp@(-40)	/* 10044256:	2d6c 0002 ffd8 */
	movew	%d6,%fp@(-36)	/* 1004425c:	3d46 ffdc */
	moveq	#2,%d0	/* 10044260:	7002 */
	movel	%d0,%sp@-	/* 10044262:	2f00 */
	pea	%fp@(-36)	/* 10044264:	486e ffdc */
	movel	%fp@(-40),%sp@-	/* 10044268:	2f2e ffd8 */
	jsr	%pc@(sub_100452b2)	/* 1004426c:	4eba 1044 */
	movel	%fp@(-40),%fp@(-34)	/* 10044270:	2d6e ffd8 ffde */
	movew	#4,%fp@(-30)	/* 10044276:	3d7c 0004 ffe2 */
	moveq	#2,%d0	/* 1004427c:	7002 */
	movel	%d0,%sp@-	/* 1004427e:	2f00 */
	pea	%fp@(-30)	/* 10044280:	486e ffe2 */
	movel	%fp@(-34),%sp@-	/* 10044284:	2f2e ffde */
	jsr	%pc@(sub_100452b2)	/* 10044288:	4eba 1028 */
	moveq	#0,%d0	/* 1004428c:	7000 */
	moveb	%d7,%d0	/* 1004428e:	1007 */
	movel	%d0,%sp@-	/* 10044290:	2f00 */
	movel	%fp@(-8),%sp@-	/* 10044292:	2f2e fff8 */
	jsr	%pc@(sub_1004531e)	/* 10044296:	4eba 1086 */
	movew	%fp@(-12),%d0	/* 1004429a:	302e fff4 */
	extl	%d0	/* 1004429e:	48c0 */
	movel	%d0,%sp@-	/* 100442a0:	2f00 */
	movew	%fp@(-14),%d0	/* 100442a2:	302e fff2 */
	extl	%d0	/* 100442a6:	48c0 */
	movel	%d0,%sp@-	/* 100442a8:	2f00 */
	movew	%fp@(-16),%fp@(-28)	/* 100442aa:	3d6e fff0 ffe4 */
	moveq	#2,%d0	/* 100442b0:	7002 */
	movel	%d0,%sp@-	/* 100442b2:	2f00 */
	pea	%fp@(-28)	/* 100442b4:	486e ffe4 */
	movel	%fp@(-8),%sp@-	/* 100442b8:	2f2e fff8 */
	jsr	%pc@(sub_100452b2)	/* 100442bc:	4eba 0ff4 */
	lea	%sp@(12),%sp	/* 100442c0:	4fef 000c */
	movel	%fp@(-8),%sp@-	/* 100442c4:	2f2e fff8 */
	jsr	%pc@(sub_10045262)	/* 100442c8:	4eba 0f98 */
	addql	#8,%sp	/* 100442cc:	508f */
	movel	%d0,%sp@-	/* 100442ce:	2f00 */
	jsr	%pc@(sub_10045262)	/* 100442d0:	4eba 0f90 */
	movew	%fp@(-10),%fp@(-26)	/* 100442d4:	3d6e fff6 ffe6 */
	moveq	#2,%d0	/* 100442da:	7002 */
	movel	%d0,%sp@-	/* 100442dc:	2f00 */
	pea	%fp@(-26)	/* 100442de:	486e ffe6 */
	movel	%fp@(-8),%sp@-	/* 100442e2:	2f2e fff8 */
	jsr	%pc@(sub_100452b2)	/* 100442e6:	4eba 0fca */
	moveal	%a3@,%a0	/* 100442ea:	2053 */
	movel	%a0@(4),%sp@-	/* 100442ec:	2f28 0004 */
	movel	%a4,%sp@-	/* 100442f0:	2f0c */
	jsr	%pc@(sub_10042b22)	/* 100442f2:	4eba e82e */
	cmpiw	#3,%d0	/* 100442f6:	0c40 0003 */
	lea	%sp@(68),%sp	/* 100442fa:	4fef 0044 */
	beqs	.L10044318	/* 100442fe:	6718 */
	movew	%fp@(-16),%d0	/* 10044300:	302e fff0 */
	extl	%d0	/* 10044304:	48c0 */
	movel	%d0,%sp@-	/* 10044306:	2f00 */
	moveal	%a3@,%a0	/* 10044308:	2053 */
	movel	%a0@(4),%sp@-	/* 1004430a:	2f28 0004 */
	movel	%a4,%sp@-	/* 1004430e:	2f0c */
	jsr	%pc@(sub_10044cd8)	/* 10044310:	4eba 09c6 */
	lea	%sp@(12),%sp	/* 10044314:	4fef 000c */

.L10044318:
	jsr	%pc@(sub_1004aacc)	/* 10044318:	4eba 67b2 */
	moveal	%d0,%a0	/* 1004431c:	2040 */
	moveq	#1,%d0	/* 1004431e:	7001 */
	andl	%a0@(68),%d0	/* 10044320:	c0a8 0044 */
	moveq	#1,%d1	/* 10044324:	7201 */
	cmpl	%d0,%d1	/* 10044326:	b280 */
	bnes	.L10044352	/* 10044328:	6628 */
	jsr	%pc@(sub_1004aacc)	/* 1004432a:	4eba 67a0 */
	moveal	%d0,%a0	/* 1004432e:	2040 */
	lea	%a0@(464),%a0	/* 10044330:	41e8 01d0 */
	movel	%a0,%fp@(-24)	/* 10044334:	2d48 ffe8 */
	moveal	%a0@,%a1	/* 10044338:	2250 */
	addql	#4,%a0@	/* 1004433a:	5890 */
	moveq	#1,%d0	/* 1004433c:	7001 */
	movel	%d0,%a1@	/* 1004433e:	2280 */
	movew	%fp@(-14),%d0	/* 10044340:	302e fff2 */
	extl	%d0	/* 10044344:	48c0 */
	movel	%d0,%sp@-	/* 10044346:	2f00 */
	movel	%a4,%sp@-	/* 10044348:	2f0c */
	jsr	%pc@(sub_1004342c)	/* 1004434a:	4eba f0e0 */
	addqw	#8,%sp	/* 1004434e:	504f */
	bras	.L1004437e	/* 10044350:	602c */

.L10044352:
	moveal	%a3@,%a0	/* 10044352:	2053 */
	movel	%a0@(8),%sp@-	/* 10044354:	2f28 0008 */
	movel	%a4,%sp@-	/* 10044358:	2f0c */
	jsr	%pc@(sub_10042b22)	/* 1004435a:	4eba e7c6 */
	cmpiw	#3,%d0	/* 1004435e:	0c40 0003 */
	addqw	#8,%sp	/* 10044362:	504f */
	beqs	.L1004437e	/* 10044364:	6718 */
	movew	%fp@(-14),%d0	/* 10044366:	302e fff2 */
	extl	%d0	/* 1004436a:	48c0 */
	movel	%d0,%sp@-	/* 1004436c:	2f00 */
	moveal	%a3@,%a0	/* 1004436e:	2053 */
	movel	%a0@(8),%sp@-	/* 10044370:	2f28 0008 */
	movel	%a4,%sp@-	/* 10044374:	2f0c */
	jsr	%pc@(sub_10044cd8)	/* 10044376:	4eba 0960 */
	lea	%sp@(12),%sp	/* 1004437a:	4fef 000c */

.L1004437e:
	moveal	%a3@,%a0	/* 1004437e:	2053 */
	movel	%a0@(12),%sp@-	/* 10044380:	2f28 000c */
	movel	%a4,%sp@-	/* 10044384:	2f0c */
	jsr	%pc@(sub_10042b22)	/* 10044386:	4eba e79a */
	cmpiw	#3,%d0	/* 1004438a:	0c40 0003 */
	addqw	#8,%sp	/* 1004438e:	504f */
	beqs	.L100443aa	/* 10044390:	6718 */
	movew	%fp@(-12),%d0	/* 10044392:	302e fff4 */
	extl	%d0	/* 10044396:	48c0 */
	movel	%d0,%sp@-	/* 10044398:	2f00 */
	moveal	%a3@,%a0	/* 1004439a:	2053 */
	movel	%a0@(12),%sp@-	/* 1004439c:	2f28 000c */
	movel	%a4,%sp@-	/* 100443a0:	2f0c */
	jsr	%pc@(sub_10044cd8)	/* 100443a2:	4eba 0934 */
	lea	%sp@(12),%sp	/* 100443a6:	4fef 000c */

.L100443aa:
	moveal	%a3@,%a0	/* 100443aa:	2053 */
	moveq	#1,%d0	/* 100443ac:	7001 */
	cmpl	%a0@(16),%d0	/* 100443ae:	b0a8 0010 */
	bnes	.L100443dc	/* 100443b2:	6628 */
	jsr	%pc@(sub_1004aacc)	/* 100443b4:	4eba 6716 */
	moveal	%d0,%a0	/* 100443b8:	2040 */
	lea	%a0@(464),%a0	/* 100443ba:	41e8 01d0 */
	movel	%a0,%fp@(-24)	/* 100443be:	2d48 ffe8 */
	moveal	%a0@,%a1	/* 100443c2:	2250 */
	addql	#4,%a0@	/* 100443c4:	5890 */
	moveq	#1,%d0	/* 100443c6:	7001 */
	movel	%d0,%a1@	/* 100443c8:	2280 */
	movew	%fp@(-10),%d0	/* 100443ca:	302e fff6 */
	extl	%d0	/* 100443ce:	48c0 */
	movel	%d0,%sp@-	/* 100443d0:	2f00 */
	movel	%a4,%sp@-	/* 100443d2:	2f0c */
	jsr	%pc@(sub_1004342c)	/* 100443d4:	4eba f056 */
	addqw	#8,%sp	/* 100443d8:	504f */
	bras	.L1004441e	/* 100443da:	6042 */

.L100443dc:
	moveal	%a3@,%a0	/* 100443dc:	2053 */
	movel	%a0@(16),%sp@-	/* 100443de:	2f28 0010 */
	movel	%a4,%sp@-	/* 100443e2:	2f0c */
	jsr	%pc@(sub_10042b22)	/* 100443e4:	4eba e73c */
	cmpiw	#3,%d0	/* 100443e8:	0c40 0003 */
	addqw	#8,%sp	/* 100443ec:	504f */
	beqs	.L1004441e	/* 100443ee:	672e */
	moveal	%a3@,%a0	/* 100443f0:	2053 */
	movel	%a0@(16),%fp@(-20)	/* 100443f2:	2d68 0010 ffec */
	jsr	%pc@(sub_1004aacc)	/* 100443f8:	4eba 66d2 */
	moveal	%d0,%a0	/* 100443fc:	2040 */
	lea	%a0@(464),%a0	/* 100443fe:	41e8 01d0 */
	movel	%a0,%fp@(-24)	/* 10044402:	2d48 ffe8 */
	moveal	%a0@,%a1	/* 10044406:	2250 */
	addql	#4,%a0@	/* 10044408:	5890 */
	movel	%fp@(-20),%a1@	/* 1004440a:	22ae ffec */
	movew	%fp@(-10),%d0	/* 1004440e:	302e fff6 */
	extl	%d0	/* 10044412:	48c0 */
	movel	%d0,%sp@-	/* 10044414:	2f00 */
	movel	%a4,%sp@-	/* 10044416:	2f0c */
	jsr	%pc@(sub_10043e7e)	/* 10044418:	4eba fa64 */
	addqw	#8,%sp	/* 1004441c:	504f */

.L1004441e:
	jsr	%pc@(sub_1004aacc)	/* 1004441e:	4eba 66ac */
	moveal	%d0,%a0	/* 10044422:	2040 */
	lea	%a0@(464),%a4	/* 10044424:	49e8 01d0 */
	movel	%a3,%a4@	/* 10044428:	288b */
	moveml	%fp@(-56),%d6-%d7/%a3-%a4	/* 1004442a:	4cee 18c0 ffc8 */
	unlk	%fp	/* 10044430:	4e5e */
	rts	/* 10044432:	4e75 */

sub_10044434:
	braw	sub_1004bc3a	/* 10044434:	6000 7804 */

sub_10044438:
	braw	sub_10048768	/* 10044438:	6000 432e */

sub_1004443c:
	braw	sub_10048a10	/* 1004443c:	6000 45d2 */

sub_10044440:
	braw	sub_1003d6ea	/* 10044440:	6000 92a8 */

sub_10044444:
	braw	sub_1003e914	/* 10044444:	6000 a4ce */

sub_10044448:
	linkw	%fp,#-50	/* 10044448:	4e56 ffce */
	moveml	%d4-%d7/%a3-%a4,%sp@-	/* 1004444c:	48e7 0f18 */
	moveal	%fp@(8),%a4	/* 10044450:	286e 0008 */
	jsr	%pc@(sub_1004aacc)	/* 10044454:	4eba 6676 */
	moveal	%d0,%a0	/* 10044458:	2040 */
	lea	%a0@(464),%a0	/* 1004445a:	41e8 01d0 */
	movel	%a0,%fp@(-4)	/* 1004445e:	2d48 fffc */
	moveal	%a0@,%a3	/* 10044462:	2650 */
	subqw	#4,%a3	/* 10044464:	594b */
	moveb	%fp@(19),%d4	/* 10044466:	182e 0013 */
	movel	%a4@(2),%fp@(-42)	/* 1004446a:	2d6c 0002 ffd6 */
	pea	%fp@(-50)	/* 10044470:	486e ffce */
	moveal	%a3@,%a0	/* 10044474:	2053 */
	movel	%a0@(4),%sp@-	/* 10044476:	2f28 0004 */
	movel	%a4,%sp@-	/* 1004447a:	2f0c */
	jsr	%pc@(sub_10045040)	/* 1004447c:	4eba 0bc2 */
	jsr	%pc@(sub_1004aacc)	/* 10044480:	4eba 664a */
	moveal	%d0,%a0	/* 10044484:	2040 */
	moveq	#1,%d0	/* 10044486:	7001 */
	andl	%a0@(68),%d0	/* 10044488:	c0a8 0044 */
	moveq	#1,%d1	/* 1004448c:	7201 */
	cmpl	%d0,%d1	/* 1004448e:	b280 */
	lea	%sp@(12),%sp	/* 10044490:	4fef 000c */
	bnes	.L100444a4	/* 10044494:	660e */
	movel	%a4,%sp@-	/* 10044496:	2f0c */
	jsr	%pc@(sub_10044cb2)	/* 10044498:	4eba 0818 */
	movew	%d0,%fp@(-48)	/* 1004449c:	3d40 ffd0 */
	addqw	#4,%sp	/* 100444a0:	584f */
	bras	.L100444b8	/* 100444a2:	6014 */

.L100444a4:
	pea	%fp@(-48)	/* 100444a4:	486e ffd0 */
	moveal	%a3@,%a0	/* 100444a8:	2053 */
	movel	%a0@(8),%sp@-	/* 100444aa:	2f28 0008 */
	movel	%a4,%sp@-	/* 100444ae:	2f0c */
	jsr	%pc@(sub_10045040)	/* 100444b0:	4eba 0b8e */
	lea	%sp@(12),%sp	/* 100444b4:	4fef 000c */

.L100444b8:
	pea	%fp@(-46)	/* 100444b8:	486e ffd2 */
	moveal	%a3@,%a0	/* 100444bc:	2053 */
	movel	%a0@(20),%sp@-	/* 100444be:	2f28 0014 */
	movel	%a4,%sp@-	/* 100444c2:	2f0c */
	jsr	%pc@(sub_1004509e)	/* 100444c4:	4eba 0bd8 */
	pea	%fp@(-44)	/* 100444c8:	486e ffd4 */
	moveal	%a3@,%a0	/* 100444cc:	2053 */
	movel	%a0@(24),%sp@-	/* 100444ce:	2f28 0018 */
	movel	%a4,%sp@-	/* 100444d2:	2f0c */
	jsr	%pc@(sub_1004509e)	/* 100444d4:	4eba 0bc8 */
	movel	%a4,%sp@-	/* 100444d8:	2f0c */
	jsr	%pc@(sub_10044cb2)	/* 100444da:	4eba 07d6 */
	movew	%d0,%d5	/* 100444de:	3a00 */
	movel	%a4,%sp@-	/* 100444e0:	2f0c */
	jsr	%pc@(sub_10044cb2)	/* 100444e2:	4eba 07ce */
	movew	%d0,%d6	/* 100444e6:	3c00 */
	movel	%a4,%sp@-	/* 100444e8:	2f0c */
	jsr	%pc@(sub_10044cb2)	/* 100444ea:	4eba 07c6 */
	movew	%d0,%d7	/* 100444ee:	3e00 */
	moveq	#14,%d0	/* 100444f0:	700e */
	movel	%d0,%sp@-	/* 100444f2:	2f00 */
	movel	%a4@(2),%sp@-	/* 100444f4:	2f2c 0002 */
	jsr	%pc@(sub_1004531e)	/* 100444f8:	4eba 0e24 */
	movel	%a4@(2),%fp@(-38)	/* 100444fc:	2d6c 0002 ffda */
	movew	%fp@(14),%fp@(-34)	/* 10044502:	3d6e 000e ffde */
	moveq	#2,%d0	/* 10044508:	7002 */
	movel	%d0,%sp@-	/* 1004450a:	2f00 */
	pea	%fp@(-34)	/* 1004450c:	486e ffde */
	movel	%fp@(-38),%sp@-	/* 10044510:	2f2e ffda */
	jsr	%pc@(sub_100452b2)	/* 10044514:	4eba 0d9c */
	movel	%fp@(-38),%fp@(-32)	/* 10044518:	2d6e ffda ffe0 */
	movew	#7,%fp@(-28)	/* 1004451e:	3d7c 0007 ffe4 */
	moveq	#2,%d0	/* 10044524:	7002 */
	movel	%d0,%sp@-	/* 10044526:	2f00 */
	pea	%fp@(-28)	/* 10044528:	486e ffe4 */
	movel	%fp@(-32),%sp@-	/* 1004452c:	2f2e ffe0 */
	jsr	%pc@(sub_100452b2)	/* 10044530:	4eba 0d80 */
	moveq	#0,%d0	/* 10044534:	7000 */
	moveb	%d4,%d0	/* 10044536:	1004 */
	movel	%d0,%sp@-	/* 10044538:	2f00 */
	movel	%fp@(-42),%sp@-	/* 1004453a:	2f2e ffd6 */
	jsr	%pc@(sub_1004531e)	/* 1004453e:	4eba 0dde */
	extl	%d6	/* 10044542:	48c6 */
	movel	%d6,%sp@-	/* 10044544:	2f06 */
	extl	%d5	/* 10044546:	48c5 */
	movel	%d5,%sp@-	/* 10044548:	2f05 */
	movew	%fp@(-48),%d0	/* 1004454a:	302e ffd0 */
	extl	%d0	/* 1004454e:	48c0 */
	movel	%d0,%sp@-	/* 10044550:	2f00 */
	movew	%fp@(-50),%fp@(-26)	/* 10044552:	3d6e ffce ffe6 */
	moveq	#2,%d0	/* 10044558:	7002 */
	movel	%d0,%sp@-	/* 1004455a:	2f00 */
	pea	%fp@(-26)	/* 1004455c:	486e ffe6 */
	movel	%fp@(-42),%sp@-	/* 10044560:	2f2e ffd6 */
	jsr	%pc@(sub_100452b2)	/* 10044564:	4eba 0d4c */
	lea	%sp@(12),%sp	/* 10044568:	4fef 000c */
	movel	%fp@(-42),%sp@-	/* 1004456c:	2f2e ffd6 */
	jsr	%pc@(sub_10045262)	/* 10044570:	4eba 0cf0 */
	addql	#8,%sp	/* 10044574:	508f */
	movel	%d0,%sp@-	/* 10044576:	2f00 */
	jsr	%pc@(sub_10045262)	/* 10044578:	4eba 0ce8 */
	addql	#8,%sp	/* 1004457c:	508f */
	movel	%d0,%sp@-	/* 1004457e:	2f00 */
	jsr	%pc@(sub_10045262)	/* 10044580:	4eba 0ce0 */
	movew	%fp@(-46),%fp@(-24)	/* 10044584:	3d6e ffd2 ffe8 */
	moveq	#2,%d0	/* 1004458a:	7002 */
	movel	%d0,%sp@-	/* 1004458c:	2f00 */
	pea	%fp@(-24)	/* 1004458e:	486e ffe8 */
	movel	%fp@(-42),%sp@-	/* 10044592:	2f2e ffd6 */
	jsr	%pc@(sub_100452b2)	/* 10044596:	4eba 0d1a */
	extl	%d7	/* 1004459a:	48c7 */
	movel	%d7,%sp@-	/* 1004459c:	2f07 */
	movew	%fp@(-44),%fp@(-22)	/* 1004459e:	3d6e ffd4 ffea */
	moveq	#2,%d0	/* 100445a4:	7002 */
	movel	%d0,%sp@-	/* 100445a6:	2f00 */
	pea	%fp@(-22)	/* 100445a8:	486e ffea */
	movel	%fp@(-42),%sp@-	/* 100445ac:	2f2e ffd6 */
	jsr	%pc@(sub_100452b2)	/* 100445b0:	4eba 0d00 */
	lea	%sp@(12),%sp	/* 100445b4:	4fef 000c */
	movel	%fp@(-42),%sp@-	/* 100445b8:	2f2e ffd6 */
	jsr	%pc@(sub_10045262)	/* 100445bc:	4eba 0ca4 */
	moveal	%a3@,%a0	/* 100445c0:	2053 */
	movel	%a0@(4),%sp@-	/* 100445c2:	2f28 0004 */
	movel	%a4,%sp@-	/* 100445c6:	2f0c */
	jsr	%pc@(sub_10042b22)	/* 100445c8:	4eba e558 */
	cmpiw	#3,%d0	/* 100445cc:	0c40 0003 */
	lea	%sp@(112),%sp	/* 100445d0:	4fef 0070 */
	beqs	.L100445ee	/* 100445d4:	6718 */
	movew	%fp@(-50),%d0	/* 100445d6:	302e ffce */
	extl	%d0	/* 100445da:	48c0 */
	movel	%d0,%sp@-	/* 100445dc:	2f00 */
	moveal	%a3@,%a0	/* 100445de:	2053 */
	movel	%a0@(4),%sp@-	/* 100445e0:	2f28 0004 */
	movel	%a4,%sp@-	/* 100445e4:	2f0c */
	jsr	%pc@(sub_10044cd8)	/* 100445e6:	4eba 06f0 */
	lea	%sp@(12),%sp	/* 100445ea:	4fef 000c */

.L100445ee:
	jsr	%pc@(sub_1004aacc)	/* 100445ee:	4eba 64dc */
	moveal	%d0,%a0	/* 100445f2:	2040 */
	moveq	#1,%d0	/* 100445f4:	7001 */
	andl	%a0@(68),%d0	/* 100445f6:	c0a8 0044 */
	moveq	#1,%d1	/* 100445fa:	7201 */
	cmpl	%d0,%d1	/* 100445fc:	b280 */
	bnes	.L10044628	/* 100445fe:	6628 */
	jsr	%pc@(sub_1004aacc)	/* 10044600:	4eba 64ca */
	moveal	%d0,%a0	/* 10044604:	2040 */
	lea	%a0@(464),%a0	/* 10044606:	41e8 01d0 */
	movel	%a0,%fp@(-20)	/* 1004460a:	2d48 ffec */
	moveal	%a0@,%a1	/* 1004460e:	2250 */
	addql	#4,%a0@	/* 10044610:	5890 */
	moveq	#1,%d0	/* 10044612:	7001 */
	movel	%d0,%a1@	/* 10044614:	2280 */
	movew	%fp@(-48),%d0	/* 10044616:	302e ffd0 */
	extl	%d0	/* 1004461a:	48c0 */
	movel	%d0,%sp@-	/* 1004461c:	2f00 */
	movel	%a4,%sp@-	/* 1004461e:	2f0c */
	jsr	%pc@(sub_1004342c)	/* 10044620:	4eba ee0a */
	addqw	#8,%sp	/* 10044624:	504f */
	bras	.L10044654	/* 10044626:	602c */

.L10044628:
	moveal	%a3@,%a0	/* 10044628:	2053 */
	movel	%a0@(8),%sp@-	/* 1004462a:	2f28 0008 */
	movel	%a4,%sp@-	/* 1004462e:	2f0c */
	jsr	%pc@(sub_10042b22)	/* 10044630:	4eba e4f0 */
	cmpiw	#3,%d0	/* 10044634:	0c40 0003 */
	addqw	#8,%sp	/* 10044638:	504f */
	beqs	.L10044654	/* 1004463a:	6718 */
	movew	%fp@(-48),%d0	/* 1004463c:	302e ffd0 */
	extl	%d0	/* 10044640:	48c0 */
	movel	%d0,%sp@-	/* 10044642:	2f00 */
	moveal	%a3@,%a0	/* 10044644:	2053 */
	movel	%a0@(8),%sp@-	/* 10044646:	2f28 0008 */
	movel	%a4,%sp@-	/* 1004464a:	2f0c */
	jsr	%pc@(sub_10044cd8)	/* 1004464c:	4eba 068a */
	lea	%sp@(12),%sp	/* 10044650:	4fef 000c */

.L10044654:
	extl	%d5	/* 10044654:	48c5 */
	movel	%d5,%sp@-	/* 10044656:	2f05 */
	moveal	%a3@,%a0	/* 10044658:	2053 */
	movel	%a0@(12),%sp@-	/* 1004465a:	2f28 000c */
	movel	%a4,%sp@-	/* 1004465e:	2f0c */
	jsr	%pc@(sub_10044cd8)	/* 10044660:	4eba 0676 */
	extl	%d6	/* 10044664:	48c6 */
	movel	%d6,%sp@-	/* 10044666:	2f06 */
	moveal	%a3@,%a0	/* 10044668:	2053 */
	movel	%a0@(16),%sp@-	/* 1004466a:	2f28 0010 */
	movel	%a4,%sp@-	/* 1004466e:	2f0c */
	jsr	%pc@(sub_10044cd8)	/* 10044670:	4eba 0666 */
	moveal	%a3@,%a0	/* 10044674:	2053 */
	movel	%a0@(20),%sp@-	/* 10044676:	2f28 0014 */
	movel	%a4,%sp@-	/* 1004467a:	2f0c */
	jsr	%pc@(sub_10042b22)	/* 1004467c:	4eba e4a4 */
	cmpiw	#3,%d0	/* 10044680:	0c40 0003 */
	lea	%sp@(32),%sp	/* 10044684:	4fef 0020 */
	beqs	.L100446b8	/* 10044688:	672e */
	moveal	%a3@,%a0	/* 1004468a:	2053 */
	movel	%a0@(20),%fp@(-16)	/* 1004468c:	2d68 0014 fff0 */
	jsr	%pc@(sub_1004aacc)	/* 10044692:	4eba 6438 */
	moveal	%d0,%a0	/* 10044696:	2040 */
	lea	%a0@(464),%a0	/* 10044698:	41e8 01d0 */
	movel	%a0,%fp@(-20)	/* 1004469c:	2d48 ffec */
	moveal	%a0@,%a1	/* 100446a0:	2250 */
	addql	#4,%a0@	/* 100446a2:	5890 */
	movel	%fp@(-16),%a1@	/* 100446a4:	22ae fff0 */
	movew	%fp@(-46),%d0	/* 100446a8:	302e ffd2 */
	extl	%d0	/* 100446ac:	48c0 */
	movel	%d0,%sp@-	/* 100446ae:	2f00 */
	movel	%a4,%sp@-	/* 100446b0:	2f0c */
	jsr	%pc@(sub_10043042)	/* 100446b2:	4eba e98e */
	addqw	#8,%sp	/* 100446b6:	504f */

.L100446b8:
	moveal	%a3@,%a0	/* 100446b8:	2053 */
	movel	%a0@(24),%sp@-	/* 100446ba:	2f28 0018 */
	movel	%a4,%sp@-	/* 100446be:	2f0c */
	jsr	%pc@(sub_10042b22)	/* 100446c0:	4eba e460 */
	cmpiw	#3,%d0	/* 100446c4:	0c40 0003 */
	addqw	#8,%sp	/* 100446c8:	504f */
	beqs	.L100446fa	/* 100446ca:	672e */
	moveal	%a3@,%a0	/* 100446cc:	2053 */
	movel	%a0@(24),%fp@(-12)	/* 100446ce:	2d68 0018 fff4 */
	jsr	%pc@(sub_1004aacc)	/* 100446d4:	4eba 63f6 */
	moveal	%d0,%a0	/* 100446d8:	2040 */
	lea	%a0@(464),%a0	/* 100446da:	41e8 01d0 */
	movel	%a0,%fp@(-20)	/* 100446de:	2d48 ffec */
	moveal	%a0@,%a1	/* 100446e2:	2250 */
	addql	#4,%a0@	/* 100446e4:	5890 */
	movel	%fp@(-12),%a1@	/* 100446e6:	22ae fff4 */
	movew	%fp@(-44),%d0	/* 100446ea:	302e ffd4 */
	extl	%d0	/* 100446ee:	48c0 */
	movel	%d0,%sp@-	/* 100446f0:	2f00 */
	movel	%a4,%sp@-	/* 100446f2:	2f0c */
	jsr	%pc@(sub_10043042)	/* 100446f4:	4eba e94c */
	addqw	#8,%sp	/* 100446f8:	504f */

.L100446fa:
	moveal	%a3@,%a0	/* 100446fa:	2053 */
	movel	%a0@(28),%fp@(-8)	/* 100446fc:	2d68 001c fff8 */
	jsr	%pc@(sub_1004aacc)	/* 10044702:	4eba 63c8 */
	moveal	%d0,%a0	/* 10044706:	2040 */
	lea	%a0@(464),%a0	/* 10044708:	41e8 01d0 */
	movel	%a0,%fp@(-20)	/* 1004470c:	2d48 ffec */
	moveal	%a0@,%a1	/* 10044710:	2250 */
	addql	#4,%a0@	/* 10044712:	5890 */
	movel	%fp@(-8),%a1@	/* 10044714:	22ae fff8 */
	extl	%d7	/* 10044718:	48c7 */
	movel	%d7,%sp@-	/* 1004471a:	2f07 */
	movel	%a4,%sp@-	/* 1004471c:	2f0c */
	jsr	%pc@(sub_100432cc)	/* 1004471e:	4eba ebac */
	jsr	%pc@(sub_1004aacc)	/* 10044722:	4eba 63a8 */
	moveal	%d0,%a0	/* 10044726:	2040 */
	lea	%a0@(464),%a4	/* 10044728:	49e8 01d0 */
	movel	%a3,%a4@	/* 1004472c:	288b */
	addqw	#8,%sp	/* 1004472e:	504f */
	moveml	%fp@(-74),%d4-%d7/%a3-%a4	/* 10044730:	4cee 18f0 ffb6 */
	unlk	%fp	/* 10044736:	4e5e */
	rts	/* 10044738:	4e75 */

sub_1004473a:
	braw	sub_1003d212	/* 1004473a:	6000 8ad6 */

sub_1004473e:
	braw	sub_10043932	/* 1004473e:	6000 f1f2 */

sub_10044742:
	braw	sub_1003d216	/* 10044742:	6000 8ad2 */

sub_10044746:
	linkw	%fp,#-34	/* 10044746:	4e56 ffde */
	moveml	%d7/%a3-%a4,%sp@-	/* 1004474a:	48e7 0118 */
	moveal	%fp@(8),%a4	/* 1004474e:	286e 0008 */
	jsr	%pc@(sub_1004aacc)	/* 10044752:	4eba 6378 */
	moveal	%d0,%a0	/* 10044756:	2040 */
	lea	%a0@(464),%a0	/* 10044758:	41e8 01d0 */
	movel	%a0,%fp@(-4)	/* 1004475c:	2d48 fffc */
	moveal	%a0@,%a3	/* 10044760:	2650 */
	subqw	#4,%a3	/* 10044762:	594b */
	moveb	%fp@(19),%d7	/* 10044764:	1e2e 0013 */
	movel	%a4@(2),%fp@(-30)	/* 10044768:	2d6c 0002 ffe2 */
	pea	%fp@(-34)	/* 1004476e:	486e ffde */
	moveal	%a3@,%a0	/* 10044772:	2053 */
	movel	%a0@(4),%sp@-	/* 10044774:	2f28 0004 */
	movel	%a4,%sp@-	/* 10044778:	2f0c */
	jsr	%pc@(sub_10045040)	/* 1004477a:	4eba 08c4 */
	moveal	%a3@,%a0	/* 1004477e:	2053 */
	moveq	#1,%d0	/* 10044780:	7001 */
	cmpl	%a0@(8),%d0	/* 10044782:	b0a8 0008 */
	lea	%sp@(12),%sp	/* 10044786:	4fef 000c */
	bnes	.L1004479a	/* 1004478a:	660e */
	movel	%a4,%sp@-	/* 1004478c:	2f0c */
	jsr	%pc@(sub_10044cb2)	/* 1004478e:	4eba 0522 */
	movew	%d0,%fp@(-32)	/* 10044792:	3d40 ffe0 */
	addqw	#4,%sp	/* 10044796:	584f */
	bras	.L100447ae	/* 10044798:	6014 */

.L1004479a:
	pea	%fp@(-32)	/* 1004479a:	486e ffe0 */
	moveal	%a3@,%a0	/* 1004479e:	2053 */
	movel	%a0@(8),%sp@-	/* 100447a0:	2f28 0008 */
	movel	%a4,%sp@-	/* 100447a4:	2f0c */
	jsr	%pc@(sub_1004509e)	/* 100447a6:	4eba 08f6 */
	lea	%sp@(12),%sp	/* 100447aa:	4fef 000c */

.L100447ae:
	moveq	#14,%d0	/* 100447ae:	700e */
	movel	%d0,%sp@-	/* 100447b0:	2f00 */
	movel	%a4@(2),%sp@-	/* 100447b2:	2f2c 0002 */
	jsr	%pc@(sub_1004531e)	/* 100447b6:	4eba 0b66 */
	movel	%a4@(2),%fp@(-26)	/* 100447ba:	2d6c 0002 ffe6 */
	movew	%fp@(14),%fp@(-22)	/* 100447c0:	3d6e 000e ffea */
	moveq	#2,%d0	/* 100447c6:	7002 */
	movel	%d0,%sp@-	/* 100447c8:	2f00 */
	pea	%fp@(-22)	/* 100447ca:	486e ffea */
	movel	%fp@(-26),%sp@-	/* 100447ce:	2f2e ffe6 */
	jsr	%pc@(sub_100452b2)	/* 100447d2:	4eba 0ade */
	movel	%fp@(-26),%fp@(-20)	/* 100447d6:	2d6e ffe6 ffec */
	movew	#2,%fp@(-16)	/* 100447dc:	3d7c 0002 fff0 */
	moveq	#2,%d0	/* 100447e2:	7002 */
	movel	%d0,%sp@-	/* 100447e4:	2f00 */
	pea	%fp@(-16)	/* 100447e6:	486e fff0 */
	movel	%fp@(-20),%sp@-	/* 100447ea:	2f2e ffec */
	jsr	%pc@(sub_100452b2)	/* 100447ee:	4eba 0ac2 */
	moveq	#0,%d0	/* 100447f2:	7000 */
	moveb	%d7,%d0	/* 100447f4:	1007 */
	movel	%d0,%sp@-	/* 100447f6:	2f00 */
	movel	%fp@(-30),%sp@-	/* 100447f8:	2f2e ffe2 */
	jsr	%pc@(sub_1004531e)	/* 100447fc:	4eba 0b20 */
	movew	%fp@(-32),%d0	/* 10044800:	302e ffe0 */
	extl	%d0	/* 10044804:	48c0 */
	movel	%d0,%sp@-	/* 10044806:	2f00 */
	movew	%fp@(-34),%fp@(-14)	/* 10044808:	3d6e ffde fff2 */
	moveq	#2,%d0	/* 1004480e:	7002 */
	movel	%d0,%sp@-	/* 10044810:	2f00 */
	pea	%fp@(-14)	/* 10044812:	486e fff2 */
	movel	%fp@(-30),%sp@-	/* 10044816:	2f2e ffe2 */
	jsr	%pc@(sub_100452b2)	/* 1004481a:	4eba 0a96 */
	lea	%sp@(12),%sp	/* 1004481e:	4fef 000c */
	movel	%fp@(-30),%sp@-	/* 10044822:	2f2e ffe2 */
	jsr	%pc@(sub_10045262)	/* 10044826:	4eba 0a3a */
	moveal	%a3@,%a0	/* 1004482a:	2053 */
	movel	%a0@(4),%sp@-	/* 1004482c:	2f28 0004 */
	movel	%a4,%sp@-	/* 10044830:	2f0c */
	jsr	%pc@(sub_10042b22)	/* 10044832:	4eba e2ee */
	cmpiw	#3,%d0	/* 10044836:	0c40 0003 */
	lea	%sp@(56),%sp	/* 1004483a:	4fef 0038 */
	beqs	.L10044858	/* 1004483e:	6718 */
	movew	%fp@(-34),%d0	/* 10044840:	302e ffde */
	extl	%d0	/* 10044844:	48c0 */
	movel	%d0,%sp@-	/* 10044846:	2f00 */
	moveal	%a3@,%a0	/* 10044848:	2053 */
	movel	%a0@(4),%sp@-	/* 1004484a:	2f28 0004 */
	movel	%a4,%sp@-	/* 1004484e:	2f0c */
	jsr	%pc@(sub_10044cd8)	/* 10044850:	4eba 0486 */
	lea	%sp@(12),%sp	/* 10044854:	4fef 000c */

.L10044858:
	moveal	%a3@,%a0	/* 10044858:	2053 */
	moveq	#1,%d0	/* 1004485a:	7001 */
	cmpl	%a0@(8),%d0	/* 1004485c:	b0a8 0008 */
	bnes	.L1004488a	/* 10044860:	6628 */
	jsr	%pc@(sub_1004aacc)	/* 10044862:	4eba 6268 */
	moveal	%d0,%a0	/* 10044866:	2040 */
	lea	%a0@(464),%a0	/* 10044868:	41e8 01d0 */
	movel	%a0,%fp@(-12)	/* 1004486c:	2d48 fff4 */
	moveal	%a0@,%a1	/* 10044870:	2250 */
	addql	#4,%a0@	/* 10044872:	5890 */
	moveq	#1,%d0	/* 10044874:	7001 */
	movel	%d0,%a1@	/* 10044876:	2280 */
	movew	%fp@(-32),%d0	/* 10044878:	302e ffe0 */
	extl	%d0	/* 1004487c:	48c0 */
	movel	%d0,%sp@-	/* 1004487e:	2f00 */
	movel	%a4,%sp@-	/* 10044880:	2f0c */
	jsr	%pc@(sub_1004342c)	/* 10044882:	4eba eba8 */
	addqw	#8,%sp	/* 10044886:	504f */
	bras	.L100448cc	/* 10044888:	6042 */

.L1004488a:
	moveal	%a3@,%a0	/* 1004488a:	2053 */
	movel	%a0@(8),%sp@-	/* 1004488c:	2f28 0008 */
	movel	%a4,%sp@-	/* 10044890:	2f0c */
	jsr	%pc@(sub_10042b22)	/* 10044892:	4eba e28e */
	cmpiw	#3,%d0	/* 10044896:	0c40 0003 */
	addqw	#8,%sp	/* 1004489a:	504f */
	beqs	.L100448cc	/* 1004489c:	672e */
	moveal	%a3@,%a0	/* 1004489e:	2053 */
	movel	%a0@(8),%fp@(-8)	/* 100448a0:	2d68 0008 fff8 */
	jsr	%pc@(sub_1004aacc)	/* 100448a6:	4eba 6224 */
	moveal	%d0,%a0	/* 100448aa:	2040 */
	lea	%a0@(464),%a0	/* 100448ac:	41e8 01d0 */
	movel	%a0,%fp@(-12)	/* 100448b0:	2d48 fff4 */
	moveal	%a0@,%a1	/* 100448b4:	2250 */
	addql	#4,%a0@	/* 100448b6:	5890 */
	movel	%fp@(-8),%a1@	/* 100448b8:	22ae fff8 */
	movew	%fp@(-32),%d0	/* 100448bc:	302e ffe0 */
	extl	%d0	/* 100448c0:	48c0 */
	movel	%d0,%sp@-	/* 100448c2:	2f00 */
	movel	%a4,%sp@-	/* 100448c4:	2f0c */
	jsr	%pc@(sub_10043e7e)	/* 100448c6:	4eba f5b6 */
	addqw	#8,%sp	/* 100448ca:	504f */

.L100448cc:
	jsr	%pc@(sub_1004aacc)	/* 100448cc:	4eba 61fe */
	moveal	%d0,%a0	/* 100448d0:	2040 */
	lea	%a0@(464),%a4	/* 100448d2:	49e8 01d0 */
	movel	%a3,%a4@	/* 100448d6:	288b */
	moveml	%fp@(-46),%d7/%a3-%a4	/* 100448d8:	4cee 1880 ffd2 */
	unlk	%fp	/* 100448de:	4e5e */
	rts	/* 100448e0:	4e75 */
