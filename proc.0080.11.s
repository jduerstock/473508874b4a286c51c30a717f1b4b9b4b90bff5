...
.L1003c606:
	...
	cmpil	#825110585,%a0@(2)	/* 1003c628:	0ca8 312e 3039 0002 */
...
.L1003c642:
	...
	cmpil	#825110832,%a0@(2)	/* 1003c644:	0ca8 312e 3130 0002 */
...
sub_1003d21a:
	linkw	%fp,#0	/* 1003d21a:	4e56 0000 */
	subql	#4,%sp	/* 1003d21e:	598f */
	moveal	%fp@(8),%a0	/* 1003d220:	206e 0008 */
	moveal	%a0@,%a0	/* 1003d224:	2050 */
	movew	%a0@(6),%sp@-	/* 1003d226:	3f28 0006 */
	moveq	#4,%d0	/* 1003d22a:	7004 */
	movew	%d0,%sp@-	/* 1003d22c:	3f00 */
	movel	#-2080112628,%sp@-	/* 1003d22e:	2f3c 8404 000c */
	.short	0xa8b5	/* 1003d234:	a8b5 */
	movel	%sp@+,%d0	/* 1003d236:	201f */
	unlk	%fp	/* 1003d238:	4e5e */
	rts	/* 1003d23a:	4e75 */

sub_1003d23c:
	braw	sub_10035ecc	/* 1003d23c:	6000 8c8e */

sub_1003d240:
	braw	sub_10035ed0	/* 1003d240:	6000 8c8e */

sub_1003d244:
	linkw	%fp,#0	/* 1003d244:	4e56 0000 */
	movel	%a4,%sp@-	/* 1003d248:	2f0c */
	moveal	%fp@(8),%a4	/* 1003d24a:	286e 0008 */
	moveal	%a4@,%a0	/* 1003d24e:	2054 */
	movel	%a0@(364),%sp@-	/* 1003d250:	2f28 016c */
	movew	%a0@(20),%d0	/* 1003d254:	3028 0014 */
	extl	%d0	/* 1003d258:	48c0 */
	movel	%d0,%sp@-	/* 1003d25a:	2f00 */
	movel	#1347571523,%sp@-	/* 1003d25c:	2f3c 5052 4f43 */
	movel	%a4,%sp@-	/* 1003d262:	2f0c */
	jsr	%pc@(sub_1003c75c)	/* 1003d264:	4eba f4f6 */
	moveal	%a4@,%a0	/* 1003d268:	2054 */
	movel	%d0,%a0@(364)	/* 1003d26a:	2140 016c */
	subql	#4,%sp	/* 1003d26e:	598f */
	moveal	%a4@,%a0	/* 1003d270:	2054 */
	moveal	%a0@(364),%a0	/* 1003d272:	2068 016c */
	movel	%a0@,%sp@-	/* 1003d276:	2f10 */
	jsr	%pc@(sub_10043a1e)	/* 1003d278:	4eba 67a4 */
	movel	%sp@+,%d0	/* 1003d27c:	201f */
	moveal	%fp@(-4),%a4	/* 1003d27e:	286e fffc */
	unlk	%fp	/* 1003d282:	4e5e */
	rts	/* 1003d284:	4e75 */

sub_1003d286:
	linkw	%fp,#0	/* 1003d286:	4e56 0000 */
	movel	%a4,%sp@-	/* 1003d28a:	2f0c */
	moveal	%fp@(8),%a4	/* 1003d28c:	286e 0008 */
	moveal	%a4@,%a0	/* 1003d290:	2054 */
	movel	%a0@(406),%sp@-	/* 1003d292:	2f28 0196 */
	movew	%a0@(22),%d0	/* 1003d296:	3028 0016 */
	extl	%d0	/* 1003d29a:	48c0 */
	movel	%d0,%sp@-	/* 1003d29c:	2f00 */
	movel	#1095988579,%sp@-	/* 1003d29e:	2f3c 4153 7563 */
	movel	%a4,%sp@-	/* 1003d2a4:	2f0c */
	jsr	%pc@(sub_1003c75c)	/* 1003d2a6:	4eba f4b4 */
	moveal	%a4@,%a0	/* 1003d2aa:	2054 */
	movel	%d0,%a0@(406)	/* 1003d2ac:	2140 0196 */
	subql	#4,%sp	/* 1003d2b0:	598f */
	moveal	%a4@,%a0	/* 1003d2b2:	2054 */
	moveal	%a0@(406),%a0	/* 1003d2b4:	2068 0196 */
	movel	%a0@,%sp@-	/* 1003d2b8:	2f10 */
	jsr	%pc@(sub_10043a1e)	/* 1003d2ba:	4eba 6762 */
	movel	%sp@+,%d0	/* 1003d2be:	201f */
	moveal	%fp@(-4),%a4	/* 1003d2c0:	286e fffc */
	unlk	%fp	/* 1003d2c4:	4e5e */
	rts	/* 1003d2c6:	4e75 */

sub_1003d2c8:
	linkw	%fp,#0	/* 1003d2c8:	4e56 0000 */
	movel	%a4,%sp@-	/* 1003d2cc:	2f0c */
	moveal	%fp@(8),%a4	/* 1003d2ce:	286e 0008 */
	moveal	%a4@,%a0	/* 1003d2d2:	2054 */
	movel	%a0@(410),%sp@-	/* 1003d2d4:	2f28 019a */
	movew	%a0@(22),%d0	/* 1003d2d8:	3028 0016 */
	extl	%d0	/* 1003d2dc:	48c0 */
	movel	%d0,%sp@-	/* 1003d2de:	2f00 */
	movel	#1095987299,%sp@-	/* 1003d2e0:	2f3c 4153 7063 */
	movel	%a4,%sp@-	/* 1003d2e6:	2f0c */
	jsr	%pc@(sub_1003c75c)	/* 1003d2e8:	4eba f472 */
	moveal	%a4@,%a0	/* 1003d2ec:	2054 */
	movel	%d0,%a0@(410)	/* 1003d2ee:	2140 019a */
	subql	#4,%sp	/* 1003d2f2:	598f */
	moveal	%a4@,%a0	/* 1003d2f4:	2054 */
	moveal	%a0@(410),%a0	/* 1003d2f6:	2068 019a */
	movel	%a0@,%sp@-	/* 1003d2fa:	2f10 */
	jsr	%pc@(sub_10043a1e)	/* 1003d2fc:	4eba 6720 */
	movel	%sp@+,%d0	/* 1003d300:	201f */
	moveal	%fp@(-4),%a4	/* 1003d302:	286e fffc */
	unlk	%fp	/* 1003d306:	4e5e */
	rts	/* 1003d308:	4e75 */

sub_1003d30a:
	linkw	%fp,#0	/* 1003d30a:	4e56 0000 */
	movel	%a4,%sp@-	/* 1003d30e:	2f0c */
	moveal	%fp@(8),%a4	/* 1003d310:	286e 0008 */
	moveal	%a4@,%a0	/* 1003d314:	2054 */
	movel	%a0@(400),%sp@-	/* 1003d316:	2f28 0190 */
	movew	%a0@(26),%d0	/* 1003d31a:	3028 001a */
	extl	%d0	/* 1003d31e:	48c0 */
	movel	%d0,%sp@-	/* 1003d320:	2f00 */
	movel	#1347571523,%sp@-	/* 1003d322:	2f3c 5052 4f43 */
	movel	%a4,%sp@-	/* 1003d328:	2f0c */
	jsr	%pc@(sub_1003c75c)	/* 1003d32a:	4eba f430 */
	moveal	%a4@,%a0	/* 1003d32e:	2054 */
	movel	%d0,%a0@(400)	/* 1003d330:	2140 0190 */
	subql	#4,%sp	/* 1003d334:	598f */
	moveal	%a4@,%a0	/* 1003d336:	2054 */
	moveal	%a0@(400),%a0	/* 1003d338:	2068 0190 */
	movel	%a0@,%sp@-	/* 1003d33c:	2f10 */
	jsr	%pc@(sub_10043a1e)	/* 1003d33e:	4eba 66de */
	movel	%sp@+,%d0	/* 1003d342:	201f */
	moveal	%fp@(-4),%a4	/* 1003d344:	286e fffc */
	unlk	%fp	/* 1003d348:	4e5e */
	rts	/* 1003d34a:	4e75 */

sub_1003d34c:
	linkw	%fp,#0	/* 1003d34c:	4e56 0000 */
	movel	%a4,%sp@-	/* 1003d350:	2f0c */
	moveal	%fp@(8),%a4	/* 1003d352:	286e 0008 */
	moveal	%a4@,%a0	/* 1003d356:	2054 */
	movel	%a0@(396),%sp@-	/* 1003d358:	2f28 018c */
	movew	%a0@(26),%d0	/* 1003d35c:	3028 001a */
	extl	%d0	/* 1003d360:	48c0 */
	movel	%d0,%sp@-	/* 1003d362:	2f00 */
	movel	#1179403608,%sp@-	/* 1003d364:	2f3c 464c 4558 */
	movel	%a4,%sp@-	/* 1003d36a:	2f0c */
	jsr	%pc@(sub_1003c75c)	/* 1003d36c:	4eba f3ee */
	moveal	%a4@,%a0	/* 1003d370:	2054 */
	movel	%d0,%a0@(396)	/* 1003d372:	2140 018c */
	moveal	%a4@,%a0	/* 1003d376:	2054 */
	moveal	%a0@(396),%a0	/* 1003d378:	2068 018c */
	_HLock
	moveal	%a4@,%a0	/* 1003d37e:	2054 */
	movel	%a0@(396),%d0	/* 1003d380:	2028 018c */
	moveal	%fp@(-4),%a4	/* 1003d384:	286e fffc */
	unlk	%fp	/* 1003d388:	4e5e */
	rts	/* 1003d38a:	4e75 */

sub_1003d38c:
	linkw	%fp,#-56	/* 1003d38c:	4e56 ffc8 */
	moveml	%d7/%a3-%a4,%sp@-	/* 1003d390:	48e7 0118 */
	moveal	%fp@(8),%a4	/* 1003d394:	286e 0008 */
	moveq	#0,%d0	/* 1003d398:	7000 */
	moveal	%d0,%a3	/* 1003d39a:	2640 */
	moveal	%a4@,%a0	/* 1003d39c:	2054 */
	moveal	%a0@(414),%a3	/* 1003d39e:	2668 019e */
	tstl	%fp@(12)	/* 1003d3a2:	4aae 000c */
	bnes	.L1003d3ca	/* 1003d3a6:	6622 */
	moveq	#0,%d0	/* 1003d3a8:	7000 */
	movel	%d0,%sp@-	/* 1003d3aa:	2f00 */
	movew	%a0@(28),%d1	/* 1003d3ac:	3228 001c */
	extl	%d1	/* 1003d3b0:	48c1 */
	movel	%d1,%sp@-	/* 1003d3b2:	2f01 */
	movel	#1095988332,%sp@-	/* 1003d3b4:	2f3c 4153 746c */
	movel	%a4,%sp@-	/* 1003d3ba:	2f0c */
	jsr	%pc@(sub_1003c75c)	/* 1003d3bc:	4eba f39e */
	movel	%d0,%fp@(12)	/* 1003d3c0:	2d40 000c */
	lea	%sp@(16),%sp	/* 1003d3c4:	4fef 0010 */
	bras	.L1003d3f2	/* 1003d3c8:	6028 */

.L1003d3ca:
	moveal	%fp@(12),%a0	/* 1003d3ca:	206e 000c */
	_GetHandleSize
	moveq	#18,%d1	/* 1003d3d0:	7212 */
	jsr	%pc@(sub_1003fd42)	/* 1003d3d2:	4eba 296e */
	moveq	#8,%d1	/* 1003d3d6:	7208 */
	cmpl	%d0,%d1	/* 1003d3d8:	b280 */
	bnes	.L1003d3ec	/* 1003d3da:	6610 */
	movel	%fp@(12),%sp@-	/* 1003d3dc:	2f2e 000c */
	jsr	%pc@(sub_1003ac32)	/* 1003d3e0:	4eba d850 */
	movel	%d0,%fp@(12)	/* 1003d3e4:	2d40 000c */
	addqw	#4,%sp	/* 1003d3e8:	584f */
	bras	.L1003d3f2	/* 1003d3ea:	6006 */

.L1003d3ec:
	moveq	#0,%d0	/* 1003d3ec:	7000 */
	braw	.L1003d4ca	/* 1003d3ee:	6000 00da */

.L1003d3f2:
	moveq	#8,%d7	/* 1003d3f2:	7e08 */
	movel	%d7,%d1	/* 1003d3f4:	2207 */
	movel	%d1,%d0	/* 1003d3f6:	2001 */
	muluw	#18,%d1	/* 1003d3f8:	c2fc 0012 */
	swap	%d0	/* 1003d3fc:	4840 */
	muluw	#18,%d0	/* 1003d3fe:	c0fc 0012 */
	swap	%d0	/* 1003d402:	4840 */
	clrw	%d0	/* 1003d404:	4240 */
	addl	%d0,%d1	/* 1003d406:	d280 */
	movel	%d1,%sp@-	/* 1003d408:	2f01 */
	movel	%fp@(12),%sp@-	/* 1003d40a:	2f2e 000c */
	jsr	%pc@(sub_1003aa70)	/* 1003d40e:	4eba d660 */
	lea	%fp@(12),%a0	/* 1003d412:	41ee 000c */
	nop	/* 1003d416:	4e71 */
	jsr	%pc@(sub_10045034)	/* 1003d418:	4eba 7c1a */
	moveal	%d0,%a0	/* 1003d41c:	2040 */
	movel	%a0@(88),%fp@(-52)	/* 1003d41e:	2d68 0058 ffcc */
	lea	%fp@(-52),%a0	/* 1003d424:	41ee ffcc */
	movel	%a0,%sp@-	/* 1003d428:	2f08 */
	jsr	%pc@(sub_10045034)	/* 1003d42a:	4eba 7c08 */
	moveal	%sp@+,%a0	/* 1003d42e:	205f */
	moveal	%d0,%a1	/* 1003d430:	2240 */
	movel	%a0,%a1@(88)	/* 1003d432:	2348 0058 */
	lea	%fp@(-52),%a0	/* 1003d436:	41ee ffcc */
	lea	%fp@(-48),%a0	/* 1003d43a:	41ee ffd0 */
	lea	%pc@(.L1003d448),%a1	/* 1003d43e:	43fa 0008 */
	moveml	%d2-%d7/%a1-%a4/%fp-%sp,%a0@	/* 1003d442:	48d0 defc */
	moveq	#0,%d0	/* 1003d446:	7000 */

.L1003d448:
	movel	%d0,%d7	/* 1003d448:	2e00 */
	addqw	#8,%sp	/* 1003d44a:	504f */
	bnes	.L1003d46c	/* 1003d44c:	661e */
	movel	%fp@(12),%sp@-	/* 1003d44e:	2f2e 000c */
	moveal	%a4@,%a0	/* 1003d452:	2054 */
	movew	%a0@(28),%d0	/* 1003d454:	3028 001c */
	extl	%d0	/* 1003d458:	48c0 */
	movel	%d0,%sp@-	/* 1003d45a:	2f00 */
	movel	#1095988332,%sp@-	/* 1003d45c:	2f3c 4153 746c */
	jsr	%pc@(sub_1004059a)	/* 1003d462:	4eba 3136 */
	lea	%sp@(12),%sp	/* 1003d466:	4fef 000c */
	bras	.L1003d4a6	/* 1003d46a:	603a */

.L1003d46c:
	jsr	%pc@(sub_10045034)	/* 1003d46c:	4eba 7bc6 */
	moveal	%d0,%a0	/* 1003d470:	2040 */
	movel	%fp@(-52),%a0@(88)	/* 1003d472:	216e ffcc 0058 */
	tstl	%fp@(12)	/* 1003d478:	4aae 000c */
	beqs	.L1003d48a	/* 1003d47c:	670c */
	_DisposeHandle %fp@(12)
	moveq	#0,%d0	/* 1003d484:	7000 */
	movel	%d0,%fp@(12)	/* 1003d486:	2d40 000c */

.L1003d48a:
	movel	%d7,%d0	/* 1003d48a:	2007 */
	movel	%d0,%fp@(-56)	/* 1003d48c:	2d40 ffc8 */
	jsr	%pc@(sub_10045034)	/* 1003d490:	4eba 7ba2 */
	moveal	%d0,%a0	/* 1003d494:	2040 */
	moveal	%a0@(88),%a0	/* 1003d496:	2068 0058 */
	addql	#4,%a0	/* 1003d49a:	5888 */
	movel	%fp@(-56),%d0	/* 1003d49c:	202e ffc8 */
	moveml	%a0@,%d2-%d7/%a1-%a4/%fp-%sp	/* 1003d4a0:	4cd0 defc */
	jmp	%a1@	/* 1003d4a4:	4ed1 */

.L1003d4a6:
	moveq	#2,%d0	/* 1003d4a6:	7002 */
	movel	%d0,%sp@-	/* 1003d4a8:	2f00 */
	pea	%fp@(-52)	/* 1003d4aa:	486e ffcc */
	jsr	%pc@(sub_10044ae6)	/* 1003d4ae:	4eba 7636 */
	moveal	%a4@,%a0	/* 1003d4b2:	2054 */
	movel	%fp@(12),%a0@(414)	/* 1003d4b4:	216e 000c 019e */
	movel	%a3,%d0	/* 1003d4ba:	200b */
	addqw	#8,%sp	/* 1003d4bc:	504f */
	beqs	.L1003d4c8	/* 1003d4be:	6708 */
	_DisposeHandle %a3
	moveq	#0,%d0	/* 1003d4c4:	7000 */
	moveal	%d0,%a3	/* 1003d4c6:	2640 */

.L1003d4c8:
	moveq	#1,%d0	/* 1003d4c8:	7001 */

.L1003d4ca:
	moveml	%fp@(-68),%d7/%a3-%a4	/* 1003d4ca:	4cee 1880 ffbc */
	unlk	%fp	/* 1003d4d0:	4e5e */
	rts	/* 1003d4d2:	4e75 */
